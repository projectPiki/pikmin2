...
/* 801AA6E8 001A7628  41 82 00 0C */	beq lbl_801AA6F4
...
/* 801AA7B4 001A76F4  40 82 00 14 */	bne lbl_801AA7C8
...
/* 801AA7D0 001A7710  42 00 FF D8 */	bdnz lbl_801AA7A8
...
/* 801AA8DC 001A781C  41 82 00 30 */	beq lbl_801AA90C
...
/* 801AA900 001A7840  40 81 00 0C */	ble lbl_801AA90C
...
/* 801AA944 001A7884  40 82 00 28 */	bne lbl_801AA96C
/* 801AA948 001A7888  80 7F 00 18 */	lwz r3, 0x18(r31)
/* 801AA94C 001A788C  28 03 00 00 */	cmplwi r3, 0
/* 801AA950 001A7890  41 82 00 1C */	beq lbl_801AA96C
...
/* 801AA98C 001A78CC  40 82 00 0C */	bne lbl_801AA998
...
/* 801AA9DC 001A791C  41 82 00 38 */	beq lbl_801AAA14
...
/* 801AAA00 001A7940  41 82 00 14 */	beq lbl_801AAA14
...
/* 801AAA1C 001A795C  41 82 00 30 */	beq lbl_801AAA4C
...
/* 801AAA30 001A7970  41 82 00 0C */	beq lbl_801AAA3C
...
/* 801AAA48 001A7988  48 00 00 0C */	b lbl_801AAA54
lbl_801AAA4C:
/* 801AAA4C 001A798C  38 60 00 00 */	li r3, 0
/* 801AAA50 001A7990  48 00 00 08 */	b lbl_801AAA58
lbl_801AAA54:
...
/* 801AAA94 001A79D4  40 82 00 0C */	bne lbl_801AAAA0
/* 801AAA98 001A79D8  38 60 00 01 */	li r3, 1
/* 801AAA9C 001A79DC  48 00 00 44 */	b lbl_801AAAE0
lbl_801AAAA0:
...
/* 801AAAB4 001A79F4  40 82 00 28 */	bne lbl_801AAADC
...
/* 801AAAD0 001A7A10  41 82 00 0C */	beq lbl_801AAADC
/* 801AAAD4 001A7A14  38 60 00 00 */	li r3, 0
/* 801AAAD8 001A7A18  48 00 00 08 */	b lbl_801AAAE0
lbl_801AAADC:
...
/* 801AAB1C 001A7A5C  41 82 00 68 */	beq lbl_801AAB84
...
/* 801AAB2C 001A7A6C  41 82 00 0C */	beq lbl_801AAB38
...
/* 801AAB80 001A7AC0  48 00 00 20 */	b lbl_801AABA0
lbl_801AAB84:
...
/* 801AABD8 001A7B18  40 82 00 0C */	bne lbl_801AABE4
/* 801AABDC 001A7B1C  38 00 00 00 */	li r0, 0
/* 801AABE0 001A7B20  48 00 00 24 */	b lbl_801AAC04
lbl_801AABE4:
...
/* 801AABF4 001A7B34  40 80 00 0C */	bge lbl_801AAC00
/* 801AABF8 001A7B38  38 00 00 01 */	li r0, 1
/* 801AABFC 001A7B3C  48 00 00 08 */	b lbl_801AAC04
lbl_801AAC00:
/* 801AAC00 001A7B40  38 00 00 00 */	li r0, 0
lbl_801AAC04:
/* 801AAC04 001A7B44  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801AAC08 001A7B48  41 82 00 14 */	beq lbl_801AAC1C
...
/* 801AACA8 001A7BE8  41 80 00 0C */	blt lbl_801AACB4
...
/* 801AACD8 001A7C18  41 82 00 08 */	beq lbl_801AACE0
...
/* 801AACFC 001A7C3C  40 82 00 0C */	bne lbl_801AAD08
...
/* 801AAD54 001A7C94  41 80 00 14 */	blt lbl_801AAD68
...
/* 801AAD64 001A7CA4  48 00 00 10 */	b lbl_801AAD74
lbl_801AAD68:
...
/* 801AAD84 001A7CC4  41 80 00 18 */	blt lbl_801AAD9C
...
/* 801AAD98 001A7CD8  48 00 00 28 */	b lbl_801AADC0
lbl_801AAD9C:
/* 801AAD9C 001A7CDC  38 03 2E 31 */	addi r0, r3, 0x2e31
/* 801AADA0 001A7CE0  7C 04 00 40 */	cmplw r4, r0
/* 801AADA4 001A7CE4  41 80 00 14 */	blt lbl_801AADB8
...
/* 801AADB4 001A7CF4  48 00 00 0C */	b lbl_801AADC0
lbl_801AADB8:
...
/* 801AADC8 001A7D08  40 82 00 28 */	bne lbl_801AADF0
...
/* 801AADE8 001A7D28  41 80 FF E8 */	blt lbl_801AADD0
/* 801AADEC 001A7D2C  48 00 00 90 */	b lbl_801AAE7C
lbl_801AADF0:
...
/* 801AAE00 001A7D40  41 80 00 44 */	blt lbl_801AAE44
...
/* 801AAE10 001A7D50  41 82 00 28 */	beq lbl_801AAE38
...
/* 801AAE30 001A7D70  41 80 FF E8 */	blt lbl_801AAE18
/* 801AAE34 001A7D74  48 00 00 18 */	b lbl_801AAE4C
lbl_801AAE38:
/* 801AAE38 001A7D78  38 00 00 00 */	li r0, 0
/* 801AAE3C 001A7D7C  98 1E 00 20 */	stb r0, 0x20(r30)
/* 801AAE40 001A7D80  48 00 00 0C */	b lbl_801AAE4C
lbl_801AAE44:
...
/* 801AAE84 001A7DC4  41 82 00 8C */	beq lbl_801AAF10
...
/* 801AAF0C 001A7E4C  48 00 00 28 */	b lbl_801AAF34
lbl_801AAF10:
...
/* 801AAF3C 001A7E7C  41 82 00 18 */	beq lbl_801AAF54
...
/* 801AAF50 001A7E90  48 00 00 28 */	b lbl_801AAF78
lbl_801AAF54:
...
/* 801AAFB0 001A7EF0  40 81 00 38 */	ble lbl_801AAFE8
lbl_801AAFB4:
...
/* 801AAFC0 001A7F00  40 82 00 1C */	bne lbl_801AAFDC
...
/* 801AAFD8 001A7F18  48 00 00 14 */	b lbl_801AAFEC
lbl_801AAFDC:
/* 801AAFDC 001A7F1C  38 84 00 10 */	addi r4, r4, 0x10
/* 801AAFE0 001A7F20  38 63 00 01 */	addi r3, r3, 1
/* 801AAFE4 001A7F24  42 00 FF D0 */	bdnz lbl_801AAFB4
lbl_801AAFE8:
...
/* 801AB024 001A7F64  48 00 00 1C */	b lbl_801AB040
lbl_801AB028:
...
/* 801AB060 001A7FA0  41 82 00 20 */	beq lbl_801AB080
...
/* 801AB07C 001A7FBC  48 00 00 10 */	b lbl_801AB08C
lbl_801AB080:
...
/* 801AB090 001A7FD0  48 00 00 0C */	b lbl_801AB09C
lbl_801AB094:
...
/* 801AB17C 001A80BC  40 82 00 48 */	bne lbl_801AB1C4
...
/* 801AB1A8 001A80E8  41 80 FF E8 */	blt lbl_801AB190
...
/* 801AB1C0 001A8100  48 00 00 40 */	b lbl_801AB200
lbl_801AB1C4:
...
/* 801AB208 001A8148  41 82 00 EC */	beq lbl_801AB2F4
...
/* 801AB2F0 001A8230  48 00 00 84 */	b lbl_801AB374
lbl_801AB2F4:
...
/* 801AB37C 001A82BC  41 82 00 B0 */	beq lbl_801AB42C
...
/* 801AB3AC 001A82EC  40 82 00 30 */	bne lbl_801AB3DC
...
/* 801AB3FC 001A833C  41 82 00 20 */	beq lbl_801AB41C
...
/* 801AB418 001A8358  48 00 00 20 */	b lbl_801AB438
lbl_801AB41C:
...
/* 801AB428 001A8368  48 00 00 10 */	b lbl_801AB438
lbl_801AB42C:
...
/* 801AB514 001A8454  40 82 00 34 */	bne lbl_801AB548
...
/* 801AB524 001A8464  41 82 00 20 */	beq lbl_801AB544
...
/* 801AB580 001A84C0  40 82 00 10 */	bne lbl_801AB590
...
/* 801AB594 001A84D4  48 00 00 08 */	b lbl_801AB59C
lbl_801AB598:
...
/* 801AB5A4 001A84E4  40 82 FF F4 */	bne lbl_801AB598
...
/* 801AB5C8 001A8508  48 00 01 18 */	b lbl_801AB6E0
lbl_801AB5CC:
/* 801AB5CC 001A850C  80 9F 00 84 */	lwz r4, 0x84(r31)
/* 801AB5D0 001A8510  2C 04 FF FF */	cmpwi r4, -1
/* 801AB5D4 001A8514  40 82 00 0C */	bne lbl_801AB5E0
/* 801AB5D8 001A8518  38 00 00 00 */	li r0, 0
/* 801AB5DC 001A851C  48 00 00 24 */	b lbl_801AB600
lbl_801AB5E0:
...
/* 801AB5F0 001A8530  40 80 00 0C */	bge lbl_801AB5FC
/* 801AB5F4 001A8534  38 00 00 01 */	li r0, 1
/* 801AB5F8 001A8538  48 00 00 08 */	b lbl_801AB600
lbl_801AB5FC:
/* 801AB5FC 001A853C  38 00 00 00 */	li r0, 0
lbl_801AB600:
/* 801AB600 001A8540  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801AB604 001A8544  41 82 00 14 */	beq lbl_801AB618
...
/* 801AB6A4 001A85E4  41 80 00 0C */	blt lbl_801AB6B0
...
/* 801AB6D4 001A8614  41 82 00 08 */	beq lbl_801AB6DC
...
/* 801AB6E4 001A8624  40 82 FE E8 */	bne lbl_801AB5CC
...
/* 801AB700 001A8640  48 00 00 0C */	b lbl_801AB70C
lbl_801AB704:
...
/* 801AB710 001A8650  40 82 FF F4 */	bne lbl_801AB704
...
/* 801AB72C 001A866C  48 00 00 68 */	b lbl_801AB794
lbl_801AB730:
/* 801AB730 001A8670  80 9F 00 84 */	lwz r4, 0x84(r31)
/* 801AB734 001A8674  2C 04 FF FF */	cmpwi r4, -1
/* 801AB738 001A8678  40 82 00 0C */	bne lbl_801AB744
/* 801AB73C 001A867C  38 00 00 00 */	li r0, 0
/* 801AB740 001A8680  48 00 00 24 */	b lbl_801AB764
lbl_801AB744:
...
/* 801AB798 001A86D8  40 82 FF 98 */	bne lbl_801AB730
...
/* 801AB7F8 001A8738  41 82 01 F4 */	beq lbl_801AB9EC
...
/* 801AB81C 001A875C  41 82 00 E4 */	beq lbl_801AB900
...
/* 801AB840 001A8780  41 82 00 5C */	beq lbl_801AB89C
...
/* 801AB868 001A87A8  41 82 00 14 */	beq lbl_801AB87C
...
/* 801AB888 001A87C8  41 82 00 14 */	beq lbl_801AB89C
...
/* 801AB8A4 001A87E4  41 82 00 5C */	beq lbl_801AB900
...
/* 801AB8CC 001A880C  41 82 00 14 */	beq lbl_801AB8E0
...
/* 801AB8EC 001A882C  41 82 00 14 */	beq lbl_801AB900
...
/* 801AB908 001A8848  41 82 00 E4 */	beq lbl_801AB9EC
...
/* 801AB92C 001A886C  41 82 00 5C */	beq lbl_801AB988
...
/* 801AB954 001A8894  41 82 00 14 */	beq lbl_801AB968
...
/* 801AB974 001A88B4  41 82 00 14 */	beq lbl_801AB988
...
/* 801AB990 001A88D0  41 82 00 5C */	beq lbl_801AB9EC
...
/* 801AB9B8 001A88F8  41 82 00 14 */	beq lbl_801AB9CC
...
/* 801AB9D8 001A8918  41 82 00 14 */	beq lbl_801AB9EC
...
/* 801AB9F4 001A8934  41 82 01 F4 */	beq lbl_801ABBE8
...
/* 801ABA18 001A8958  41 82 00 E4 */	beq lbl_801ABAFC
...
/* 801ABA3C 001A897C  41 82 00 5C */	beq lbl_801ABA98
...
/* 801ABA64 001A89A4  41 82 00 14 */	beq lbl_801ABA78
...
/* 801ABA84 001A89C4  41 82 00 14 */	beq lbl_801ABA98
...
/* 801ABAA0 001A89E0  41 82 00 5C */	beq lbl_801ABAFC
...
/* 801ABAC8 001A8A08  41 82 00 14 */	beq lbl_801ABADC
...
/* 801ABAE8 001A8A28  41 82 00 14 */	beq lbl_801ABAFC
...
/* 801ABB04 001A8A44  41 82 00 E4 */	beq lbl_801ABBE8
...
/* 801ABB28 001A8A68  41 82 00 5C */	beq lbl_801ABB84
...
/* 801ABB50 001A8A90  41 82 00 14 */	beq lbl_801ABB64
...
/* 801ABB70 001A8AB0  41 82 00 14 */	beq lbl_801ABB84
...
/* 801ABB8C 001A8ACC  41 82 00 5C */	beq lbl_801ABBE8
...
/* 801ABBB4 001A8AF4  41 82 00 14 */	beq lbl_801ABBC8
...
/* 801ABBD4 001A8B14  41 82 00 14 */	beq lbl_801ABBE8
...
/* 801ABC44 001A8B84  41 82 00 24 */	beq lbl_801ABC68
/* 801ABC48 001A8B88  41 82 00 18 */	beq lbl_801ABC60
...
/* 801ABCBC 001A8BFC  41 82 00 10 */	beq lbl_801ABCCC
...
/* 801ABCE4 001A8C24  48 00 01 F8 */	b lbl_801ABEDC
lbl_801ABCE8:
/* 801ABCE8 001A8C28  80 1D 00 30 */	lwz r0, 0x30(r29)
/* 801ABCEC 001A8C2C  28 00 00 00 */	cmplwi r0, 0
/* 801ABCF0 001A8C30  40 82 00 EC */	bne lbl_801ABDDC
...
/* 801ABD00 001A8C40  41 82 00 B4 */	beq lbl_801ABDB4
...
/* 801ABDD8 001A8D18  48 00 01 00 */	b lbl_801ABED8
lbl_801ABDDC:
...
/* 801ABDE8 001A8D28  41 82 00 B4 */	beq lbl_801ABE9C
...
/* 801ABEB0 001A8DF0  48 00 00 08 */	b lbl_801ABEB8
lbl_801ABEB4:
...
/* 801ABEC0 001A8E00  40 82 FF F4 */	bne lbl_801ABEB4
...
/* 801ABEE4 001A8E24  41 80 FE 04 */	blt lbl_801ABCE8
...
/* 801ABF24 001A8E64  41 82 00 8C */	beq lbl_801ABFB0
/* 801ABF28 001A8E68  80 03 00 20 */	lwz r0, 0x20(r3)
/* 801ABF2C 001A8E6C  28 00 00 00 */	cmplwi r0, 0
/* 801ABF30 001A8E70  41 82 00 80 */	beq lbl_801ABFB0
...
/* 801ABFB8 001A8EF8  41 82 00 14 */	beq lbl_801ABFCC
...
/* 801ABFFC 001A8F3C  41 82 00 24 */	beq lbl_801AC020
/* 801AC000 001A8F40  80 63 00 20 */	lwz r3, 0x20(r3)
/* 801AC004 001A8F44  28 03 00 00 */	cmplwi r3, 0
/* 801AC008 001A8F48  41 82 00 18 */	beq lbl_801AC020
...
/* 801AC028 001A8F68  41 82 00 14 */	beq lbl_801AC03C
...
/* 801AC074 001A8FB4  41 82 00 14 */	beq lbl_801AC088
/* 801AC078 001A8FB8  80 63 00 20 */	lwz r3, 0x20(r3)
/* 801AC07C 001A8FBC  28 03 00 00 */	cmplwi r3, 0
/* 801AC080 001A8FC0  41 82 00 08 */	beq lbl_801AC088
...
/* 801AC090 001A8FD0  41 82 00 18 */	beq lbl_801AC0A8
...
/* 801AC0DC 001A901C  41 82 00 14 */	beq lbl_801AC0F0
/* 801AC0E0 001A9020  80 63 00 20 */	lwz r3, 0x20(r3)
/* 801AC0E4 001A9024  28 03 00 00 */	cmplwi r3, 0
/* 801AC0E8 001A9028  41 82 00 08 */	beq lbl_801AC0F0
...
/* 801AC0F8 001A9038  41 82 00 14 */	beq lbl_801AC10C
...
/* 801AC13C 001A907C  41 82 00 14 */	beq lbl_801AC150
...
/* 801AC158 001A9098  41 82 00 14 */	beq lbl_801AC16C
...
/* 801AC174 001A90B4  41 82 00 14 */	beq lbl_801AC188
...
/* 801AC1B8 001A90F8  41 82 00 14 */	beq lbl_801AC1CC
...
/* 801AC1D4 001A9114  41 82 00 14 */	beq lbl_801AC1E8
...
/* 801AC1F0 001A9130  41 82 00 14 */	beq lbl_801AC204
...
/* 801AC23C 001A917C  41 82 00 14 */	beq lbl_801AC250
...
/* 801AC258 001A9198  41 82 00 18 */	beq lbl_801AC270
...
/* 801AC278 001A91B8  41 82 00 18 */	beq lbl_801AC290
...
/* 801AC2C4 001A9204  41 82 00 14 */	beq lbl_801AC2D8
...
/* 801AC2E0 001A9220  41 82 00 14 */	beq lbl_801AC2F4
...
/* 801AC2FC 001A923C  41 82 00 14 */	beq lbl_801AC310
...
/* 801AC340 001A9280  41 82 00 28 */	beq lbl_801AC368
...
/* 801AC35C 001A929C  40 81 00 0C */	ble lbl_801AC368
