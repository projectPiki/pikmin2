...
/* 8022D150 0022A090  41 82 00 10 */	beq .L_8022D160
...
/* 8022D170 0022A0B0  41 82 00 4C */	beq .L_8022D1BC
...
/* 8022D204 0022A144  41 82 00 0C */	beq .L_8022D210
...
/* 8022D270 0022A1B0  90 1E 03 88 */	stw r0, 0x3ac(r30)
/* 8022D274 0022A1B4  90 1E 03 8C */	stw r0, 0x3b0(r30)
/* 8022D278 0022A1B8  90 1E 03 90 */	stw r0, 0x3b4(r30)
/* 8022D27C 0022A1BC  90 1E 03 94 */	stw r0, 0x3b8(r30)
/* 8022D280 0022A1C0  90 1E 03 98 */	stw r0, 0x3bc(r30)
/* 8022D284 0022A1C4  90 1E 03 9C */	stw r0, 0x3c0(r30)
/* 8022D288 0022A1C8  90 1E 03 A0 */	stw r0, 0x3c4(r30)
...
/* 8022D2F0 0022A230  40 82 01 30 */	bne .L_8022D420
/* 8022D2F4 0022A234  88 1E 00 28 */	lbz r0, 0x28(r30)
/* 8022D2F8 0022A238  28 00 00 00 */	cmplwi r0, 0
/* 8022D2FC 0022A23C  41 82 00 24 */	beq .L_8022D320
...
/* 8022D394 0022A2D4  41 82 00 0C */	beq .L_8022D3A0
/* 8022D398 0022A2D8  2C 00 00 03 */	cmpwi r0, 3
/* 8022D39C 0022A2DC  40 82 00 08 */	bne .L_8022D3A4
.L_8022D3A0:
/* 8022D3A0 0022A2E0  38 60 00 01 */	li r3, 1
.L_8022D3A4:
/* 8022D3A4 0022A2E4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8022D3A8 0022A2E8  41 82 00 20 */	beq .L_8022D3C8
/* 8022D3AC 0022A2EC  80 BF 03 34 */	lwz r5, 0x358(r31)
...
/* 8022D3C4 0022A304  48 00 00 1C */	b .L_8022D3E0
.L_8022D3C8:
/* 8022D3C8 0022A308  80 BF 03 3C */	lwz r5, 0x360(r31)
...
/* 8022D41C 0022A35C  48 00 01 5C */	b .L_8022D578
.L_8022D420:
...
/* 8022D430 0022A370  41 82 00 08 */	beq .L_8022D438
...
/* 8022D44C 0022A38C  40 82 00 64 */	bne .L_8022D4B0
...
/* 8022D45C 0022A39C  40 81 00 54 */	ble .L_8022D4B0
/* 8022D460 0022A3A0  80 1E 00 48 */	lwz r0, 0x48(r30)
/* 8022D464 0022A3A4  2C 00 00 02 */	cmpwi r0, 2
/* 8022D468 0022A3A8  40 82 00 34 */	bne .L_8022D49C
...
/* 8022D480 0022A3C0  41 82 00 1C */	beq .L_8022D49C
...
/* 8022D4B8 0022A3F8  40 82 00 C0 */	bne .L_8022D578
/* 8022D4BC 0022A3FC  80 1E 00 48 */	lwz r0, 0x48(r30)
/* 8022D4C0 0022A400  2C 00 00 02 */	cmpwi r0, 2
/* 8022D4C4 0022A404  40 82 00 B4 */	bne .L_8022D578
...
/* 8022D4D8 0022A418  41 82 00 0C */	beq .L_8022D4E4
/* 8022D4DC 0022A41C  2C 03 00 03 */	cmpwi r3, 3
/* 8022D4E0 0022A420  40 82 00 08 */	bne .L_8022D4E8
.L_8022D4E4:
/* 8022D4E4 0022A424  38 00 00 01 */	li r0, 1
.L_8022D4E8:
/* 8022D4E8 0022A428  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 8022D4EC 0022A42C  40 82 00 20 */	bne .L_8022D50C
/* 8022D4F0 0022A430  2C 03 00 01 */	cmpwi r3, 1
/* 8022D4F4 0022A434  40 82 00 84 */	bne .L_8022D578
...
/* 8022D508 0022A448  40 82 00 70 */	bne .L_8022D578
.L_8022D50C:
...
/* 8022D530 0022A470  40 82 00 28 */	bne .L_8022D558
...
/* 8022D554 0022A494  48 00 00 24 */	b .L_8022D578
.L_8022D558:
