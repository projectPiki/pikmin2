...
/* 801D0E38 001CDD78  48 00 00 18 */	b lbl_801D0E50
lbl_801D0E3C:
...
/* 801D0EAC 001CDDEC  48 00 00 2C */	b lbl_801D0ED8
lbl_801D0EB0:
...
/* 801D0F14 001CDE54  48 00 00 18 */	b lbl_801D0F2C
lbl_801D0F18:
...
/* 801D0FDC 001CDF1C  48 00 00 2C */	b lbl_801D1008
lbl_801D0FE0:
...
/* 801D10B8 001CDFF8  41 80 00 10 */	blt lbl_801D10C8
/* 801D10BC 001CDFFC  2C 1F 00 07 */	cmpwi r31, 7
/* 801D10C0 001CE000  40 80 00 08 */	bge lbl_801D10C8
/* 801D10C4 001CE004  38 00 00 01 */	li r0, 1
lbl_801D10C8:
/* 801D10C8 001CE008  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801D10CC 001CE00C  40 82 00 20 */	bne lbl_801D10EC
...
/* 801D113C 001CE07C  41 80 00 10 */	blt lbl_801D114C
/* 801D1140 001CE080  2C 1F 00 07 */	cmpwi r31, 7
/* 801D1144 001CE084  40 80 00 08 */	bge lbl_801D114C
/* 801D1148 001CE088  38 00 00 01 */	li r0, 1
lbl_801D114C:
/* 801D114C 001CE08C  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801D1150 001CE090  40 82 00 20 */	bne lbl_801D1170
...
/* 801D11BC 001CE0FC  41 80 00 10 */	blt lbl_801D11CC
/* 801D11C0 001CE100  2C 1F 00 07 */	cmpwi r31, 7
/* 801D11C4 001CE104  40 80 00 08 */	bge lbl_801D11CC
/* 801D11C8 001CE108  38 00 00 01 */	li r0, 1
lbl_801D11CC:
/* 801D11CC 001CE10C  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801D11D0 001CE110  40 82 00 20 */	bne lbl_801D11F0
...
/* 801D123C 001CE17C  41 80 00 10 */	blt lbl_801D124C
/* 801D1240 001CE180  2C 1F 00 07 */	cmpwi r31, 7
/* 801D1244 001CE184  40 80 00 08 */	bge lbl_801D124C
/* 801D1248 001CE188  38 00 00 01 */	li r0, 1
lbl_801D124C:
/* 801D124C 001CE18C  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801D1250 001CE190  40 82 00 20 */	bne lbl_801D1270
...
/* 801D138C 001CE2CC  41 82 00 0C */	beq lbl_801D1398
/* 801D1390 001CE2D0  A3 E5 02 DC */	lhz r31, 0x2dc(r5)
/* 801D1394 001CE2D4  48 00 00 08 */	b lbl_801D139C
lbl_801D1398:
...
/* 801D13A8 001CE2E8  41 80 00 10 */	blt lbl_801D13B8
/* 801D13AC 001CE2EC  2C 1E 00 07 */	cmpwi r30, 7
/* 801D13B0 001CE2F0  40 80 00 08 */	bge lbl_801D13B8
/* 801D13B4 001CE2F4  38 00 00 01 */	li r0, 1
lbl_801D13B8:
/* 801D13B8 001CE2F8  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801D13BC 001CE2FC  40 82 00 20 */	bne lbl_801D13DC
...
/* 801D1438 001CE378  41 82 00 0C */	beq lbl_801D1444
/* 801D143C 001CE37C  A3 E5 02 DC */	lhz r31, 0x2dc(r5)
/* 801D1440 001CE380  48 00 00 08 */	b lbl_801D1448
lbl_801D1444:
...
/* 801D1454 001CE394  41 80 00 10 */	blt lbl_801D1464
/* 801D1458 001CE398  2C 1E 00 07 */	cmpwi r30, 7
/* 801D145C 001CE39C  40 80 00 08 */	bge lbl_801D1464
/* 801D1460 001CE3A0  38 00 00 01 */	li r0, 1
lbl_801D1464:
/* 801D1464 001CE3A4  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 801D1468 001CE3A8  40 82 00 20 */	bne lbl_801D1488
