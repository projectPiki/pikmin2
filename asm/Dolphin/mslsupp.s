...
/* 800C0A28 000BD968  40 82 00 0C */	bne lbl_800C0A34
/* 800C0A2C 000BD96C  38 60 00 01 */	li r3, 1
/* 800C0A30 000BD970  48 00 00 4C */	b lbl_800C0A7C
lbl_800C0A34:
/* 800C0A34 000BD974  7F E4 FB 78 */	mr r4, r31
/* 800C0A38 000BD978  38 60 00 D3 */	li r3, 0xd3
/* 800C0A3C 000BD97C  4B FF F0 15 */	bl func_800BFA50
/* 800C0A40 000BD980  54 60 06 3E */	clrlwi r0, r3, 0x18
/* 800C0A44 000BD984  2C 00 00 01 */	cmpwi r0, 1
/* 800C0A48 000BD988  41 82 00 30 */	beq lbl_800C0A78
/* 800C0A4C 000BD98C  40 80 00 10 */	bge lbl_800C0A5C
/* 800C0A50 000BD990  2C 00 00 00 */	cmpwi r0, 0
/* 800C0A54 000BD994  40 80 00 14 */	bge lbl_800C0A68
/* 800C0A58 000BD998  48 00 00 20 */	b lbl_800C0A78
lbl_800C0A5C:
/* 800C0A5C 000BD99C  2C 00 00 03 */	cmpwi r0, 3
/* 800C0A60 000BD9A0  40 80 00 18 */	bge lbl_800C0A78
/* 800C0A64 000BD9A4  48 00 00 0C */	b lbl_800C0A70
lbl_800C0A68:
/* 800C0A68 000BD9A8  38 60 00 00 */	li r3, 0
/* 800C0A6C 000BD9AC  48 00 00 10 */	b lbl_800C0A7C
lbl_800C0A70:
/* 800C0A70 000BD9B0  38 60 00 02 */	li r3, 2
/* 800C0A74 000BD9B4  48 00 00 08 */	b lbl_800C0A7C
lbl_800C0A78:
...
/* 800C0AB4 000BD9F4  40 82 00 0C */	bne lbl_800C0AC0
/* 800C0AB8 000BD9F8  38 60 00 01 */	li r3, 1
/* 800C0ABC 000BD9FC  48 00 00 78 */	b lbl_800C0B34
lbl_800C0AC0:
/* 800C0AC0 000BDA00  4B FF CA 7D */	bl GetTRKConnected
/* 800C0AC4 000BDA04  2C 03 00 00 */	cmpwi r3, 0
/* 800C0AC8 000BDA08  40 82 00 0C */	bne lbl_800C0AD4
/* 800C0ACC 000BDA0C  38 60 00 01 */	li r3, 1
/* 800C0AD0 000BDA10  48 00 00 64 */	b lbl_800C0B34
lbl_800C0AD4:
...
/* 800C0AEC 000BDA2C  4B FF EF 55 */	bl func_800BFA40
...
/* 800C0B00 000BDA40  41 82 00 30 */	beq lbl_800C0B30
/* 800C0B04 000BDA44  40 80 00 10 */	bge lbl_800C0B14
/* 800C0B08 000BDA48  2C 00 00 00 */	cmpwi r0, 0
/* 800C0B0C 000BDA4C  40 80 00 14 */	bge lbl_800C0B20
/* 800C0B10 000BDA50  48 00 00 20 */	b lbl_800C0B30
lbl_800C0B14:
/* 800C0B14 000BDA54  2C 00 00 03 */	cmpwi r0, 3
/* 800C0B18 000BDA58  40 80 00 18 */	bge lbl_800C0B30
/* 800C0B1C 000BDA5C  48 00 00 0C */	b lbl_800C0B28
lbl_800C0B20:
/* 800C0B20 000BDA60  38 60 00 00 */	li r3, 0
/* 800C0B24 000BDA64  48 00 00 10 */	b lbl_800C0B34
lbl_800C0B28:
/* 800C0B28 000BDA68  38 60 00 02 */	li r3, 2
/* 800C0B2C 000BDA6C  48 00 00 08 */	b lbl_800C0B34
lbl_800C0B30:
...
/* 800C0B70 000BDAB0  40 82 00 0C */	bne lbl_800C0B7C
/* 800C0B74 000BDAB4  38 60 00 01 */	li r3, 1
/* 800C0B78 000BDAB8  48 00 00 78 */	b lbl_800C0BF0
lbl_800C0B7C:
/* 800C0B7C 000BDABC  4B FF C9 C1 */	bl GetTRKConnected
/* 800C0B80 000BDAC0  2C 03 00 00 */	cmpwi r3, 0
/* 800C0B84 000BDAC4  40 82 00 0C */	bne lbl_800C0B90
/* 800C0B88 000BDAC8  38 60 00 01 */	li r3, 1
/* 800C0B8C 000BDACC  48 00 00 64 */	b lbl_800C0BF0
lbl_800C0B90:
...
/* 800C0BA8 000BDAE8  4B FF EE 99 */	bl func_800BFA40
...
/* 800C0BBC 000BDAFC  41 82 00 30 */	beq lbl_800C0BEC
/* 800C0BC0 000BDB00  40 80 00 10 */	bge lbl_800C0BD0
/* 800C0BC4 000BDB04  2C 00 00 00 */	cmpwi r0, 0
/* 800C0BC8 000BDB08  40 80 00 14 */	bge lbl_800C0BDC
/* 800C0BCC 000BDB0C  48 00 00 20 */	b lbl_800C0BEC
lbl_800C0BD0:
/* 800C0BD0 000BDB10  2C 00 00 03 */	cmpwi r0, 3
/* 800C0BD4 000BDB14  40 80 00 18 */	bge lbl_800C0BEC
/* 800C0BD8 000BDB18  48 00 00 0C */	b lbl_800C0BE4
lbl_800C0BDC:
/* 800C0BDC 000BDB1C  38 60 00 00 */	li r3, 0
/* 800C0BE0 000BDB20  48 00 00 10 */	b lbl_800C0BF0
lbl_800C0BE4:
/* 800C0BE4 000BDB24  38 60 00 02 */	li r3, 2
/* 800C0BE8 000BDB28  48 00 00 08 */	b lbl_800C0BF0
lbl_800C0BEC:
