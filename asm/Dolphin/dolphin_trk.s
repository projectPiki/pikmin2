...
/* 800BFE4C 000BCD8C  40 82 00 14 */	bne lbl_800BFE60
...
/* 800BFEE0 000BCE20  40 82 00 14 */	bne lbl_800BFEF4
...
/* 800BFF28 000BCE68  41 80 01 A8 */	blt lbl_800C00D0
...
/* 800BFF3C 000BCE7C  40 81 00 08 */	ble lbl_800BFF44
/* 800BFF40 000BCE80  48 00 01 90 */	b lbl_800C00D0
lbl_800BFF44:
...
/* 800BFF68 000BCEA8  40 81 00 6C */	ble lbl_800BFFD4
/* 800BFF6C 000BCEAC  54 60 E8 FF */	rlwinm. r0, r3, 0x1d, 3, 0x1f
/* 800BFF70 000BCEB0  7C 09 03 A6 */	mtctr r0
/* 800BFF74 000BCEB4  41 82 00 50 */	beq lbl_800BFFC4
lbl_800BFF78:
...
/* 800BFFB8 000BCEF8  42 00 FF C0 */	bdnz lbl_800BFF78
/* 800BFFBC 000BCEFC  70 63 00 07 */	andi. r3, r3, 7
/* 800BFFC0 000BCF00  41 82 00 14 */	beq lbl_800BFFD4
lbl_800BFFC4:
...
/* 800BFFD0 000BCF10  42 00 FF F8 */	bdnz lbl_800BFFC8
lbl_800BFFD4:
/* 800BFFD4 000BCF14  48 01 26 E5 */	bl ARGetDMAStatus
/* 800BFFD8 000BCF18  28 03 00 00 */	cmplwi r3, 0
/* 800BFFDC 000BCF1C  40 82 FF F8 */	bne lbl_800BFFD4
...
/* 800BFFF0 000BCF30  41 82 00 48 */	beq lbl_800C0038
...
/* 800C0020 000BCF60  41 82 FF F8 */	beq lbl_800C0018
...
/* 800C007C 000BCFBC  41 82 FF F8 */	beq lbl_800C0074
lbl_800C0080:
...
/* 800C010C 000BD04C  41 80 00 F0 */	blt lbl_800C01FC
...
/* 800C0120 000BD060  40 81 00 08 */	ble lbl_800C0128
/* 800C0124 000BD064  48 00 00 D8 */	b lbl_800C01FC
lbl_800C0128:
...
/* 800C014C 000BD08C  40 81 00 6C */	ble lbl_800C01B8
/* 800C0150 000BD090  54 60 E8 FF */	rlwinm. r0, r3, 0x1d, 3, 0x1f
/* 800C0154 000BD094  7C 09 03 A6 */	mtctr r0
/* 800C0158 000BD098  41 82 00 50 */	beq lbl_800C01A8
lbl_800C015C:
...
/* 800C019C 000BD0DC  42 00 FF C0 */	bdnz lbl_800C015C
/* 800C01A0 000BD0E0  70 63 00 07 */	andi. r3, r3, 7
/* 800C01A4 000BD0E4  41 82 00 14 */	beq lbl_800C01B8
lbl_800C01A8:
...
/* 800C01B4 000BD0F4  42 00 FF F8 */	bdnz lbl_800C01AC
lbl_800C01B8:
/* 800C01B8 000BD0F8  48 01 25 01 */	bl ARGetDMAStatus
/* 800C01BC 000BD0FC  28 03 00 00 */	cmplwi r3, 0
/* 800C01C0 000BD100  40 82 FF F8 */	bne lbl_800C01B8
...
/* 800C01EC 000BD12C  41 82 FF F8 */	beq lbl_800C01E4
/* 800C01F0 000BD130  57 E0 04 3F */	clrlwi. r0, r31, 0x10
/* 800C01F4 000BD134  40 82 00 08 */	bne lbl_800C01FC
...
/* 800C0288 000BD1C8  41 81 00 2C */	bgt lbl_800C02B4
/* 800C028C 000BD1CC  38 03 40 00 */	addi r0, r3, 0x4000
/* 800C0290 000BD1D0  28 00 00 44 */	cmplwi r0, 0x44
/* 800C0294 000BD1D4  40 81 00 20 */	ble lbl_800C02B4
...
/* 800C02A8 000BD1E8  41 82 00 0C */	beq lbl_800C02B4
/* 800C02AC 000BD1EC  38 A0 00 44 */	li r5, 0x44
/* 800C02B0 000BD1F0  48 00 00 0C */	b lbl_800C02BC
lbl_800C02B4:
...
/* 800C02E0 000BD220  41 82 00 90 */	beq lbl_800C0370
/* 800C02E4 000BD224  2C 1E 00 04 */	cmpwi r30, 4
/* 800C02E8 000BD228  41 82 00 88 */	beq lbl_800C0370
...
/* 800C037C 000BD2BC  40 81 FF 58 */	ble lbl_800C02D4
...
/* 800C03A4 000BD2E4  41 80 00 24 */	blt lbl_800C03C8
/* 800C03A8 000BD2E8  38 04 40 00 */	addi r0, r4, 0x4000
/* 800C03AC 000BD2EC  7C 03 00 40 */	cmplw r3, r0
/* 800C03B0 000BD2F0  40 80 00 18 */	bge lbl_800C03C8
...
/* 800C03D0 000BD310  41 80 00 10 */	blt lbl_800C03E0
