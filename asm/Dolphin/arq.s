...
/* 800D41F4 000D1134  41 82 00 B8 */	beq lbl_800D42AC
...
/* 800D4204 000D1144  41 81 00 3C */	bgt lbl_800D4240
/* 800D4208 000D1148  80 65 00 08 */	lwz r3, 8(r5)
/* 800D420C 000D114C  28 03 00 00 */	cmplwi r3, 0
/* 800D4210 000D1150  40 82 00 14 */	bne lbl_800D4224
...
/* 800D4220 000D1160  48 00 00 10 */	b lbl_800D4230
lbl_800D4224:
...
/* 800D423C 000D117C  48 00 00 34 */	b lbl_800D4270
lbl_800D4240:
/* 800D4240 000D1180  80 65 00 08 */	lwz r3, 8(r5)
/* 800D4244 000D1184  28 03 00 00 */	cmplwi r3, 0
/* 800D4248 000D1188  40 82 00 18 */	bne lbl_800D4260
...
/* 800D425C 000D119C  48 00 00 14 */	b lbl_800D4270
lbl_800D4260:
...
/* 800D42D4 000D1214  41 82 00 20 */	beq lbl_800D42F4
...
/* 800D4320 000D1260  41 82 00 4C */	beq lbl_800D436C
/* 800D4324 000D1264  80 66 00 08 */	lwz r3, 8(r6)
/* 800D4328 000D1268  28 03 00 00 */	cmplwi r3, 0
/* 800D432C 000D126C  40 82 00 18 */	bne lbl_800D4344
...
/* 800D4340 000D1280  48 00 00 14 */	b lbl_800D4354
lbl_800D4344:
...
/* 800D4374 000D12B4  40 82 00 08 */	bne lbl_800D437C
...
/* 800D43A4 000D12E4  41 82 00 44 */	beq lbl_800D43E8
...
/* 800D443C 000D137C  41 82 00 0C */	beq lbl_800D4448
/* 800D4440 000D1380  91 5D 00 1C */	stw r10, 0x1c(r29)
/* 800D4444 000D1384  48 00 00 10 */	b lbl_800D4454
lbl_800D4448:
...
/* 800D4460 000D13A0  41 82 00 38 */	beq lbl_800D4498
/* 800D4464 000D13A4  40 80 00 54 */	bge lbl_800D44B8
/* 800D4468 000D13A8  2C 1E 00 00 */	cmpwi r30, 0
/* 800D446C 000D13AC  40 80 00 08 */	bge lbl_800D4474
/* 800D4470 000D13B0  48 00 00 48 */	b lbl_800D44B8
lbl_800D4474:
/* 800D4474 000D13B4  80 0D 8D 80 */	lwz r0, __ARQRequestQueueLo@sda21(r13)
/* 800D4478 000D13B8  28 00 00 00 */	cmplwi r0, 0
/* 800D447C 000D13BC  41 82 00 10 */	beq lbl_800D448C
/* 800D4480 000D13C0  80 6D 8D 84 */	lwz r3, __ARQRequestTailLo@sda21(r13)
/* 800D4484 000D13C4  93 A3 00 00 */	stw r29, 0(r3)
/* 800D4488 000D13C8  48 00 00 08 */	b lbl_800D4490
lbl_800D448C:
...
/* 800D44F8 000D1438  48 00 00 14 */	b lbl_800D450C
lbl_800D44FC:
...
/* 800D452C 000D146C  40 82 00 08 */	bne lbl_800D4534
