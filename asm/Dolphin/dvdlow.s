...
/* 800DB318 000D8258  41 82 00 40 */	beq lbl_800DB358
...
/* 800DB350 000D8290  40 82 00 08 */	bne lbl_800DB358
...
/* 800DB3CC 000D830C  41 82 00 A0 */	beq lbl_800DB46C
...
/* 800DB420 000D8360  41 82 00 4C */	beq lbl_800DB46C
...
/* 800DB498 000D83D8  41 82 00 08 */	beq lbl_800DB4A0
...
/* 800DB4B0 000D83F0  48 00 00 10 */	b lbl_800DB4C0
lbl_800DB4B4:
...
/* 800DB4F0 000D8430  40 82 00 30 */	bne lbl_800DB520
...
/* 800DB51C 000D845C  48 00 00 34 */	b lbl_800DB550
lbl_800DB520:
/* 800DB520 000D8460  2C 03 00 02 */	cmpwi r3, 2
/* 800DB524 000D8464  40 82 00 28 */	bne lbl_800DB54C
...
/* 800DB548 000D8488  48 00 00 08 */	b lbl_800DB550
lbl_800DB54C:
/* 800DB54C 000D848C  38 00 00 00 */	li r0, 0
lbl_800DB550:
/* 800DB550 000D8490  2C 00 00 00 */	cmpwi r0, 0
/* 800DB554 000D8494  41 82 00 18 */	beq lbl_800DB56C
/* 800DB558 000D8498  48 00 00 64 */	b lbl_800DB5BC
lbl_800DB55C:
...
/* 800DB580 000D84C0  41 82 00 2C */	beq lbl_800DB5AC
...
/* 800DB594 000D84D4  41 82 00 10 */	beq lbl_800DB5A4
...
/* 800DB5F4 000D8534  40 82 00 2C */	bne lbl_800DB620
...
/* 800DB61C 000D855C  48 00 00 28 */	b lbl_800DB644
lbl_800DB620:
/* 800DB620 000D8560  2C 03 00 02 */	cmpwi r3, 2
/* 800DB624 000D8564  40 82 00 20 */	bne lbl_800DB644
...
/* 800DB690 000D85D0  41 82 00 10 */	beq lbl_800DB6A0
...
/* 800DB74C 000D868C  40 81 00 38 */	ble lbl_800DB784
...
/* 800DB780 000D86C0  48 00 00 34 */	b lbl_800DB7B4
lbl_800DB784:
...
/* 800DB7EC 000D872C  40 82 00 0C */	bne lbl_800DB7F8
/* 800DB7F0 000D8730  39 40 00 00 */	li r10, 0
/* 800DB7F4 000D8734  48 00 00 0C */	b lbl_800DB800
lbl_800DB7F8:
...
/* 800DB8A0 000D87E0  40 82 00 2C */	bne lbl_800DB8CC
...
/* 800DB8F8 000D8838  48 00 01 DC */	b lbl_800DBAD4
lbl_800DB8FC:
...
/* 800DB92C 000D886C  41 82 00 0C */	beq lbl_800DB938
/* 800DB930 000D8870  38 00 00 01 */	li r0, 1
/* 800DB934 000D8874  48 00 00 08 */	b lbl_800DB93C
lbl_800DB938:
/* 800DB938 000D8878  38 00 00 00 */	li r0, 0
lbl_800DB93C:
/* 800DB93C 000D887C  2C 00 00 00 */	cmpwi r0, 0
/* 800DB940 000D8880  41 82 00 0C */	beq lbl_800DB94C
/* 800DB944 000D8884  38 60 00 05 */	li r3, 5
/* 800DB948 000D8888  48 00 00 08 */	b lbl_800DB950
lbl_800DB94C:
...
/* 800DB958 000D8898  41 81 00 14 */	bgt lbl_800DB96C
...
/* 800DB968 000D88A8  40 80 00 0C */	bge lbl_800DB974
lbl_800DB96C:
/* 800DB96C 000D88AC  38 00 00 01 */	li r0, 1
/* 800DB970 000D88B0  48 00 00 08 */	b lbl_800DB978
lbl_800DB974:
/* 800DB974 000D88B4  38 00 00 00 */	li r0, 0
lbl_800DB978:
/* 800DB978 000D88B8  2C 00 00 00 */	cmpwi r0, 0
/* 800DB97C 000D88BC  40 82 00 2C */	bne lbl_800DB9A8
...
/* 800DB9A4 000D88E4  48 00 01 30 */	b lbl_800DBAD4
lbl_800DB9A8:
...
/* 800DB9C8 000D8908  41 82 00 10 */	beq lbl_800DB9D8
/* 800DB9CC 000D890C  38 03 00 01 */	addi r0, r3, 1
/* 800DB9D0 000D8910  7C 00 20 40 */	cmplw r0, r4
/* 800DB9D4 000D8914  40 82 00 EC */	bne lbl_800DBAC0
lbl_800DB9D8:
...
/* 800DBA28 000D8968  41 82 00 28 */	beq lbl_800DBA50
...
/* 800DBA4C 000D898C  48 00 00 88 */	b lbl_800DBAD4
lbl_800DBA50:
...
/* 800DBABC 000D89FC  48 00 00 18 */	b lbl_800DBAD4
lbl_800DBAC0:
...
/* 800DBF4C 000D8E8C  41 82 00 08 */	beq lbl_800DBF54
...
/* 800DC04C 000D8F8C  40 82 FF DC */	bne lbl_800DC028
...
/* 800DC100 000D9040  40 82 00 0C */	bne lbl_800DC10C
...
/* 800DC118 000D9058  40 82 00 0C */	bne lbl_800DC124
