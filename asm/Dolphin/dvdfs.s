...
/* 800DC1C8 000D9108  40 82 00 44 */	bne lbl_800DC20C
/* 800DC1CC 000D910C  88 77 00 02 */	lbz r3, 2(r23)
/* 800DC1D0 000D9110  2C 03 00 2F */	cmpwi r3, 0x2f
/* 800DC1D4 000D9114  40 82 00 1C */	bne lbl_800DC1F0
...
/* 800DC1EC 000D912C  4B FF FF 9C */	b lbl_800DC188
lbl_800DC1F0:
/* 800DC1F0 000D9130  7C 60 07 75 */	extsb. r0, r3
/* 800DC1F4 000D9134  40 82 00 38 */	bne lbl_800DC22C
...
/* 800DC2DC 000D921C  48 00 00 28 */	b lbl_800DC304
lbl_800DC2E0:
/* 800DC2E0 000D9220  7E FC BB 78 */	mr r28, r23
/* 800DC2E4 000D9224  48 00 00 08 */	b lbl_800DC2EC
lbl_800DC2E8:
...
/* 800DC328 000D9268  48 00 00 E4 */	b lbl_800DC40C
lbl_800DC32C:
...
/* 800DC338 000D9278  40 82 00 0C */	bne lbl_800DC344
/* 800DC33C 000D927C  38 00 00 00 */	li r0, 0
/* 800DC340 000D9280  48 00 00 08 */	b lbl_800DC348
lbl_800DC344:
/* 800DC344 000D9284  38 00 00 01 */	li r0, 1
lbl_800DC348:
/* 800DC348 000D9288  2C 00 00 00 */	cmpwi r0, 0
/* 800DC34C 000D928C  40 82 00 0C */	bne lbl_800DC358
/* 800DC350 000D9290  2C 1E 00 01 */	cmpwi r30, 1
/* 800DC354 000D9294  41 82 00 80 */	beq lbl_800DC3D4
lbl_800DC358:
...
/* 800DC368 000D92A8  48 00 00 38 */	b lbl_800DC3A0
lbl_800DC36C:
...
/* 800DC3E4 000D9324  40 82 00 0C */	bne lbl_800DC3F0
/* 800DC3E8 000D9328  38 00 00 00 */	li r0, 0
/* 800DC3EC 000D932C  48 00 00 08 */	b lbl_800DC3F4
lbl_800DC3F0:
/* 800DC3F0 000D9330  38 00 00 01 */	li r0, 1
lbl_800DC3F4:
/* 800DC3F4 000D9334  2C 00 00 00 */	cmpwi r0, 0
/* 800DC3F8 000D9338  41 82 00 0C */	beq lbl_800DC404
/* 800DC3FC 000D933C  80 03 00 08 */	lwz r0, 8(r3)
/* 800DC400 000D9340  48 00 00 08 */	b lbl_800DC408
lbl_800DC404:
...
/* 800DC41C 000D935C  41 80 FF 10 */	blt lbl_800DC32C
/* 800DC420 000D9360  38 60 FF FF */	li r3, -1
/* 800DC424 000D9364  48 00 00 20 */	b lbl_800DC444
lbl_800DC428:
/* 800DC428 000D9368  2C 1E 00 00 */	cmpwi r30, 0
/* 800DC42C 000D936C  40 82 00 0C */	bne lbl_800DC438
/* 800DC430 000D9370  7F 43 D3 78 */	mr r3, r26
/* 800DC434 000D9374  48 00 00 10 */	b lbl_800DC444
lbl_800DC438:
/* 800DC438 000D9378  7E FB BA 14 */	add r23, r27, r23
/* 800DC43C 000D937C  3A F7 00 01 */	addi r23, r23, 1
/* 800DC440 000D9380  4B FF FD 48 */	b lbl_800DC188
lbl_800DC444:
...
/* 800DC47C 000D93BC  40 82 00 0C */	bne lbl_800DC488
/* 800DC480 000D93C0  38 00 00 00 */	li r0, 0
/* 800DC484 000D93C4  48 00 00 08 */	b lbl_800DC48C
lbl_800DC488:
/* 800DC488 000D93C8  38 00 00 01 */	li r0, 1
lbl_800DC48C:
/* 800DC48C 000D93CC  2C 00 00 00 */	cmpwi r0, 0
/* 800DC490 000D93D0  41 82 00 0C */	beq lbl_800DC49C
lbl_800DC494:
...
/* 800DC4F0 000D9430  40 80 00 30 */	bge lbl_800DC520
...
/* 800DC51C 000D945C  48 00 00 60 */	b lbl_800DC57C
lbl_800DC520:
...
/* 800DC530 000D9470  40 82 00 0C */	bne lbl_800DC53C
/* 800DC534 000D9474  38 00 00 00 */	li r0, 0
/* 800DC538 000D9478  48 00 00 08 */	b lbl_800DC540
lbl_800DC53C:
/* 800DC53C 000D947C  38 00 00 01 */	li r0, 1
lbl_800DC540:
/* 800DC540 000D9480  2C 00 00 00 */	cmpwi r0, 0
/* 800DC544 000D9484  41 82 00 0C */	beq lbl_800DC550
/* 800DC548 000D9488  38 60 00 00 */	li r3, 0
/* 800DC54C 000D948C  48 00 00 30 */	b lbl_800DC57C
lbl_800DC550:
...
/* 800DC5E0 000D9520  40 82 00 0C */	bne lbl_800DC5EC
/* 800DC5E4 000D9524  38 60 00 00 */	li r3, 0
/* 800DC5E8 000D9528  48 00 01 10 */	b lbl_800DC6F8
lbl_800DC5EC:
...
/* 800DC610 000D9550  40 82 00 0C */	bne lbl_800DC61C
/* 800DC614 000D9554  38 60 00 00 */	li r3, 0
/* 800DC618 000D9558  48 00 00 80 */	b lbl_800DC698
lbl_800DC61C:
...
/* 800DC640 000D9580  40 82 00 08 */	bne lbl_800DC648
/* 800DC644 000D9584  48 00 00 54 */	b lbl_800DC698
lbl_800DC648:
...
/* 800DC664 000D95A4  48 00 00 18 */	b lbl_800DC67C
lbl_800DC668:
...
/* 800DC680 000D95C0  41 82 00 10 */	beq lbl_800DC690
/* 800DC684 000D95C4  88 1C 00 00 */	lbz r0, 0(r28)
/* 800DC688 000D95C8  7C 00 07 75 */	extsb. r0, r0
/* 800DC68C 000D95CC  40 82 FF DC */	bne lbl_800DC668
lbl_800DC690:
...
/* 800DC69C 000D95DC  40 82 00 08 */	bne lbl_800DC6A4
/* 800DC6A0 000D95E0  48 00 00 58 */	b lbl_800DC6F8
lbl_800DC6A4:
...
/* 800DC6C4 000D9604  48 00 00 18 */	b lbl_800DC6DC
lbl_800DC6C8:
...
/* 800DC6E0 000D9620  41 82 00 10 */	beq lbl_800DC6F0
/* 800DC6E4 000D9624  88 06 00 00 */	lbz r0, 0(r6)
/* 800DC6E8 000D9628  7C 00 07 75 */	extsb. r0, r0
/* 800DC6EC 000D962C  40 82 FF DC */	bne lbl_800DC6C8
lbl_800DC6F0:
...
/* 800DC740 000D9680  40 82 00 0C */	bne lbl_800DC74C
/* 800DC744 000D9684  38 60 00 00 */	li r3, 0
/* 800DC748 000D9688  48 00 00 8C */	b lbl_800DC7D4
lbl_800DC74C:
...
/* 800DC77C 000D96BC  40 82 00 08 */	bne lbl_800DC784
/* 800DC780 000D96C0  48 00 00 54 */	b lbl_800DC7D4
lbl_800DC784:
...
/* 800DC7A0 000D96E0  48 00 00 18 */	b lbl_800DC7B8
lbl_800DC7A4:
...
/* 800DC7BC 000D96FC  41 82 00 10 */	beq lbl_800DC7CC
/* 800DC7C0 000D9700  88 1C 00 00 */	lbz r0, 0(r28)
/* 800DC7C4 000D9704  7C 00 07 75 */	extsb. r0, r0
/* 800DC7C8 000D9708  40 82 FF DC */	bne lbl_800DC7A4
lbl_800DC7CC:
...
/* 800DC7D8 000D9718  40 82 00 18 */	bne lbl_800DC7F0
...
/* 800DC7EC 000D972C  48 00 00 60 */	b lbl_800DC84C
lbl_800DC7F0:
...
/* 800DC8A4 000D97E4  40 82 00 14 */	bne lbl_800DC8B8
...
/* 800DC8B4 000D97F4  48 00 00 5C */	b lbl_800DC910
lbl_800DC8B8:
...
/* 800DC944 000D9884  41 80 00 2C */	blt lbl_800DC970
...
/* 800DC958 000D9898  40 82 00 0C */	bne lbl_800DC964
/* 800DC95C 000D989C  38 00 00 00 */	li r0, 0
/* 800DC960 000D98A0  48 00 00 08 */	b lbl_800DC968
lbl_800DC964:
/* 800DC964 000D98A4  38 00 00 01 */	li r0, 1
lbl_800DC968:
/* 800DC968 000D98A8  2C 00 00 00 */	cmpwi r0, 0
/* 800DC96C 000D98AC  40 82 00 0C */	bne lbl_800DC978
lbl_800DC970:
/* 800DC970 000D98B0  38 60 00 00 */	li r3, 0
/* 800DC974 000D98B4  48 00 00 0C */	b lbl_800DC980
lbl_800DC978:
...
/* 800DC9B8 000D98F8  41 80 00 10 */	blt lbl_800DC9C8
/* 800DC9BC 000D98FC  80 1A 00 34 */	lwz r0, 0x34(r26)
/* 800DC9C0 000D9900  7C 1D 00 40 */	cmplw r29, r0
/* 800DC9C4 000D9904  40 81 00 1C */	ble lbl_800DC9E0
lbl_800DC9C8:
...
/* 800DC9E4 000D9924  41 80 00 14 */	blt lbl_800DC9F8
...
/* 800DC9F4 000D9934  41 80 00 1C */	blt lbl_800DCA10
lbl_800DC9F8:
...
/* 800DCA64 000D99A4  41 82 00 0C */	beq lbl_800DCA70
...
/* 800DCAA4 000D99E4  41 80 00 10 */	blt lbl_800DCAB4
/* 800DCAA8 000D99E8  80 1F 00 34 */	lwz r0, 0x34(r31)
/* 800DCAAC 000D99EC  7C 1D 00 40 */	cmplw r29, r0
/* 800DCAB0 000D99F0  40 81 00 1C */	ble lbl_800DCACC
lbl_800DCAB4:
...
/* 800DCAD0 000D9A10  41 80 00 14 */	blt lbl_800DCAE4
...
/* 800DCAE0 000D9A20  41 80 00 1C */	blt lbl_800DCAFC
lbl_800DCAE4:
...
/* 800DCB24 000D9A64  40 82 00 0C */	bne lbl_800DCB30
/* 800DCB28 000D9A68  38 60 FF FF */	li r3, -1
/* 800DCB2C 000D9A6C  48 00 00 58 */	b lbl_800DCB84
lbl_800DCB30:
...
/* 800DCB40 000D9A80  40 82 00 0C */	bne lbl_800DCB4C
/* 800DCB44 000D9A84  83 FF 00 20 */	lwz r31, 0x20(r31)
/* 800DCB48 000D9A88  48 00 00 30 */	b lbl_800DCB78
lbl_800DCB4C:
/* 800DCB4C 000D9A8C  2C 00 FF FF */	cmpwi r0, -1
/* 800DCB50 000D9A90  40 82 00 0C */	bne lbl_800DCB5C
/* 800DCB54 000D9A94  3B E0 FF FF */	li r31, -1
/* 800DCB58 000D9A98  48 00 00 20 */	b lbl_800DCB78
lbl_800DCB5C:
/* 800DCB5C 000D9A9C  2C 00 00 0A */	cmpwi r0, 0xa
/* 800DCB60 000D9AA0  40 82 00 0C */	bne lbl_800DCB6C
/* 800DCB64 000D9AA4  3B E0 FF FD */	li r31, -3
/* 800DCB68 000D9AA8  48 00 00 10 */	b lbl_800DCB78
lbl_800DCB6C:
/* 800DCB6C 000D9AAC  38 6D 8E 28 */	addi r3, r13, __DVDThreadQueue@sda21
/* 800DCB70 000D9AB0  48 01 5D 7D */	bl OSSleepThread
/* 800DCB74 000D9AB4  4B FF FF C4 */	b lbl_800DCB38
lbl_800DCB78:
...
/* 800DCBE0 000D9B20  40 80 00 34 */	bge lbl_800DCC14
...
/* 800DCC10 000D9B50  48 00 00 54 */	b lbl_800DCC64
lbl_800DCC14:
...
/* 800DCC24 000D9B64  40 82 00 0C */	bne lbl_800DCC30
/* 800DCC28 000D9B68  38 00 00 00 */	li r0, 0
/* 800DCC2C 000D9B6C  48 00 00 08 */	b lbl_800DCC34
lbl_800DCC30:
/* 800DCC30 000D9B70  38 00 00 01 */	li r0, 1
lbl_800DCC34:
/* 800DCC34 000D9B74  2C 00 00 00 */	cmpwi r0, 0
/* 800DCC38 000D9B78  40 82 00 0C */	bne lbl_800DCC44
/* 800DCC3C 000D9B7C  38 60 00 00 */	li r3, 0
/* 800DCC40 000D9B80  48 00 00 24 */	b lbl_800DCC64
lbl_800DCC44:
...
/* 800DCC88 000D9BC8  40 81 00 10 */	ble lbl_800DCC98
/* 800DCC8C 000D9BCC  80 03 00 08 */	lwz r0, 8(r3)
/* 800DCC90 000D9BD0  7C 00 38 40 */	cmplw r0, r7
/* 800DCC94 000D9BD4  41 81 00 0C */	bgt lbl_800DCCA0
lbl_800DCC98:
...
/* 800DCCB4 000D9BF4  40 82 00 0C */	bne lbl_800DCCC0
/* 800DCCB8 000D9BF8  38 00 00 00 */	li r0, 0
/* 800DCCBC 000D9BFC  48 00 00 08 */	b lbl_800DCCC4
lbl_800DCCC0:
