...
/* 800DA644 000D7584  40 82 00 18 */	bne lbl_800DA65C
...
/* 800DA66C 000D75AC  41 82 00 28 */	beq lbl_800DA694
/* 800DA670 000D75B0  40 80 00 38 */	bge lbl_800DA6A8
/* 800DA674 000D75B4  2C 00 00 01 */	cmpwi r0, 1
/* 800DA678 000D75B8  40 80 00 08 */	bge lbl_800DA680
/* 800DA67C 000D75BC  48 00 00 2C */	b lbl_800DA6A8
lbl_800DA680:
...
/* 800DA690 000D75D0  48 00 00 24 */	b lbl_800DA6B4
lbl_800DA694:
...
/* 800DA6A4 000D75E4  48 00 00 10 */	b lbl_800DA6B4
lbl_800DA6A8:
...
/* 800DA6DC 000D761C  41 82 00 24 */	beq lbl_800DA700
/* 800DA6E0 000D7620  40 80 00 2C */	bge lbl_800DA70C
/* 800DA6E4 000D7624  2C 05 00 01 */	cmpwi r5, 1
/* 800DA6E8 000D7628  40 80 00 08 */	bge lbl_800DA6F0
/* 800DA6EC 000D762C  48 00 00 20 */	b lbl_800DA70C
lbl_800DA6F0:
...
/* 800DA728 000D7668  41 82 00 24 */	beq lbl_800DA74C
/* 800DA72C 000D766C  40 80 00 2C */	bge lbl_800DA758
/* 800DA730 000D7670  2C 05 00 01 */	cmpwi r5, 1
/* 800DA734 000D7674  40 80 00 08 */	bge lbl_800DA73C
/* 800DA738 000D7678  48 00 00 20 */	b lbl_800DA758
lbl_800DA73C:
...
/* 800DA778 000D76B8  41 82 00 24 */	beq lbl_800DA79C
/* 800DA77C 000D76BC  40 80 00 2C */	bge lbl_800DA7A8
/* 800DA780 000D76C0  2C 05 00 01 */	cmpwi r5, 1
/* 800DA784 000D76C4  40 80 00 08 */	bge lbl_800DA78C
/* 800DA788 000D76C8  48 00 00 20 */	b lbl_800DA7A8
lbl_800DA78C:
...
/* 800DA7C8 000D7708  41 82 00 24 */	beq lbl_800DA7EC
/* 800DA7CC 000D770C  40 80 00 2C */	bge lbl_800DA7F8
/* 800DA7D0 000D7710  2C 05 00 01 */	cmpwi r5, 1
/* 800DA7D4 000D7714  40 80 00 08 */	bge lbl_800DA7DC
/* 800DA7D8 000D7718  48 00 00 20 */	b lbl_800DA7F8
lbl_800DA7DC:
...
/* 800DA808 000D7748  42 00 FE C4 */	bdnz lbl_800DA6CC
/* 800DA80C 000D774C  2C 09 00 00 */	cmpwi r9, 0
/* 800DA810 000D7750  41 82 00 10 */	beq lbl_800DA820
/* 800DA814 000D7754  91 04 00 64 */	stw r8, 0x64(r4)
/* 800DA818 000D7758  39 08 02 00 */	addi r8, r8, 0x200
/* 800DA81C 000D775C  48 00 00 0C */	b lbl_800DA828
lbl_800DA820:
...
/* 800DA850 000D7790  41 80 00 0C */	blt lbl_800DA85C
/* 800DA854 000D7794  2C 1D 00 7F */	cmpwi r29, 0x7f
/* 800DA858 000D7798  41 80 00 0C */	blt lbl_800DA864
lbl_800DA85C:
/* 800DA85C 000D779C  38 60 FF 80 */	li r3, -128
/* 800DA860 000D77A0  48 00 00 C8 */	b lbl_800DA928
lbl_800DA864:
...
/* 800DA870 000D77B0  40 80 00 08 */	bge lbl_800DA878
/* 800DA874 000D77B4  48 00 00 B4 */	b lbl_800DA928
lbl_800DA878:
...
/* 800DA898 000D77D8  41 80 00 84 */	blt lbl_800DA91C
...
/* 800DA970 000D78B0  41 80 00 40 */	blt lbl_800DA9B0
/* 800DA974 000D78B4  2C 1F 00 7F */	cmpwi r31, 0x7f
/* 800DA978 000D78B8  40 80 00 38 */	bge lbl_800DA9B0
...
/* 800DA988 000D78C8  41 82 00 0C */	beq lbl_800DA994
/* 800DA98C 000D78CC  28 03 02 00 */	cmplwi r3, 0x200
/* 800DA990 000D78D0  40 80 00 20 */	bge lbl_800DA9B0
lbl_800DA994:
...
/* 800DA9A0 000D78E0  41 82 00 18 */	beq lbl_800DA9B8
/* 800DA9A4 000D78E4  54 60 04 FE */	clrlwi r0, r3, 0x13
/* 800DA9A8 000D78E8  28 00 1F C0 */	cmplwi r0, 0x1fc0
/* 800DA9AC 000D78EC  40 81 00 0C */	ble lbl_800DA9B8
lbl_800DA9B0:
/* 800DA9B0 000D78F0  38 60 FF 80 */	li r3, -128
/* 800DA9B4 000D78F4  48 00 00 E4 */	b lbl_800DAA98
lbl_800DA9B8:
...
/* 800DA9C8 000D7908  40 80 00 08 */	bge lbl_800DA9D0
/* 800DA9CC 000D790C  48 00 00 CC */	b lbl_800DAA98
lbl_800DA9D0:
...
/* 800DAA40 000D7980  40 82 00 14 */	bne lbl_800DAA54
...
/* 800DAA84 000D79C4  40 80 00 10 */	bge lbl_800DAA94
...
/* 800DAADC 000D7A1C  40 80 00 08 */	bge lbl_800DAAE4
/* 800DAAE0 000D7A20  48 00 00 0C */	b lbl_800DAAEC
lbl_800DAAE4:
