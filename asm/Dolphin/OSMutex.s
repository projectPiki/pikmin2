...
/* 800EFBA4 000ECAE4  40 82 00 40 */	bne lbl_800EFBE4
...
/* 800EFBC0 000ECB00  40 82 00 0C */	bne lbl_800EFBCC
/* 800EFBC4 000ECB04  93 9E 02 F4 */	stw r28, 0x2f4(r30)
/* 800EFBC8 000ECB08  48 00 00 08 */	b lbl_800EFBD0
lbl_800EFBCC:
...
/* 800EFBE0 000ECB20  48 00 00 3C */	b lbl_800EFC1C
lbl_800EFBE4:
/* 800EFBE4 000ECB24  7C 00 F0 40 */	cmplw r0, r30
/* 800EFBE8 000ECB28  40 82 00 14 */	bne lbl_800EFBFC
...
/* 800EFBF8 000ECB38  48 00 00 24 */	b lbl_800EFC1C
lbl_800EFBFC:
...
/* 800EFC18 000ECB58  4B FF FF 84 */	b lbl_800EFB9C
lbl_800EFC1C:
...
/* 800EFC78 000ECBB8  40 82 00 70 */	bne lbl_800EFCE8
...
/* 800EFC88 000ECBC8  40 82 00 60 */	bne lbl_800EFCE8
...
/* 800EFC98 000ECBD8  40 82 00 0C */	bne lbl_800EFCA4
/* 800EFC9C 000ECBDC  90 9E 02 F8 */	stw r4, 0x2f8(r30)
/* 800EFCA0 000ECBE0  48 00 00 08 */	b lbl_800EFCA8
lbl_800EFCA4:
/* 800EFCA4 000ECBE4  90 83 00 14 */	stw r4, 0x14(r3)
lbl_800EFCA8:
/* 800EFCA8 000ECBE8  28 04 00 00 */	cmplwi r4, 0
/* 800EFCAC 000ECBEC  40 82 00 0C */	bne lbl_800EFCB8
/* 800EFCB0 000ECBF0  90 7E 02 F4 */	stw r3, 0x2f4(r30)
/* 800EFCB4 000ECBF4  48 00 00 08 */	b lbl_800EFCBC
lbl_800EFCB8:
...
/* 800EFCD0 000ECC10  40 80 00 10 */	bge lbl_800EFCE0
...
/* 800EFD28 000ECC68  48 00 00 30 */	b lbl_800EFD58
lbl_800EFD2C:
...
/* 800EFD38 000ECC78  40 82 00 0C */	bne lbl_800EFD44
/* 800EFD3C 000ECC7C  93 FE 02 F8 */	stw r31, 0x2f8(r30)
/* 800EFD40 000ECC80  48 00 00 08 */	b lbl_800EFD48
lbl_800EFD44:
...
/* 800EFD60 000ECCA0  40 82 FF CC */	bne lbl_800EFD2C
...
/* 800EFDAC 000ECCEC  40 82 00 44 */	bne lbl_800EFDF0
...
/* 800EFDC8 000ECD08  40 82 00 0C */	bne lbl_800EFDD4
/* 800EFDCC 000ECD0C  93 A3 02 F4 */	stw r29, 0x2f4(r3)
/* 800EFDD0 000ECD10  48 00 00 08 */	b lbl_800EFDD8
lbl_800EFDD4:
...
/* 800EFDEC 000ECD2C  48 00 00 24 */	b lbl_800EFE10
lbl_800EFDF0:
/* 800EFDF0 000ECD30  7C 00 18 40 */	cmplw r0, r3
/* 800EFDF4 000ECD34  40 82 00 18 */	bne lbl_800EFE0C
...
/* 800EFE08 000ECD48  48 00 00 08 */	b lbl_800EFE10
lbl_800EFE0C:
...
/* 800EFE88 000ECDC8  40 82 00 88 */	bne lbl_800EFF10
...
/* 800EFEA4 000ECDE4  40 82 00 0C */	bne lbl_800EFEB0
/* 800EFEA8 000ECDE8  90 9E 02 F8 */	stw r4, 0x2f8(r30)
/* 800EFEAC 000ECDEC  48 00 00 08 */	b lbl_800EFEB4
lbl_800EFEB0:
/* 800EFEB0 000ECDF0  90 83 00 14 */	stw r4, 0x14(r3)
lbl_800EFEB4:
/* 800EFEB4 000ECDF4  28 04 00 00 */	cmplwi r4, 0
/* 800EFEB8 000ECDF8  40 82 00 0C */	bne lbl_800EFEC4
/* 800EFEBC 000ECDFC  90 7E 02 F4 */	stw r3, 0x2f4(r30)
/* 800EFEC0 000ECE00  48 00 00 08 */	b lbl_800EFEC8
lbl_800EFEC4:
...
/* 800EFEDC 000ECE1C  40 80 00 10 */	bge lbl_800EFEEC
