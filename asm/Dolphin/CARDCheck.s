...
/* 800D73E0 000D4320  40 81 01 70 */	ble lbl_800D7550
/* 800D73E4 000D4324  54 80 E8 FF */	rlwinm. r0, r4, 0x1d, 3, 0x1f
/* 800D73E8 000D4328  7C 09 03 A6 */	mtctr r0
/* 800D73EC 000D432C  41 82 01 34 */	beq lbl_800D7520
lbl_800D73F0:
...
/* 800D7514 000D4454  42 00 FE DC */	bdnz lbl_800D73F0
/* 800D7518 000D4458  70 84 00 07 */	andi. r4, r4, 7
/* 800D751C 000D445C  41 82 00 34 */	beq lbl_800D7550
lbl_800D7520:
...
/* 800D754C 000D448C  42 00 FF D8 */	bdnz lbl_800D7524
lbl_800D7550:
/* 800D7550 000D4490  A0 05 00 00 */	lhz r0, 0(r5)
/* 800D7554 000D4494  28 00 FF FF */	cmplwi r0, 0xffff
/* 800D7558 000D4498  40 82 00 0C */	bne lbl_800D7564
...
/* 800D75A0 000D44E0  40 82 00 14 */	bne lbl_800D75B4
...
/* 800D75B0 000D44F0  41 82 00 0C */	beq lbl_800D75BC
lbl_800D75B4:
/* 800D75B4 000D44F4  38 60 FF FA */	li r3, -6
/* 800D75B8 000D44F8  48 00 02 34 */	b lbl_800D77EC
lbl_800D75BC:
...
/* 800D75D8 000D4518  40 81 00 BC */	ble lbl_800D7694
/* 800D75DC 000D451C  54 60 E8 FF */	rlwinm. r0, r3, 0x1d, 3, 0x1f
/* 800D75E0 000D4520  7C 09 03 A6 */	mtctr r0
/* 800D75E4 000D4524  41 82 00 94 */	beq lbl_800D7678
lbl_800D75E8:
...
/* 800D766C 000D45AC  42 00 FF 7C */	bdnz lbl_800D75E8
/* 800D7670 000D45B0  70 63 00 07 */	andi. r3, r3, 7
/* 800D7674 000D45B4  41 82 00 20 */	beq lbl_800D7694
lbl_800D7678:
...
/* 800D7690 000D45D0  42 00 FF EC */	bdnz lbl_800D767C
lbl_800D7694:
/* 800D7694 000D45D4  54 C0 04 3E */	clrlwi r0, r6, 0x10
/* 800D7698 000D45D8  28 00 FF FF */	cmplwi r0, 0xffff
/* 800D769C 000D45DC  40 82 00 08 */	bne lbl_800D76A4
...
/* 800D76AC 000D45EC  40 82 00 08 */	bne lbl_800D76B4
...
/* 800D76C0 000D4600  40 82 00 14 */	bne lbl_800D76D4
...
/* 800D76D0 000D4610  41 82 00 0C */	beq lbl_800D76DC
lbl_800D76D4:
/* 800D76D4 000D4614  38 60 FF FA */	li r3, -6
/* 800D76D8 000D4618  48 00 01 14 */	b lbl_800D77EC
lbl_800D76DC:
...
/* 800D7768 000D46A8  41 82 00 14 */	beq lbl_800D777C
...
/* 800D7778 000D46B8  48 00 00 74 */	b lbl_800D77EC
lbl_800D777C:
...
/* 800D77C0 000D4700  41 80 FF 64 */	blt lbl_800D7724
...
/* 800D77DC 000D471C  41 82 00 0C */	beq lbl_800D77E8
/* 800D77E0 000D4720  38 60 FF F3 */	li r3, -13
/* 800D77E4 000D4724  48 00 00 08 */	b lbl_800D77EC
lbl_800D77E8:
...
/* 800D7868 000D47A8  40 81 00 BC */	ble lbl_800D7924
/* 800D786C 000D47AC  54 C0 E8 FF */	rlwinm. r0, r6, 0x1d, 3, 0x1f
/* 800D7870 000D47B0  7C 09 03 A6 */	mtctr r0
/* 800D7874 000D47B4  41 82 00 94 */	beq lbl_800D7908
lbl_800D7878:
...
/* 800D78FC 000D483C  42 00 FF 7C */	bdnz lbl_800D7878
/* 800D7900 000D4840  70 C6 00 07 */	andi. r6, r6, 7
/* 800D7904 000D4844  41 82 00 20 */	beq lbl_800D7924
lbl_800D7908:
...
/* 800D793C 000D487C  40 82 00 08 */	bne lbl_800D7944
...
/* 800D7954 000D4894  40 82 00 14 */	bne lbl_800D7968
...
/* 800D7964 000D48A4  41 82 00 14 */	beq lbl_800D7978
lbl_800D7968:
...
/* 800D7988 000D48C8  41 80 FE A8 */	blt lbl_800D7830
/* 800D798C 000D48CC  2C 1F 00 00 */	cmpwi r31, 0
/* 800D7990 000D48D0  40 82 00 84 */	bne lbl_800D7A14
/* 800D7994 000D48D4  80 83 00 84 */	lwz r4, 0x84(r3)
/* 800D7998 000D48D8  28 04 00 00 */	cmplwi r4, 0
/* 800D799C 000D48DC  40 82 00 5C */	bne lbl_800D79F8
...
/* 800D79B4 000D48F4  40 80 00 0C */	bge lbl_800D79C0
/* 800D79B8 000D48F8  3B C0 00 00 */	li r30, 0
/* 800D79BC 000D48FC  48 00 00 08 */	b lbl_800D79C4
lbl_800D79C0:
...
/* 800D79F4 000D4934  48 00 00 20 */	b lbl_800D7A14
lbl_800D79F8:
/* 800D79F8 000D4938  80 01 00 1C */	lwz r0, 0x1c(r1)
/* 800D79FC 000D493C  7C 04 00 40 */	cmplw r4, r0
/* 800D7A00 000D4940  40 82 00 0C */	bne lbl_800D7A0C
/* 800D7A04 000D4944  38 00 00 00 */	li r0, 0
/* 800D7A08 000D4948  48 00 00 08 */	b lbl_800D7A10
lbl_800D7A0C:
...
/* 800D7A18 000D4958  41 82 00 08 */	beq lbl_800D7A20
...
/* 800D7A98 000D49D8  40 81 00 BC */	ble lbl_800D7B54
/* 800D7A9C 000D49DC  55 00 E8 FF */	rlwinm. r0, r8, 0x1d, 3, 0x1f
/* 800D7AA0 000D49E0  7C 09 03 A6 */	mtctr r0
/* 800D7AA4 000D49E4  41 82 00 94 */	beq lbl_800D7B38
lbl_800D7AA8:
...
/* 800D7B2C 000D4A6C  42 00 FF 7C */	bdnz lbl_800D7AA8
/* 800D7B30 000D4A70  71 08 00 07 */	andi. r8, r8, 7
/* 800D7B34 000D4A74  41 82 00 20 */	beq lbl_800D7B54
lbl_800D7B38:
...
/* 800D7B6C 000D4AAC  40 82 00 08 */	bne lbl_800D7B74
...
/* 800D7B80 000D4AC0  40 82 00 14 */	bne lbl_800D7B94
...
/* 800D7B90 000D4AD0  41 82 00 18 */	beq lbl_800D7BA8
lbl_800D7B94:
...
/* 800D7BA4 000D4AE4  48 00 00 5C */	b lbl_800D7C00
lbl_800D7BA8:
...
/* 800D7BB8 000D4AF8  48 00 00 1C */	b lbl_800D7BD4
lbl_800D7BBC:
/* 800D7BBC 000D4AFC  A0 06 00 00 */	lhz r0, 0(r6)
/* 800D7BC0 000D4B00  28 00 00 00 */	cmplwi r0, 0
/* 800D7BC4 000D4B04  40 82 00 08 */	bne lbl_800D7BCC
...
/* 800D7BDC 000D4B1C  41 80 FF E0 */	blt lbl_800D7BBC
...
/* 800D7BEC 000D4B2C  41 82 00 14 */	beq lbl_800D7C00
...
/* 800D7C0C 000D4B4C  41 80 FE 60 */	blt lbl_800D7A6C
/* 800D7C10 000D4B50  2C 1F 00 00 */	cmpwi r31, 0
/* 800D7C14 000D4B54  40 82 00 84 */	bne lbl_800D7C98
/* 800D7C18 000D4B58  80 83 00 88 */	lwz r4, 0x88(r3)
/* 800D7C1C 000D4B5C  28 04 00 00 */	cmplwi r4, 0
/* 800D7C20 000D4B60  40 82 00 5C */	bne lbl_800D7C7C
...
/* 800D7C38 000D4B78  40 80 00 0C */	bge lbl_800D7C44
/* 800D7C3C 000D4B7C  3B C0 00 00 */	li r30, 0
/* 800D7C40 000D4B80  48 00 00 08 */	b lbl_800D7C48
lbl_800D7C44:
...
/* 800D7C78 000D4BB8  48 00 00 20 */	b lbl_800D7C98
lbl_800D7C7C:
/* 800D7C7C 000D4BBC  80 01 00 10 */	lwz r0, 0x10(r1)
/* 800D7C80 000D4BC0  7C 04 00 40 */	cmplw r4, r0
/* 800D7C84 000D4BC4  40 82 00 0C */	bne lbl_800D7C90
/* 800D7C88 000D4BC8  38 00 00 00 */	li r0, 0
/* 800D7C8C 000D4BCC  48 00 00 08 */	b lbl_800D7C94
lbl_800D7C90:
...
/* 800D7C9C 000D4BDC  41 82 00 08 */	beq lbl_800D7CA4
...
/* 800D7CE4 000D4C24  40 80 00 08 */	bge lbl_800D7CEC
/* 800D7CE8 000D4C28  48 00 00 50 */	b lbl_800D7D38
lbl_800D7CEC:
...
/* 800D7D10 000D4C50  41 82 00 1C */	beq lbl_800D7D2C
/* 800D7D14 000D4C54  40 80 00 20 */	bge lbl_800D7D34
/* 800D7D18 000D4C58  2C 00 00 00 */	cmpwi r0, 0
/* 800D7D1C 000D4C5C  40 80 00 08 */	bge lbl_800D7D24
/* 800D7D20 000D4C60  48 00 00 14 */	b lbl_800D7D34
lbl_800D7D24:
/* 800D7D24 000D4C64  38 60 00 00 */	li r3, 0
/* 800D7D28 000D4C68  48 00 00 10 */	b lbl_800D7D38
lbl_800D7D2C:
/* 800D7D2C 000D4C6C  38 60 FF FA */	li r3, -6
/* 800D7D30 000D4C70  48 00 00 08 */	b lbl_800D7D38
lbl_800D7D34:
...
/* 800D7D78 000D4CB8  41 82 00 0C */	beq lbl_800D7D84
...
/* 800D7D94 000D4CD4  40 80 00 08 */	bge lbl_800D7D9C
/* 800D7D98 000D4CD8  48 00 05 34 */	b lbl_800D82CC
lbl_800D7D9C:
...
/* 800D7DDC 000D4D1C  40 81 00 14 */	ble lbl_800D7DF0
...
/* 800D7DEC 000D4D2C  48 00 04 E0 */	b lbl_800D82CC
lbl_800D7DF0:
...
/* 800D7E1C 000D4D5C  41 82 00 0C */	beq lbl_800D7E28
/* 800D7E20 000D4D60  40 80 00 8C */	bge lbl_800D7EAC
/* 800D7E24 000D4D64  48 00 00 88 */	b lbl_800D7EAC
lbl_800D7E28:
...
/* 800D7E34 000D4D74  40 82 00 40 */	bne lbl_800D7E74
...
/* 800D7E70 000D4DB0  48 00 00 3C */	b lbl_800D7EAC
lbl_800D7E74:
...
/* 800D7F30 000D4E70  40 81 00 14 */	ble lbl_800D7F44
lbl_800D7F34:
...
/* 800D7F40 000D4E80  48 00 03 8C */	b lbl_800D82CC
lbl_800D7F44:
...
/* 800D7F58 000D4E98  41 82 00 14 */	beq lbl_800D7F6C
...
/* 800D7F68 000D4EA8  41 80 FF 98 */	blt lbl_800D7F00
lbl_800D7F6C:
...
/* 800D7F94 000D4ED4  48 00 03 38 */	b lbl_800D82CC
lbl_800D7F98:
/* 800D7F98 000D4ED8  38 C6 00 40 */	addi r6, r6, 0x40
/* 800D7F9C 000D4EDC  42 00 FF 44 */	bdnz lbl_800D7EE0
...
/* 800D7FB4 000D4EF4  48 00 00 68 */	b lbl_800D801C
lbl_800D7FB8:
...
/* 800D7FCC 000D4F0C  40 82 00 20 */	bne lbl_800D7FEC
...
/* 800D7FE8 000D4F28  48 00 00 28 */	b lbl_800D8010
lbl_800D7FEC:
/* 800D7FEC 000D4F2C  28 00 00 05 */	cmplwi r0, 5
/* 800D7FF0 000D4F30  41 80 00 0C */	blt lbl_800D7FFC
/* 800D7FF4 000D4F34  7C 00 38 40 */	cmplw r0, r7
/* 800D7FF8 000D4F38  41 80 00 18 */	blt lbl_800D8010
lbl_800D7FFC:
/* 800D7FFC 000D4F3C  28 00 FF FF */	cmplwi r0, 0xffff
/* 800D8000 000D4F40  41 82 00 10 */	beq lbl_800D8010
/* 800D8004 000D4F44  38 80 FF FA */	li r4, -6
/* 800D8008 000D4F48  4B FF D6 7D */	bl __CARDPutControlBlock
/* 800D800C 000D4F4C  48 00 02 C0 */	b lbl_800D82CC
lbl_800D8010:
...
/* 800D8028 000D4F68  41 80 FF 90 */	blt lbl_800D7FB8
...
/* 800D807C 000D4FBC  40 81 01 70 */	ble lbl_800D81EC
/* 800D8080 000D4FC0  54 60 E8 FF */	rlwinm. r0, r3, 0x1d, 3, 0x1f
/* 800D8084 000D4FC4  7C 09 03 A6 */	mtctr r0
/* 800D8088 000D4FC8  41 82 01 34 */	beq lbl_800D81BC
lbl_800D808C:
...
/* 800D81B0 000D50F0  42 00 FE DC */	bdnz lbl_800D808C
/* 800D81B4 000D50F4  70 63 00 07 */	andi. r3, r3, 7
/* 800D81B8 000D50F8  41 82 00 34 */	beq lbl_800D81EC
lbl_800D81BC:
...
/* 800D81E8 000D5128  42 00 FF D8 */	bdnz lbl_800D81C0
lbl_800D81EC:
/* 800D81EC 000D512C  A0 06 00 00 */	lhz r0, 0(r6)
/* 800D81F0 000D5130  28 00 FF FF */	cmplwi r0, 0xffff
/* 800D81F4 000D5134  40 82 00 0C */	bne lbl_800D8200
...
/* 800D8208 000D5148  40 82 00 0C */	bne lbl_800D8214
...
/* 800D823C 000D517C  41 82 00 24 */	beq lbl_800D8260
/* 800D8240 000D5180  28 1A 00 00 */	cmplwi r26, 0
/* 800D8244 000D5184  41 82 00 0C */	beq lbl_800D8250
...
/* 800D825C 000D519C  48 00 00 70 */	b lbl_800D82CC
lbl_800D8260:
/* 800D8260 000D51A0  7F C0 E3 79 */	or. r0, r30, r28
/* 800D8264 000D51A4  41 82 00 2C */	beq lbl_800D8290
/* 800D8268 000D51A8  28 1A 00 00 */	cmplwi r26, 0
/* 800D826C 000D51AC  41 82 00 0C */	beq lbl_800D8278
...
/* 800D828C 000D51CC  48 00 00 40 */	b lbl_800D82CC
lbl_800D8290:
...
/* 800D82A0 000D51E0  41 82 00 28 */	beq lbl_800D82C8
...
/* 800D8308 000D5248  41 80 00 18 */	blt lbl_800D8320
/* 800D830C 000D524C  34 01 00 0C */	addic. r0, r1, 0xc
/* 800D8310 000D5250  40 82 00 08 */	bne lbl_800D8318
/* 800D8314 000D5254  48 00 00 0C */	b lbl_800D8320
lbl_800D8318:
