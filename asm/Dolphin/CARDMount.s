...
/* 800D8374 000D52B4  41 82 00 48 */	beq lbl_800D83BC
/* 800D8378 000D52B8  40 80 00 28 */	bge lbl_800D83A0
/* 800D837C 000D52BC  2C 05 00 08 */	cmpwi r5, 8
/* 800D8380 000D52C0  41 82 00 3C */	beq lbl_800D83BC
/* 800D8384 000D52C4  40 80 00 10 */	bge lbl_800D8394
/* 800D8388 000D52C8  2C 05 00 04 */	cmpwi r5, 4
/* 800D838C 000D52CC  41 82 00 30 */	beq lbl_800D83BC
/* 800D8390 000D52D0  48 00 00 24 */	b lbl_800D83B4
lbl_800D8394:
/* 800D8394 000D52D4  2C 05 00 10 */	cmpwi r5, 0x10
/* 800D8398 000D52D8  41 82 00 24 */	beq lbl_800D83BC
/* 800D839C 000D52DC  48 00 00 18 */	b lbl_800D83B4
lbl_800D83A0:
/* 800D83A0 000D52E0  2C 05 00 80 */	cmpwi r5, 0x80
/* 800D83A4 000D52E4  41 82 00 18 */	beq lbl_800D83BC
/* 800D83A8 000D52E8  40 80 00 0C */	bge lbl_800D83B4
/* 800D83AC 000D52EC  2C 05 00 40 */	cmpwi r5, 0x40
/* 800D83B0 000D52F0  41 82 00 0C */	beq lbl_800D83BC
lbl_800D83B4:
...
/* 800D83D4 000D5314  40 82 00 0C */	bne lbl_800D83E0
...
/* 800D83EC 000D532C  40 80 00 0C */	bge lbl_800D83F8
...
/* 800D8418 000D5358  41 82 00 0C */	beq lbl_800D8424
/* 800D841C 000D535C  38 60 00 00 */	li r3, 0
/* 800D8420 000D5360  48 00 00 08 */	b lbl_800D8428
lbl_800D8424:
...
/* 800D8454 000D5394  41 80 00 0C */	blt lbl_800D8460
/* 800D8458 000D5398  2C 1B 00 02 */	cmpwi r27, 2
/* 800D845C 000D539C  41 80 00 0C */	blt lbl_800D8468
lbl_800D8460:
/* 800D8460 000D53A0  38 60 FF 80 */	li r3, -128
/* 800D8464 000D53A4  48 00 01 3C */	b lbl_800D85A0
lbl_800D8468:
...
/* 800D8474 000D53B4  41 82 00 0C */	beq lbl_800D8480
/* 800D8478 000D53B8  38 60 FF FD */	li r3, -3
/* 800D847C 000D53BC  48 00 01 24 */	b lbl_800D85A0
lbl_800D8480:
...
/* 800D84F4 000D5434  41 82 00 0C */	beq lbl_800D8500
...
/* 800D8504 000D5444  48 00 00 90 */	b lbl_800D8594
lbl_800D8508:
...
/* 800D8514 000D5454  41 82 00 0C */	beq lbl_800D8520
/* 800D8518 000D5458  3B C0 FF FE */	li r30, -2
/* 800D851C 000D545C  48 00 00 78 */	b lbl_800D8594
lbl_800D8520:
...
/* 800D8534 000D5474  40 82 00 0C */	bne lbl_800D8540
/* 800D8538 000D5478  3B C0 FF FF */	li r30, -1
/* 800D853C 000D547C  48 00 00 58 */	b lbl_800D8594
lbl_800D8540:
...
/* 800D854C 000D548C  41 82 00 44 */	beq lbl_800D8590
/* 800D8550 000D5490  28 1C 00 00 */	cmplwi r28, 0
/* 800D8554 000D5494  41 82 00 10 */	beq lbl_800D8564
...
/* 800D8568 000D54A8  41 82 00 20 */	beq lbl_800D8588
...
/* 800D858C 000D54CC  48 00 00 08 */	b lbl_800D8594
lbl_800D8590:
...
/* 800D85F0 000D5530  40 82 02 AC */	bne lbl_800D889C
...
/* 800D8608 000D5548  40 82 00 0C */	bne lbl_800D8614
/* 800D860C 000D554C  3B C0 FF FD */	li r30, -3
/* 800D8610 000D5550  48 00 00 20 */	b lbl_800D8630
lbl_800D8614:
...
/* 800D8620 000D5560  41 82 00 0C */	beq lbl_800D862C
/* 800D8624 000D5564  3B C0 00 00 */	li r30, 0
/* 800D8628 000D5568  48 00 00 08 */	b lbl_800D8630
lbl_800D862C:
/* 800D862C 000D556C  3B C0 FF FE */	li r30, -2
lbl_800D8630:
/* 800D8630 000D5570  2C 1E 00 00 */	cmpwi r30, 0
/* 800D8634 000D5574  41 80 03 44 */	blt lbl_800D8978
...
/* 800D86AC 000D55EC  41 80 02 CC */	blt lbl_800D8978
...
/* 800D86F8 000D5638  41 80 02 80 */	blt lbl_800D8978
...
/* 800D87A4 000D56E4  48 00 01 F0 */	b lbl_800D8994
lbl_800D87A8:
...
/* 800D87B4 000D56F4  40 80 00 28 */	bge lbl_800D87DC
lbl_800D87B8:
...
/* 800D87D8 000D5718  42 00 FF E0 */	bdnz lbl_800D87B8
lbl_800D87DC:
...
/* 800D87F4 000D5734  48 00 01 B0 */	b lbl_800D89A4
lbl_800D87F8:
...
/* 800D8850 000D5790  48 00 01 4C */	b lbl_800D899C
lbl_800D8854:
...
/* 800D8860 000D57A0  40 80 00 14 */	bge lbl_800D8874
lbl_800D8864:
...
/* 800D8870 000D57B0  42 00 FF F4 */	bdnz lbl_800D8864
lbl_800D8874:
...
/* 800D8890 000D57D0  41 82 00 0C */	beq lbl_800D889C
/* 800D8894 000D57D4  3B C0 FF FB */	li r30, -5
/* 800D8898 000D57D8  48 00 00 E0 */	b lbl_800D8978
lbl_800D889C:
/* 800D889C 000D57DC  80 1F 00 24 */	lwz r0, 0x24(r31)
/* 800D88A0 000D57E0  2C 00 00 01 */	cmpwi r0, 1
/* 800D88A4 000D57E4  40 82 00 88 */	bne lbl_800D892C
...
/* 800D88B4 000D57F4  40 82 00 34 */	bne lbl_800D88E8
...
/* 800D88D4 000D5814  41 82 00 0C */	beq lbl_800D88E0
/* 800D88D8 000D5818  7C 1C 00 40 */	cmplw r28, r0
/* 800D88DC 000D581C  41 82 00 0C */	beq lbl_800D88E8
lbl_800D88E0:
/* 800D88E0 000D5820  3B C0 FF FE */	li r30, -2
/* 800D88E4 000D5824  48 00 00 94 */	b lbl_800D8978
lbl_800D88E8:
...
/* 800D8900 000D5840  41 80 00 78 */	blt lbl_800D8978
...
/* 800D8960 000D58A0  40 80 00 10 */	bge lbl_800D8970
...
/* 800D8974 000D58B4  48 00 00 30 */	b lbl_800D89A4
lbl_800D8978:
...
/* 800D8990 000D58D0  48 00 00 14 */	b lbl_800D89A4
lbl_800D8994:
/* 800D8994 000D58D4  38 C4 00 08 */	addi r6, r4, 8
/* 800D8998 000D58D8  4B FF FE 10 */	b lbl_800D87A8
lbl_800D899C:
/* 800D899C 000D58DC  38 65 00 08 */	addi r3, r5, 8
/* 800D89A0 000D58E0  4B FF FE B4 */	b lbl_800D8854
lbl_800D89A4:
...
/* 800D89FC 000D593C  41 82 00 A8 */	beq lbl_800D8AA4
/* 800D8A00 000D5940  40 80 00 10 */	bge lbl_800D8A10
/* 800D8A04 000D5944  2C 1D FF FB */	cmpwi r29, -5
/* 800D8A08 000D5948  41 82 00 9C */	beq lbl_800D8AA4
/* 800D8A0C 000D594C  48 00 00 A4 */	b lbl_800D8AB0
lbl_800D8A10:
/* 800D8A10 000D5950  2C 1D 00 01 */	cmpwi r29, 1
/* 800D8A14 000D5954  41 82 00 4C */	beq lbl_800D8A60
/* 800D8A18 000D5958  40 80 00 98 */	bge lbl_800D8AB0
/* 800D8A1C 000D595C  2C 1D 00 00 */	cmpwi r29, 0
/* 800D8A20 000D5960  40 80 00 08 */	bge lbl_800D8A28
/* 800D8A24 000D5964  48 00 00 8C */	b lbl_800D8AB0
lbl_800D8A28:
...
/* 800D8A38 000D5978  40 80 00 18 */	bge lbl_800D8A50
...
/* 800D8A48 000D5988  41 80 00 68 */	blt lbl_800D8AB0
/* 800D8A4C 000D598C  48 00 00 90 */	b lbl_800D8ADC
lbl_800D8A50:
...
/* 800D8A5C 000D599C  48 00 00 54 */	b lbl_800D8AB0
lbl_800D8A60:
...
/* 800D8A84 000D59C4  41 82 00 58 */	beq lbl_800D8ADC
...
/* 800D8A9C 000D59DC  41 80 00 14 */	blt lbl_800D8AB0
/* 800D8AA0 000D59E0  48 00 00 3C */	b lbl_800D8ADC
lbl_800D8AA4:
...
/* 800D8B1C 000D5A5C  41 80 00 0C */	blt lbl_800D8B28
/* 800D8B20 000D5A60  2C 1E 00 02 */	cmpwi r30, 2
/* 800D8B24 000D5A64  41 80 00 0C */	blt lbl_800D8B30
lbl_800D8B28:
/* 800D8B28 000D5A68  38 60 FF 80 */	li r3, -128
/* 800D8B2C 000D5A6C  48 00 01 5C */	b lbl_800D8C88
lbl_800D8B30:
...
/* 800D8B3C 000D5A7C  41 82 00 0C */	beq lbl_800D8B48
/* 800D8B40 000D5A80  38 60 FF FD */	li r3, -3
/* 800D8B44 000D5A84  48 00 01 44 */	b lbl_800D8C88
lbl_800D8B48:
...
/* 800D8B68 000D5AA8  40 82 00 14 */	bne lbl_800D8B7C
...
/* 800D8B78 000D5AB8  48 00 01 10 */	b lbl_800D8C88
lbl_800D8B7C:
/* 800D8B7C 000D5ABC  80 1F 00 00 */	lwz r0, 0(r31)
/* 800D8B80 000D5AC0  2C 00 00 00 */	cmpwi r0, 0
/* 800D8B84 000D5AC4  40 82 00 24 */	bne lbl_800D8BA8
...
/* 800D8B94 000D5AD4  41 82 00 14 */	beq lbl_800D8BA8
...
/* 800D8BA4 000D5AE4  48 00 00 E4 */	b lbl_800D8C88
lbl_800D8BA8:
...
/* 800D8BBC 000D5AFC  41 82 00 0C */	beq lbl_800D8BC8
/* 800D8BC0 000D5B00  7F A0 EB 78 */	mr r0, r29
/* 800D8BC4 000D5B04  48 00 00 0C */	b lbl_800D8BD0
lbl_800D8BC8:
...
/* 800D8BE4 000D5B24  40 82 00 34 */	bne lbl_800D8C18
...
/* 800D8BFC 000D5B3C  40 82 00 1C */	bne lbl_800D8C18
...
/* 800D8C14 000D5B54  48 00 00 74 */	b lbl_800D8C88
lbl_800D8C18:
...
/* 800D8C70 000D5BB0  40 82 00 0C */	bne lbl_800D8C7C
/* 800D8C74 000D5BB4  38 60 00 00 */	li r3, 0
/* 800D8C78 000D5BB8  48 00 00 10 */	b lbl_800D8C88
lbl_800D8C7C:
...
/* 800D8CC0 000D5C00  40 80 00 08 */	bge lbl_800D8CC8
/* 800D8CC4 000D5C04  48 00 00 0C */	b lbl_800D8CD0
lbl_800D8CC8:
...
/* 800D8D28 000D5C68  41 82 00 30 */	beq lbl_800D8D58
...
/* 800D8DA8 000D5CE8  40 80 00 08 */	bge lbl_800D8DB0
/* 800D8DAC 000D5CEC  48 00 00 64 */	b lbl_800D8E10
lbl_800D8DB0:
...
/* 800D8DD0 000D5D10  41 82 00 34 */	beq lbl_800D8E04
