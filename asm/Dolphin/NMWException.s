...
/* 800C1760 000BE6A0  41 82 00 50 */	beq lbl_800C17B0
/* 800C1764 000BE6A4  28 1B 00 00 */	cmplwi r27, 0
/* 800C1768 000BE6A8  41 82 00 40 */	beq lbl_800C17A8
...
/* 800C1780 000BE6C0  48 00 00 20 */	b lbl_800C17A0
lbl_800C1784:
...
/* 800C17A4 000BE6E4  41 80 FF E0 */	blt lbl_800C1784
lbl_800C17A8:
...
/* 800C17F4 000BE734  48 00 00 20 */	b lbl_800C1814
lbl_800C17F8:
...
/* 800C1818 000BE758  40 82 FF E0 */	bne lbl_800C17F8
...
/* 800C1884 000BE7C4  48 00 00 28 */	b lbl_800C18AC
lbl_800C1888:
...
/* 800C18E0 000BE820  48 00 00 2C */	b lbl_800C190C
lbl_800C18E4:
...
/* 800C1914 000BE854  40 82 FF D0 */	bne lbl_800C18E4
lbl_800C1918:
...
/* 800C1958 000BE898  41 82 00 78 */	beq lbl_800C19D0
...
/* 800C1968 000BE8A8  40 80 00 58 */	bge lbl_800C19C0
/* 800C196C 000BE8AC  80 1D 00 0C */	lwz r0, 0xc(r29)
/* 800C1970 000BE8B0  28 00 00 00 */	cmplwi r0, 0
/* 800C1974 000BE8B4  41 82 00 4C */	beq lbl_800C19C0
...
/* 800C1988 000BE8C8  48 00 00 2C */	b lbl_800C19B4
lbl_800C198C:
...
/* 800C19BC 000BE8FC  40 82 FF D0 */	bne lbl_800C198C
lbl_800C19C0:
/* 800C19C0 000BE900  7F C0 07 35 */	extsh. r0, r30
/* 800C19C4 000BE904  40 81 00 0C */	ble lbl_800C19D0
...
/* 800C1A10 000BE950  41 82 00 CC */	beq lbl_800C1ADC
...
/* 800C1A24 000BE964  41 82 00 B8 */	beq lbl_800C1ADC
...
/* 800C1A48 000BE988  48 00 00 28 */	b lbl_800C1A70
lbl_800C1A4C:
...
/* 800C1AA4 000BE9E4  48 00 00 2C */	b lbl_800C1AD0
lbl_800C1AA8:
...
/* 800C1AD8 000BEA18  40 82 FF D0 */	bne lbl_800C1AA8
lbl_800C1ADC:
