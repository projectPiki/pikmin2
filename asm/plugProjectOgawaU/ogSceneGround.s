...
/* 8030DA8C 0030A9CC  41 82 00 14 */	beq lbl_8030DAA0
...
/* 8030DAB8 0030A9F8  41 82 00 0C */	beq lbl_8030DAC4
...
/* 8030DADC 0030AA1C  41 82 00 0C */	beq lbl_8030DAE8
...
/* 8030DBE0 0030AB20  40 82 00 18 */	bne lbl_8030DBF8
...
/* 8030DC00 0030AB40  40 82 00 18 */	bne lbl_8030DC18
...
/* 8030DC24 0030AB64  40 82 00 18 */	bne lbl_8030DC3C
...
/* 8030DC7C 0030ABBC  40 82 00 3C */	bne lbl_8030DCB8
/* 8030DC80 0030ABC0  88 1E 02 20 */	lbz r0, 0x220(r30)
/* 8030DC84 0030ABC4  28 00 00 00 */	cmplwi r0, 0
/* 8030DC88 0030ABC8  40 82 00 38 */	bne lbl_8030DCC0
...
/* 8030DCB4 0030ABF4  48 00 00 0C */	b lbl_8030DCC0
lbl_8030DCB8:
...
/* 8030DCC8 0030AC08  40 82 00 4C */	bne lbl_8030DD14
...
/* 8030DCE8 0030AC28  40 82 00 2C */	bne lbl_8030DD14
/* 8030DCEC 0030AC2C  88 1E 02 24 */	lbz r0, 0x224(r30)
/* 8030DCF0 0030AC30  28 00 00 00 */	cmplwi r0, 0
/* 8030DCF4 0030AC34  40 82 00 20 */	bne lbl_8030DD14
...
/* 8030DD30 0030AC70  40 82 00 5C */	bne lbl_8030DD8C
/* 8030DD34 0030AC74  88 1E 02 21 */	lbz r0, 0x221(r30)
/* 8030DD38 0030AC78  28 00 00 00 */	cmplwi r0, 0
/* 8030DD3C 0030AC7C  40 82 00 58 */	bne lbl_8030DD94
...
/* 8030DD70 0030ACB0  40 82 00 24 */	bne lbl_8030DD94
...
/* 8030DD88 0030ACC8  48 00 00 0C */	b lbl_8030DD94
lbl_8030DD8C:
...
/* 8030DDE4 0030AD24  40 80 00 30 */	bge lbl_8030DE14
/* 8030DDE8 0030AD28  FC 1F 08 40 */	fcmpo cr0, f31, f1
/* 8030DDEC 0030AD2C  40 81 00 28 */	ble lbl_8030DE14
/* 8030DDF0 0030AD30  88 1E 02 22 */	lbz r0, 0x222(r30)
/* 8030DDF4 0030AD34  28 00 00 00 */	cmplwi r0, 0
/* 8030DDF8 0030AD38  40 82 00 1C */	bne lbl_8030DE14
...
/* 8030DE18 0030AD58  40 81 00 34 */	ble lbl_8030DE4C
/* 8030DE1C 0030AD5C  FC 1F E8 40 */	fcmpo cr0, f31, f29
/* 8030DE20 0030AD60  40 81 00 2C */	ble lbl_8030DE4C
/* 8030DE24 0030AD64  88 1E 02 23 */	lbz r0, 0x223(r30)
/* 8030DE28 0030AD68  28 00 00 00 */	cmplwi r0, 0
/* 8030DE2C 0030AD6C  40 82 00 20 */	bne lbl_8030DE4C
