...
/* 802BFD14 002BCC54  41 82 00 24 */	beq lbl_802BFD38
...
/* 802BFD9C 002BCCDC  41 82 00 44 */	beq lbl_802BFDE0
...
/* 802BFDF0 002BCD30  41 82 00 24 */	beq lbl_802BFE14
...
/* 802C001C 002BCF5C  41 82 00 50 */	beq lbl_802C006C
/* 802C0020 002BCF60  88 04 00 48 */	lbz r0, 0x48(r4)
/* 802C0024 002BCF64  28 00 00 00 */	cmplwi r0, 0
/* 802C0028 002BCF68  41 82 00 44 */	beq lbl_802C006C
...
/* 802C0040 002BCF80  41 82 00 2C */	beq lbl_802C006C
...
/* 802C005C 002BCF9C  40 82 00 10 */	bne lbl_802C006C
...
/* 802C00E8 002BD028  41 82 00 40 */	beq lbl_802C0128
...
/* 802C00F8 002BD038  40 81 00 30 */	ble lbl_802C0128
...
/* 802C02EC 002BD22C  41 82 00 68 */	beq lbl_802C0354
/* 802C02F0 002BD230  28 05 00 00 */	cmplwi r5, 0
/* 802C02F4 002BD234  41 82 00 60 */	beq lbl_802C0354
...
/* 802C0310 002BD250  41 82 00 44 */	beq lbl_802C0354
...
/* 802C0320 002BD260  41 82 00 34 */	beq lbl_802C0354
...
/* 802C0330 002BD270  40 82 00 0C */	bne lbl_802C033C
...
/* 802C0350 002BD290  48 00 00 08 */	b lbl_802C0358
lbl_802C0354:
...
/* 802C054C 002BD48C  40 82 00 50 */	bne lbl_802C059C
...
/* 802C0670 002BD5B0  48 00 01 A8 */	b lbl_802C0818
lbl_802C0674:
...
/* 802C069C 002BD5DC  40 80 01 7C */	bge lbl_802C0818
...
/* 802C0754 002BD694  40 80 00 30 */	bge lbl_802C0784
...
/* 802C0780 002BD6C0  48 00 00 28 */	b lbl_802C07A8
lbl_802C0784:
...
/* 802C07C4 002BD704  40 80 00 08 */	bge lbl_802C07CC
...
/* 802C0800 002BD740  48 00 00 18 */	b lbl_802C0818
lbl_802C0804:
...
/* 802C0890 002BD7D0  41 82 00 28 */	beq lbl_802C08B8
...
/* 802C08B4 002BD7F4  48 00 00 40 */	b lbl_802C08F4
lbl_802C08B8:
...
/* 802C08F8 002BD838  41 82 00 34 */	beq lbl_802C092C
...
/* 802C0928 002BD868  48 00 01 24 */	b lbl_802C0A4C
lbl_802C092C:
...
/* 802C0938 002BD878  40 81 01 14 */	ble lbl_802C0A4C
...
/* 802C09B4 002BD8F4  40 80 00 08 */	bge lbl_802C09BC
...
/* 802C09F8 002BD938  40 80 00 28 */	bge lbl_802C0A20
...
/* 802C0A1C 002BD95C  48 00 00 1C */	b lbl_802C0A38
lbl_802C0A20:
...
/* 802C0A9C 002BD9DC  41 82 00 0C */	beq lbl_802C0AA8
...
/* 802C0AB8 002BD9F8  41 82 00 88 */	beq lbl_802C0B40
...
/* 802C0B50 002BDA90  41 82 00 20 */	beq lbl_802C0B70
...
/* 802C0F7C 002BDEBC  41 82 00 10 */	beq lbl_802C0F8C
...
/* 802C0FF0 002BDF30  41 80 FF E0 */	blt lbl_802C0FD0
...
/* 802C1000 002BDF40  41 80 FF C8 */	blt lbl_802C0FC8
...
/* 802C1134 002BE074  41 82 00 10 */	beq lbl_802C1144
...
/* 802C1198 002BE0D8  41 82 00 10 */	beq lbl_802C11A8
...
/* 802C13EC 002BE32C  41 82 00 08 */	beq lbl_802C13F4
...
/* 802C1438 002BE378  41 82 00 3C */	beq lbl_802C1474
...
/* 802C1454 002BE394  41 82 00 20 */	beq lbl_802C1474
...
/* 802C1470 002BE3B0  40 82 00 08 */	bne lbl_802C1478
lbl_802C1474:
/* 802C1474 002BE3B4  3B E0 00 01 */	li r31, 1
lbl_802C1478:
/* 802C1478 002BE3B8  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C147C 002BE3BC  40 82 00 20 */	bne lbl_802C149C
...
/* 802C14E8 002BE428  40 82 00 A8 */	bne lbl_802C1590
...
/* 802C1514 002BE454  41 82 00 3C */	beq lbl_802C1550
...
/* 802C1530 002BE470  41 82 00 20 */	beq lbl_802C1550
...
/* 802C154C 002BE48C  40 82 00 08 */	bne lbl_802C1554
lbl_802C1550:
/* 802C1550 002BE490  3B E0 00 01 */	li r31, 1
lbl_802C1554:
/* 802C1554 002BE494  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C1558 002BE498  40 82 00 20 */	bne lbl_802C1578
...
/* 802C15C4 002BE504  41 82 00 A4 */	beq lbl_802C1668
...
/* 802C15EC 002BE52C  41 82 00 3C */	beq lbl_802C1628
...
/* 802C1608 002BE548  41 82 00 20 */	beq lbl_802C1628
...
/* 802C1624 002BE564  40 82 00 08 */	bne lbl_802C162C
lbl_802C1628:
/* 802C1628 002BE568  3B E0 00 01 */	li r31, 1
lbl_802C162C:
/* 802C162C 002BE56C  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C1630 002BE570  40 82 00 20 */	bne lbl_802C1650
...
/* 802C169C 002BE5DC  41 82 00 A0 */	beq lbl_802C173C
...
/* 802C16C0 002BE600  41 82 00 3C */	beq lbl_802C16FC
...
/* 802C16DC 002BE61C  41 82 00 20 */	beq lbl_802C16FC
...
/* 802C16F8 002BE638  40 82 00 08 */	bne lbl_802C1700
lbl_802C16FC:
/* 802C16FC 002BE63C  3B E0 00 01 */	li r31, 1
lbl_802C1700:
/* 802C1700 002BE640  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C1704 002BE644  40 82 00 20 */	bne lbl_802C1724
...
/* 802C1770 002BE6B0  41 82 00 A0 */	beq lbl_802C1810
...
/* 802C1794 002BE6D4  41 82 00 3C */	beq lbl_802C17D0
...
/* 802C17B0 002BE6F0  41 82 00 20 */	beq lbl_802C17D0
...
/* 802C17CC 002BE70C  40 82 00 08 */	bne lbl_802C17D4
lbl_802C17D0:
/* 802C17D0 002BE710  3B E0 00 01 */	li r31, 1
lbl_802C17D4:
/* 802C17D4 002BE714  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C17D8 002BE718  40 82 00 20 */	bne lbl_802C17F8
...
/* 802C185C 002BE79C  41 82 00 3C */	beq lbl_802C1898
...
/* 802C1878 002BE7B8  41 82 00 20 */	beq lbl_802C1898
...
/* 802C1894 002BE7D4  40 82 00 08 */	bne lbl_802C189C
lbl_802C1898:
/* 802C1898 002BE7D8  3B E0 00 01 */	li r31, 1
lbl_802C189C:
/* 802C189C 002BE7DC  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C18A0 002BE7E0  40 82 00 20 */	bne lbl_802C18C0
...
/* 802C192C 002BE86C  41 82 00 3C */	beq lbl_802C1968
...
/* 802C1948 002BE888  41 82 00 20 */	beq lbl_802C1968
...
/* 802C1970 002BE8B0  40 82 00 20 */	bne lbl_802C1990
...
/* 802C1998 002BE8D8  41 82 00 20 */	beq lbl_802C19B8
...
/* 802C19B4 002BE8F4  48 00 00 1C */	b lbl_802C19D0
lbl_802C19B8:
...
/* 802C1A20 002BE960  41 82 00 3C */	beq lbl_802C1A5C
...
/* 802C1A3C 002BE97C  41 82 00 20 */	beq lbl_802C1A5C
...
/* 802C1A58 002BE998  40 82 00 08 */	bne lbl_802C1A60
lbl_802C1A5C:
/* 802C1A5C 002BE99C  3B E0 00 01 */	li r31, 1
lbl_802C1A60:
/* 802C1A60 002BE9A0  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C1A64 002BE9A4  40 82 00 20 */	bne lbl_802C1A84
...
/* 802C1ADC 002BEA1C  41 82 00 3C */	beq lbl_802C1B18
...
/* 802C1AF8 002BEA38  41 82 00 20 */	beq lbl_802C1B18
...
/* 802C1B14 002BEA54  40 82 00 08 */	bne lbl_802C1B1C
lbl_802C1B18:
/* 802C1B18 002BEA58  3B E0 00 01 */	li r31, 1
lbl_802C1B1C:
/* 802C1B1C 002BEA5C  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C1B20 002BEA60  40 82 00 20 */	bne lbl_802C1B40
...
/* 802C1BB0 002BEAF0  41 82 00 70 */	beq lbl_802C1C20
...
/* 802C1C30 002BEB70  41 80 FF 74 */	blt lbl_802C1BA4
...
/* 802C1C84 002BEBC4  41 82 00 70 */	beq lbl_802C1CF4
...
/* 802C1D04 002BEC44  41 82 00 6C */	beq lbl_802C1D70
...
/* 802C1D80 002BECC0  41 82 00 6C */	beq lbl_802C1DEC
...
/* 802C1DFC 002BED3C  41 82 00 70 */	beq lbl_802C1E6C
...
/* 802C1E7C 002BEDBC  41 80 FD FC */	blt lbl_802C1C78
...
/* 802C1EAC 002BEDEC  41 82 00 6C */	beq lbl_802C1F18
...
/* 802C1F28 002BEE68  41 80 FF 78 */	blt lbl_802C1EA0
...
/* 802C1F38 002BEE78  41 82 00 70 */	beq lbl_802C1FA8
...
/* 802C1FB8 002BEEF8  41 82 00 74 */	beq lbl_802C202C
...
/* 802C203C 002BEF7C  41 82 00 74 */	beq lbl_802C20B0
...
/* 802C20C0 002BF000  41 82 00 28 */	beq lbl_802C20E8
...
/* 802C20F8 002BF038  41 82 00 20 */	beq lbl_802C2118
...
/* 802C22C0 002BF200  41 80 FF C4 */	blt lbl_802C2284
...
/* 802C2318 002BF258  40 82 01 50 */	bne lbl_802C2468
/* 802C231C 002BF25C  28 05 00 00 */	cmplwi r5, 0
/* 802C2320 002BF260  41 82 00 D0 */	beq lbl_802C23F0
...
/* 802C23CC 002BF30C  41 82 00 88 */	beq lbl_802C2454
...
/* 802C23EC 002BF32C  48 00 00 68 */	b lbl_802C2454
lbl_802C23F0:
...
/* 802C2464 002BF3A4  48 00 01 DC */	b lbl_802C2640
lbl_802C2468:
/* 802C2468 002BF3A8  28 05 00 00 */	cmplwi r5, 0
/* 802C246C 002BF3AC  41 82 01 00 */	beq lbl_802C256C
...
/* 802C2548 002BF488  41 82 00 8C */	beq lbl_802C25D4
...
/* 802C2568 002BF4A8  48 00 00 6C */	b lbl_802C25D4
lbl_802C256C:
...
/* 802C25DC 002BF51C  41 82 00 54 */	beq lbl_802C2630
/* 802C25E0 002BF520  2C 1E 00 02 */	cmpwi r30, 2
/* 802C25E4 002BF524  38 00 00 00 */	li r0, 0
/* 802C25E8 002BF528  40 82 00 0C */	bne lbl_802C25F4
/* 802C25EC 002BF52C  38 00 00 00 */	li r0, 0
/* 802C25F0 002BF530  48 00 00 20 */	b lbl_802C2610
lbl_802C25F4:
/* 802C25F4 002BF534  2C 1E 00 01 */	cmpwi r30, 1
/* 802C25F8 002BF538  40 82 00 0C */	bne lbl_802C2604
/* 802C25FC 002BF53C  38 00 00 01 */	li r0, 1
/* 802C2600 002BF540  48 00 00 10 */	b lbl_802C2610
lbl_802C2604:
/* 802C2604 002BF544  2C 1E 00 03 */	cmpwi r30, 3
/* 802C2608 002BF548  40 82 00 08 */	bne lbl_802C2610
...
/* 802C26EC 002BF62C  48 00 00 C8 */	b lbl_802C27B4
lbl_802C26F0:
...
/* 802C2788 002BF6C8  48 00 00 2C */	b lbl_802C27B4
lbl_802C278C:
...
/* 802C2804 002BF744  41 80 FF DC */	blt lbl_802C27E0
...
/* 802C285C 002BF79C  41 80 FF E0 */	blt lbl_802C283C
...
/* 802C290C 002BF84C  41 80 FF B8 */	blt lbl_802C28C4
...
/* 802C291C 002BF85C  41 80 FF 98 */	blt lbl_802C28B4
...
/* 802C294C 002BF88C  41 80 FF DC */	blt lbl_802C2928
...
/* 802C29F4 002BF934  41 80 FF E0 */	blt lbl_802C29D4
...
/* 802C2A3C 002BF97C  41 82 00 D4 */	beq lbl_802C2B10
...
/* 802C2AD8 002BFA18  41 80 FF DC */	blt lbl_802C2AB4
...
/* 802C2CA8 002BFBE8  41 82 00 1C */	beq lbl_802C2CC4
...
/* 802C2CEC 002BFC2C  41 80 FF DC */	blt lbl_802C2CC8
...
/* 802C2D58 002BFC98  41 80 FF E0 */	blt lbl_802C2D38
...
/* 802C2DB4 002BFCF4  41 80 FF DC */	blt lbl_802C2D90
...
/* 802C2E0C 002BFD4C  41 80 FF E0 */	blt lbl_802C2DEC
...
/* 802C2FF4 002BFF34  41 80 FF 40 */	blt lbl_802C2F34
...
/* 802C30E8 002C0028  41 80 FF 4C */	blt lbl_802C3034
lbl_802C30EC:
...
/* 802C30F8 002C0038  41 80 FD FC */	blt lbl_802C2EF4
...
/* 802C3154 002C0094  41 80 FF E0 */	blt lbl_802C3134
...
/* 802C3194 002C00D4  41 80 FF CC */	blt lbl_802C3160
...
/* 802C31D4 002C0114  41 80 FF E0 */	blt lbl_802C31B4
...
/* 802C323C 002C017C  41 80 FF CC */	blt lbl_802C3208
...
/* 802C32D0 002C0210  41 80 FF E0 */	blt lbl_802C32B0
...
/* 802C3310 002C0250  41 80 FF CC */	blt lbl_802C32DC
...
/* 802C3350 002C0290  41 80 FF E0 */	blt lbl_802C3330
...
/* 802C33B8 002C02F8  41 80 FF CC */	blt lbl_802C3384
...
/* 802C3430 002C0370  41 82 00 64 */	beq lbl_802C3494
...
/* 802C3448 002C0388  41 82 00 3C */	beq lbl_802C3484
...
/* 802C3460 002C03A0  41 82 00 24 */	beq lbl_802C3484
...
/* 802C3488 002C03C8  40 81 00 0C */	ble lbl_802C3494
...
/* 802C34CC 002C040C  41 82 00 64 */	beq lbl_802C3530
...
/* 802C34E4 002C0424  41 82 00 3C */	beq lbl_802C3520
...
/* 802C34FC 002C043C  41 82 00 24 */	beq lbl_802C3520
...
/* 802C3524 002C0464  40 81 00 0C */	ble lbl_802C3530
...
/* 802C3568 002C04A8  41 82 00 64 */	beq lbl_802C35CC
...
/* 802C3580 002C04C0  41 82 00 3C */	beq lbl_802C35BC
...
/* 802C3598 002C04D8  41 82 00 24 */	beq lbl_802C35BC
...
/* 802C35C0 002C0500  40 81 00 0C */	ble lbl_802C35CC
...
/* 802C3604 002C0544  41 82 00 64 */	beq lbl_802C3668
...
/* 802C361C 002C055C  41 82 00 3C */	beq lbl_802C3658
...
/* 802C3634 002C0574  41 82 00 24 */	beq lbl_802C3658
...
/* 802C365C 002C059C  40 81 00 0C */	ble lbl_802C3668
...
/* 802C36A0 002C05E0  41 82 00 64 */	beq lbl_802C3704
...
/* 802C36B8 002C05F8  41 82 00 3C */	beq lbl_802C36F4
...
/* 802C36D0 002C0610  41 82 00 24 */	beq lbl_802C36F4
...
/* 802C36F8 002C0638  40 81 00 0C */	ble lbl_802C3704
...
/* 802C373C 002C067C  41 82 00 64 */	beq lbl_802C37A0
...
/* 802C3754 002C0694  41 82 00 3C */	beq lbl_802C3790
...
/* 802C376C 002C06AC  41 82 00 24 */	beq lbl_802C3790
...
/* 802C3794 002C06D4  40 81 00 0C */	ble lbl_802C37A0
...
/* 802C37D8 002C0718  41 82 00 64 */	beq lbl_802C383C
...
/* 802C3808 002C0748  41 82 00 24 */	beq lbl_802C382C
...
/* 802C3830 002C0770  40 81 00 0C */	ble lbl_802C383C
