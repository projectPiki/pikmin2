...
/* 802C7F54 002C4E94  41 82 00 24 */	beq lbl_802C7F78
...
/* 802C7FDC 002C4F1C  41 82 00 44 */	beq lbl_802C8020
...
/* 802C8030 002C4F70  41 82 00 24 */	beq lbl_802C8054
...
/* 802C8194 002C50D4  41 82 00 34 */	beq lbl_802C81C8
/* 802C8198 002C50D8  80 03 00 44 */	lwz r0, 0x44(r3)
/* 802C819C 002C50DC  2C 00 00 04 */	cmpwi r0, 4
/* 802C81A0 002C50E0  40 82 00 28 */	bne lbl_802C81C8
...
/* 802C81C4 002C5104  48 00 00 18 */	b lbl_802C81DC
lbl_802C81C8:
...
/* 802C8418 002C5358  41 82 00 0C */	beq lbl_802C8424
/* 802C841C 002C535C  38 60 00 01 */	li r3, 1
/* 802C8420 002C5360  48 00 00 18 */	b lbl_802C8438
lbl_802C8424:
...
/* 802C8474 002C53B4  41 82 00 50 */	beq lbl_802C84C4
/* 802C8478 002C53B8  28 05 00 00 */	cmplwi r5, 0
/* 802C847C 002C53BC  41 82 00 48 */	beq lbl_802C84C4
...
/* 802C8498 002C53D8  41 82 00 2C */	beq lbl_802C84C4
...
/* 802C84A8 002C53E8  41 82 00 1C */	beq lbl_802C84C4
...
/* 802C84C0 002C5400  48 00 00 08 */	b lbl_802C84C8
lbl_802C84C4:
...
/* 802C8544 002C5484  41 82 01 1C */	beq lbl_802C8660
/* 802C8548 002C5488  80 1F 00 C8 */	lwz r0, 0xc8(r31)
/* 802C854C 002C548C  28 00 00 00 */	cmplwi r0, 0
/* 802C8550 002C5490  41 82 01 10 */	beq lbl_802C8660
...
/* 802C856C 002C54AC  40 82 00 20 */	bne lbl_802C858C
...
/* 802C8588 002C54C8  41 82 00 64 */	beq lbl_802C85EC
lbl_802C858C:
...
/* 802C859C 002C54DC  41 82 00 C4 */	beq lbl_802C8660
...
/* 802C85E8 002C5528  48 00 00 78 */	b lbl_802C8660
lbl_802C85EC:
...
/* 802C8604 002C5544  41 82 00 5C */	beq lbl_802C8660
...
/* 802C8618 002C5558  41 82 00 48 */	beq lbl_802C8660
...
/* 802C8714 002C5654  41 82 00 0C */	beq lbl_802C8720
...
/* 802C8964 002C58A4  40 80 03 58 */	bge lbl_802C8CBC
/* 802C8968 002C58A8  88 1F 02 DE */	lbz r0, 0x2de(r31)
/* 802C896C 002C58AC  28 00 00 00 */	cmplwi r0, 0
/* 802C8970 002C58B0  41 82 01 2C */	beq lbl_802C8A9C
...
/* 802C89E4 002C5924  40 80 00 30 */	bge lbl_802C8A14
...
/* 802C8A10 002C5950  48 00 00 28 */	b lbl_802C8A38
lbl_802C8A14:
...
/* 802C8A58 002C5998  40 80 00 08 */	bge lbl_802C8A60
...
/* 802C8A98 002C59D8  48 00 02 38 */	b lbl_802C8CD0
lbl_802C8A9C:
...
/* 802C8AD0 002C5A10  41 82 00 38 */	beq lbl_802C8B08
...
/* 802C8B04 002C5A44  48 00 01 CC */	b lbl_802C8CD0
lbl_802C8B08:
...
/* 802C8B30 002C5A70  40 80 01 A0 */	bge lbl_802C8CD0
...
/* 802C8BE8 002C5B28  40 80 00 30 */	bge lbl_802C8C18
...
/* 802C8C14 002C5B54  48 00 00 28 */	b lbl_802C8C3C
lbl_802C8C18:
...
/* 802C8C58 002C5B98  40 80 00 30 */	bge lbl_802C8C88
...
/* 802C8C84 002C5BC4  48 00 00 28 */	b lbl_802C8CAC
lbl_802C8C88:
...
/* 802C8CB8 002C5BF8  48 00 00 18 */	b lbl_802C8CD0
lbl_802C8CBC:
...
/* 802C8D20 002C5C60  41 82 00 0C */	beq lbl_802C8D2C
...
/* 802C8D3C 002C5C7C  41 82 00 88 */	beq lbl_802C8DC4
...
/* 802C8DD4 002C5D14  41 82 00 20 */	beq lbl_802C8DF4
...
/* 802C8F88 002C5EC8  41 82 00 68 */	beq lbl_802C8FF0
...
/* 802C92B8 002C61F8  41 82 00 10 */	beq lbl_802C92C8
...
/* 802C932C 002C626C  41 80 FF E0 */	blt lbl_802C930C
...
/* 802C933C 002C627C  41 80 FF C8 */	blt lbl_802C9304
...
/* 802C939C 002C62DC  41 82 00 14 */	beq lbl_802C93B0
...
/* 802C942C 002C636C  41 82 00 7C */	beq lbl_802C94A8
...
/* 802C9440 002C6380  41 82 00 0C */	beq lbl_802C944C
/* 802C9444 002C6384  48 16 AC 61 */	bl getFrameMax__Q23Sys16MatBaseAnimationFv
/* 802C9448 002C6388  48 00 00 08 */	b lbl_802C9450
lbl_802C944C:
...
/* 802C9464 002C63A4  40 80 00 14 */	bge lbl_802C9478
...
/* 802C9474 002C63B4  48 00 00 10 */	b lbl_802C9484
lbl_802C9478:
...
/* 802C949C 002C63DC  40 80 00 40 */	bge lbl_802C94DC
/* 802C94A0 002C63E0  D0 1F 02 D4 */	stfs f0, 0x2d4(r31)
/* 802C94A4 002C63E4  48 00 00 38 */	b lbl_802C94DC
lbl_802C94A8:
...
/* 802C9554 002C6494  41 82 00 08 */	beq lbl_802C955C
...
/* 802C9568 002C64A8  41 80 FF DC */	blt lbl_802C9544
...
/* 802C95AC 002C64EC  41 82 00 68 */	beq lbl_802C9614
...
/* 802C95C0 002C6500  41 82 00 54 */	beq lbl_802C9614
...
/* 802C9660 002C65A0  41 82 00 3C */	beq lbl_802C969C
...
/* 802C967C 002C65BC  41 82 00 20 */	beq lbl_802C969C
...
/* 802C9698 002C65D8  40 82 00 08 */	bne lbl_802C96A0
lbl_802C969C:
/* 802C969C 002C65DC  3B E0 00 01 */	li r31, 1
lbl_802C96A0:
/* 802C96A0 002C65E0  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C96A4 002C65E4  40 82 00 20 */	bne lbl_802C96C4
...
/* 802C9728 002C6668  41 82 00 3C */	beq lbl_802C9764
...
/* 802C9744 002C6684  41 82 00 20 */	beq lbl_802C9764
...
/* 802C9760 002C66A0  40 82 00 08 */	bne lbl_802C9768
lbl_802C9764:
/* 802C9764 002C66A4  3B E0 00 01 */	li r31, 1
lbl_802C9768:
/* 802C9768 002C66A8  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C976C 002C66AC  40 82 00 20 */	bne lbl_802C978C
...
/* 802C97F0 002C6730  41 82 00 3C */	beq lbl_802C982C
...
/* 802C980C 002C674C  41 82 00 20 */	beq lbl_802C982C
...
/* 802C9828 002C6768  40 82 00 08 */	bne lbl_802C9830
lbl_802C982C:
/* 802C982C 002C676C  3B E0 00 01 */	li r31, 1
lbl_802C9830:
/* 802C9830 002C6770  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C9834 002C6774  40 82 00 20 */	bne lbl_802C9854
...
/* 802C98A0 002C67E0  41 82 00 A0 */	beq lbl_802C9940
...
/* 802C98C4 002C6804  41 82 00 3C */	beq lbl_802C9900
...
/* 802C98E0 002C6820  41 82 00 20 */	beq lbl_802C9900
...
/* 802C98FC 002C683C  40 82 00 08 */	bne lbl_802C9904
lbl_802C9900:
/* 802C9900 002C6840  3B E0 00 01 */	li r31, 1
lbl_802C9904:
/* 802C9904 002C6844  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C9908 002C6848  40 82 00 20 */	bne lbl_802C9928
...
/* 802C9974 002C68B4  41 82 00 A0 */	beq lbl_802C9A14
...
/* 802C9998 002C68D8  41 82 00 3C */	beq lbl_802C99D4
...
/* 802C99B4 002C68F4  41 82 00 20 */	beq lbl_802C99D4
...
/* 802C99D0 002C6910  40 82 00 08 */	bne lbl_802C99D8
lbl_802C99D4:
/* 802C99D4 002C6914  3B E0 00 01 */	li r31, 1
lbl_802C99D8:
/* 802C99D8 002C6918  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C99DC 002C691C  40 82 00 20 */	bne lbl_802C99FC
...
/* 802C9A68 002C69A8  41 82 00 3C */	beq lbl_802C9AA4
...
/* 802C9A84 002C69C4  41 82 00 20 */	beq lbl_802C9AA4
...
/* 802C9AA0 002C69E0  40 82 00 08 */	bne lbl_802C9AA8
lbl_802C9AA4:
/* 802C9AA4 002C69E4  3B E0 00 01 */	li r31, 1
lbl_802C9AA8:
/* 802C9AA8 002C69E8  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C9AAC 002C69EC  40 82 00 20 */	bne lbl_802C9ACC
...
/* 802C9AD4 002C6A14  41 82 00 20 */	beq lbl_802C9AF4
...
/* 802C9AF0 002C6A30  48 00 00 1C */	b lbl_802C9B0C
lbl_802C9AF4:
...
/* 802C9B5C 002C6A9C  41 82 00 3C */	beq lbl_802C9B98
...
/* 802C9B78 002C6AB8  41 82 00 20 */	beq lbl_802C9B98
...
/* 802C9B94 002C6AD4  40 82 00 08 */	bne lbl_802C9B9C
lbl_802C9B98:
/* 802C9B98 002C6AD8  3B E0 00 01 */	li r31, 1
lbl_802C9B9C:
/* 802C9B9C 002C6ADC  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C9BA0 002C6AE0  40 82 00 20 */	bne lbl_802C9BC0
...
/* 802C9C18 002C6B58  41 82 00 3C */	beq lbl_802C9C54
...
/* 802C9C34 002C6B74  41 82 00 20 */	beq lbl_802C9C54
...
/* 802C9C50 002C6B90  40 82 00 08 */	bne lbl_802C9C58
lbl_802C9C54:
/* 802C9C54 002C6B94  3B E0 00 01 */	li r31, 1
lbl_802C9C58:
/* 802C9C58 002C6B98  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 802C9C5C 002C6B9C  40 82 00 20 */	bne lbl_802C9C7C
...
/* 802C9D54 002C6C94  41 82 00 20 */	beq lbl_802C9D74
...
/* 802C9D84 002C6CC4  41 82 00 6C */	beq lbl_802C9DF0
...
/* 802C9E08 002C6D48  41 82 00 70 */	beq lbl_802C9E78
...
/* 802C9E88 002C6DC8  41 82 00 70 */	beq lbl_802C9EF8
...
/* 802C9F08 002C6E48  41 80 FE F4 */	blt lbl_802C9DFC
...
/* 802C9F20 002C6E60  41 82 00 6C */	beq lbl_802C9F8C
...
/* 802C9F9C 002C6EDC  41 82 00 70 */	beq lbl_802CA00C
...
/* 802CA01C 002C6F5C  41 80 FE F8 */	blt lbl_802C9F14
...
/* 802CA02C 002C6F6C  41 82 00 70 */	beq lbl_802CA09C
...
/* 802CA0AC 002C6FEC  41 82 00 6C */	beq lbl_802CA118
...
/* 802CA130 002C7070  41 80 FC 18 */	blt lbl_802C9D48
...
/* 802CA154 002C7094  41 82 00 6C */	beq lbl_802CA1C0
...
/* 802CA1D0 002C7110  41 80 FF 78 */	blt lbl_802CA148
...
/* 802CA1E0 002C7120  41 82 00 70 */	beq lbl_802CA250
...
/* 802CA260 002C71A0  41 82 00 70 */	beq lbl_802CA2D0
...
/* 802CA2E0 002C7220  41 82 00 70 */	beq lbl_802CA350
...
/* 802CA4EC 002C742C  41 80 FE D0 */	blt lbl_802CA3BC
...
/* 802CA5A0 002C74E0  41 82 00 D4 */	beq lbl_802CA674
...
/* 802CA650 002C7590  41 82 00 88 */	beq lbl_802CA6D8
...
/* 802CA670 002C75B0  48 00 00 68 */	b lbl_802CA6D8
lbl_802CA674:
...
/* 802CA6E0 002C7620  41 82 00 38 */	beq lbl_802CA718
...
/* 802CA714 002C7654  41 80 FF DC */	blt lbl_802CA6F0
lbl_802CA718:
...
/* 802CA78C 002C76CC  41 82 00 28 */	beq lbl_802CA7B4
...
/* 802CA7B0 002C76F0  48 00 00 24 */	b lbl_802CA7D4
lbl_802CA7B4:
...
/* 802CA7DC 002C771C  41 82 00 34 */	beq lbl_802CA810
...
/* 802CA80C 002C774C  48 00 00 B8 */	b lbl_802CA8C4
lbl_802CA810:
...
/* 802CA828 002C7768  40 80 00 34 */	bge lbl_802CA85C
...
/* 802CA894 002C77D4  48 00 00 30 */	b lbl_802CA8C4
lbl_802CA898:
...
/* 802CA960 002C78A0  41 80 FF C0 */	blt lbl_802CA920
...
/* 802CA9EC 002C792C  41 80 FF B4 */	blt lbl_802CA9A0
...
/* 802CAA48 002C7988  41 80 FF B0 */	blt lbl_802CA9F8
...
/* 802CAAB4 002C79F4  41 80 FF E0 */	blt lbl_802CAA94
...
/* 802CAB70 002C7AB0  41 80 FF B8 */	blt lbl_802CAB28
...
/* 802CABA0 002C7AE0  41 80 FF DC */	blt lbl_802CAB7C
...
/* 802CABE8 002C7B28  41 80 FF C4 */	blt lbl_802CABAC
...
/* 802CAC1C 002C7B5C  41 80 FE FC */	blt lbl_802CAB18
...
/* 802CAC78 002C7BB8  41 80 FF E0 */	blt lbl_802CAC58
...
/* 802CACD0 002C7C10  41 82 01 E8 */	beq lbl_802CAEB8
...
/* 802CAD9C 002C7CDC  41 80 FF C0 */	blt lbl_802CAD5C
...
/* 802CAE24 002C7D64  41 80 FF B4 */	blt lbl_802CADD8
...
/* 802CAE80 002C7DC0  41 80 FF B0 */	blt lbl_802CAE30
...
/* 802CAF3C 002C7E7C  41 80 FF DC */	blt lbl_802CAF18
...
/* 802CAFA8 002C7EE8  41 80 FF E0 */	blt lbl_802CAF88
...
/* 802CB00C 002C7F4C  41 80 FF E8 */	blt lbl_802CAFF4
...
/* 802CB07C 002C7FBC  41 80 FF CC */	blt lbl_802CB048
...
/* 802CB0A8 002C7FE8  41 80 FF E0 */	blt lbl_802CB088
...
/* 802CB0F0 002C8030  41 80 FF CC */	blt lbl_802CB0BC
...
/* 802CB100 002C8040  41 80 FF B4 */	blt lbl_802CB0B4
...
/* 802CB148 002C8088  41 80 FF CC */	blt lbl_802CB114
...
/* 802CB158 002C8098  41 80 FF B4 */	blt lbl_802CB10C
...
/* 802CB184 002C80C4  41 80 FF E0 */	blt lbl_802CB164
...
/* 802CB1EC 002C812C  41 80 FF E0 */	blt lbl_802CB1CC
...
/* 802CB254 002C8194  41 80 FF CC */	blt lbl_802CB220
...
/* 802CB280 002C81C0  41 80 FF E0 */	blt lbl_802CB260
...
/* 802CB2C8 002C8208  41 80 FF CC */	blt lbl_802CB294
...
/* 802CB2D8 002C8218  41 80 FF B4 */	blt lbl_802CB28C
...
/* 802CB320 002C8260  41 80 FF CC */	blt lbl_802CB2EC
...
/* 802CB330 002C8270  41 80 FF B4 */	blt lbl_802CB2E4
...
/* 802CB35C 002C829C  41 80 FF E0 */	blt lbl_802CB33C
...
/* 802CB3C4 002C8304  41 80 FF E0 */	blt lbl_802CB3A4
...
/* 802CB430 002C8370  41 82 00 64 */	beq lbl_802CB494
...
/* 802CB448 002C8388  41 82 00 3C */	beq lbl_802CB484
...
/* 802CB460 002C83A0  41 82 00 24 */	beq lbl_802CB484
...
/* 802CB488 002C83C8  40 81 00 0C */	ble lbl_802CB494
...
/* 802CB4CC 002C840C  41 82 00 64 */	beq lbl_802CB530
...
/* 802CB4E4 002C8424  41 82 00 3C */	beq lbl_802CB520
...
/* 802CB4FC 002C843C  41 82 00 24 */	beq lbl_802CB520
...
/* 802CB524 002C8464  40 81 00 0C */	ble lbl_802CB530
...
/* 802CB568 002C84A8  41 82 00 64 */	beq lbl_802CB5CC
...
/* 802CB580 002C84C0  41 82 00 3C */	beq lbl_802CB5BC
...
/* 802CB598 002C84D8  41 82 00 24 */	beq lbl_802CB5BC
...
/* 802CB5C0 002C8500  40 81 00 0C */	ble lbl_802CB5CC
...
/* 802CB604 002C8544  41 82 00 64 */	beq lbl_802CB668
...
/* 802CB61C 002C855C  41 82 00 3C */	beq lbl_802CB658
...
/* 802CB634 002C8574  41 82 00 24 */	beq lbl_802CB658
...
/* 802CB65C 002C859C  40 81 00 0C */	ble lbl_802CB668
...
/* 802CB6A0 002C85E0  41 82 00 64 */	beq lbl_802CB704
...
/* 802CB6B8 002C85F8  41 82 00 3C */	beq lbl_802CB6F4
...
/* 802CB6D0 002C8610  41 82 00 24 */	beq lbl_802CB6F4
...
/* 802CB6F8 002C8638  40 81 00 0C */	ble lbl_802CB704
...
/* 802CB73C 002C867C  41 82 00 64 */	beq lbl_802CB7A0
...
/* 802CB754 002C8694  41 82 00 3C */	beq lbl_802CB790
...
/* 802CB76C 002C86AC  41 82 00 24 */	beq lbl_802CB790
...
/* 802CB794 002C86D4  40 81 00 0C */	ble lbl_802CB7A0
...
/* 802CB7D8 002C8718  41 82 00 64 */	beq lbl_802CB83C
...
/* 802CB7F0 002C8730  41 82 00 3C */	beq lbl_802CB82C
...
/* 802CB808 002C8748  41 82 00 24 */	beq lbl_802CB82C
...
/* 802CB830 002C8770  40 81 00 0C */	ble lbl_802CB83C
...
/* 802CB880 002C87C0  3C 60 80 4D */	lis r3, lbl_804D1BC0@ha
/* 802CB884 002C87C4  90 0D 97 30 */	stw r0, lbl_80515DB0@sda21(r13)
/* 802CB888 002C87C8  D4 03 1B C0 */	stfsu f0, lbl_804D1BC0@l(r3)
/* 802CB88C 002C87CC  D0 0D 97 34 */	stfs f0, lbl_80515DB4@sda21(r13)
