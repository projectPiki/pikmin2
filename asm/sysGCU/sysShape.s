...
/* 80428C58 00425B98  48 00 00 20 */	b lbl_80428C78
lbl_80428C5C:
...
/* 80428C80 00425BC0  41 80 FF DC */	blt lbl_80428C5C
...
/* 80428CAC 00425BEC  48 00 00 18 */	b lbl_80428CC4
lbl_80428CB0:
/* 80428CB0 00425BF0  A8 03 00 20 */	lha r0, 0x20(r3)
/* 80428CB4 00425BF4  7C 04 00 00 */	cmpw r4, r0
/* 80428CB8 00425BF8  40 82 00 08 */	bne lbl_80428CC0
/* 80428CBC 00425BFC  48 00 00 14 */	b lbl_80428CD0
lbl_80428CC0:
/* 80428CC0 00425C00  80 63 00 04 */	lwz r3, 4(r3)
lbl_80428CC4:
/* 80428CC4 00425C04  28 03 00 00 */	cmplwi r3, 0
/* 80428CC8 00425C08  40 82 FF E8 */	bne lbl_80428CB0
...
/* 80428CDC 00425C1C  40 82 00 28 */	bne lbl_80428D04
...
/* 80428D1C 00425C5C  41 82 00 0C */	beq lbl_80428D28
/* 80428D20 00425C60  93 FE 00 04 */	stw r31, 4(r30)
/* 80428D24 00425C64  48 00 00 0C */	b lbl_80428D30
lbl_80428D28:
...
/* 80428D8C 00425CCC  41 82 00 1C */	beq lbl_80428DA8
...
/* 80428E24 00425D64  41 82 00 24 */	beq lbl_80428E48
...
/* 80428E4C 00425D8C  40 82 00 50 */	bne lbl_80428E9C
...
/* 80428E98 00425DD8  48 00 00 50 */	b lbl_80428EE8
lbl_80428E9C:
...
/* 80428EAC 00425DEC  41 82 00 3C */	beq lbl_80428EE8
...
/* 80428F1C 00425E5C  41 82 00 48 */	beq lbl_80428F64
...
/* 80428F98 00425ED8  41 82 02 74 */	beq lbl_8042920C
...
/* 80428FAC 00425EEC  48 00 00 C8 */	b lbl_80429074
lbl_80428FB0:
/* 80428FB0 00425EF0  80 1F 00 04 */	lwz r0, 4(r31)
/* 80428FB4 00425EF4  28 00 00 00 */	cmplwi r0, 0
/* 80428FB8 00425EF8  41 82 00 28 */	beq lbl_80428FE0
...
/* 80428FE8 00425F28  41 82 00 BC */	beq lbl_804290A4
/* 80428FEC 00425F2C  80 04 00 1C */	lwz r0, 0x1c(r4)
/* 80428FF0 00425F30  2C 00 00 01 */	cmpwi r0, 1
/* 80428FF4 00425F34  41 82 00 08 */	beq lbl_80428FFC
...
/* 80429004 00425F44  40 82 00 64 */	bne lbl_80429068
...
/* 80429014 00425F54  41 82 00 2C */	beq lbl_80429040
...
/* 8042903C 00425F7C  48 00 00 28 */	b lbl_80429064
lbl_80429040:
...
/* 80429078 00425FB8  40 82 00 2C */	bne lbl_804290A4
/* 8042907C 00425FBC  80 9F 00 14 */	lwz r4, 0x14(r31)
/* 80429080 00425FC0  28 04 00 00 */	cmplwi r4, 0
/* 80429084 00425FC4  41 82 00 20 */	beq lbl_804290A4
...
/* 804290A0 00425FE0  41 80 FF 10 */	blt lbl_80428FB0
lbl_804290A4:
/* 804290A4 00425FE4  57 C0 06 3F */	clrlwi. r0, r30, 0x18
/* 804290A8 00425FE8  41 82 00 14 */	beq lbl_804290BC
...
/* 804290F0 00426030  40 82 00 E4 */	bne lbl_804291D4
...
/* 80429118 00426058  41 82 00 BC */	beq lbl_804291D4
/* 8042911C 0042605C  88 1F 00 18 */	lbz r0, 0x18(r31)
/* 80429120 00426060  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 80429124 00426064  40 82 00 B0 */	bne lbl_804291D4
...
/* 804292EC 0042622C  48 00 00 18 */	b lbl_80429304
lbl_804292F0:
/* 804292F0 00426230  A8 03 00 20 */	lha r0, 0x20(r3)
/* 804292F4 00426234  2C 00 00 00 */	cmpwi r0, 0
/* 804292F8 00426238  40 82 00 08 */	bne lbl_80429300
/* 804292FC 0042623C  48 00 00 14 */	b lbl_80429310
lbl_80429300:
/* 80429300 00426240  80 63 00 04 */	lwz r3, 4(r3)
lbl_80429304:
/* 80429304 00426244  28 03 00 00 */	cmplwi r3, 0
/* 80429308 00426248  40 82 FF E8 */	bne lbl_804292F0
...
/* 8042931C 0042625C  40 82 00 20 */	bne lbl_8042933C
...
/* 80429450 00426390  40 82 00 18 */	bne lbl_80429468
...
/* 80429460 004263A0  40 82 00 08 */	bne lbl_80429468
/* 80429464 004263A4  38 00 00 01 */	li r0, 1
lbl_80429468:
/* 80429468 004263A8  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 8042946C 004263AC  40 82 00 20 */	bne lbl_8042948C
...
/* 80429494 004263D4  41 82 00 0C */	beq lbl_804294A0
/* 80429498 004263D8  80 A3 00 18 */	lwz r5, 0x18(r3)
/* 8042949C 004263DC  48 00 00 08 */	b lbl_804294A4
lbl_804294A0:
...
/* 804294E4 00426424  41 82 00 0C */	beq lbl_804294F0
/* 804294E8 00426428  80 A3 00 18 */	lwz r5, 0x18(r3)
/* 804294EC 0042642C  48 00 00 08 */	b lbl_804294F4
lbl_804294F0:
...
/* 804295A8 004264E8  41 82 01 FC */	beq lbl_804297A4
...
/* 804295F8 00426538  40 82 00 9C */	bne lbl_80429694
...
/* 80429608 00426548  40 82 00 8C */	bne lbl_80429694
...
/* 8042961C 0042655C  41 82 00 78 */	beq lbl_80429694
...
/* 804296C8 00426608  40 82 00 18 */	bne lbl_804296E0
...
/* 804296D8 00426618  40 82 00 08 */	bne lbl_804296E0
/* 804296DC 0042661C  38 00 00 01 */	li r0, 1
lbl_804296E0:
/* 804296E0 00426620  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 804296E4 00426624  40 82 00 20 */	bne lbl_80429704
...
/* 8042970C 0042664C  41 82 00 0C */	beq lbl_80429718
/* 80429710 00426650  80 A3 00 18 */	lwz r5, 0x18(r3)
/* 80429714 00426654  48 00 00 08 */	b lbl_8042971C
lbl_80429718:
...
/* 8042975C 0042669C  41 82 00 0C */	beq lbl_80429768
/* 80429760 004266A0  80 A3 00 18 */	lwz r5, 0x18(r3)
/* 80429764 004266A4  48 00 00 08 */	b lbl_8042976C
lbl_80429768:
...
/* 804297A0 004266E0  48 00 00 1C */	b lbl_804297BC
lbl_804297A4:
...
/* 804297F8 00426738  41 82 00 0C */	beq lbl_80429804
/* 804297FC 0042673C  80 63 00 4C */	lwz r3, 0x4c(r3)
/* 80429800 00426740  48 00 00 14 */	b lbl_80429814
lbl_80429804:
...
/* 804298E4 00426824  48 00 00 38 */	b lbl_8042991C
lbl_804298E8:
...
/* 80429904 00426844  41 80 00 14 */	blt lbl_80429918
/* 80429908 00426848  FC 00 10 40 */	fcmpo cr0, f0, f2
/* 8042990C 0042684C  40 80 00 0C */	bge lbl_80429918
...
/* 80429920 00426860  40 82 FF C8 */	bne lbl_804298E8
...
/* 80429930 00426870  48 00 00 14 */	b lbl_80429944
lbl_80429934:
...
/* 80429948 00426888  40 82 FF EC */	bne lbl_80429934
...
/* 80429958 00426898  48 00 00 14 */	b lbl_8042996C
lbl_8042995C:
...
/* 80429970 004268B0  40 82 FF EC */	bne lbl_8042995C
...
/* 804299E8 00426928  48 00 00 68 */	b lbl_80429A50
lbl_804299EC:
...
/* 804299FC 0042693C  41 82 00 8C */	beq lbl_80429A88
...
/* 80429A0C 0042694C  41 82 00 28 */	beq lbl_80429A34
...
/* 80429A68 004269A8  41 82 FF 84 */	beq lbl_804299EC
...
/* 80429AEC 00426A2C  40 82 00 0C */	bne lbl_80429AF8
/* 80429AF0 00426A30  38 60 00 00 */	li r3, 0
/* 80429AF4 00426A34  48 00 00 DC */	b lbl_80429BD0
lbl_80429AF8:
...
/* 80429B14 00426A54  40 82 00 0C */	bne lbl_80429B20
...
/* 80429B2C 00426A6C  41 82 00 80 */	beq lbl_80429BAC
...
/* 80429C00 00426B40  41 82 00 4C */	beq lbl_80429C4C
...
/* 80429C14 00426B54  41 82 00 1C */	beq lbl_80429C30
...
/* 80429C40 00426B80  40 81 00 0C */	ble lbl_80429C4C
...
/* 80429C84 00426BC4  48 00 00 40 */	b lbl_80429CC4
lbl_80429C88:
/* 80429C88 00426BC8  80 7E 00 2C */	lwz r3, 0x2c(r30)
/* 80429C8C 00426BCC  48 00 00 18 */	b lbl_80429CA4
lbl_80429C90:
/* 80429C90 00426BD0  A8 03 00 20 */	lha r0, 0x20(r3)
/* 80429C94 00426BD4  7C 1F 00 00 */	cmpw r31, r0
/* 80429C98 00426BD8  40 82 00 08 */	bne lbl_80429CA0
/* 80429C9C 00426BDC  48 00 00 14 */	b lbl_80429CB0
lbl_80429CA0:
/* 80429CA0 00426BE0  80 63 00 04 */	lwz r3, 4(r3)
lbl_80429CA4:
/* 80429CA4 00426BE4  28 03 00 00 */	cmplwi r3, 0
/* 80429CA8 00426BE8  40 82 FF E8 */	bne lbl_80429C90
...
/* 80429CCC 00426C0C  41 80 FF BC */	blt lbl_80429C88
...
/* 80429D04 00426C44  41 82 00 68 */	beq lbl_80429D6C
...
/* 80429D18 00426C58  41 82 00 38 */	beq lbl_80429D50
...
/* 80429D2C 00426C6C  41 82 00 18 */	beq lbl_80429D44
...
/* 80429D60 00426CA0  40 81 00 0C */	ble lbl_80429D6C
