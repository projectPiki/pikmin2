...
/* 8044F8D0 0044C810  41 82 00 40 */	beq lbl_8044F910
...
/* 8044F904 0044C844  40 82 00 44 */	bne lbl_8044F948
/* 8044F908 0044C848  38 60 00 00 */	li r3, 0
/* 8044F90C 0044C84C  48 00 00 6C */	b lbl_8044F978
lbl_8044F910:
...
/* 8044F93C 0044C87C  40 82 00 0C */	bne lbl_8044F948
/* 8044F940 0044C880  38 60 00 00 */	li r3, 0
/* 8044F944 0044C884  48 00 00 34 */	b lbl_8044F978
lbl_8044F948:
...
/* 8044F9A0 0044C8E0  41 82 00 10 */	beq lbl_8044F9B0
...
/* 8044F9D4 0044C914  41 82 00 18 */	beq lbl_8044F9EC
...
/* 8044FA20 0044C960  41 82 00 70 */	beq lbl_8044FA90
/* 8044FA24 0044C964  48 00 00 60 */	b lbl_8044FA84
lbl_8044FA28:
...
/* 8044FA54 0044C994  40 82 00 14 */	bne lbl_8044FA68
/* 8044FA58 0044C998  88 1F 00 A6 */	lbz r0, 0xa6(r31)
/* 8044FA5C 0044C99C  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 8044FA60 0044C9A0  40 82 00 08 */	bne lbl_8044FA68
...
/* 8044FAF8 0044CA38  41 82 00 84 */	beq lbl_8044FB7C
/* 8044FAFC 0044CA3C  48 00 00 74 */	b lbl_8044FB70
lbl_8044FB00:
...
/* 8044FB34 0044CA74  40 82 00 24 */	bne lbl_8044FB58
/* 8044FB38 0044CA78  88 1F 00 A6 */	lbz r0, 0xa6(r31)
/* 8044FB3C 0044CA7C  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 8044FB40 0044CA80  41 82 00 3C */	beq lbl_8044FB7C
...
/* 8044FB54 0044CA94  48 00 00 18 */	b lbl_8044FB6C
lbl_8044FB58:
...
/* 8044FB78 0044CAB8  41 80 FF 88 */	blt lbl_8044FB00
lbl_8044FB7C:
...
/* 8044FBA8 0044CAE8  40 82 00 34 */	bne lbl_8044FBDC
/* 8044FBAC 0044CAEC  88 1F 00 A6 */	lbz r0, 0xa6(r31)
/* 8044FBB0 0044CAF0  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 8044FBB4 0044CAF4  41 82 00 18 */	beq lbl_8044FBCC
...
/* 8044FBC8 0044CB08  48 00 00 28 */	b lbl_8044FBF0
lbl_8044FBCC:
...
/* 8044FBD8 0044CB18  48 00 00 18 */	b lbl_8044FBF0
lbl_8044FBDC:
...
/* 8044FC44 0044CB84  48 00 00 98 */	b lbl_8044FCDC
lbl_8044FC48:
/* 8044FC48 0044CB88  88 19 00 70 */	lbz r0, 0x70(r25)
/* 8044FC4C 0044CB8C  2C 00 00 00 */	cmpwi r0, 0
/* 8044FC50 0044CB90  41 82 00 08 */	beq lbl_8044FC58
/* 8044FC54 0044CB94  48 00 00 74 */	b lbl_8044FCC8
lbl_8044FC58:
...
/* 8044FC78 0044CBB8  41 82 00 2C */	beq lbl_8044FCA4
/* 8044FC7C 0044CBBC  80 0D 9C 5C */	lwz r0, First@sda21(r13)
/* 8044FC80 0044CBC0  2C 00 00 00 */	cmpwi r0, 0
/* 8044FC84 0044CBC4  41 82 00 14 */	beq lbl_8044FC98
...
/* 8044FCE4 0044CC24  41 80 FF 64 */	blt lbl_8044FC48
/* 8044FCE8 0044CC28  80 0D 9C 5C */	lwz r0, First@sda21(r13)
/* 8044FCEC 0044CC2C  2C 00 00 00 */	cmpwi r0, 0
/* 8044FCF0 0044CC30  41 82 00 14 */	beq lbl_8044FD04
...
/* 8044FDA0 0044CCE0  40 82 00 0C */	bne lbl_8044FDAC
/* 8044FDA4 0044CCE4  80 61 00 08 */	lwz r3, 8(r1)
/* 8044FDA8 0044CCE8  48 00 00 08 */	b lbl_8044FDB0
lbl_8044FDAC:
