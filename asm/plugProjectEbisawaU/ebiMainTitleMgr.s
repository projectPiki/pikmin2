...
/* 803EA528 003E7468  41 82 00 44 */	beq lbl_803EA56C
/* 803EA52C 003E746C  40 80 00 14 */	bge lbl_803EA540
/* 803EA530 003E7470  2C 04 00 00 */	cmpwi r4, 0
/* 803EA534 003E7474  41 82 00 18 */	beq lbl_803EA54C
/* 803EA538 003E7478  40 80 00 24 */	bge lbl_803EA55C
/* 803EA53C 003E747C  4E 80 00 20 */	blr 
lbl_803EA540:
/* 803EA540 003E7480  2C 04 00 04 */	cmpwi r4, 4
/* 803EA544 003E7484  4C 80 00 20 */	bgelr 
/* 803EA548 003E7488  48 00 00 34 */	b lbl_803EA57C
lbl_803EA54C:
...
/* 803EA5F4 003E7534  40 82 00 18 */	bne lbl_803EA60C
...
/* 803EA7E0 003E7720  41 82 00 48 */	beq lbl_803EA828
/* 803EA7E4 003E7724  40 80 00 1C */	bge lbl_803EA800
/* 803EA7E8 003E7728  2C 00 00 01 */	cmpwi r0, 1
/* 803EA7EC 003E772C  41 82 00 2C */	beq lbl_803EA818
/* 803EA7F0 003E7730  40 80 00 30 */	bge lbl_803EA820
/* 803EA7F4 003E7734  2C 00 00 00 */	cmpwi r0, 0
/* 803EA7F8 003E7738  40 80 00 18 */	bge lbl_803EA810
/* 803EA7FC 003E773C  48 00 00 44 */	b lbl_803EA840
lbl_803EA800:
/* 803EA800 003E7740  2C 00 00 05 */	cmpwi r0, 5
/* 803EA804 003E7744  41 82 00 34 */	beq lbl_803EA838
/* 803EA808 003E7748  40 80 00 38 */	bge lbl_803EA840
/* 803EA80C 003E774C  48 00 00 24 */	b lbl_803EA830
lbl_803EA810:
/* 803EA810 003E7750  3B E0 00 00 */	li r31, 0
/* 803EA814 003E7754  48 00 00 48 */	b lbl_803EA85C
lbl_803EA818:
/* 803EA818 003E7758  3B E0 00 02 */	li r31, 2
/* 803EA81C 003E775C  48 00 00 40 */	b lbl_803EA85C
lbl_803EA820:
/* 803EA820 003E7760  3B E0 00 01 */	li r31, 1
/* 803EA824 003E7764  48 00 00 38 */	b lbl_803EA85C
lbl_803EA828:
/* 803EA828 003E7768  3B E0 00 03 */	li r31, 3
/* 803EA82C 003E776C  48 00 00 30 */	b lbl_803EA85C
lbl_803EA830:
/* 803EA830 003E7770  3B E0 00 04 */	li r31, 4
/* 803EA834 003E7774  48 00 00 28 */	b lbl_803EA85C
lbl_803EA838:
/* 803EA838 003E7778  3B E0 00 05 */	li r31, 5
/* 803EA83C 003E777C  48 00 00 20 */	b lbl_803EA85C
lbl_803EA840:
...
/* 803EA86C 003E77AC  41 82 00 38 */	beq lbl_803EA8A4
...
/* 803EA8A0 003E77E0  48 00 00 4C */	b lbl_803EA8EC
lbl_803EA8A4:
...
/* 803EA9F8 003E7938  41 82 02 50 */	beq lbl_803EAC48
/* 803EA9FC 003E793C  40 80 00 14 */	bge lbl_803EAA10
/* 803EAA00 003E7940  2C 00 00 01 */	cmpwi r0, 1
/* 803EAA04 003E7944  41 82 00 18 */	beq lbl_803EAA1C
/* 803EAA08 003E7948  40 80 00 48 */	bge lbl_803EAA50
/* 803EAA0C 003E794C  48 00 03 E4 */	b lbl_803EADF0
lbl_803EAA10:
/* 803EAA10 003E7950  2C 00 00 05 */	cmpwi r0, 5
/* 803EAA14 003E7954  40 80 03 DC */	bge lbl_803EADF0
/* 803EAA18 003E7958  48 00 03 B0 */	b lbl_803EADC8
lbl_803EAA1C:
...
/* 803EAA28 003E7968  41 82 03 C8 */	beq lbl_803EADF0
...
/* 803EAA4C 003E798C  48 00 03 A4 */	b lbl_803EADF0
lbl_803EAA50:
...
/* 803EAA5C 003E799C  41 82 00 10 */	beq lbl_803EAA6C
/* 803EAA60 003E79A0  38 00 00 01 */	li r0, 1
/* 803EAA64 003E79A4  98 1F 13 8C */	stb r0, 0x138c(r31)
/* 803EAA68 003E79A8  48 00 00 0C */	b lbl_803EAA74
lbl_803EAA6C:
...
/* 803EAA84 003E79C4  41 82 00 20 */	beq lbl_803EAAA4
...
/* 803EAA94 003E79D4  41 82 00 10 */	beq lbl_803EAAA4
...
/* 803EAABC 003E79FC  41 82 03 34 */	beq lbl_803EADF0
...
/* 803EAAD0 003E7A10  41 82 00 5C */	beq lbl_803EAB2C
...
/* 803EAB28 003E7A68  48 00 02 C8 */	b lbl_803EADF0
lbl_803EAB2C:
/* 803EAB2C 003E7A6C  80 1E 02 38 */	lwz r0, 0x238(r30)
/* 803EAB30 003E7A70  2C 00 00 00 */	cmpwi r0, 0
/* 803EAB34 003E7A74  41 82 00 5C */	beq lbl_803EAB90
...
/* 803EAB8C 003E7ACC  48 00 02 64 */	b lbl_803EADF0
lbl_803EAB90:
/* 803EAB90 003E7AD0  80 03 01 C8 */	lwz r0, 0x1c8(r3)
/* 803EAB94 003E7AD4  2C 00 00 00 */	cmpwi r0, 0
/* 803EAB98 003E7AD8  41 82 00 4C */	beq lbl_803EABE4
...
/* 803EABE0 003E7B20  48 00 02 10 */	b lbl_803EADF0
lbl_803EABE4:
...
/* 803EAC70 003E7BB0  41 82 00 50 */	beq lbl_803EACC0
/* 803EAC74 003E7BB4  40 80 00 1C */	bge lbl_803EAC90
/* 803EAC78 003E7BB8  2C 00 00 01 */	cmpwi r0, 1
/* 803EAC7C 003E7BBC  41 82 00 30 */	beq lbl_803EACAC
/* 803EAC80 003E7BC0  40 80 00 38 */	bge lbl_803EACB8
/* 803EAC84 003E7BC4  2C 00 00 00 */	cmpwi r0, 0
/* 803EAC88 003E7BC8  40 80 00 18 */	bge lbl_803EACA0
/* 803EAC8C 003E7BCC  48 00 00 54 */	b lbl_803EACE0
lbl_803EAC90:
/* 803EAC90 003E7BD0  2C 00 00 05 */	cmpwi r0, 5
/* 803EAC94 003E7BD4  41 82 00 44 */	beq lbl_803EACD8
/* 803EAC98 003E7BD8  40 80 00 48 */	bge lbl_803EACE0
/* 803EAC9C 003E7BDC  48 00 00 30 */	b lbl_803EACCC
lbl_803EACA0:
/* 803EACA0 003E7BE0  38 00 00 00 */	li r0, 0
/* 803EACA4 003E7BE4  90 1F 16 58 */	stw r0, 0x1658(r31)
/* 803EACA8 003E7BE8  48 00 00 38 */	b lbl_803EACE0
lbl_803EACAC:
/* 803EACAC 003E7BEC  38 00 00 02 */	li r0, 2
/* 803EACB0 003E7BF0  90 1F 16 58 */	stw r0, 0x1658(r31)
/* 803EACB4 003E7BF4  48 00 00 2C */	b lbl_803EACE0
lbl_803EACB8:
/* 803EACB8 003E7BF8  90 7F 16 58 */	stw r3, 0x1658(r31)
/* 803EACBC 003E7BFC  48 00 00 24 */	b lbl_803EACE0
lbl_803EACC0:
/* 803EACC0 003E7C00  38 00 00 03 */	li r0, 3
/* 803EACC4 003E7C04  90 1F 16 58 */	stw r0, 0x1658(r31)
/* 803EACC8 003E7C08  48 00 00 18 */	b lbl_803EACE0
lbl_803EACCC:
/* 803EACCC 003E7C0C  38 00 00 04 */	li r0, 4
/* 803EACD0 003E7C10  90 1F 16 58 */	stw r0, 0x1658(r31)
/* 803EACD4 003E7C14  48 00 00 0C */	b lbl_803EACE0
lbl_803EACD8:
...
/* 803EAD2C 003E7C6C  40 82 00 30 */	bne lbl_803EAD5C
...
/* 803EAD80 003E7CC0  41 82 00 70 */	beq lbl_803EADF0
/* 803EAD84 003E7CC4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 803EAD88 003E7CC8  41 82 00 28 */	beq lbl_803EADB0
...
/* 803EADE4 003E7D24  40 82 00 0C */	bne lbl_803EADF0
...
/* 803EAE50 003E7D90  41 82 00 18 */	beq lbl_803EAE68
/* 803EAE54 003E7D94  80 7F 16 40 */	lwz r3, 0x1640(r31)
/* 803EAE58 003E7D98  28 03 00 00 */	cmplwi r3, 0
/* 803EAE5C 003E7D9C  41 82 00 0C */	beq lbl_803EAE68
...
/* 803EAEA0 003E7DE0  41 82 02 3C */	beq lbl_803EB0DC
...
/* 803EAF14 003E7E54  41 82 01 C8 */	beq lbl_803EB0DC
...
/* 803EAF48 003E7E88  41 82 00 8C */	beq lbl_803EAFD4
/* 803EAF4C 003E7E8C  40 80 01 04 */	bge lbl_803EB050
/* 803EAF50 003E7E90  2C 00 00 01 */	cmpwi r0, 1
/* 803EAF54 003E7E94  40 80 00 08 */	bge lbl_803EAF5C
/* 803EAF58 003E7E98  48 00 00 F8 */	b lbl_803EB050
lbl_803EAF5C:
/* 803EAF5C 003E7E9C  80 9E 16 44 */	lwz r4, 0x1644(r30)
/* 803EAF60 003E7EA0  28 04 00 00 */	cmplwi r4, 0
/* 803EAF64 003E7EA4  41 82 00 38 */	beq lbl_803EAF9C
...
/* 803EAF98 003E7ED8  48 00 00 08 */	b lbl_803EAFA0
lbl_803EAF9C:
...
/* 803EAFD0 003E7F10  48 00 00 80 */	b lbl_803EB050
lbl_803EAFD4:
/* 803EAFD4 003E7F14  80 9E 16 44 */	lwz r4, 0x1644(r30)
/* 803EAFD8 003E7F18  28 04 00 00 */	cmplwi r4, 0
/* 803EAFDC 003E7F1C  41 82 00 38 */	beq lbl_803EB014
...
/* 803EB010 003E7F50  48 00 00 08 */	b lbl_803EB018
lbl_803EB014:
