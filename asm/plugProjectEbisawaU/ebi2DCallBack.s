...
/* 803D06A8 003CD5E8  41 82 00 30 */	beq lbl_803D06D8
...
/* 803D0718 003CD658  41 82 00 14 */	beq lbl_803D072C
...
/* 803D0728 003CD668  41 80 00 74 */	blt lbl_803D079C
lbl_803D072C:
/* 803D072C 003CD66C  88 1B 00 48 */	lbz r0, 0x48(r27)
/* 803D0730 003CD670  28 00 00 00 */	cmplwi r0, 0
/* 803D0734 003CD674  41 82 00 38 */	beq lbl_803D076C
...
/* 803D0758 003CD698  40 82 00 44 */	bne lbl_803D079C
...
/* 803D0768 003CD6A8  48 00 00 34 */	b lbl_803D079C
lbl_803D076C:
...
/* 803D078C 003CD6CC  40 82 00 10 */	bne lbl_803D079C
...
/* 803D07A4 003CD6E4  41 82 01 F0 */	beq lbl_803D0994
...
/* 803D07C0 003CD700  40 82 01 D4 */	bne lbl_803D0994
...
/* 803D09D0 003CD910  41 82 00 14 */	beq lbl_803D09E4
...
/* 803D09E0 003CD920  41 80 00 74 */	blt lbl_803D0A54
lbl_803D09E4:
/* 803D09E4 003CD924  88 06 00 28 */	lbz r0, 0x28(r6)
/* 803D09E8 003CD928  28 00 00 00 */	cmplwi r0, 0
/* 803D09EC 003CD92C  41 82 00 38 */	beq lbl_803D0A24
...
/* 803D0A10 003CD950  40 82 00 44 */	bne lbl_803D0A54
...
/* 803D0A20 003CD960  48 00 00 34 */	b lbl_803D0A54
lbl_803D0A24:
...
/* 803D0A44 003CD984  40 82 00 10 */	bne lbl_803D0A54
...
/* 803D0A5C 003CD99C  41 82 00 64 */	beq lbl_803D0AC0
...
/* 803D0B08 003CDA48  40 82 00 20 */	bne lbl_803D0B28
...
/* 803D0B6C 003CDAAC  40 80 00 08 */	bge lbl_803D0B74
...
/* 803D0BD0 003CDB10  40 82 00 20 */	bne lbl_803D0BF0
...
/* 803D0BF8 003CDB38  40 82 00 20 */	bne lbl_803D0C18
...
/* 803D0C44 003CDB84  41 82 00 28 */	beq lbl_803D0C6C
...
/* 803D0CD4 003CDC14  40 82 00 20 */	bne lbl_803D0CF4
...
/* 803D0CFC 003CDC3C  40 82 00 20 */	bne lbl_803D0D1C
...
/* 803D0D58 003CDC98  41 82 00 28 */	beq lbl_803D0D80
...
/* 803D0F70 003CDEB0  41 82 00 18 */	beq lbl_803D0F88
...
/* 803D0F90 003CDED0  41 82 00 0C */	beq lbl_803D0F9C
...
/* 803D0FD4 003CDF14  41 82 01 1C */	beq lbl_803D10F0
/* 803D0FD8 003CDF18  80 7F 00 40 */	lwz r3, 0x40(r31)
/* 803D0FDC 003CDF1C  28 03 00 00 */	cmplwi r3, 0
/* 803D0FE0 003CDF20  41 82 00 0C */	beq lbl_803D0FEC
...
/* 803D0FF4 003CDF34  41 82 00 38 */	beq lbl_803D102C
...
/* 803D1028 003CDF68  48 00 00 08 */	b lbl_803D1030
lbl_803D102C:
...
/* 803D1090 003CDFD0  4B C6 6E A9 */	bl place__7J2DPaneFRCQ29JGeometry8TBox2$$0f$$1
...
/* 803D10C8 003CE008  41 82 00 28 */	beq lbl_803D10F0
