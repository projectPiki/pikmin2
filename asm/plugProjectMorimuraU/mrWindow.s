...
/* 803A37C4 003A0704  41 82 00 0C */	beq lbl_803A37D0
/* 803A37C8 003A0708  4B F8 62 65 */	bl doDraw__Q32og9newScreen15ObjSMenuPauseVSFR8Graphics
/* 803A37CC 003A070C  48 00 00 0C */	b lbl_803A37D8
lbl_803A37D0:
...
/* 803A3858 003A0798  41 82 00 0C */	beq lbl_803A3864
...
/* 803A38D0 003A0810  48 00 00 18 */	b lbl_803A38E8
lbl_803A38D4:
...
/* 803A38F0 003A0830  41 80 FF E4 */	blt lbl_803A38D4
/* 803A38F4 003A0834  80 1D 00 18 */	lwz r0, 0x18(r29)
/* 803A38F8 003A0838  2C 00 00 02 */	cmpwi r0, 2
/* 803A38FC 003A083C  41 82 00 98 */	beq lbl_803A3994
/* 803A3900 003A0840  40 80 00 10 */	bge lbl_803A3910
/* 803A3904 003A0844  2C 00 00 01 */	cmpwi r0, 1
/* 803A3908 003A0848  40 80 00 14 */	bge lbl_803A391C
/* 803A390C 003A084C  48 00 00 88 */	b lbl_803A3994
lbl_803A3910:
/* 803A3910 003A0850  2C 00 00 04 */	cmpwi r0, 4
/* 803A3914 003A0854  40 80 00 80 */	bge lbl_803A3994
/* 803A3918 003A0858  48 00 00 4C */	b lbl_803A3964
lbl_803A391C:
...
/* 803A393C 003A087C  40 82 00 58 */	bne lbl_803A3994
...
/* 803A3960 003A08A0  48 00 00 34 */	b lbl_803A3994
lbl_803A3964:
...
/* 803A3980 003A08C0  40 80 00 14 */	bge lbl_803A3994
...
/* 803A3A28 003A0968  41 82 00 08 */	beq lbl_803A3A30
...
/* 803A3A84 003A09C4  41 82 00 48 */	beq lbl_803A3ACC
...
/* 803A3A9C 003A09DC  41 82 00 20 */	beq lbl_803A3ABC
...
/* 803A3AC0 003A0A00  40 81 00 0C */	ble lbl_803A3ACC
