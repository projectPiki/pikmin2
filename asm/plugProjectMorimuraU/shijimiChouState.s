...
/* 80387740 00384680  41 82 00 10 */	beq lbl_80387750
...
/* 80387764 003846A4  41 82 00 10 */	beq lbl_80387774
...
/* 80387788 003846C8  41 82 00 10 */	beq lbl_80387798
...
/* 803877AC 003846EC  41 82 00 10 */	beq lbl_803877BC
...
/* 803877D0 00384710  41 82 00 10 */	beq lbl_803877E0
...
/* 803877F4 00384734  41 82 00 10 */	beq lbl_80387804
...
/* 80387980 003848C0  48 00 00 C4 */	b lbl_80387A44
lbl_80387984:
/* 80387984 003848C4  80 7F 02 C8 */	lwz r3, 0x2c8(r31)
/* 80387988 003848C8  28 03 00 00 */	cmplwi r3, 0
/* 8038798C 003848CC  41 82 00 B0 */	beq lbl_80387A3C
...
/* 8038799C 003848DC  40 82 00 0C */	bne lbl_803879A8
/* 803879A0 003848E0  54 80 03 5B */	rlwinm. r0, r4, 0, 0xd, 0xd
/* 803879A4 003848E4  41 82 00 08 */	beq lbl_803879AC
lbl_803879A8:
/* 803879A8 003848E8  38 60 00 01 */	li r3, 1
lbl_803879AC:
/* 803879AC 003848EC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 803879B0 003848F0  40 82 00 8C */	bne lbl_80387A3C
...
/* 803879D4 00384914  48 00 00 70 */	b lbl_80387A44
lbl_803879D8:
/* 803879D8 00384918  80 1F 02 E8 */	lwz r0, 0x2e8(r31)
/* 803879DC 0038491C  7C 00 F8 40 */	cmplw r0, r31
/* 803879E0 00384920  40 82 00 24 */	bne lbl_80387A04
...
/* 80387A24 00384964  48 00 00 20 */	b lbl_80387A44
lbl_80387A28:
/* 80387A28 00384968  80 1F 02 E8 */	lwz r0, 0x2e8(r31)
/* 80387A2C 0038496C  7C 00 F8 40 */	cmplw r0, r31
/* 80387A30 00384970  40 82 00 0C */	bne lbl_80387A3C
...
/* 80387B14 00384A54  41 82 00 10 */	beq lbl_80387B24
...
/* 80387B54 00384A94  40 82 00 08 */	bne lbl_80387B5C
/* 80387B58 00384A98  C0 43 08 44 */	lfs f2, 0x844(r3)
lbl_80387B5C:
/* 80387B5C 00384A9C  2C 00 00 03 */	cmpwi r0, 3
/* 80387B60 00384AA0  40 82 00 08 */	bne lbl_80387B68
...
/* 80387B8C 00384ACC  40 81 00 28 */	ble lbl_80387BB4
...
/* 80387BB0 00384AF0  48 00 00 0C */	b lbl_80387BBC
lbl_80387BB4:
...
/* 80387C4C 00384B8C  41 82 00 28 */	beq lbl_80387C74
...
/* 80387D08 00384C48  41 82 00 0C */	beq lbl_80387D14
...
/* 80387D20 00384C60  40 82 00 10 */	bne lbl_80387D30
/* 80387D24 00384C64  80 1E 00 10 */	lwz r0, 0x10(r30)
/* 80387D28 00384C68  2C 00 00 64 */	cmpwi r0, 0x64
/* 80387D2C 00384C6C  40 81 00 24 */	ble lbl_80387D50
lbl_80387D30:
...
/* 80387E70 00384DB0  41 82 00 E0 */	beq lbl_80387F50
/* 80387E74 00384DB4  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80387E78 00384DB8  28 00 03 E8 */	cmplwi r0, 0x3e8
/* 80387E7C 00384DBC  40 82 00 D4 */	bne lbl_80387F50
...
/* 803880CC 0038500C  41 82 00 1C */	beq lbl_803880E8
/* 803880D0 00385010  80 03 00 44 */	lwz r0, 0x44(r3)
/* 803880D4 00385014  2C 00 00 04 */	cmpwi r0, 4
/* 803880D8 00385018  40 82 00 10 */	bne lbl_803880E8
...
/* 8038813C 0038507C  40 82 00 30 */	bne lbl_8038816C
...
/* 8038814C 0038508C  40 82 00 0C */	bne lbl_80388158
/* 80388150 00385090  54 80 03 5B */	rlwinm. r0, r4, 0, 0xd, 0xd
/* 80388154 00385094  41 82 00 08 */	beq lbl_8038815C
lbl_80388158:
/* 80388158 00385098  38 60 00 01 */	li r3, 1
lbl_8038815C:
/* 8038815C 0038509C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80388160 003850A0  40 82 00 0C */	bne lbl_8038816C
...
/* 80388180 003850C0  41 82 01 FC */	beq lbl_8038837C
...
/* 80388194 003850D4  41 82 00 0C */	beq lbl_803881A0
...
/* 803881A8 003850E8  41 82 00 64 */	beq lbl_8038820C
...
/* 80388208 00385148  48 00 00 44 */	b lbl_8038824C
lbl_8038820C:
...
/* 80388218 00385158  41 82 00 34 */	beq lbl_8038824C
...
/* 80388228 00385168  41 82 00 24 */	beq lbl_8038824C
/* 8038822C 0038516C  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80388230 00385170  28 00 03 E8 */	cmplwi r0, 0x3e8
/* 80388234 00385174  40 82 00 18 */	bne lbl_8038824C
...
/* 80388260 003851A0  41 80 01 B4 */	blt lbl_80388414
/* 80388264 003851A4  40 82 00 1C */	bne lbl_80388280
...
/* 8038828C 003851CC  41 82 01 88 */	beq lbl_80388414
...
/* 80388378 003852B8  48 00 00 9C */	b lbl_80388414
lbl_8038837C:
...
/* 80388388 003852C8  40 81 00 34 */	ble lbl_803883BC
...
/* 803883D0 00385310  40 81 00 44 */	ble lbl_80388414
...
/* 803883E0 00385320  41 82 00 34 */	beq lbl_80388414
