...
/* 8034BBF4 00348B34  40 82 00 B8 */	bne .L_8034BCAC
...
/* 8034BC0C 00348B4C  41 82 00 40 */	beq .L_8034BC4C
...
/* 8034BCDC 00348C1C  41 82 00 24 */	beq .L_8034BD00
...
/* 8034BD50 00348C90  41 82 00 44 */	beq .L_8034BD94
...
/* 8034BDA4 00348CE4  41 82 00 24 */	beq .L_8034BDC8
...
/* 8034BE5C 00348D9C  41 82 00 18 */	beq .L_8034BE74
...
/* 8034BE70 00348DB0  48 00 00 1C */	b .L_8034BE8C
.L_8034BE74:
...
/* 8034BEE8 00348E28  41 82 00 24 */	beq .L_8034BF0C
...
/* 8034BF08 00348E48  48 00 00 08 */	b .L_8034BF10
.L_8034BF0C:
...
/* 8034BF68 00348EA8  41 82 00 3C */	beq .L_8034BFA4
...
/* 8034BF80 00348EC0  40 82 00 14 */	bne .L_8034BF94
/* 8034BF84 00348EC4  FC 02 00 00 */	fcmpu cr0, f2, f0
/* 8034BF88 00348EC8  40 82 00 0C */	bne .L_8034BF94
/* 8034BF8C 00348ECC  FC 03 20 00 */	fcmpu cr0, f3, f4
/* 8034BF90 00348ED0  41 82 00 54 */	beq .L_8034BFE4
.L_8034BF94:
...
/* 8034BFA0 00348EE0  48 00 00 44 */	b .L_8034BFE4
.L_8034BFA4:
...
/* 8034BFE8 00348F28  40 82 00 14 */	bne .L_8034BFFC
...
/* 8034BFF8 00348F38  40 82 00 38 */	bne .L_8034C030
.L_8034BFFC:
...
/* 8034C06C 00348FAC  40 82 00 10 */	bne .L_8034C07C
...
/* 8034C078 00348FB8  41 82 00 18 */	beq .L_8034C090
.L_8034C07C:
...
/* 8034C0D0 00349010  41 82 00 4C */	beq .L_8034C11C
/* 8034C0D4 00349014  80 7F 00 00 */	lwz r3, 0(r31)
/* 8034C0D8 00349018  28 03 00 00 */	cmplwi r3, 0
/* 8034C0DC 0034901C  41 82 00 40 */	beq .L_8034C11C
...
/* 8034C0F4 00349034  40 82 00 28 */	bne .L_8034C11C
...
/* 8034C104 00349044  40 82 00 18 */	bne .L_8034C11C
...
/* 8034C1A0 003490E0  40 82 00 0C */	bne .L_8034C1AC
/* 8034C1A4 003490E4  38 60 00 00 */	li r3, 0
/* 8034C1A8 003490E8  48 00 00 10 */	b .L_8034C1B8
.L_8034C1AC:
...
/* 8034C1E8 00349128  41 82 00 70 */	beq .L_8034C258
...
/* 8034C340 00349280  40 80 00 0C */	bge .L_8034C34C
/* 8034C344 00349284  3B C0 00 02 */	li r30, 2
/* 8034C348 00349288  48 00 00 60 */	b .L_8034C3A8
.L_8034C34C:
...
/* 8034C358 00349298  40 80 00 0C */	bge .L_8034C364
/* 8034C35C 0034929C  3B C0 00 03 */	li r30, 3
/* 8034C360 003492A0  48 00 00 48 */	b .L_8034C3A8
.L_8034C364:
...
/* 8034C370 003492B0  40 80 00 0C */	bge .L_8034C37C
/* 8034C374 003492B4  3B C0 00 04 */	li r30, 4
/* 8034C378 003492B8  48 00 00 30 */	b .L_8034C3A8
.L_8034C37C:
...
/* 8034C388 003492C8  40 80 00 0C */	bge .L_8034C394
/* 8034C38C 003492CC  3B C0 00 05 */	li r30, 5
/* 8034C390 003492D0  48 00 00 18 */	b .L_8034C3A8
.L_8034C394:
...
/* 8034C3A0 003492E0  40 80 00 08 */	bge .L_8034C3A8
...
/* 8034C3B0 003492F0  41 82 00 08 */	beq .L_8034C3B8
...
/* 8034C3C0 00349300  41 82 00 48 */	beq .L_8034C408
/* 8034C3C4 00349304  2C 1E 00 05 */	cmpwi r30, 5
/* 8034C3C8 00349308  40 82 00 20 */	bne .L_8034C3E8
...
/* 8034C3DC 0034931C  40 82 00 2C */	bne .L_8034C408
/* 8034C3E0 00349320  3B C0 00 02 */	li r30, 2
/* 8034C3E4 00349324  48 00 00 24 */	b .L_8034C408
.L_8034C3E8:
/* 8034C3E8 00349328  2C 1E 00 06 */	cmpwi r30, 6
/* 8034C3EC 0034932C  40 82 00 1C */	bne .L_8034C408
...
/* 8034C400 00349340  40 82 00 08 */	bne .L_8034C408
/* 8034C404 00349344  3B C0 00 02 */	li r30, 2
.L_8034C408:
/* 8034C408 00349348  2C 1E 00 03 */	cmpwi r30, 3
/* 8034C40C 0034934C  3B E0 00 00 */	li r31, 0
/* 8034C410 00349350  41 82 01 90 */	beq .L_8034C5A0
/* 8034C414 00349354  40 80 00 1C */	bge .L_8034C430
/* 8034C418 00349358  2C 1E 00 01 */	cmpwi r30, 1
/* 8034C41C 0034935C  41 82 00 A8 */	beq .L_8034C4C4
/* 8034C420 00349360  40 80 01 24 */	bge .L_8034C544
/* 8034C424 00349364  2C 1E 00 00 */	cmpwi r30, 0
/* 8034C428 00349368  40 80 00 1C */	bge .L_8034C444
/* 8034C42C 0034936C  48 00 04 50 */	b .L_8034C87C
.L_8034C430:
/* 8034C430 00349370  2C 1E 00 07 */	cmpwi r30, 7
/* 8034C434 00349374  40 80 04 48 */	bge .L_8034C87C
/* 8034C438 00349378  2C 1E 00 05 */	cmpwi r30, 5
/* 8034C43C 0034937C  40 80 03 D8 */	bge .L_8034C814
/* 8034C440 00349380  48 00 02 E8 */	b .L_8034C728
.L_8034C444:
...
/* 8034C4C0 00349400  48 00 03 BC */	b .L_8034C87C
.L_8034C4C4:
...
/* 8034C540 00349480  48 00 03 3C */	b .L_8034C87C
.L_8034C544:
...
/* 8034C55C 0034949C  41 82 03 20 */	beq .L_8034C87C
...
/* 8034C59C 003494DC  48 00 02 E0 */	b .L_8034C87C
.L_8034C5A0:
...
/* 8034C604 00349544  41 82 01 14 */	beq .L_8034C718
...
/* 8034C63C 0034957C  40 80 00 30 */	bge .L_8034C66C
...
/* 8034C668 003495A8  48 00 00 28 */	b .L_8034C690
.L_8034C66C:
...
/* 8034C6A0 003495E0  40 80 00 08 */	bge .L_8034C6A8
...
/* 8034C720 00349660  41 80 FE B4 */	blt .L_8034C5D4
/* 8034C724 00349664  48 00 01 58 */	b .L_8034C87C
.L_8034C728:
...
/* 8034C738 00349678  41 82 00 78 */	beq .L_8034C7B0
...
/* 8034C7B4 003496F4  40 82 00 C8 */	bne .L_8034C87C
...
/* 8034C7D0 00349710  41 82 00 AC */	beq .L_8034C87C
...
/* 8034C810 00349750  48 00 00 6C */	b .L_8034C87C
.L_8034C814:
...
/* 8034C82C 0034976C  41 82 00 50 */	beq .L_8034C87C
...
/* 8034C848 00349788  40 82 00 0C */	bne .L_8034C854
