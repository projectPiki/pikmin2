...
/* 80022F0C 0001FE4C  41 82 00 54 */	beq lbl_80022F60
...
/* 80022F24 0001FE64  40 82 00 0C */	bne lbl_80022F30
...
/* 80022F34 0001FE74  41 82 00 10 */	beq lbl_80022F44
...
/* 80022F54 0001FE94  40 81 00 0C */	ble lbl_80022F60
...
/* 80022F90 0001FED0  41 82 00 2C */	beq lbl_80022FBC
/* 80022F94 0001FED4  34 04 FF FF */	addic. r0, r4, -1
/* 80022F98 0001FED8  90 03 00 34 */	stw r0, 0x34(r3)
/* 80022F9C 0001FEDC  40 82 00 20 */	bne lbl_80022FBC
/* 80022FA0 0001FEE0  28 03 00 00 */	cmplwi r3, 0
/* 80022FA4 0001FEE4  41 82 00 18 */	beq lbl_80022FBC
...
/* 80022FE8 0001FF28  40 82 00 0C */	bne lbl_80022FF4
/* 80022FEC 0001FF2C  38 60 00 00 */	li r3, 0
/* 80022FF0 0001FF30  48 00 00 18 */	b lbl_80023008
lbl_80022FF4:
...
/* 80023038 0001FF78  41 82 00 24 */	beq lbl_8002305C
...
/* 80023058 0001FF98  48 00 00 40 */	b lbl_80023098
lbl_8002305C:
...
/* 80023064 0001FFA4  48 00 00 2C */	b lbl_80023090
lbl_80023068:
...
/* 80023088 0001FFC8  40 82 00 10 */	bne lbl_80023098
/* 8002308C 0001FFCC  83 FF 00 0C */	lwz r31, 0xc(r31)
lbl_80023090:
/* 80023090 0001FFD0  28 1F 00 00 */	cmplwi r31, 0
/* 80023094 0001FFD4  40 82 FF D4 */	bne lbl_80023068
lbl_80023098:
...
/* 800230D0 00020010  41 82 00 0C */	beq lbl_800230DC
/* 800230D4 00020014  80 6D 88 20 */	lwz r3, sCurrentVolume__13JKRFileLoader@sda21(r13)
/* 800230D8 00020018  48 00 00 50 */	b lbl_80023128
lbl_800230DC:
...
/* 800230F4 00020034  48 00 00 28 */	b lbl_8002311C
lbl_800230F8:
...
/* 8002310C 0002004C  40 82 00 0C */	bne lbl_80023118
/* 80023110 00020050  80 7F 00 00 */	lwz r3, 0(r31)
/* 80023114 00020054  48 00 00 14 */	b lbl_80023128
lbl_80023118:
/* 80023118 00020058  83 FF 00 0C */	lwz r31, 0xc(r31)
lbl_8002311C:
/* 8002311C 0002005C  28 1F 00 00 */	cmplwi r31, 0
/* 80023120 00020060  40 82 FF D8 */	bne lbl_800230F8
...
/* 80023170 000200B0  40 82 00 18 */	bne lbl_80023188
...
/* 80023184 000200C4  48 00 00 7C */	b lbl_80023200
lbl_80023188:
...
/* 80023194 000200D4  48 00 00 38 */	b lbl_800231CC
lbl_80023198:
/* 80023198 000200D8  2C 1E 00 01 */	cmpwi r30, 1
/* 8002319C 000200DC  40 81 00 2C */	ble lbl_800231C8
/* 800231A0 000200E0  7C 80 07 74 */	extsb r0, r4
/* 800231A4 000200E4  2C 00 FF FF */	cmpwi r0, -1
/* 800231A8 000200E8  40 82 00 0C */	bne lbl_800231B4
/* 800231AC 000200EC  38 00 FF FF */	li r0, -1
/* 800231B0 000200F0  48 00 00 0C */	b lbl_800231BC
lbl_800231B4:
...
/* 800231D4 00020114  41 82 00 10 */	beq lbl_800231E4
/* 800231D8 00020118  7C 80 07 74 */	extsb r0, r4
/* 800231DC 0002011C  2C 00 00 2F */	cmpwi r0, 0x2f
/* 800231E0 00020120  40 82 FF B8 */	bne lbl_80023198
lbl_800231E4:
...
/* 800231F4 00020134  40 82 00 08 */	bne lbl_800231FC
...
/* 8002327C 000201BC  41 82 00 1C */	beq lbl_80023298
...
/* 8002328C 000201CC  40 81 00 0C */	ble lbl_80023298
