...
/* 800A5BB4 000A2AF4  41 82 00 24 */	beq lbl_800A5BD8
...
/* 800A5C10 000A2B50  41 82 00 14 */	beq lbl_800A5C24
...
/* 800A5D10 000A2C50  41 82 00 50 */	beq lbl_800A5D60
/* 800A5D14 000A2C54  40 80 00 10 */	bge lbl_800A5D24
/* 800A5D18 000A2C58  2C 00 00 00 */	cmpwi r0, 0
/* 800A5D1C 000A2C5C  40 80 00 14 */	bge lbl_800A5D30
/* 800A5D20 000A2C60  4B FF FF D8 */	b lbl_800A5CF8
lbl_800A5D24:
/* 800A5D24 000A2C64  2C 00 00 03 */	cmpwi r0, 3
/* 800A5D28 000A2C68  40 80 FF D0 */	bge lbl_800A5CF8
/* 800A5D2C 000A2C6C  48 00 00 78 */	b lbl_800A5DA4
lbl_800A5D30:
/* 800A5D30 000A2C70  88 0D 8A AC */	lbz r0, sbPauseFlag__14JASAudioThread@sda21(r13)
/* 800A5D34 000A2C74  28 00 00 00 */	cmplwi r0, 0
/* 800A5D38 000A2C78  41 82 00 10 */	beq lbl_800A5D48
...
/* 800A5D5C 000A2C9C  4B FF FF 9C */	b lbl_800A5CF8
lbl_800A5D60:
...
/* 800A5D74 000A2CB4  40 82 00 14 */	bne lbl_800A5D88
...
/* 800A5D84 000A2CC4  4B FF FF 74 */	b lbl_800A5CF8
lbl_800A5D88:
...
/* 800A5DA0 000A2CE0  4B FF FF 58 */	b lbl_800A5CF8
lbl_800A5DA4:
/* 800A5DA4 000A2CE4  38 60 00 00 */	li r3, 0
/* 800A5DA8 000A2CE8  48 04 C4 0D */	bl OSExitThread
/* 800A5DAC 000A2CEC  4B FF FF 4C */	b lbl_800A5CF8
...
/* 800A5E0C 000A2D4C  41 82 FF F8 */	beq lbl_800A5E04
...
/* 800A5E40 000A2D80  48 00 00 0C */	b lbl_800A5E4C
lbl_800A5E44:
...
/* 800A5E78 000A2DB8  41 82 00 28 */	beq lbl_800A5EA0
...
/* 800A5E94 000A2DD4  40 81 00 0C */	ble lbl_800A5EA0
