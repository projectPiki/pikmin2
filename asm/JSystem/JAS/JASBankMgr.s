...
/* 80098F8C 00095ECC  40 81 00 C4 */	ble lbl_80099050
/* 80098F90 00095ED0  2C 1F 00 08 */	cmpwi r31, 8
/* 80098F94 00095ED4  38 9F FF F8 */	addi r4, r31, -8
/* 80098F98 00095ED8  40 81 00 8C */	ble lbl_80099024
...
/* 80098FB8 00095EF8  40 81 00 6C */	ble lbl_80099024
lbl_80098FBC:
...
/* 80099020 00095F60  42 00 FF 9C */	bdnz lbl_80098FBC
lbl_80099024:
...
/* 8009903C 00095F7C  40 80 00 14 */	bge lbl_80099050
lbl_80099040:
...
/* 8009904C 00095F8C  42 00 FF F4 */	bdnz lbl_80099040
lbl_80099050:
...
/* 800990A0 00095FE0  40 82 00 0C */	bne lbl_800990AC
/* 800990A4 00095FE4  38 60 00 00 */	li r3, 0
/* 800990A8 00095FE8  48 00 00 14 */	b lbl_800990BC
lbl_800990AC:
...
/* 80099140 00096080  40 82 00 0C */	bne lbl_8009914C
/* 80099144 00096084  38 60 00 00 */	li r3, 0
/* 80099148 00096088  48 00 00 24 */	b lbl_8009916C
lbl_8009914C:
...
/* 80099158 00096098  40 82 00 0C */	bne lbl_80099164
/* 8009915C 0009609C  38 60 00 00 */	li r3, 0
/* 80099160 000960A0  48 00 00 0C */	b lbl_8009916C
lbl_80099164:
...
/* 800991AC 000960EC  40 81 00 24 */	ble lbl_800991D0
...
/* 80099204 00096144  40 82 00 0C */	bne lbl_80099210
/* 80099208 00096148  38 60 00 00 */	li r3, 0
/* 8009920C 0009614C  48 00 02 C0 */	b lbl_800994CC
lbl_80099210:
...
/* 8009922C 0009616C  40 82 00 0C */	bne lbl_80099238
/* 80099230 00096170  38 60 00 00 */	li r3, 0
/* 80099234 00096174  48 00 02 98 */	b lbl_800994CC
lbl_80099238:
...
/* 80099298 000961D8  40 82 00 0C */	bne lbl_800992A4
/* 8009929C 000961DC  38 60 00 00 */	li r3, 0
/* 800992A0 000961E0  48 00 02 2C */	b lbl_800994CC
lbl_800992A4:
...
/* 800992B4 000961F4  48 00 02 18 */	b lbl_800994CC
lbl_800992B8:
...
/* 800992D0 00096210  40 82 00 0C */	bne lbl_800992DC
/* 800992D4 00096214  38 60 00 00 */	li r3, 0
/* 800992D8 00096218  48 00 01 F4 */	b lbl_800994CC
lbl_800992DC:
...
/* 800992F0 00096230  40 82 00 0C */	bne lbl_800992FC
/* 800992F4 00096234  38 60 00 00 */	li r3, 0
/* 800992F8 00096238  48 00 01 D4 */	b lbl_800994CC
lbl_800992FC:
...
/* 80099314 00096254  40 82 00 0C */	bne lbl_80099320
/* 80099318 00096258  38 60 00 00 */	li r3, 0
/* 8009931C 0009625C  48 00 01 B0 */	b lbl_800994CC
lbl_80099320:
/* 80099320 00096260  80 0D 8A 24 */	lwz r0, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
/* 80099324 00096264  28 00 00 00 */	cmplwi r0, 0
/* 80099328 00096268  40 82 00 40 */	bne lbl_80099368
/* 8009932C 0009626C  48 05 59 0D */	bl OSDisableInterrupts
/* 80099330 00096270  80 0D 8A 24 */	lwz r0, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
/* 80099334 00096274  90 61 00 08 */	stw r3, 8(r1)
/* 80099338 00096278  28 00 00 00 */	cmplwi r0, 0
/* 8009933C 0009627C  40 82 00 24 */	bne lbl_80099360
...
/* 80099354 00096294  41 82 00 08 */	beq lbl_8009935C
/* 80099358 00096298  48 00 DE 2D */	bl __ct__17JASGenericMemPoolFv
lbl_8009935C:
/* 8009935C 0009629C  93 4D 8A 24 */	stw r26, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
lbl_80099360:
/* 80099360 000962A0  80 61 00 08 */	lwz r3, 8(r1)
/* 80099364 000962A4  48 05 58 FD */	bl OSRestoreInterrupts
lbl_80099368:
/* 80099368 000962A8  80 6D 8A 24 */	lwz r3, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
...
/* 80099378 000962B8  41 82 00 14 */	beq lbl_8009938C
...
/* 80099390 000962D0  40 82 00 0C */	bne lbl_8009939C
/* 80099394 000962D4  38 60 00 00 */	li r3, 0
/* 80099398 000962D8  48 00 01 34 */	b lbl_800994CC
lbl_8009939C:
...
/* 800993EC 0009632C  40 82 00 20 */	bne lbl_8009940C
...
/* 80099478 000963B8  48 00 00 20 */	b lbl_80099498
lbl_8009947C:
...
/* 800994A0 000963E0  41 80 FF DC */	blt lbl_8009947C
...
/* 800994BC 000963FC  41 82 00 0C */	beq lbl_800994C8
/* 800994C0 00096400  7F 43 D3 78 */	mr r3, r26
/* 800994C4 00096404  48 00 00 08 */	b lbl_800994CC
lbl_800994C8:
...
/* 80099508 00096448  80 0D 8A 24 */	lwz r0, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
/* 8009950C 0009644C  28 00 00 00 */	cmplwi r0, 0
/* 80099510 00096450  40 82 00 40 */	bne lbl_80099550
/* 80099514 00096454  48 05 57 25 */	bl OSDisableInterrupts
/* 80099518 00096458  80 0D 8A 24 */	lwz r0, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
/* 8009951C 0009645C  90 61 00 08 */	stw r3, 8(r1)
/* 80099520 00096460  28 00 00 00 */	cmplwi r0, 0
/* 80099524 00096464  40 82 00 24 */	bne lbl_80099548
...
/* 8009953C 0009647C  41 82 00 08 */	beq lbl_80099544
/* 80099540 00096480  48 00 DC 45 */	bl __ct__17JASGenericMemPoolFv
lbl_80099544:
/* 80099544 00096484  93 ED 8A 24 */	stw r31, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
lbl_80099548:
/* 80099548 00096488  80 61 00 08 */	lwz r3, 8(r1)
/* 8009954C 0009648C  48 05 57 15 */	bl OSRestoreInterrupts
lbl_80099550:
/* 80099550 00096490  80 6D 8A 24 */	lwz r3, sInstance__123JASSingletonHolder$$062JASMemPool$$010JASChannel$$4Q217JASThreadingModel14SingleThreaded$$1$$4Q217JASCreationPolicy15NewFromRootHeap$$1@sda21(r13)
...
/* 80099560 000964A0  41 82 00 14 */	beq lbl_80099574
...
/* 80099578 000964B8  40 82 00 0C */	bne lbl_80099584
/* 8009957C 000964BC  38 60 00 00 */	li r3, 0
/* 80099580 000964C0  48 00 00 C0 */	b lbl_80099640
lbl_80099584:
...
/* 80099630 00096570  41 82 00 0C */	beq lbl_8009963C
/* 80099634 00096574  7F E3 FB 78 */	mr r3, r31
/* 80099638 00096578  48 00 00 08 */	b lbl_80099640
lbl_8009963C:
...
/* 80099678 000965B8  40 82 00 0C */	bne lbl_80099684
/* 8009967C 000965BC  54 83 06 3E */	clrlwi r3, r4, 0x18
/* 80099680 000965C0  48 00 00 18 */	b lbl_80099698
lbl_80099684:
