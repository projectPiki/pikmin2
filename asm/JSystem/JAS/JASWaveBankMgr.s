...
/* 8009C09C 00098FDC  40 80 00 0C */	bge .L_8009C0A8
...
/* 8009C0B0 00098FF0  41 80 00 0C */	blt .L_8009C0BC
...
/* 8009C0F4 00099034  40 82 00 14 */	bne .L_8009C108
...
/* 8009C104 00099044  48 00 00 10 */	b .L_8009C114
.L_8009C108:
...
/* 8009C118 00099058  40 82 00 0C */	bne .L_8009C124
/* 8009C11C 0009905C  38 60 00 00 */	li r3, 0
/* 8009C120 00099060  48 00 00 14 */	b .L_8009C134
.L_8009C124:
...
/* 8009C194 000990D4  40 82 00 0C */	bne .L_8009C1A0
/* 8009C198 000990D8  38 60 00 00 */	li r3, 0
/* 8009C19C 000990DC  48 00 00 14 */	b .L_8009C1B0
.L_8009C1A0:
...
/* 8009C1B4 000990F4  40 82 00 0C */	bne .L_8009C1C0
/* 8009C1B8 000990F8  38 60 00 00 */	li r3, 0
/* 8009C1BC 000990FC  48 00 00 0C */	b .L_8009C1C8
.L_8009C1C0:
...
/* 8009C224 00099164  40 82 00 0C */	bne .L_8009C230
/* 8009C228 00099168  38 60 00 00 */	li r3, 0
/* 8009C22C 0009916C  48 00 00 14 */	b .L_8009C240
.L_8009C230:
...
/* 8009C244 00099184  40 82 00 0C */	bne .L_8009C250
/* 8009C248 00099188  38 60 00 00 */	li r3, 0
/* 8009C24C 0009918C  48 00 00 0C */	b .L_8009C258
.L_8009C250:
...
/* 8009C2AC 000991EC  40 82 00 0C */	bne .L_8009C2B8
/* 8009C2B0 000991F0  38 60 00 00 */	li r3, 0
/* 8009C2B4 000991F4  48 00 00 14 */	b .L_8009C2C8
.L_8009C2B8:
...
/* 8009C2CC 0009920C  40 82 00 0C */	bne .L_8009C2D8
/* 8009C2D0 00099210  38 60 00 00 */	li r3, 0
/* 8009C2D4 00099214  48 00 00 18 */	b .L_8009C2EC
.L_8009C2D8:
