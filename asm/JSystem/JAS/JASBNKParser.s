...
/* 8009A818 00097758  41 82 00 0C */	beq lbl_8009A824
...
/* 8009A828 00097768  40 82 00 0C */	bne lbl_8009A834
/* 8009A82C 0009776C  38 60 00 00 */	li r3, 0
/* 8009A830 00097770  48 00 06 68 */	b lbl_8009AE98
lbl_8009A834:
...
/* 8009A850 00097790  48 00 08 51 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TInst$$1__FPCvUl
/* 8009A854 00097794  7C 70 1B 79 */	or. r16, r3, r3
/* 8009A858 00097798  41 82 03 C4 */	beq lbl_8009AC1C
...
/* 8009A870 000977B0  41 82 00 0C */	beq lbl_8009A87C
...
/* 8009A8AC 000977EC  48 00 07 DD */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser4TOsc$$1__FPCvUl
/* 8009A8B0 000977F0  7C 74 1B 79 */	or. r20, r3, r3
/* 8009A8B4 000977F4  41 82 01 2C */	beq lbl_8009A9E0
...
/* 8009A8CC 0009780C  40 82 01 00 */	bne lbl_8009A9CC
...
/* 8009A8FC 0009783C  48 00 07 75 */	bl JSUConvertOffsetToPtr$$0s$$1__FPCvUl
/* 8009A900 00097840  7C 76 1B 79 */	or. r22, r3, r3
/* 8009A904 00097844  41 82 00 4C */	beq lbl_8009A950
...
/* 8009A94C 0009788C  48 00 00 0C */	b lbl_8009A958
lbl_8009A950:
...
/* 8009A960 000978A0  48 00 07 11 */	bl JSUConvertOffsetToPtr$$0s$$1__FPCvUl
/* 8009A964 000978A4  7C 76 1B 79 */	or. r22, r3, r3
/* 8009A968 000978A8  41 82 00 4C */	beq lbl_8009A9B4
...
/* 8009A9B0 000978F0  48 00 00 0C */	b lbl_8009A9BC
lbl_8009A9B4:
...
/* 8009A9EC 0009792C  41 80 FE B8 */	blt lbl_8009A8A4
...
/* 8009AA0C 0009794C  48 00 06 4D */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TRand$$1__FPCvUl
/* 8009AA10 00097950  7C 73 1B 79 */	or. r19, r3, r3
/* 8009AA14 00097954  41 82 00 78 */	beq lbl_8009AA8C
...
/* 8009AA2C 0009796C  41 82 00 34 */	beq lbl_8009AA60
...
/* 8009AA98 000979D8  41 80 FF 6C */	blt lbl_8009AA04
...
/* 8009AAAC 000979EC  48 00 05 95 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser6TSense$$1__FPCvUl
/* 8009AAB0 000979F0  7C 71 1B 79 */	or. r17, r3, r3
/* 8009AAB4 000979F4  41 82 00 88 */	beq lbl_8009AB3C
...
/* 8009AACC 00097A0C  41 82 00 3C */	beq lbl_8009AB08
...
/* 8009AB48 00097A88  41 80 FF 5C */	blt lbl_8009AAA4
...
/* 8009AB60 00097AA0  48 00 00 A0 */	b lbl_8009AC00
lbl_8009AB64:
...
/* 8009AB7C 00097ABC  48 00 04 AD */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser7TKeymap$$1__FPCvUl
...
/* 8009ABA0 00097AE0  48 00 00 4C */	b lbl_8009ABEC
lbl_8009ABA4:
...
/* 8009ABBC 00097AFC  48 00 04 55 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TVmap$$1__FPCvUl
...
/* 8009ABF4 00097B34  41 80 FF B0 */	blt lbl_8009ABA4
...
/* 8009AC08 00097B48  41 80 FF 5C */	blt lbl_8009AB64
...
/* 8009AC28 00097B68  41 80 FC 20 */	blt lbl_8009A848
...
/* 8009AC3C 00097B7C  48 00 03 BD */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TPerc$$1__FPCvUl
/* 8009AC40 00097B80  7C 79 1B 79 */	or. r25, r3, r3
/* 8009AC44 00097B84  41 82 02 28 */	beq lbl_8009AE6C
...
/* 8009AC5C 00097B9C  41 82 00 40 */	beq lbl_8009AC9C
...
/* 8009ACB0 00097BF0  48 00 03 31 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TPmap$$1__FPCvUl
/* 8009ACB4 00097BF4  7C 78 1B 79 */	or. r24, r3, r3
/* 8009ACB8 00097BF8  41 82 01 90 */	beq lbl_8009AE48
...
/* 8009ACE8 00097C28  40 82 00 40 */	bne lbl_8009AD28
...
/* 8009AD48 00097C88  48 00 03 11 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TRand$$1__FPCvUl
/* 8009AD4C 00097C8C  7C 70 1B 79 */	or. r16, r3, r3
/* 8009AD50 00097C90  41 82 00 7C */	beq lbl_8009ADCC
...
/* 8009AD68 00097CA8  41 82 00 34 */	beq lbl_8009AD9C
...
/* 8009ADD8 00097D18  41 80 FF 68 */	blt lbl_8009AD40
...
/* 8009ADF0 00097D30  48 00 00 4C */	b lbl_8009AE3C
lbl_8009ADF4:
...
/* 8009AE0C 00097D4C  48 00 02 05 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TVmap$$1__FPCvUl
...
/* 8009AE44 00097D84  41 80 FF B0 */	blt lbl_8009ADF4
lbl_8009AE48:
...
/* 8009AE58 00097D98  41 80 FE 50 */	blt lbl_8009ACA8
...
/* 8009AE78 00097DB8  41 80 FD BC */	blt lbl_8009AC34
...
/* 8009AED8 00097E18  48 00 01 C9 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser5TInst$$1__FPCvUl
/* 8009AEDC 00097E1C  28 03 00 00 */	cmplwi r3, 0
/* 8009AEE0 00097E20  41 82 00 C4 */	beq lbl_8009AFA4
...
/* 8009AEF4 00097E34  48 00 01 95 */	bl JSUConvertOffsetToPtr$$0Q212JASBNKParser4TOsc$$1__FPCvUl
/* 8009AEF8 00097E38  7C 03 D8 40 */	cmplw r3, r27
/* 8009AEFC 00097E3C  40 82 00 98 */	bne lbl_8009AF94
...
/* 8009AF1C 00097E5C  41 82 00 78 */	beq lbl_8009AF94
...
/* 8009AF80 00097EC0  40 80 00 14 */	bge lbl_8009AF94
...
/* 8009AF90 00097ED0  48 00 00 28 */	b lbl_8009AFB8
lbl_8009AF94:
...
/* 8009AFA0 00097EE0  41 80 FF 4C */	blt lbl_8009AEEC
lbl_8009AFA4:
...
/* 8009AFB0 00097EF0  41 80 FF 20 */	blt lbl_8009AED0
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser5TPmap$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser5TPmap$$1__FPCvUl:
/* 8009AFE0 00097F20  28 04 00 00 */	cmplwi r4, 0
/* 8009AFE4 00097F24  40 82 00 0C */	bne lbl_8009AFF0
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser5TPerc$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser5TPerc$$1__FPCvUl:
/* 8009AFF8 00097F38  28 04 00 00 */	cmplwi r4, 0
/* 8009AFFC 00097F3C  40 82 00 0C */	bne lbl_8009B008
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser5TVmap$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser5TVmap$$1__FPCvUl:
/* 8009B010 00097F50  28 04 00 00 */	cmplwi r4, 0
/* 8009B014 00097F54  40 82 00 0C */	bne lbl_8009B020
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser7TKeymap$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser7TKeymap$$1__FPCvUl:
/* 8009B028 00097F68  28 04 00 00 */	cmplwi r4, 0
/* 8009B02C 00097F6C  40 82 00 0C */	bne lbl_8009B038
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser6TSense$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser6TSense$$1__FPCvUl:
/* 8009B040 00097F80  28 04 00 00 */	cmplwi r4, 0
/* 8009B044 00097F84  40 82 00 0C */	bne lbl_8009B050
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser5TRand$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser5TRand$$1__FPCvUl:
/* 8009B058 00097F98  28 04 00 00 */	cmplwi r4, 0
/* 8009B05C 00097F9C  40 82 00 0C */	bne lbl_8009B068
...
/* 8009B074 00097FB4  40 82 00 0C */	bne lbl_8009B080
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser4TOsc$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser4TOsc$$1__FPCvUl:
/* 8009B088 00097FC8  28 04 00 00 */	cmplwi r4, 0
/* 8009B08C 00097FCC  40 82 00 0C */	bne lbl_8009B098
...
.global JSUConvertOffsetToPtr$$0Q212JASBNKParser5TInst$$1__FPCvUl
JSUConvertOffsetToPtr$$0Q212JASBNKParser5TInst$$1__FPCvUl:
/* 8009B0A0 00097FE0  28 04 00 00 */	cmplwi r4, 0
/* 8009B0A4 00097FE4  40 82 00 0C */	bne lbl_8009B0B0
