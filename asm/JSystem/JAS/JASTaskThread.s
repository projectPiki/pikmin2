...
/* 800A88B8 000A57F8  41 82 00 F8 */	beq lbl_800A89B0
...
/* 800A88DC 000A581C  41 82 00 08 */	beq lbl_800A88E4
...
/* 800A88F0 000A5830  41 82 00 A4 */	beq lbl_800A8994
...
/* 800A8910 000A5850  48 00 00 70 */	b lbl_800A8980
lbl_800A8914:
...
/* 800A8950 000A5890  41 82 00 1C */	beq lbl_800A896C
/* 800A8954 000A5894  80 03 00 08 */	lwz r0, 8(r3)
/* 800A8958 000A5898  28 00 00 00 */	cmplwi r0, 0
/* 800A895C 000A589C  40 82 00 10 */	bne lbl_800A896C
...
/* 800A8974 000A58B4  4B FF FF 54 */	b lbl_800A88C8
lbl_800A8978:
...
/* 800A8984 000A58C4  40 82 FF 90 */	bne lbl_800A8914
/* 800A8988 000A58C8  80 61 00 08 */	lwz r3, 8(r1)
/* 800A898C 000A58CC  48 04 72 B9 */	bl OSUnlockMutex
/* 800A8990 000A58D0  4B FF FF 38 */	b lbl_800A88C8
lbl_800A8994:
...
/* 800A89A4 000A58E4  40 81 00 0C */	ble lbl_800A89B0
...
/* 800A8A10 000A5950  40 80 00 E4 */	bge lbl_800A8AF4
/* 800A8A14 000A5954  28 1A 04 00 */	cmplwi r26, 0x400
/* 800A8A18 000A5958  40 81 00 14 */	ble lbl_800A8A2C
...
/* 800A8A68 000A59A8  41 82 00 14 */	beq lbl_800A8A7C
...
/* 800A8A88 000A59C8  41 82 00 0C */	beq lbl_800A8A94
/* 800A8A8C 000A59CC  38 60 00 01 */	li r3, 1
/* 800A8A90 000A59D0  48 00 00 4C */	b lbl_800A8ADC
lbl_800A8A94:
...
/* 800A8AA8 000A59E8  41 82 00 14 */	beq lbl_800A8ABC
...
/* 800A8AC8 000A5A08  41 82 00 0C */	beq lbl_800A8AD4
/* 800A8ACC 000A5A0C  38 60 00 01 */	li r3, 1
/* 800A8AD0 000A5A10  48 00 00 0C */	b lbl_800A8ADC
lbl_800A8AD4:
...
/* 800A8AE0 000A5A20  40 82 00 14 */	bne lbl_800A8AF4
...
/* 800A8AF0 000A5A30  48 00 00 30 */	b lbl_800A8B20
lbl_800A8AF4:
...
/* 800A8B24 000A5A64  40 82 00 0C */	bne lbl_800A8B30
/* 800A8B28 000A5A68  3B E0 00 00 */	li r31, 0
/* 800A8B2C 000A5A6C  48 00 00 20 */	b lbl_800A8B4C
lbl_800A8B30:
...
/* 800A8B50 000A5A90  40 82 00 0C */	bne lbl_800A8B5C
/* 800A8B54 000A5A94  38 60 00 00 */	li r3, 0
/* 800A8B58 000A5A98  48 00 00 BC */	b lbl_800A8C14
lbl_800A8B5C:
...
/* 800A8B70 000A5AB0  40 82 00 A0 */	bne lbl_800A8C10
...
/* 800A8B90 000A5AD0  48 00 00 70 */	b lbl_800A8C00
lbl_800A8B94:
...
/* 800A8BD0 000A5B10  41 82 00 1C */	beq lbl_800A8BEC
/* 800A8BD4 000A5B14  80 03 00 08 */	lwz r0, 8(r3)
/* 800A8BD8 000A5B18  28 00 00 00 */	cmplwi r0, 0
/* 800A8BDC 000A5B1C  40 82 00 10 */	bne lbl_800A8BEC
...
/* 800A8BF4 000A5B34  48 00 00 1C */	b lbl_800A8C10
lbl_800A8BF8:
...
/* 800A8C04 000A5B44  40 82 FF 90 */	bne lbl_800A8B94
...
/* 800A8CA8 000A5BE8  41 82 00 14 */	beq lbl_800A8CBC
...
/* 800A8CC8 000A5C08  41 82 00 0C */	beq lbl_800A8CD4
/* 800A8CCC 000A5C0C  38 60 00 01 */	li r3, 1
/* 800A8CD0 000A5C10  48 00 00 4C */	b lbl_800A8D1C
lbl_800A8CD4:
...
/* 800A8CE8 000A5C28  41 82 00 14 */	beq lbl_800A8CFC
...
/* 800A8D08 000A5C48  41 82 00 0C */	beq lbl_800A8D14
/* 800A8D0C 000A5C4C  38 60 00 01 */	li r3, 1
/* 800A8D10 000A5C50  48 00 00 0C */	b lbl_800A8D1C
lbl_800A8D14:
...
/* 800A8D20 000A5C60  40 82 00 14 */	bne lbl_800A8D34
...
/* 800A8D30 000A5C70  48 00 00 30 */	b lbl_800A8D60
lbl_800A8D34:
...
/* 800A8D64 000A5CA4  40 82 00 0C */	bne lbl_800A8D70
/* 800A8D68 000A5CA8  3B 60 00 00 */	li r27, 0
/* 800A8D6C 000A5CAC  48 00 00 14 */	b lbl_800A8D80
lbl_800A8D70:
...
/* 800A8D84 000A5CC4  40 82 00 0C */	bne lbl_800A8D90
/* 800A8D88 000A5CC8  38 60 00 00 */	li r3, 0
/* 800A8D8C 000A5CCC  48 00 00 BC */	b lbl_800A8E48
lbl_800A8D90:
...
/* 800A8DA4 000A5CE4  40 82 00 A0 */	bne lbl_800A8E44
...
/* 800A8DC4 000A5D04  48 00 00 70 */	b lbl_800A8E34
lbl_800A8DC8:
...
/* 800A8E04 000A5D44  41 82 00 1C */	beq lbl_800A8E20
/* 800A8E08 000A5D48  80 03 00 08 */	lwz r0, 8(r3)
/* 800A8E0C 000A5D4C  28 00 00 00 */	cmplwi r0, 0
/* 800A8E10 000A5D50  40 82 00 10 */	bne lbl_800A8E20
...
/* 800A8E28 000A5D68  48 00 00 1C */	b lbl_800A8E44
lbl_800A8E2C:
...
/* 800A8E38 000A5D78  40 82 FF 90 */	bne lbl_800A8DC8
...
/* 800A8EC8 000A5E08  41 82 00 0C */	beq lbl_800A8ED4
...
/* 800A8EDC 000A5E1C  41 82 00 18 */	beq lbl_800A8EF4
...
/* 800A8EF0 000A5E30  48 00 00 14 */	b lbl_800A8F04
lbl_800A8EF4:
...
/* 800A8F20 000A5E60  48 00 00 70 */	b lbl_800A8F90
lbl_800A8F24:
...
/* 800A8F60 000A5EA0  41 82 00 1C */	beq lbl_800A8F7C
/* 800A8F64 000A5EA4  80 03 00 08 */	lwz r0, 8(r3)
/* 800A8F68 000A5EA8  28 00 00 00 */	cmplwi r0, 0
/* 800A8F6C 000A5EAC  40 82 00 10 */	bne lbl_800A8F7C
...
/* 800A8F84 000A5EC4  4B FF FF 28 */	b lbl_800A8EAC
lbl_800A8F88:
...
/* 800A8F94 000A5ED4  40 82 FF 90 */	bne lbl_800A8F24
/* 800A8F98 000A5ED8  80 61 00 08 */	lwz r3, 8(r1)
/* 800A8F9C 000A5EDC  48 04 6C A9 */	bl OSUnlockMutex
/* 800A8FA0 000A5EE0  4B FF FF 0C */	b lbl_800A8EAC
