...
/* 800B9618 000B6558  41 82 00 3C */	beq lbl_800B9654
...
/* 800B9648 000B6588  40 81 00 0C */	ble lbl_800B9654
...
/* 800B9694 000B65D4  40 82 00 18 */	bne lbl_800B96AC
...
/* 800B96B0 000B65F0  40 82 00 1C */	bne lbl_800B96CC
...
/* 800B96F0 000B6630  4B F5 C1 7D */	bl startSoundVecT$$08JAISound$$1__8JAIBasicFUlPP8JAISoundP3VecUlUlUc
/* 800B96F4 000B6634  80 7C 00 00 */	lwz r3, 0(r28)
/* 800B96F8 000B6638  48 00 00 C8 */	b lbl_800B97C0
lbl_800B96FC:
...
/* 800B970C 000B664C  48 00 00 30 */	b lbl_800B973C
lbl_800B9710:
...
/* 800B972C 000B666C  41 81 00 0C */	bgt lbl_800B9738
...
/* 800B9744 000B6684  41 80 FF CC */	blt lbl_800B9710
/* 800B9748 000B6688  57 60 06 3E */	clrlwi r0, r27, 0x18
/* 800B974C 000B668C  28 00 00 FF */	cmplwi r0, 0xff
/* 800B9750 000B6690  41 82 00 6C */	beq lbl_800B97BC
...
/* 800B9768 000B66A8  41 80 00 54 */	blt lbl_800B97BC
...
/* 800B97AC 000B66EC  4B F5 C0 C1 */	bl startSoundVecT$$08JAISound$$1__8JAIBasicFUlPP8JAISoundP3VecUlUlUc
/* 800B97B0 000B66F0  80 7D 00 1C */	lwz r3, 0x1c(r29)
/* 800B97B4 000B66F4  7C 63 E0 2E */	lwzx r3, r3, r28
/* 800B97B8 000B66F8  48 00 00 08 */	b lbl_800B97C0
lbl_800B97BC:
...
/* 800B97F0 000B6730  41 82 00 18 */	beq lbl_800B9808
...
/* 800B984C 000B678C  4B F5 C0 21 */	bl startSoundVecT$$08JAISound$$1__8JAIBasicFUlPP8JAISoundP3VecUlUlUc
...
/* 800B9890 000B67D0  4B F5 BF DD */	bl startSoundVecT$$08JAISound$$1__8JAIBasicFUlPP8JAISoundP3VecUlUlUc
...
/* 800B98D0 000B6810  41 82 00 1C */	beq lbl_800B98EC
...
/* 800B9920 000B6860  48 00 00 24 */	b lbl_800B9944
lbl_800B9924:
...
/* 800B9950 000B6890  41 80 FF D4 */	blt lbl_800B9924
...
/* 800B9A08 000B6948  40 81 00 3C */	ble lbl_800B9A44
lbl_800B9A0C:
...
/* 800B9A18 000B6958  40 82 00 20 */	bne lbl_800B9A38
...
/* 800B9A28 000B6968  40 82 00 10 */	bne lbl_800B9A38
...
/* 800B9A40 000B6980  42 00 FF CC */	bdnz lbl_800B9A0C
lbl_800B9A44:
...
/* 800B9A60 000B69A0  40 81 00 38 */	ble lbl_800B9A98
lbl_800B9A64:
...
/* 800B9A70 000B69B0  41 82 00 1C */	beq lbl_800B9A8C
/* 800B9A74 000B69B4  80 06 00 20 */	lwz r0, 0x20(r6)
/* 800B9A78 000B69B8  7C 04 00 40 */	cmplw r4, r0
/* 800B9A7C 000B69BC  40 82 00 10 */	bne lbl_800B9A8C
...
/* 800B9A94 000B69D4  42 00 FF D0 */	bdnz lbl_800B9A64
lbl_800B9A98:
...
/* 800B9AA8 000B69E8  48 00 00 30 */	b lbl_800B9AD8
lbl_800B9AAC:
...
/* 800B9ABC 000B69FC  41 82 00 18 */	beq lbl_800B9AD4
/* 800B9AC0 000B6A00  80 05 00 20 */	lwz r0, 0x20(r5)
/* 800B9AC4 000B6A04  7C 04 00 40 */	cmplw r4, r0
/* 800B9AC8 000B6A08  40 82 00 0C */	bne lbl_800B9AD4
...
/* 800B9AE0 000B6A20  41 80 FF CC */	blt lbl_800B9AAC
...
/* 800B9B2C 000B6A6C  40 82 00 08 */	bne lbl_800B9B34
...
/* 800B9B58 000B6A98  48 00 00 14 */	b lbl_800B9B6C
lbl_800B9B5C:
...
/* 800B9B78 000B6AB8  41 80 FF E4 */	blt lbl_800B9B5C
...
/* 800B9BFC 000B6B3C  41 82 00 4C */	beq lbl_800B9C48
...
/* 800B9C0C 000B6B4C  41 82 00 2C */	beq lbl_800B9C38
...
/* 800B9C3C 000B6B7C  40 81 00 0C */	ble lbl_800B9C48
...
/* 800B9C88 000B6BC8  40 82 00 18 */	bne lbl_800B9CA0
...
/* 800B9CA4 000B6BE4  40 82 00 1C */	bne lbl_800B9CC0
...
/* 800B9CC4 000B6C04  41 82 00 70 */	beq lbl_800B9D34
/* 800B9CC8 000B6C08  28 1B 00 00 */	cmplwi r27, 0
/* 800B9CCC 000B6C0C  80 9B 00 24 */	lwz r4, 0x24(r27)
/* 800B9CD0 000B6C10  40 82 00 0C */	bne lbl_800B9CDC
/* 800B9CD4 000B6C14  7C 83 23 78 */	mr r3, r4
/* 800B9CD8 000B6C18  48 00 00 08 */	b lbl_800B9CE0
lbl_800B9CDC:
...
/* 800B9CF8 000B6C38  40 82 00 10 */	bne lbl_800B9D08
/* 800B9CFC 000B6C3C  38 00 00 01 */	li r0, 1
/* 800B9D00 000B6C40  98 01 00 2C */	stb r0, 0x2c(r1)
/* 800B9D04 000B6C44  48 00 00 0C */	b lbl_800B9D10
lbl_800B9D08:
...
/* 800B9D28 000B6C68  4B F5 BB A5 */	bl startSoundActorT$$08JAISound$$1__8JAIBasicFUlPP8JAISoundPQ27JAInter5ActorUlUc
/* 800B9D2C 000B6C6C  80 7E 00 00 */	lwz r3, 0(r30)
/* 800B9D30 000B6C70  48 00 01 3C */	b lbl_800B9E6C
lbl_800B9D34:
...
/* 800B9D48 000B6C88  48 00 00 44 */	b lbl_800B9D8C
lbl_800B9D4C:
...
/* 800B9D5C 000B6C9C  40 82 00 2C */	bne lbl_800B9D88
...
/* 800B9D7C 000B6CBC  41 81 00 0C */	bgt lbl_800B9D88
...
/* 800B9D94 000B6CD4  41 80 FF B8 */	blt lbl_800B9D4C
/* 800B9D98 000B6CD8  57 C0 06 3E */	clrlwi r0, r30, 0x18
/* 800B9D9C 000B6CDC  28 00 00 FF */	cmplwi r0, 0xff
/* 800B9DA0 000B6CE0  41 82 00 C8 */	beq lbl_800B9E68
...
/* 800B9DB8 000B6CF8  41 80 00 B0 */	blt lbl_800B9E68
...
/* 800B9DE0 000B6D20  40 82 00 0C */	bne lbl_800B9DEC
/* 800B9DE4 000B6D24  7C 83 23 78 */	mr r3, r4
/* 800B9DE8 000B6D28  48 00 00 08 */	b lbl_800B9DF0
lbl_800B9DEC:
...
/* 800B9E08 000B6D48  40 82 00 10 */	bne lbl_800B9E18
/* 800B9E0C 000B6D4C  38 00 00 01 */	li r0, 1
/* 800B9E10 000B6D50  98 01 00 18 */	stb r0, 0x18(r1)
/* 800B9E14 000B6D54  48 00 00 0C */	b lbl_800B9E20
lbl_800B9E18:
...
/* 800B9E40 000B6D80  4B F5 BA 8D */	bl startSoundActorT$$08JAISound$$1__8JAIBasicFUlPP8JAISoundPQ27JAInter5ActorUlUc
...
/* 800B9E50 000B6D90  41 82 00 0C */	beq lbl_800B9E5C
...
/* 800B9E64 000B6DA4  48 00 00 08 */	b lbl_800B9E6C
lbl_800B9E68:
...
/* 800B9EA8 000B6DE8  48 00 00 F8 */	b lbl_800B9FA0
lbl_800B9EAC:
...
/* 800B9EBC 000B6DFC  41 82 00 E0 */	beq lbl_800B9F9C
/* 800B9EC0 000B6E00  80 03 00 20 */	lwz r0, 0x20(r3)
/* 800B9EC4 000B6E04  54 00 00 03 */	rlwinm. r0, r0, 0, 0, 1
/* 800B9EC8 000B6E08  40 82 00 B8 */	bne lbl_800B9F80
...
/* 800B9EDC 000B6E1C  41 82 00 A4 */	beq lbl_800B9F80
/* 800B9EE0 000B6E20  28 1E 00 00 */	cmplwi r30, 0
/* 800B9EE4 000B6E24  40 82 00 10 */	bne lbl_800B9EF4
...
/* 800B9EF8 000B6E38  41 82 00 68 */	beq lbl_800B9F60
...
/* 800B9F5C 000B6E9C  48 00 00 40 */	b lbl_800B9F9C
lbl_800B9F60:
...
/* 800B9F7C 000B6EBC  48 00 00 20 */	b lbl_800B9F9C
lbl_800B9F80:
...
/* 800B9FAC 000B6EEC  41 80 FF 00 */	blt lbl_800B9EAC
...
/* 800BA004 000B6F44  48 00 01 BC */	b lbl_800BA1C0
lbl_800BA008:
...
/* 800BA014 000B6F54  41 82 01 A4 */	beq lbl_800BA1B8
/* 800BA018 000B6F58  57 C0 06 3F */	clrlwi. r0, r30, 0x18
/* 800BA01C 000B6F5C  40 82 01 20 */	bne lbl_800BA13C
/* 800BA020 000B6F60  80 9C 00 24 */	lwz r4, 0x24(r28)
/* 800BA024 000B6F64  28 04 00 00 */	cmplwi r4, 0
/* 800BA028 000B6F68  41 82 01 14 */	beq lbl_800BA13C
...
/* 800BA068 000B6FA8  40 81 00 4C */	ble lbl_800BA0B4
...
/* 800BA0E0 000B7020  41 82 00 14 */	beq lbl_800BA0F4
/* 800BA0E4 000B7024  40 80 00 40 */	bge lbl_800BA124
/* 800BA0E8 000B7028  2C 03 00 00 */	cmpwi r3, 0
/* 800BA0EC 000B702C  41 82 00 20 */	beq lbl_800BA10C
/* 800BA0F0 000B7030  48 00 00 34 */	b lbl_800BA124
lbl_800BA0F4:
/* 800BA0F4 000B7034  54 80 02 7F */	clrlwi. r0, r4, 9
/* 800BA0F8 000B7038  41 82 00 0C */	beq lbl_800BA104
/* 800BA0FC 000B703C  38 00 00 01 */	li r0, 1
/* 800BA100 000B7040  48 00 00 28 */	b lbl_800BA128
lbl_800BA104:
/* 800BA104 000B7044  38 00 00 02 */	li r0, 2
/* 800BA108 000B7048  48 00 00 20 */	b lbl_800BA128
lbl_800BA10C:
/* 800BA10C 000B704C  54 80 02 7F */	clrlwi. r0, r4, 9
/* 800BA110 000B7050  41 82 00 0C */	beq lbl_800BA11C
/* 800BA114 000B7054  38 00 00 05 */	li r0, 5
/* 800BA118 000B7058  48 00 00 10 */	b lbl_800BA128
lbl_800BA11C:
/* 800BA11C 000B705C  38 00 00 03 */	li r0, 3
/* 800BA120 000B7060  48 00 00 08 */	b lbl_800BA128
lbl_800BA124:
/* 800BA124 000B7064  38 00 00 04 */	li r0, 4
lbl_800BA128:
/* 800BA128 000B7068  2C 00 00 01 */	cmpwi r0, 1
/* 800BA12C 000B706C  40 82 00 0C */	bne lbl_800BA138
...
/* 800BA16C 000B70AC  40 82 00 4C */	bne lbl_800BA1B8
/* 800BA170 000B70B0  80 1C 00 24 */	lwz r0, 0x24(r28)
/* 800BA174 000B70B4  28 00 00 00 */	cmplwi r0, 0
/* 800BA178 000B70B8  41 82 00 3C */	beq lbl_800BA1B4
...
/* 800BA1C8 000B7108  41 80 FE 40 */	blt lbl_800BA008
