...
/* 800AD4E4 000AA424  48 00 00 38 */	b lbl_800AD51C
lbl_800AD4E8:
...
/* 800AD528 000AA468  41 80 FF C0 */	blt lbl_800AD4E8
...
/* 800AD57C 000AA4BC  41 82 00 4C */	beq lbl_800AD5C8
...
/* 800AD594 000AA4D4  41 82 00 14 */	beq lbl_800AD5A8
...
/* 800AD5A4 000AA4E4  48 00 00 0C */	b lbl_800AD5B0
lbl_800AD5A8:
...
/* 800AD5C4 000AA504  48 00 00 08 */	b lbl_800AD5CC
lbl_800AD5C8:
...
/* 800AD5EC 000AA52C  48 00 00 C0 */	b lbl_800AD6AC
lbl_800AD5F0:
...
/* 800AD614 000AA554  40 82 00 94 */	bne lbl_800AD6A8
lbl_800AD618:
/* 800AD618 000AA558  80 7F 00 08 */	lwz r3, 8(r31)
/* 800AD61C 000AA55C  28 03 00 00 */	cmplwi r3, 0
/* 800AD620 000AA560  41 82 00 18 */	beq lbl_800AD638
...
/* 800AD648 000AA588  41 82 00 28 */	beq lbl_800AD670
...
/* 800AD660 000AA5A0  41 82 00 2C */	beq lbl_800AD68C
/* 800AD664 000AA5A4  80 1F 00 00 */	lwz r0, 0(r31)
/* 800AD668 000AA5A8  90 03 00 00 */	stw r0, 0(r3)
/* 800AD66C 000AA5AC  48 00 00 20 */	b lbl_800AD68C
lbl_800AD670:
...
/* 800AD680 000AA5C0  41 82 00 0C */	beq lbl_800AD68C
...
/* 800AD69C 000AA5DC  41 82 00 08 */	beq lbl_800AD6A4
...
/* 800AD6B0 000AA5F0  40 82 FF 40 */	bne lbl_800AD5F0
