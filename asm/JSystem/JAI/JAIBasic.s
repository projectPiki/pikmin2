...
/* 800AC260 000A91A0  41 82 00 0C */	beq lbl_800AC26C
...
/* 800AC2B8 000A91F8  40 82 00 08 */	bne lbl_800AC2C0
...
/* 800AC2F0 000A9230  41 82 00 24 */	beq lbl_800AC314
...
/* 800AC310 000A9250  48 00 00 0C */	b lbl_800AC31C
lbl_800AC314:
...
/* 800AC344 000A9284  40 82 00 28 */	bne lbl_800AC36C
...
/* 800AC394 000A92D4  41 82 00 9C */	beq lbl_800AC430
...
/* 800AC590 000A94D0  40 82 00 E8 */	bne lbl_800AC678
...
/* 800AC630 000A9570  48 00 00 3C */	b lbl_800AC66C
lbl_800AC634:
...
/* 800AC640 000A9580  40 81 00 24 */	ble lbl_800AC664
...
/* 800AC674 000A95B4  41 80 FF C0 */	blt lbl_800AC634
lbl_800AC678:
...
/* 800AC6C0 000A9600  41 82 00 44 */	beq lbl_800AC704
/* 800AC6C4 000A9604  40 80 00 10 */	bge lbl_800AC6D4
/* 800AC6C8 000A9608  2C 00 00 02 */	cmpwi r0, 2
/* 800AC6CC 000A960C  40 80 00 14 */	bge lbl_800AC6E0
/* 800AC6D0 000A9610  48 00 00 34 */	b lbl_800AC704
lbl_800AC6D4:
/* 800AC6D4 000A9614  2C 00 00 05 */	cmpwi r0, 5
/* 800AC6D8 000A9618  40 80 00 2C */	bge lbl_800AC704
/* 800AC6DC 000A961C  48 00 00 18 */	b lbl_800AC6F4
lbl_800AC6E0:
/* 800AC6E0 000A9620  48 00 14 D5 */	bl checkInitDataFile__Q27JAInter8InitDataFv
/* 800AC6E4 000A9624  2C 03 00 00 */	cmpwi r3, 0
/* 800AC6E8 000A9628  40 82 00 1C */	bne lbl_800AC704
/* 800AC6EC 000A962C  38 60 00 00 */	li r3, 0
/* 800AC6F0 000A9630  48 00 00 18 */	b lbl_800AC708
lbl_800AC6F4:
/* 800AC6F4 000A9634  80 0D 8B C8 */	lwz r0, aafPointer__Q27JAInter8InitData@sda21(r13)
/* 800AC6F8 000A9638  28 00 00 00 */	cmplwi r0, 0
/* 800AC6FC 000A963C  41 82 00 08 */	beq lbl_800AC704
...
/* 800AC734 000A9674  40 80 00 28 */	bge lbl_800AC75C
...
/* 800AC744 000A9684  41 82 00 0C */	beq lbl_800AC750
...
/* 800AC794 000A96D4  41 82 00 38 */	beq lbl_800AC7CC
/* 800AC798 000A96D8  40 80 00 18 */	bge lbl_800AC7B0
...
/* 800AC81C 000A975C  41 82 00 38 */	beq lbl_800AC854
lbl_800AC820:
/* 800AC820 000A9760  28 05 00 00 */	cmplwi r5, 0
/* 800AC824 000A9764  40 82 00 14 */	bne lbl_800AC838
...
/* 800AC884 000A97C4  40 82 00 24 */	bne lbl_800AC8A8
...
/* 800AC8A4 000A97E4  48 00 00 14 */	b lbl_800AC8B8
lbl_800AC8A8:
/* 800AC8A8 000A97E8  28 05 00 00 */	cmplwi r5, 0
/* 800AC8AC 000A97EC  41 82 00 0C */	beq lbl_800AC8B8
...
/* 800AC8E4 000A9824  41 82 00 2C */	beq lbl_800AC910
...
/* 800AC8F0 000A9830  40 82 00 20 */	bne lbl_800AC910
...
/* 800AC930 000A9870  41 82 00 68 */	beq lbl_800AC998
...
/* 800AC944 000A9884  41 82 00 48 */	beq lbl_800AC98C
/* 800AC948 000A9888  40 80 00 18 */	bge lbl_800AC960
...
/* 800AC958 000A9898  40 80 00 40 */	bge lbl_800AC998
/* 800AC95C 000A989C  48 00 00 10 */	b lbl_800AC96C
lbl_800AC960:
/* 800AC960 000A98A0  2C 06 00 00 */	cmpwi r6, 0
/* 800AC964 000A98A4  41 82 00 18 */	beq lbl_800AC97C
/* 800AC968 000A98A8  48 00 00 30 */	b lbl_800AC998
lbl_800AC96C:
...
/* 800AC978 000A98B8  48 00 00 20 */	b lbl_800AC998
lbl_800AC97C:
...
/* 800AC988 000A98C8  48 00 00 10 */	b lbl_800AC998
lbl_800AC98C:
...
/* 800AC9CC 000A990C  48 00 00 6C */	b lbl_800ACA38
lbl_800AC9D0:
...
/* 800AC9DC 000A991C  41 82 00 5C */	beq lbl_800ACA38
...
/* 800AC9F0 000A9930  41 82 00 40 */	beq lbl_800ACA30
/* 800AC9F4 000A9934  40 80 00 18 */	bge lbl_800ACA0C
...
/* 800ACA04 000A9944  40 80 00 34 */	bge lbl_800ACA38
/* 800ACA08 000A9948  48 00 00 10 */	b lbl_800ACA18
lbl_800ACA0C:
/* 800ACA0C 000A994C  2C 05 00 00 */	cmpwi r5, 0
/* 800ACA10 000A9950  41 82 00 14 */	beq lbl_800ACA24
/* 800ACA14 000A9954  48 00 00 24 */	b lbl_800ACA38
lbl_800ACA18:
...
/* 800ACA3C 000A997C  40 82 FF 94 */	bne lbl_800AC9D0
...
/* 800ACAB8 000A99F8  40 82 00 0C */	bne lbl_800ACAC4
...
/* 800ACAEC 000A9A2C  41 82 00 14 */	beq lbl_800ACB00
...
/* 800ACAFC 000A9A3C  48 00 00 0C */	b lbl_800ACB08
lbl_800ACB00:
...
/* 800ACB3C 000A9A7C  41 82 01 04 */	beq lbl_800ACC40
/* 800ACB40 000A9A80  40 80 00 10 */	bge lbl_800ACB50
/* 800ACB44 000A9A84  2C 00 00 00 */	cmpwi r0, 0
/* 800ACB48 000A9A88  40 80 00 14 */	bge lbl_800ACB5C
/* 800ACB4C 000A9A8C  48 00 01 94 */	b lbl_800ACCE0
lbl_800ACB50:
/* 800ACB50 000A9A90  2C 00 00 7F */	cmpwi r0, 0x7f
/* 800ACB54 000A9A94  41 82 01 80 */	beq lbl_800ACCD4
/* 800ACB58 000A9A98  48 00 01 88 */	b lbl_800ACCE0
lbl_800ACB5C:
/* 800ACB5C 000A9A9C  54 1F 07 FE */	clrlwi r31, r0, 0x1f
/* 800ACB60 000A9AA0  3B 40 00 00 */	li r26, 0
/* 800ACB64 000A9AA4  48 00 00 CC */	b lbl_800ACC30
lbl_800ACB68:
...
/* 800ACB78 000A9AB8  41 82 00 B4 */	beq lbl_800ACC2C
...
/* 800ACC38 000A9B78  41 80 FF 30 */	blt lbl_800ACB68
/* 800ACC3C 000A9B7C  48 00 00 A4 */	b lbl_800ACCE0
lbl_800ACC40:
...
/* 800ACCB8 000A9BF8  41 82 00 0C */	beq lbl_800ACCC4
/* 800ACCBC 000A9BFC  C0 22 8B B0 */	lfs f1, lbl_80516F10@sda21(r2)
/* 800ACCC0 000A9C00  48 00 00 0C */	b lbl_800ACCCC
lbl_800ACCC4:
...
/* 800ACCD0 000A9C10  48 00 00 10 */	b lbl_800ACCE0
lbl_800ACCD4:
...
/* 800ACD10 000A9C50  41 82 00 D4 */	beq lbl_800ACDE4
...
/* 800ACD24 000A9C64  41 82 00 48 */	beq lbl_800ACD6C
...
/* 800ACD70 000A9CB0  41 82 00 48 */	beq lbl_800ACDB8
...
/* 800ACDBC 000A9CFC  41 82 00 28 */	beq lbl_800ACDE4
...
/* 800ACE10 000A9D50  41 82 00 28 */	beq lbl_800ACE38
...
/* 800ACE24 000A9D64  41 82 00 0C */	beq lbl_800ACE30
...
/* 800ACE34 000A9D74  48 00 00 28 */	b lbl_800ACE5C
lbl_800ACE38:
...
/* 800ACE4C 000A9D8C  41 82 00 0C */	beq lbl_800ACE58
...
/* 800ACE80 000A9DC0  41 82 00 28 */	beq lbl_800ACEA8
...
/* 800ACE94 000A9DD4  41 82 00 0C */	beq lbl_800ACEA0
...
/* 800ACEA4 000A9DE4  48 00 00 28 */	b lbl_800ACECC
lbl_800ACEA8:
...
/* 800ACEBC 000A9DFC  41 82 00 0C */	beq lbl_800ACEC8
...
/* 800ACEF0 000A9E30  41 82 00 28 */	beq lbl_800ACF18
...
/* 800ACF04 000A9E44  41 82 00 0C */	beq lbl_800ACF10
...
/* 800ACF14 000A9E54  48 00 00 28 */	b lbl_800ACF3C
lbl_800ACF18:
...
/* 800ACF2C 000A9E6C  41 82 00 0C */	beq lbl_800ACF38
...
/* 800ACF68 000A9EA8  40 82 00 AC */	bne lbl_800AD014
/* 800ACF6C 000A9EAC  28 1F 00 05 */	cmplwi r31, 5
/* 800ACF70 000A9EB0  40 80 00 08 */	bge lbl_800ACF78
...
/* 800AD030 000A9F70  41 82 00 1C */	beq lbl_800AD04C
/* 800AD034 000A9F74  40 80 00 20 */	bge lbl_800AD054
/* 800AD038 000A9F78  2C 00 00 01 */	cmpwi r0, 1
/* 800AD03C 000A9F7C  40 80 00 08 */	bge lbl_800AD044
/* 800AD040 000A9F80  48 00 00 14 */	b lbl_800AD054
lbl_800AD044:
...
/* 800AD07C 000A9FBC  40 82 00 24 */	bne lbl_800AD0A0
...
/* 800AD0CC 000AA00C  40 82 00 08 */	bne lbl_800AD0D4
...
/* 800AD0FC 000AA03C  41 82 00 24 */	beq lbl_800AD120
...
/* 800AD12C 000AA06C  41 80 FF C0 */	blt lbl_800AD0EC
...
/* 800AD13C 000AA07C  41 82 00 18 */	beq lbl_800AD154
...
/* 800AD180 000AA0C0  40 80 00 08 */	bge lbl_800AD188
...
/* 800AD1A0 000AA0E0  40 80 00 08 */	bge lbl_800AD1A8
