...
CallBack_CounterDay* setCallBack_CounterDay(P2DScreen::Mgr*, u64, u64, u64,
                                            u32*, u16, JKRArchive*);
CallBack_CounterDay* setCallBack_CounterDay(char**, P2DScreen::Mgr*, u64, u64,
                                            u64, u32*, u16, JKRArchive*);
void setCallBack_CounterMap(P2DScreen::Mgr*, u64, u64, u64, u32*, u16, u16,
                            bool, JKRArchive*);
CallBack_CounterRV* setCallBack_CounterRV(P2DScreen::Mgr*, u64, u64, u64, u32*,
                                          u16, u16, bool, JKRArchive*);
CallBack_CounterRV* setCallBack_CounterRV(P2DScreen::Mgr*, u64, u32*, u16, bool,
                                          bool, JKRArchive*);
CallBack_CounterRV* setCallBack_CounterRV(P2DScreen::Mgr*, u64, u32, u16, bool,
                                          bool, JKRArchive*);
void setCallBack_CounterRV2(P2DScreen::Mgr*, u64, u32*, u16, bool, bool,
                            JKRArchive*);
CallBack_CounterSlot* setCallBack_CounterSlot(P2DScreen::Mgr*, u64, u32*, u16,
...
CallBack_Picture* setCallBack_Picture(JKRArchive*, char*, u64, P2DScreen::Mgr*,
                                      u64);
