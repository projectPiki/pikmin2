...
struct WaveScene : public JKRDisposer {
	...
	enum WaveSceneID {
		...
		WSCENE7_unk               = 7,  // wScene_7.aw
		WSCENE8_unk               = 8,  // wScene_8.aw
		WSCENE9_unk               = 9,  // wScene_9.aw
		WSCENE10_CaveMetal_00     = 10, // wScene_10.aw (cavemetal_00_X.cnd)
		WSCENE11_unk              = 11, // wScene_11.aw
		WSCENE12_unk              = 12, // wScene_12.aw
		WSCENE13_ChallengeResult  = 13, // wScene_13.aw (unused c_result.bms)
		WSCENE14_unk              = 14, // wScene_14.aw
		...
		WSCENE27_unk              = 27, // wScene_27.aw (unused boss theme?)
