...
struct CollPart : public CNode {
	...
	float m_radius;               // _1C
	Vector3f m_position;          // _20
	u32 m_jointIndex;             // _2C
	ID32 m_currentID;             // _30, identifier of current part, initialised to root
	ID32 m_isStickableID;         // _3C, used to detect whether the collpart is stickable, denoted by prefixed -s: e.g. 'sp01'
	u16 m_attribute;              // _48
...
struct MouthCollPart : public CollPart {
	...
	CollPart* _64;                 // _64
	SysShape::Joint* m_mouthJoint; // _68, joint the collpart is attached to
	u8 _6C;                        // _6C
};
