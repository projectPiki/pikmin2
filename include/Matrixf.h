...
struct Matrixf {
	...
	{
		mMatrix.mtxView[0][3]
		    = -(position.x * mMatrix.mtxView[0][0] + position.y * mMatrix.mtxView[0][1] + position.z * mMatrix.mtxView[0][2]);
		mMatrix.mtxView[1][3]
		    = -(position.x * mMatrix.mtxView[1][0] + position.y * mMatrix.mtxView[1][1] + position.z * mMatrix.mtxView[1][2]);
		mMatrix.mtxView[2][3]
		    = -(position.x * mMatrix.mtxView[2][0] + position.y * mMatrix.mtxView[2][1] + position.z * mMatrix.mtxView[2][2]);
	}
