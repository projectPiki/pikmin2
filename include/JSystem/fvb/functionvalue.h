...
// This file is basically untouched from the TP decomp so far
...
public:
    ...
    void composite_parameter(TVector_pointer<TFunctionValue*> const&, TData const&,
                                            f64);
    void composite_add(TVector_pointer<JStudio::TFunctionValue*> const&,
                                      TData const&, f64);
    void composite_subtract(TVector_pointer<TFunctionValue*> const&, TData const&,
                                           f64);
    void composite_multiply(TVector_pointer<TFunctionValue*> const&, TData const&,
                                           f64);
