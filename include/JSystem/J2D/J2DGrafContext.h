...
// TODO: These matrix members wouldn't actually be Matrixf, because this is in a separate library.
struct J2DGrafContext {
	...
	float _38;            // _38
	float _3C;            // _3C
	PSMatrix _40;          // _40 /* Might actually be larger than Matrixf. See C_MTXPerspective, called by J2DPerspGraph::setPort */
	u8 _70[0x10];         // _70
	PSMatrix _80;          // _80
	u8 _B0;               // _B0
	u8 _B1;               // _B1
