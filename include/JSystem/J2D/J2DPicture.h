...
struct J2DPicture : public J2DPane {
	...
	virtual int remove(u8 id);                                                                                                // _D8
	virtual int remove() { return remove(mTextureCount - 1); }                                                                // _DC (weak)
	virtual int remove(JUTTexture* texture);                                                                                  // _E0
...
struct J2DPictureEx : public J2DPicture {
	...
	virtual void drawFullSet(f32, f32, f32, f32, Mtx*);                                          // _140
	virtual void drawTexCoord(f32, f32, f32, f32, s16, s16, s16, s16, s16, s16, s16, s16, Mtx*); // _144
