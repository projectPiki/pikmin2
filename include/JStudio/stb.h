...
namespace stb {
	...
	*/
	struct TObject {
		...
		virtual void do_paragraph(unsigned long, void const*,
		                          unsigned long); //_14
		...
		void process_paragraph_reserved_(unsigned long, void const*,
		                                 unsigned long);

		int* _00; // this through 10 are for something called object::TObject_ID
