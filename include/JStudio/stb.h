...
struct TObject {
    ...
    virtual void do_data(void const *, unsigned long, void const *, unsigned long);     //_1c
    ...
    int* _00;//this through 10 are for something called object::TObject_ID in TP that doesnt exist here
    int _04;
    int _08;
    int _0C;
    int _10;
