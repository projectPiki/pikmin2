...
struct EnemyParmsBase : public CreatureParms {
	struct Parms : public Parameters {
		Parms()
		    ...
		    , m_fp20(this, 'fp20', "攻撃可能範囲", 70.0f, 0.0f, 1000.0f)                        // attack range - SHIFT-JIS IS WRONG
		    , m_fp21(this, 'fp21', "攻撃可能角度", 15.0f, 0.0f, 180.0f)    // 'possible attack angle' - SHIFT-JIS IS WRONG
