...
struct Parms : public EnemyParmsBase {
	struct ProperParms : Parameters {
		ProperParms()
		    ...
		    , mMinAppearTime(this, 'fp01', "èoåªéûä‘(Min)", 15.0f, 0.0f, 100.0f) // 'appearance time (Min)'
		    , mMaxAppearTime(this, 'fp02', "èoåªéûä‘(Max)", 30.0f, 0.0f, 100.0f) // 'appearance time (Max)'
		    , mMinTravelTime(this, 'fp10', "à⁄ìÆéûä‘(Min)", 0.5f, 0.0f, 10.0f)   // 'travel time (Min)'
		    , mMaxTravelTime(this, 'fp11', "à⁄ìÆéûä‘(Max)", 2.0f, 0.0f, 10.0f)   // 'travel time (Max)'
		    , mMinStopTime(this, 'fp20', "í‚é~éûä‘(Min)", 0.5f, 0.0f, 10.0f)     // 'stop time (Min)'
		    , mMaxStopTime(this, 'fp21', "í‚é~éûä‘(Max)", 2.0f, 0.0f, 10.0f)     // 'stop time (Max)'
		    , mTurnAngle(this, 'fp30', "å¸Ç´ïœÇ¶äpìx", 45.0f, 0.0f, 90.0f)       // 'turning angle'
		    , mScale(this, 'fp40', "ÉXÉPÅ[Éã", 0.8f, 0.0f, 5.0f)                 // 'scale'
		{
		}
