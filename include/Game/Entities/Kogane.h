...
struct Parms : public EnemyParmsBase {
	struct ProperParms : Parameters {
		ProperParms()
		    ...
		    , mFp01(this, 'fp01', "èoåªéûä‘(Min)", 15.0f, 0.0f, 100.0f)
		    , mFp02(this, 'fp02', "èoåªéûä‘(Max)", 30.0f, 0.0f, 100.0f)
		    , mFp10(this, 'fp10', "à⁄ìÆéûä‘(Min)", 0.5f, 0.0f, 10.0f)
		    , mFp11(this, 'fp11', "à⁄ìÆéûä‘(Max)", 2.0f, 0.0f, 10.0f)
		    , mFp20(this, 'fp20', "í‚é~éûä‘(Min)", 0.5f, 0.0f, 10.0f)
		    , mFp21(this, 'fp21', "í‚é~éûä‘(Max)", 2.0f, 0.0f, 10.0f)
		    , mFp30(this, 'fp30', "å¸Ç´ïœÇ¶äpìx", 45.0f, 0.0f, 90.0f)
		    , mFp40(this, 'fp40', "ÉXÉPÅ[Éã", 0.8f, 0.0f, 5.0f)
		{
		}
