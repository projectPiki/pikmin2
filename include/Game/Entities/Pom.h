...
struct Parms : public EnemyParmsBase {
	struct ProperParms : public Parameters {
		inline ProperParms()
		    ...
		    , mNormalMaxSlots(this, 'ip01', "ãzÇ¢çûÇ›ÉsÉLêî(pom)", 5, 1, 50)           // 'sucking piki number (pom)'
		    , mQueenMaxSlots(this, 'ip11', "ãzÇ¢çûÇ›ÉsÉLêî(pop)", 1, 1, 50)            // 'sucking piki number (pop)'
		    , mQueenShotMultiplier(this, 'ip13', "ìfÇ´èoÇµî{êî(pop)", 5, 1, 50)        // 'spitting multiple (pop)'
		    , mRemainOpenTime(this, 'fp01', "äJâ‘éûä‘", 30.0f, 0.0f, 60.0f)            // 'flowering time'
		    , mColorChangeTime(this, 'fp02', "êFä∑Ç¶éûä‘", 1.25f, 0.0f, 60.0f)         // 'color change time'
		    , mBlackWhiteAppearanceRate(this, 'fp03', "îíçïèoåªó¶", 0.15f, 0.0f, 1.0f) // 'black and white appearance rate'
		{
		}
