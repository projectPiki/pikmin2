...
struct Parms : public EnemyParmsBase {
	struct ProperParms : public Parameters {
		inline ProperParms()
		    ...
		    , mPoisonDamage(this, 'fp01', "îíÉsÉNÉ~Éì", 300.0f, 0.0f, 10000.0f)          // eat white pikmin damage
		    , mHealthGaugeTimer(this, 'fp11', "éÄñS Å` ÉQÅ[ÉWèoåª", 30.0f, 1.0f, 500.0f) // 'death ~ gauge appears`
		    , mRespawnRate(this, 'fp12', "ÉQÅ[ÉWèoåª Å` ïúäà", 10.0f, 1.0f, 500.0f)      // 'gauge appears ~ revival'
		{
		}
