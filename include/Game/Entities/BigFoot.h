...
struct Parms : public EnemyParmsBase {
	struct ProperParms : public Parameters {
		inline ProperParms()
		    ...
		    , m_minDecelFactor(this, 'fp04', "ç≈í·å∏â¡ë¨åWêî", -2.5f, -10.0f, 10.0f)    // 'minimum deceleration acceleration factor'
		    , m_maxDecelFactor(this, 'fp05', "ç≈çÇå∏â¡ë¨åWêî", 10.0f, -10.0f, 10.0f)    // 'maximum deceleration acceleration factor'
