...
struct Obj : public KochappyBase::Obj {
    ...
    virtual EnemyTypeID::EEnemyTypeID getEnemyTypeID() { return EnemyTypeID::EEnemyTypeID::EnemyID_Catfish; } // _250
	...
	virtual void setEnemyNonStone() { m_events[0].typeView |= ENEMY_EVENT_STONE; } // _2FC
