...
struct StateCharge : public State {
	inline StateCharge() : State(ELECBUG_Charge, "charge") {} 
...
struct StateChildCharge : public State {
	inline StateChildCharge() : State(ELECBUG_ChildCharge, "childcharge") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateChildDischarge : public State {
	inline StateChildDischarge() : State(ELECBUG_ChildDischarge, "childdischarge") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateDead : public State {
	inline StateDead() : State(ELECBUG_Dead, "dead") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateDischarge : public State {
	inline StateDischarge() : State(ELECBUG_Discharge, "discharge") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateMove : public State {
	inline StateMove() : State(ELECBUG_Move, "move") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateReturn : public State {
	inline StateReturn() : State(ELECBUG_Return, "return") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateReverse : public State {
	inline StateReverse() : State(ELECBUG_Reverse, "reverse") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateTurn : public State {
	inline StateTurn() : State(ELECBUG_Turn, "turn") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
...
struct StateWait : public State {
	inline StateWait() : State(ELECBUG_Wait, "wait") {} 
	virtual void init(EnemyBase*, StateArg*); // _08
	virtual void exec(EnemyBase*);            // _0C
	virtual void cleanup(EnemyBase*);         // _10
