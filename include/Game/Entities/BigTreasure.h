...
struct Parms : public EnemyParmsBase {
	struct ProperParms : public Parameters {
		ProperParms()
		    ...
		    , mBaseFactor(this, 'fp01', "ÉxÅ[ÉXåWêî", 3.0f, 0.0f, 10.0f)                   // 'base factor'
		    , mRaiseDecelFactor(this, 'fp02', "è„Ç∞å∏ë¨åWêî", -0.2f, -5.0f, 5.0f)          // 'raising deceleration factor'
		    , mDownwardDecelFactor(this, 'fp03', "â∫Ç∞â¡ë¨åWêî", 0.5f, -5.0f, 5.0f)        // 'downward acceleration factor'
		    , mMinReducedAccelFactor(this, 'fp04', "ç≈í·å∏â¡ë¨åWêî", -2.0f, -10.0f, 10.0f) // 'min reduced acceleration factor'
		    , mMaxDecelAccelFactor(this, 'fp05', "ç≈çÇå∏â¡ë¨åWêî", 10.0f, -10.0f, 10.0f)   // 'max deceleration acceleration factor'
		    , mLegSwing(this, 'fp06', "ë´ÇÃêUÇËè„Ç∞", 120.0f, 0.0f, 200.0f)                // 'leg swing'
		    , mElectricityWaitTime(this, 'fp10', "ó\\îıéûä‘(ìdãC)", 2.5f, 0.0f, 10.0f)     // 'wait time (electricity)'
		    , mFireWaitTime1(this, 'fp11', "ó\\îıéûä‘(âŒ:1)", 2.8f, 0.0f, 10.0f)           // 'wait time (fire:1)'
		    , mFireWaitTime2(this, 'fp31', "ó\\îıéûä‘(âŒ:2)", 2.5f, 0.0f, 10.0f)           // 'wait time (fire:2)'
		    , mGasWaitTime(this, 'fp12', "ó\\îıéûä‘(ÉKÉX)", 2.5f, 0.0f, 10.0f)             // 'wait time (gas)'
		    , mWaterWaitTime(this, 'fp13', "ó\\îıéûä‘(êÖ)", 2.5f, 0.0f, 10.0f)             // 'wait time (water)'
		    ...
		    , mPatternCheckFlame(this, 'fe99', "ÉpÉ^Å[ÉìÉ`ÉFÉbÉN", 0, 0, 4)    // 'pattern check'
		    , mFlameScale1(this, 'ff00', "âŒâäÉXÉPÅ[Éã(1)", 1.0f, 0.5f, 5.0f)  // 'flame scale (1)'
		    , mFlameScale2(this, 'ff10', "âŒâäÉXÉPÅ[Éã(2)", 1.25f, 0.5f, 5.0f) // 'flame scale (2)'

		    , mPatternCheckRotation(this, 'fg99', "ÉpÉ^Å[ÉìÉ`ÉFÉbÉN", 0, 0, 2)       // 'pattern check'
		    , mRotationSpeed1(this, 'fg00', "âÒì]ÉXÉsÅ[Éh(1)", 0.015f, 0.01f, 0.03f) // 'rotation speed (1)'
		    , mRotationSpeed2(this, 'fg10', "âÒì]ÉXÉsÅ[Éh(2)", 0.02f, 0.01f, 0.03f)  // 'rotation speed (2)'
		    , mReversalTime2_1(this, 'fg30', "îΩì]éûä‘(2-1)", 30.0f, 0.0f, 30.0f)    // 'reversal time (2-1)'
		    , mReversalTime2_2(this, 'fg40', "îΩì]éûä‘(2-2)", 2.0f, 0.0f, 30.0f)     // 'reversal time (2-2)'

		    , mPatternCheckWater(this, 'fg99', "ÉpÉ^Å[ÉìÉ`ÉFÉbÉN", 0, 0, 3)            // 'pattern check'
		    , mWaterDischargeInterval1(this, 'fw00', "ï˙êÖä‘äu(1)", 0.5f, 0.1f, 1.0f)  // 'water discharge interval (1)'
		    , mRandomAngle1(this, 'fw01', "ÉâÉìÉ_ÉÄäpìx(1)", 0.5f, 0.0f, 1.0f)         // 'random angle (1)'
		    , mRandomDistance1(this, 'fw02', "ÉâÉìÉ_ÉÄãóó£(1)", 100.0f, 0.0f, 500.0f)  // 'random distance (1)'
		    , mWaterDischargeInterval2(this, 'fw10', "ï˙êÖä‘äu(2)", 0.25f, 0.1f, 1.0f) // 'water discharge interval (2)
		    , mRandomAngle2(this, 'fw11', "ÉâÉìÉ_ÉÄäpìx(2)", 0.4f, 0.0f, 1.0f)         // 'random angle (2)'
		    , mRandomDistance2(this, 'fw12', "ÉâÉìÉ_ÉÄãóó£(2)", 50.0f, 0.0f, 500.0f)   // 'random distance (2)'
		    , mPatternCheck4(this, 'fw99', "ÉpÉ^Å[ÉìÉ`ÉFÉbÉN", 0, 0, 2)                // 'pattern check'
		{
		}
