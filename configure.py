...
LIBS = [
    ...
    },
    {
        ...
        "host": True,
        "objects": [
            "JSystem/JAudio2/JAS/JASWSParser",
            "JSystem/JAudio2/JAS/JASBankMgr",
            ["JSystem/JAudio2/JAS/JASBasicBank", True],
            ["JSystem/JAudio2/JAS/JASBasicInst", True],
            "JSystem/JAudio2/JAS/JASBasicWaveBank",
            "JSystem/JAudio2/JAS/JASBNKParser",
            "JSystem/JAudio2/JAS/JASDrumSet",
            ["JSystem/JAudio2/JAS/JASInstEffect", True],
            "JSystem/JAudio2/JAS/JASInstRand",
            "JSystem/JAudio2/JAS/JASInstSense",
            ["JSystem/JAudio2/JAS/JASSimpleWaveBank", True],
            ["JSystem/JAudio2/JAS/JASWaveArcLoader", True],
            ["JSystem/JAudio2/JAS/JASWaveBank", True],
            ["JSystem/JAudio2/JAS/JASWaveBankMgr", True],
            ["JSystem/JAudio2/JAS/JASBank", True],
            ["JSystem/JAudio2/JAS/JASTrackPort", True],
            ["JSystem/JAudio2/JAS/JASOuterParam", True],
            "JSystem/JAudio2/JAS/JASPlayer_impl",
            "JSystem/JAudio2/JAS/JASRegisterParam",
            "JSystem/JAudio2/JAS/JASSeqCtrl",
            "JSystem/JAudio2/JAS/JASSeqParser",
            "JSystem/JAudio2/JAS/JASTrack",
            "JSystem/JAudio2/JAS/JASTrackInterrupt",
            "JSystem/JAudio2/JAS/JASOscillator",
            "JSystem/JAudio2/JAS/JASChannel",
            "JSystem/JAudio2/JAS/JASDriverIF",
            "JSystem/JAudio2/JAS/JASDSPChannel",
            "JSystem/JAudio2/JAS/JASDSPInterface",
            "JSystem/JAudio2/JAS/JASAudioThread",
            "JSystem/JAudio2/JAS/JASCalc",
            ["JSystem/JAudio2/JAS/JASCallback", True],
            "JSystem/JAudio2/JAS/JASCmdStack",
            ["JSystem/JAudio2/JAS/JASDvdThread", True],
            ...
            "JSystem/JAudio2/JAS/JASAramStream",
        ],
    },
    {
        "lib": "JAudio2_DSP",
        "cflags": "$cflags_pikmin -func_align 32 -inline noauto -common off -use_lmw_stmw off",
        "mw_version": "2.6",
        "host": True,
        "objects": [
    ...
    },
    {
        ...
        "host": True,
        "objects": [
            "JSystem/JAudio2/JAI/JAIAnimation",
            "JSystem/JAudio2/JAI/JAIBankWave",
            "JSystem/JAudio2/JAI/JAIBasic",
            ["JSystem/JAudio2/JAI/JAIConst", True],
            "JSystem/JAudio2/JAI/JAIDummyObject",
            "JSystem/JAudio2/JAI/JAIFx",
            ["JSystem/JAudio2/JAI/JAIGlobalParameter", True],
            "JSystem/JAudio2/JAI/JAIInitData",
            "JSystem/JAudio2/JAI/JAISeMgr",
            "JSystem/JAudio2/JAI/JAISequenceHeap",
            "JSystem/JAudio2/JAI/JAISequenceMgr",
            "JSystem/JAudio2/JAI/JAISound",
            "JSystem/JAudio2/JAI/JAISoundTable",
            "JSystem/JAudio2/JAI/JAIStreamMgr",
            "JSystem/JAudio2/JAI/JAISystemInterface",
            "JSystem/JAudio2/JAI/JAIObject",
        ],
    },
    {
        "lib": "JAudio2_JAD",
        ...
        "host": True,
        "objects": [
            ["JSystem/JAudio2/JAD/JADHioNode", True],
        ],
    },
    {
        "lib": "JAudio2_JAL",
    ...
    },
    {
        ...
        "host": True,
        "objects": [
            "JSystem/JAudio2/JAU/JAUData",
            "JSystem/JAudio2/JAU/JAUDataMgr",
        ],
    },
    {
        ...
        "objects": [
            ...
            ["Dolphin/TRK_MINNOW_DOLPHIN/targsupp", True],
