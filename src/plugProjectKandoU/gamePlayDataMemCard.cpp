...
void PlayData::LimitGen::write(Stream&)
{
	...
	stwu     r1, -0x10(r1)
	mflr     r0
	lis      r5, lbl_80482B00@ha
	stw      r0, 0x14(r1)
	stw      r31, 0xc(r1)
	mr       r31, r4
	addi     r4, r5, lbl_80482B00@l
	stw      r30, 8(r1)
	mr       r30, r3
	mr       r3, r31
	bl       textBeginGroup__6StreamFPc
...
void PelletCropMemory::read(Stream&)
{
	...
	cmpw     r6, r7
	beq      lbl_8021DE50
	lis      r3, lbl_804829BC@ha
	lis      r4, lbl_80482B24@ha
	addi     r5, r4, lbl_80482B24@l
	addi     r3, r3, lbl_804829BC@l
	li       r4, 0x31a
	crclr    6
	bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_8021DF7C:
	...
	cmplwi   r30, 2
	blt      lbl_8021DF7C
	lis      r4, lbl_80482B8C@ha
	mr       r3, r29
	addi     r4, r4, lbl_80482B8C@l
	crclr    6
	bl       textWriteText__6StreamFPce
	lwz      r0, 0x24(r1)
	lwz      r31, 0x1c(r1)
