 ...
 * Size:	000154
 */
void BaseFlockMgr::getNearestFlock(Vector3f&)
{
	/*
	stwu     r1, -0x30(r1)
	mflr     r0
 ...
 * Size:	00011C
 */
int BaseFlockMgr::attackFlock(int p1, f32 p2)
{
	P2ASSERTBOUNDSLINE(93, 0, p1, getMaxObjects());
	TFlock* flock = getFlock(p1);
	if (isFlagAlive(p1)) {
		if (flock->damaged(p2)) {
			killFlock(flock);
			return 1;
 ...
 * Size:	000294
 */
void BaseFlockMgr::resolveCollision(f32)
{
	/*
	stwu     r1, -0x40(r1)
	mflr     r0
