 ...
 * Size:	000034
 */
void ItemHoney::FallState::onBounce(Game::CFSMItem* item, Sys::Triangle* tri) { transit(item, HONEYSTATE_Bounce, nullptr); }
 ...
 * Size:	0001C4
 */
void ItemHoney::BounceState::init(Game::CFSMItem* item, Game::StateArg* arg)
{
 ...
 * Size:	000034
 */
void ItemHoney::BounceState::onKeyEvent(Game::CFSMItem* item, const SysShape::KeyEvent& keyEvent)
{
	transit(item, HONEYSTATE_Wait, nullptr);
}
 ...
 * Size:	000038
 */
void ItemHoney::WaitState::init(Game::CFSMItem* item, Game::StateArg* arg) { item->mAnimator.startAnim(4, item); }
 ...
 * Size:	000038
 */
bool ItemHoney::WaitState::interactAbsorb(Game::CFSMItem* item, Game::InteractAbsorb& interaction)
{
	transit(item, HONEYSTATE_Shrink, nullptr);
	return true;
}
 ...
 * Size:	000038
 */
void ItemHoney::ShrinkState::init(Game::CFSMItem* item, Game::StateArg* arg) { item->mAnimator.startAnim(6, item); }
 ...
 * Size:	00004C
 */
void ItemHoney::TouchState::init(Game::CFSMItem* item, Game::StateArg* arg)
{
 ...
 * Size:	000038
 */
bool ItemHoney::TouchState::interactAbsorb(Game::CFSMItem* item, Game::InteractAbsorb& interaction)
{
	transit(item, HONEYSTATE_Shrink, nullptr);
	return true;
}
 ...
 * Size:	000034
 */
void ItemHoney::TouchState::onKeyEvent(Game::CFSMItem* item, const SysShape::KeyEvent& keyEvent)
{
	transit(item, HONEYSTATE_Wait, nullptr);
}
 ...
 * Size:	000080
 */
void ItemHoney::TouchState::collisionCallback(Game::CFSMItem* item, Game::CollEvent& collEvent)
{
	Creature* other = collEvent.mCollidingCreature;
	if (_10 == false && other->isNavi()) {
		_10 = true;
 ...
 * Size:	000038
 */
void ItemHoney::DemoState::init(Game::CFSMItem* item, Game::StateArg* arg) { item->mAnimator.startAnim(5, item); }
 ...
 * Size:	000038
 */
void ItemHoney::DemoState::onKeyEvent(Game::CFSMItem* item, const SysShape::KeyEvent& keyEvent) { item->mAnimator.startAnim(5, item); }
 ...
 * Size:	00003C
 */
bool ItemHoney::Item::demoOK()
{
	int stateID = getStateID();
	bool result = false;
	if (stateID == HONEYSTATE_Wait || stateID == HONEYSTATE_Touch) {
		result = true;
	}
	return result;
}
 ...
 * Size:	000058
 */
CItemFSM* ItemHoney::Item::createFSM() { return new FSM(); }
 ...
 * Size:	000008
 */
f32 ItemHoney::Item::getMapCollisionRadius()
{
	return 7.5f;
	/*
 ...
 * Size:	000094
 */
void ItemHoney::Item::doSimulation(f32 rate)
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	000054
 */
bool ItemHoney::Item::absorbable()
{
 ...
 * Size:	000008
 */
bool ItemHoney::State::absorbable() { return false; }
 ...
 * Size:	000060
 */
void ItemHoney::Item::onKeyEvent(const SysShape::KeyEvent& keyEvent)
{
	if (getCurrState() != nullptr) {
 ...
 * Size:	000060
 */
void ItemHoney::Item::collisionCallback(Game::CollEvent& collEvent)
{
	if (getCurrState() != nullptr) {
 ...
 * Size:	000068
 */
bool ItemHoney::Item::interactAbsorb(Game::InteractAbsorb& interaction)
{
	if (getCurrState() != nullptr) {
 ...
 * Size:	000008
 */
bool ItemHoney::State::interactAbsorb(Game::CFSMItem*, Game::InteractAbsorb&) { return false; }
 ...
 * Size:	000004
 */
void ItemHoney::Item::doDirectDraw(Graphics& gfx) { }
 ...
 * Size:	00003C
 */
void ItemHoney::Item::onStartCapture() { mStateMachine->start(this, HONEYSTATE_Fall, nullptr); }
 ...
 * Size:	000054
 */
void ItemHoney::Item::onUpdateCapture(Matrixf& mtx)
{
 ...
 * Size:	000028
 */
void ItemHoney::Item::onEndCapture() { setPosition(mPosition, false); }
 ...
 * Size:	00002C
 */
void ItemHoney::Item::on_movie_end(bool shouldResetAnims) { mAnimator.startAnim(4, nullptr); }
 ...
 * Size:	00002C
 */
bool ItemHoney::Item::isShrinking() { return getStateID() == HONEYSTATE_Shrink; }
 ...
 * Size:	000070
 */
void ItemHoney::Mgr::onCreateModel(SysShape::Model* model)
{
 ...
 * Size:	00002C
 */
ItemHoney::Item* ItemHoney::Mgr::birth() { return mMonoObjectMgr.birth(); }
 ...
 * Size:	000060
 */
ItemHoney::Item* ItemHoney::Mgr::generatorBirth(Vector3f& pos, Vector3f& rot, Game::GenItemParm* genParm)
{
	Item* item = birth();
	item->init(nullptr);
 ...
 * Size:	00000C
 */
u32 ItemHoney::Mgr::generatorGetID() { return 'mitu'; }
 ...
 * Size:	000008
 */
char* ItemHoney::Item::getCreatureName()
{
	return "Honey";
	/*
 ...
 * Size:	000008
 */
bool ItemHoney::TouchState::absorbable() { return true; }
 ...
 * Size:	000008
 */
bool ItemHoney::ShrinkState::interactAbsorb(Game::CFSMItem*, Game::InteractAbsorb&) { return true; }
 ...
 * Size:	000008
 */
bool ItemHoney::ShrinkState::absorbable() { return true; }
 ...
 * Size:	000008
 */
bool ItemHoney::WaitState::absorbable() { return true; }
