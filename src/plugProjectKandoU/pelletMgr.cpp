...
void Pellet::onInit(CreatureInitArg* initArg)
{
	...
	mRigid._175.unset(0x01);
	mRigid._175.unset(0x80);
...
{
	if (mCarryInfoList) {
		mCarryInfoList->mParam.mCarryInfo.disappear(); // something's off in the CarryInfoList tree
		mCarryInfoList = nullptr;
	}
}
...
void PelletMgr::OtakaraItemCode::write(Stream& stream)
{
	...
	stream.textWriteText(
	    "# "
	    "??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽ??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽ??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽ??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽA??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽC??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽe?"
	    "?ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽ??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽ??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽR??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽ[??ｿｽ?ｽｽ?ｽｿ?ｿｽ?ｽｽ?ｽｽh\r\n");
}
 ...
 */
// WEAK - in header
// void BasePelletMgr::doSimulation(f32) { }
 ...
 * Size:	000090
 */
void MonoObjectMgr<CollPart>::doSimulation(f32)
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	0001F4
 */
void ObjectMgr<GenericObjectMgr>::doSimulation(f32)
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	0001F4
 */
void ObjectMgr<CollPart>::doSimulation(f32)
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
