...
void ItemRock::FSM::init(Game::ItemRock::Item*)
{
	...
	stw      r31, 0xc(r1)
	mr       r31, r3
	bl       "create__Q24Game35StateMachine<Q34Game8ItemRock4Item>Fi"
	li       r3, 0x14
	bl       __nw__FUl
	or.      r4, r3, r3
	beq      lbl_801E0EEC
	lis      r3, "__vt__Q24Game31FSMState<Q34Game8ItemRock4Item>"@ha
	lis      r6, "__vt__Q24Game32ItemState<Q34Game8ItemRock4Item>"@ha
	addi     r0, r3, "__vt__Q24Game31FSMState<Q34Game8ItemRock4Item>"@l
	lis      r5, __vt__Q34Game8ItemRock5State@ha
	stw      r0, 0(r4)
	li       r7, 0
	lis      r3, __vt__Q34Game8ItemRock11NormalState@ha
	addi     r6, r6, "__vt__Q24Game32ItemState<Q34Game8ItemRock4Item>"@l
	stw      r7, 4(r4)
	addi     r5, r5, __vt__Q34Game8ItemRock5State@l
	addi     r0, r3, __vt__Q34Game8ItemRock11NormalState@l
	stw      r7, 8(r4)
	stw      r6, 0(r4)
	stw      r5, 0(r4)
	stw      r0, 0(r4)
...
"registerState__Q24Game35StateMachine<Q34Game8ItemRock4Item>FPQ24Game31FSMState<Q34Game8ItemRock4Item>"
	...
	stw      r0, 0(r4)
	li       r0, 1
	lis      r3, __vt__Q34Game8ItemRock9DownState@ha
	li       r7, 0
	stw      r0, 4(r4)
	addi     r6, r6, "__vt__Q24Game32ItemState<Q34Game8ItemRock4Item>"@l
	addi     r5, r5, __vt__Q34Game8ItemRock5State@l
	addi     r0, r3, __vt__Q34Game8ItemRock9DownState@l
	stw      r7, 8(r4)
	stw      r6, 0(r4)
	stw      r5, 0(r4)
	stw      r0, 0(r4)
...
"registerState__Q24Game35StateMachine<Q34Game8ItemRock4Item>FPQ24Game31FSMState<Q34Game8ItemRock4Item>"
	...
	stw      r0, 0(r4)
	li       r0, 2
	lis      r3, __vt__Q34Game8ItemRock7UpState@ha
	li       r7, 0
	stw      r0, 4(r4)
	addi     r6, r6, "__vt__Q24Game32ItemState<Q34Game8ItemRock4Item>"@l
	addi     r5, r5, __vt__Q34Game8ItemRock5State@l
	addi     r0, r3, __vt__Q34Game8ItemRock7UpState@l
	stw      r7, 8(r4)
	stw      r6, 0(r4)
	stw      r5, 0(r4)
	stw      r0, 0(r4)
...
void ItemRock::NormalState::init(Game::ItemRock::Item*, Game::StateArg*)
{
	...
	mr       r31, r3
	mr       r3, r4
	bl       startWaitMotion__Q34Game8ItemRock4ItemFv
	li       r0, 0
	stb      r0, 0x10(r31)
	stb      r0, 0x11(r31)
	lwz      r31, 0xc(r1)
...
void ItemRock::NormalState::onDamage(Game::ItemRock::Item*, float)
{
	...
	mr       r30, r3
	mr       r3, r31
	bl       startDamageMotion__Q34Game8ItemRock4ItemFv
	lfs      f1, 0x218(r31)
...
void ItemRock::DownState::init(Game::ItemRock::Item*, Game::StateArg*)
{
	...
	mr       r31, r4
	mr       r3, r31
	bl       startDownMotion__Q34Game8ItemRock4ItemFv
	mr       r3, r31
	li       r4, 0x383b
	lwz      r12, 0(r31)
	lwz      r12, 0x1c0(r12)
...
void ItemRock::UpState::init(Game::ItemRock::Item*, Game::StateArg*)
{
	...
	mr       r31, r4
	mr       r3, r31
	bl       startUpMotion__Q34Game8ItemRock4ItemFv
	lfs      f1, lbl_805198D8@sda21(r2)
	mr       r3, r31
	lfs      f0, lbl_805198C8@sda21(r2)
	li       r4, 0x383a
	stfs     f1, 0x1d4(r31)
...
lbl_801E1594:
	...
	lis      r3, __vt__Q23efx8TKouhai1@ha
	addi     r0, r3, __vt__Q23efx8TKouhai1@l
	stw      r0, 0(r30)
...
lbl_801E1608:
	...
	li       r5, 0xca
	bl       __ct__Q23efx9TForever2FUsUs
	lis      r3, __vt__Q23efx8TKouhai2@ha
	addi     r0, r3, __vt__Q23efx8TKouhai2@l
	stw      r0, 0(r30)
...
lbl_801E1634:
	...
	li       r5, 0xcc
	bl       __ct__Q23efx9TForever2FUsUs
	lis      r3, __vt__Q23efx8TKouhai3@ha
	addi     r0, r3, __vt__Q23efx8TKouhai3@l
	stw      r0, 0(r30)

lbl_801E1660:
	stw      r30, 0x1f8(r31)
	cmplwi   r31, 0
	lfs      f0, lbl_805198D8@sda21(r2)
	mr       r5, r31
	stfs     f0, 0x1d4(r31)
	lwz      r3, mgr__Q24Game8ItemRock@sda21(r13)
	lwz      r0, 0x20(r3)
...
lbl_801E1688:
	...
	mr       r3, r31
	li       r4, 3
	bl       createRock__Q34Game8ItemRock4ItemFi
...
void ItemRock::Item::onSetPosition()
{
	...
	stwu     r1, -0x10(r1)
	mflr     r0
	lfs      f1, lbl_805198DC@sda21(r2)
	stw      r0, 0x14(r1)
	lfs      f2, lbl_805198CC@sda21(r2)
	stw      r31, 0xc(r1)
	mr       r31, r3
	mr       r4, r31
	lwz      r3, farmMgr__Q24Game4Farm@sda21(r13)
	bl       addObstacle__Q34Game4Farm7FarmMgrFPQ24Game8Creatureff
	stw      r3, 0x1ec(r31)
	mr       r3, r31
	lwz      r12, 0(r31)
	lwz      r12, 0x210(r12)
	...
	bctrl
	mr       r3, r31
	bl       startLoopEffect__Q34Game8ItemRock4ItemFv
	lwz      r0, 0x14(r1)
	lwz      r31, 0xc(r1)
	mtlr     r0
	addi     r1, r1, 0x10
...
void ItemRock::Item::startFukuEffect(Vector3f&)
{
	...
	stwu     r1, -0x30(r1)
	mflr     r0
	lis      r6, __vt__Q23efx11TKouhaiFuku@ha
	...
	li       r8, 0xd0
	mr       r31, r3
	addi     r6, r6, __vt__Q23efx11TKouhaiFuku@l
	stw      r0, 0x18(r1)
	addi     r0, r5, __vt__Q23efx8TSimple2@l
...
void ItemRock::Item::doLoad(Stream&)
{
	...
	stfs     f1, 0x200(r30)
	lis      r4, 0x4330
	lfd      f2, lbl_805198D0@sda21(r2)
	lwz      r3, 0x21c(r30)
	lwz      r0, 0x220(r30)
	xoris    r3, r3, 0x8000
	stw      r4, 0x18(r1)
	xoris    r0, r0, 0x8000
	lfs      f3, lbl_805198CC@sda21(r2)
	stw      r3, 0x1c(r1)
	lwz      r3, 0x1ec(r30)
	lfd      f0, 0x18(r1)
	stw      r0, 0x24(r1)
	...
	fdivs    f0, f1, f0
	fsubs    f1, f3, f0
	bl       setPower__Q34Game4Farm8ObstacleFf
	mr       r3, r30
	bl       initMotion__Q34Game8ItemRock4ItemFv
	lwz      r3, 0x1f0(r30)
	lwz      r12, 0(r3)
	lwz      r12, 0xc(r12)
	mtctr    r12
