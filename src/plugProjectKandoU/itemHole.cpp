 ...
 * Size:	000030
 */
void Game::FSMState<Game::CFSMItem>::transit(Game::CFSMItem *, int, Game::StateArg *)
{
/*
.loc_0x0:
  stwu      r1, -0x10(r1)
 ...
 * Size:	000078
 */
void Game::StateMachine<Game::CFSMItem>::start(Game::CFSMItem *, int, Game::StateArg *)
{
/*
.loc_0x0:
  stwu      r1, -0x20(r1)
 ...
 * Size:	000054
 */
void Game::ItemHole::Mgr::generatorBirth(Vector3<float> &, Vector3<float> &, Game::GenItemParm *)
{
/*
.loc_0x0:
  stwu      r1, -0x10(r1)
 ...
 * Size:	0000AC
 */
void Game::StateMachine<Game::CFSMItem>::transit(Game::CFSMItem *, int, Game::StateArg *)
{
/*
.loc_0x0:
  stwu      r1, -0x20(r1)
 ...
 * Size:	000084
 */
void Game::StateMachine<Game::CFSMItem>::registerState(Game::FSMState<Game::CFSMItem> *)
{
/*
.loc_0x0:
  lwz       r6, 0x8(r3)
