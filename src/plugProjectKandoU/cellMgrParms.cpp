...
inline _CellParms::_CellParms(Parameters* p)
    : m_p000(p, 'p000', "バッファを使う", false, false, true)
    , m_p001(p, 'p001', "マジックナンバー", true, false, true)
...
inline CellMgrParms::CellMgrParms()
    ...
    , _CellParms(this)
// , _CellParms {
// 	.m_p000 = Parm<bool>(this, 0x70303030, "??ｿｽ?ｿｽo??ｿｽ?ｿｽb??ｿｽ?ｿｽt??ｿｽ?ｿｽ@??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽg??ｿｽ?ｿｽ??ｿｽ?ｿｽ",
// false, false, true), 	.m_p001 = Parm<bool>(this, 0x70303031,
// "??ｿｽ?ｿｽ}??ｿｽ?ｿｽW??ｿｽ?ｿｽb??ｿｽ?ｿｽN??ｿｽ?ｿｽi??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽo??ｿｽ?ｿｽ[", true, false, true), 	.m_p002 =
...
// 	}
// 	, JKRDisposer()
//     , Parm<bool>(this, 0x70303030, "??ｿｽ?ｿｽo??ｿｽ?ｿｽb??ｿｽ?ｿｽt??ｿｽ?ｿｽ@??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽg??ｿｽ?ｿｽ??ｿｽ?ｿｽ", false,
//     false, true) , Parm<bool>(this, 0x70303031,
//     "??ｿｽ?ｿｽ}??ｿｽ?ｿｽW??ｿｽ?ｿｽb??ｿｽ?ｿｽN??ｿｽ?ｿｽi??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽo??ｿｽ?ｿｽ[", true, false, true) ,
