...
void PikiHoleinState::exec(Piki* piki)
{
	...
	if (m_countdown > 0.0f) {
		m_countdown -= sys->m_secondsPerFrame;
		return;
	}
	...
	_2C += 80.0f * sys->m_secondsPerFrame;
	f32 val = _28 * 0.2f;
	if (_2C > val) {
...
void PikiFountainonState::exec(Piki* piki)
{
	...
	if (_2C >= p1) {
		...
		position   = _1C * p1 + _10;
		position.y += factor;
		_2C += sys->m_secondsPerFrame * 400.0f;

	} else {
		position = _1C * _2C + _10;
		position.y += otherFactor;
		_2C += sys->m_secondsPerFrame * 40.0f;
 ...
 * Size:	000038
 */
void PikiTaneState::exec(Piki* piki) { piki->applyAirDrag(sys->m_secondsPerFrame, _10, _14); }
...
void PikiNukareState::exec(Piki* piki)
{
	...
	if (_14) {
		...
		PikiAI::ActFormationInitArg initArg(piki->m_navi, 0, 0);
...
lbl_8018B874:
	...
	lis      r3, __vt__Q26PikiAI19ActFormationInitArg@ha
	lwz      r7, 0x2c4(r31)
	li       r0, 0
	addi     r5, r5, __vt__Q26PikiAI9ActionArg@l
	addi     r6, r4, __vt__Q26PikiAI17CreatureActionArg@l
	stw      r5, 8(r1)
	addi     r3, r3, __vt__Q26PikiAI19ActFormationInitArg@l
	addi     r5, r1, 8
	li       r4, 0
	stw      r6, 8(r1)
	stw      r7, 0xc(r1)
...
lbl_8018BE2C:
	...
	lfs      f0, lbl_80518DE0@sda21(r2)
	lis      r3, lbl_8047ED08@ha
	li       r0, 0
	mr       r4, r31
	addi     r5, r3, lbl_8047ED08@l
	stw      r0, 0x18(r1)
	addi     r3, r1, 8
	stw      r5, 0x14(r1)
	stw      r0, 0x20(r1)
...
lbl_8018BF38:
	...
	mr       r3, r30
	mr       r4, r31
	bl       panicLobster__Q24Game14PikiPanicStateFPQ24Game4Piki
	b        lbl_8018BF60

lbl_8018BF54:
	mr       r3, r30
	mr       r4, r31
	bl       panicRun__Q24Game14PikiPanicStateFPQ24Game4Piki
...
lbl_8018C194:
	...
	fsubs    f3, f0, f1
	subf     r0, r3, r0
	lfs      f1, lbl_80518E48@sda21(r2)
	cmpwi    r0, 1
	lfs      f0, lbl_80518E44@sda21(r2)
	fdivs    f4, f3, f2
	lfs      f2, lbl_80518E40@sda21(r2)
	lfs      f3, lbl_80518E3C@sda21(r2)
	fmadds   f0, f1, f4, f0
	fmuls    f0, f2, f0
	fmuls    f1, f3, f0
	bne      lbl_8018C240
...
lbl_8018C328:
	...
	lfs      f2, lbl_80518DC8@sda21(r2)
	lfd      f0, 0x18(r1)
	lfs      f1, lbl_80518E54@sda21(r2)
	fsubs    f3, f0, f3
	lfs      f0, lbl_80518E50@sda21(r2)
	fdivs    f2, f3, f2
	fmadds   f30, f1, f2, f0
	bl       rand
	xoris    r3, r3, 0x8000
...
lbl_8018C8C4:
	...
	cmplwi   r3, 0
	beq      lbl_8018C8E4
	lis      r4, lbl_8047ED14@ha
	addi     r4, r4, lbl_8047ED14@l
...
void PikiDenkiDyingState::exec(Piki* piki)
{
	...
	addi     r11, r5, __vt__Q23efx8TSimple3@l
	stw      r0, 0x24(r1)
	lfs      f1, 4(r3)
	lis      r5, __vt__Q23efx3Arg@ha
	lfs      f0, 8(r3)
	addi     r0, r5, __vt__Q23efx3Arg@l
	lis      r6, __vt__Q23efx9TPkKanden@ha
	li       r10, 0x165
	li       r9, 0x166
	li       r8, 0x167
	stw      r11, 0x24(r1)
	addi     r5, r6, __vt__Q23efx9TPkKanden@l
	addi     r3, r1, 8
	sth      r10, 0x28(r1)
	sth      r9, 0x2a(r1)
	sth      r8, 0x2c(r1)
...
void PikiPressedState::init(Piki* piki, StateArg* stateArg)
{
	...
	stwu     r1, -0x40(r1)
	mflr     r0
	lfs      f1, lbl_80518E5C@sda21(r2)
	stw      r0, 0x44(r1)
	lfs      f0, lbl_80518E08@sda21(r2)
	stw      r31, 0x3c(r1)
	mr       r31, r4
	lwz      r5, 0xc0(r4)
	li       r4, 0
...
lbl_8018EC04:
	...
	mr       r3, r30
	mr       r4, r31
	bl       execMouth__Q24Game16PikiSuikomiStateFPQ24Game4Piki
	b        lbl_8018EC44
...
lbl_8018EC20:
	...
	mr       r3, r30
	mr       r4, r31
	bl       execString__Q24Game16PikiSuikomiStateFPQ24Game4Piki
	b        lbl_8018EC44

lbl_8018EC38:
	mr       r3, r30
	mr       r4, r31
	bl       execStomach__Q24Game16PikiSuikomiStateFPQ24Game4Piki
...
void PikiSuikomiState::execStomach(Piki* piki)
{
	...
	mtctr    r12
	bctrl
	lis      r5, lbl_8047ED20@ha
	lis      r7, lbl_8047EC60@ha
	mr       r6, r3
	li       r4, 0xa78
	addi     r3, r7, lbl_8047EC60@l
	addi     r5, r5, lbl_8047ED20@l
	crclr    6
	bl       panic_f__12JUTExceptionFPCciPCce
