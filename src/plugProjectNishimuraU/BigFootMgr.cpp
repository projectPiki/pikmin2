...
BigFoot::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game7BigFoot3Mgr@ha
	lis      r4, lbl_8048B250@ha
	addi     r5, r3, __vt__Q34Game7BigFoot3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_8048B250@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
void BigFoot::Mgr::doAlloc()
{
	...
	or.      r4, r3, r3
	beq      lbl_802C6FD4
	bl       __ct__Q34Game7BigFoot5ParmsFv
	mr       r4, r3
...
BigFoot::Parms::Parms()
{
	...
	lis      r4, __vt__Q34Game7BigFoot5Parms@ha
	addi     r3, r31, 0x7f8
	addi     r0, r4, __vt__Q34Game7BigFoot5Parms@l
	li       r4, 1
	stw      r0, 0xd8(r31)
	bl       __ct__Q44Game7BigFoot5Parms11ProperParmsFv
	lwz      r0, 0x14(r1)
	mr       r3, r31
	lwz      r31, 0xc(r1)
	mtlr     r0
...
BigFoot::Parms::ProperParms::ProperParms()
{
	...
	stw      r0, 0x14(r1)
	extsh.   r0, r4
	lis      r4, lbl_8048B218@ha
	stw      r31, 0xc(r1)
	addi     r31, r4, lbl_8048B218@l
	stw      r30, 8(r1)
	mr       r30, r3
	beq      lbl_802C7068
	addi     r0, r30, 0x264
...
lbl_802C7068:
	...
	lfs      f0, lbl_8051C6B0@sda21(r2)
	stw      r0, 0xc(r30)
	mr       r4, r30
	lfs      f1, lbl_8051C6B4@sda21(r2)
	addi     r3, r30, 0x34
	stfs     f0, 0x24(r30)
	addi     r5, r5, 0x66703032@l
	lfs      f0, lbl_8051C6B8@sda21(r2)
	addi     r6, r31, 0x68
	stfs     f1, 0x2c(r30)
	stfs     f0, 0x30(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	...
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f0, lbl_8051C6BC@sda21(r2)
	stw      r0, 0x34(r30)
	mr       r4, r30
	lfs      f1, lbl_8051C6C0@sda21(r2)
	addi     r3, r30, 0x5c
	stfs     f0, 0x4c(r30)
	addi     r5, r5, 0x66703033@l
	lfs      f0, lbl_8051C6C4@sda21(r2)
	addi     r6, r31, 0x78
	stfs     f1, 0x54(r30)
	stfs     f0, 0x58(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	...
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f0, lbl_8051C6CC@sda21(r2)
	stw      r0, 0x84(r30)
	mr       r4, r30
	lfs      f1, lbl_8051C6D0@sda21(r2)
	addi     r3, r30, 0xac
	stfs     f0, 0x9c(r30)
	...
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f1, lbl_8051C6B8@sda21(r2)
	stw      r0, 0xac(r30)
	mr       r4, r30
	lfs      f0, lbl_8051C6D0@sda21(r2)
	addi     r3, r30, 0xd4
	stfs     f1, 0xc4(r30)
	...
	lfs      f0, lbl_8051C6E4@sda21(r2)
	addi     r6, r31, 0x144
	stfs     f1, 0x234(r30)
	stfs     f0, 0x238(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lfs      f2, lbl_8051C6B0@sda21(r2)
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f1, lbl_8051C6B4@sda21(r2)
	stw      r0, 0x23c(r30)
	mr       r3, r30
...
void BigFoot::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game7BigFoot3ObjFv@ha
	lis      r5, __dt__Q34Game7BigFoot3ObjFv@ha
	addi     r4, r4, __ct__Q34Game7BigFoot3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game7BigFoot3ObjFv@l
	li       r6, 0x4bc
...
BigFoot::Obj::~Obj()
{
	...
	mr       r30, r4
	beq      lbl_802C7510
	lis      r3, __vt__Q34Game7BigFoot3Obj@ha
	addi     r0, r31, 0x4ac
	addi     r4, r3, __vt__Q34Game7BigFoot3Obj@l
	stw      r4, 0(r31)
	addi     r3, r4, 0x1b0
	addi     r4, r4, 0x2fc
	stw      r3, 0x178(r31)
...
void BigFoot::Mgr::loadTexData()
{
	...
	lwz      r4,
"cMatAnimBrkTexName__Q34Game7BigFoot24@unnamed@BigFootMgr_cpp@"@sda21(r13) addi
r3, r1, 8 li       r31, 0 bl       __ct__Q212LoadResource3ArgFPCc lwz      r3,
gLoadResourceMgr@sda21(r13) addi     r4, r1, 8 bl
load__Q212LoadResource3MgrFRQ212LoadResource3Arg cmplwi   r3, 0 beq lbl_802C75F0
	lwz      r31, 0x30(r3)

lbl_802C75F0:
	cmplwi   r31, 0
	bne      lbl_802C7614
	lis      r3, lbl_8048B624@ha
	lis      r5, lbl_8048B634@ha
	addi     r3, r3, lbl_8048B624@l
	li       r4, 0x6c
	addi     r5, r5, lbl_8048B634@l
	crclr    6
...
BigFoot::Mgr::~Mgr()
{
	...
	beq      lbl_802C7768
	lis      r3, __vt__Q34Game7BigFoot3Mgr@ha
	addi     r3, r3, __vt__Q34Game7BigFoot3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_802C7758
