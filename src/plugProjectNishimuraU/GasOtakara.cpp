...
lbl_802B92D0:
	...
	addi     r0, r31, 0x2f8
	addi     r5, r3, __vt__Q34Game10GasOtakara3Obj@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r4, r5, 0x1b0
	addi     r5, r5, 0x324
 ...
 * Size:	0001A4
 */
void GasOtakara::Obj::changeMaterial()
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	000060
 */
void GasOtakara::Obj::interactCreature(Game::Creature*)
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
	...
	mr       r8, r4
	stw      r0, 0x24(r1)
	lis      r5, __vt__Q24Game11InteractGas@ha
	addi     r6, r6, __vt__Q24Game11Interaction@l
	addi     r4, r1, 8
	lwz      r7, 0xc0(r3)
	addi     r0, r5, __vt__Q24Game11InteractGas@l
	lfs      f0, 0x604(r7)
	stw      r6, 8(r1)
	stw      r3, 0xc(r1)
	mr       r3, r8
 ...
 * Size:	000060
 */
void GasOtakara::Obj::createEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	lis      r3, __vt__Q23efx13TOtaChargegas@ha
	addi     r0, r3, __vt__Q23efx13TOtaChargegas@l
	stw      r0, 0(r31)
 ...
 * Size:	000048
 */
void GasOtakara::Obj::setupEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	addi     r4, r2, lbl_8051C318@sda21
	stw      r0, 0x14(r1)
	stw      r31, 0xc(r1)
	mr       r31, r3
	lwz      r3, 0x174(r3)
 ...
 * Size:	000034
 */
void GasOtakara::Obj::startChargeEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000030
 */
void GasOtakara::Obj::finishChargeEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	00008C
 */
void GasOtakara::Obj::createDisChargeEffect()
{
	/*
	stwu     r1, -0x30(r1)
	mflr     r0
	...
	lis      r4, __vt__Q23efx7TOtaGas@ha
	li       r7, 0x13c
	lfs      f0, 0x18c(r3)
	addi     r0, r4, __vt__Q23efx7TOtaGas@l
	li       r6, 0x13d
	li       r5, 0
	stfs     f0, 0x1c(r1)
	addi     r4, r1, 0x18
 ...
 * Size:	000030
 */
void GasOtakara::Obj::effectDrawOn()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000030
 */
void GasOtakara::Obj::effectDrawOff()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000044
 */
void GasOtakara::Obj::startDisChargeSE()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000008
 */
u32 GasOtakara::Obj::getEnemyTypeID() { return 0x3D; }
} // namespace Game
