...
VibrationParms::VibrationParms()
    ...
    , mElevationMiddleSpeed(this, 'cemv', "ELEVATION_MIDDLE(speed)", 25.0f, 0.0f, 100.0f)
    , mElevationFastSpeed(this, 'cefs', "ELEVATION_FAST(speed)", 35.0f, 0.0f, 100.0f)
    , mElevationShortTime(this, 'cets', "ELEVATION_SHORT(time)", 0.3f, 0.0f, 5.0f)
    , mElevationMiddleTime(this, 'cetm', "ELEVATION_MIDDLE(time)", 0.75f, 0.0f, 5.0f)
    , mElevationLongTime(this, 'cetl', "ELEVATION_LONG(time)", 1.5f, 0.0f, 5.0f)
...
CameraParms::CameraParms()
    ...
    , mCnlw(this, 'cnlw', "Near(Low)ウェイト", 1000.0f, 0.0f, 0.0f)
    ...
    , mCnha(this, 'cnha', "Near(High)アングル", f, f, f)
    , mCnhf(this, 'cnhf', "Near(High)ＦＯＶ", f, f, f)
    , mCnho(this, 'cnho', "Near(High)オフセット", f, f, f)
    , mCnhw(this, 'cnhw', "Near(High)ウェイト", f, f, f)
    , mNhdt(this, 'nhdt', "Near(High)Detached", f, f, f)
    , mNhnc(this, 'nhnc', "Near(High)Near", f, f, f)
    , mNhfc(this, 'nhfc', "Near(High)Far", f, f, f)
    , mCmhd(this, 'cmhd', "Mid(High)距離", 900.0f, 10.0f, 5000.0f)
    , mCmha(this, 'cmha', "Mid(High)アングル", f, f, f)
    , mCmhf(this, 'cmhf', "Mid(High)ＦＯＶ", f, f, f)
    , mCmho(this, 'cmho', "Mid(High)オフセット", f, f, f)
    , mCmhw(this, 'cmhw', "Mid(High)ウェイト", f, f, f)
    , mMhdt(this, 'mhdt', "Mid(High)Detached", f, f, f)
    , mMhnc(this, 'mhnc', "Mid(High)Near", f, f, f)
    , mMhfc(this, 'mhfc', "Mid(High)Far", f, f, f)
    , mCfhd(this, 'cfhd', "Far(High)距離", f, f, f)
    , mCfha(this, 'cfha', "Far(High)アングル", f, f, f)
    , mCfhf(this, 'cfhf', "Far(High)ＦＯＶ", f, f, f)
    , mCfho(this, 'cfho', "Far(High)オフセット", f, f, f)
    , mCfhw(this, 'cfhw', "Far(High)ウェイト", f, f, f)
    , mFhdt(this, 'fhdt', "Far(High)Detached", f, f, f)
    , mFhnc(this, 'fhnc', "Far(High)Near", f, f, f)
    , mFhfc(this, 'fhfc', "Far(High)Far", f, f, f)
    , mZmdt(this, 'zmdt', "ZOOM 距離", f, f, f)
    , mZman(this, 'zman', "ZOOM アングル", f, f, f)
    , mZmfv(this, 'zmfv', "ZOOM ＦＯＶ", f, f, f)
