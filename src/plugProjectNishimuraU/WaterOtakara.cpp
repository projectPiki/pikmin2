...
lbl_802B8A74:
	...
	addi     r0, r31, 0x2f8
	addi     r5, r3, __vt__Q34Game12WaterOtakara3Obj@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r4, r5, 0x1b0
	addi     r5, r5, 0x324
 ...
 * Size:	0001A4
 */
void WaterOtakara::Obj::changeMaterial()
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	000060
 */
void WaterOtakara::Obj::interactCreature(Game::Creature*)
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	000060
 */
void WaterOtakara::Obj::createEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	lis      r3, __vt__Q23efx13TOtaChargewat@ha
	addi     r0, r3, __vt__Q23efx13TOtaChargewat@l
	stw      r0, 0(r31)
 ...
 * Size:	000048
 */
void WaterOtakara::Obj::setupEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	addi     r4, r2, lbl_8051C310@sda21
	stw      r0, 0x14(r1)
	stw      r31, 0xc(r1)
	mr       r31, r3
	lwz      r3, 0x174(r3)
 ...
 * Size:	000034
 */
void WaterOtakara::Obj::startChargeEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000030
 */
void WaterOtakara::Obj::finishChargeEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	0000A4
 */
void WaterOtakara::Obj::createDisChargeEffect()
{
	/*
	stwu     r1, -0x40(r1)
	mflr     r0
	lis      r6, __vt__Q23efx5TBase@ha
	lis      r5, __vt__Q23efx8TSimple4@ha
	stw      r0, 0x44(r1)
	lis      r4, __vt__Q23efx3Arg@ha
	addi     r0, r4, __vt__Q23efx3Arg@l
	addi     r11, r6, __vt__Q23efx5TBase@l
	stw      r0, 8(r1)
	addi     r10, r5, __vt__Q23efx8TSimple4@l
	lis      r4, __vt__Q23efx7TOtaWat@ha
	li       r9, 0x13e
	lfs      f0, 0x18c(r3)
	addi     r0, r4, __vt__Q23efx7TOtaWat@l
	li       r8, 0x13f
	li       r7, 0x140
	stfs     f0, 0xc(r1)
	li       r6, 0x141
 ...
 * Size:	000030
 */
void WaterOtakara::Obj::effectDrawOn()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000030
 */
void WaterOtakara::Obj::effectDrawOff()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000044
 */
void WaterOtakara::Obj::startDisChargeSE()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000008
 */
u32 WaterOtakara::Obj::getEnemyTypeID() { return 0x3C; }
} // namespace Game
