...
Sokkuri::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game7Sokkuri3Mgr@ha
	lis      r4, lbl_8048CE30@ha
	addi     r5, r3, __vt__Q34Game7Sokkuri3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_8048CE30@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
void Sokkuri::Mgr::doAlloc(void)
{
	...
	or.      r4, r3, r3
	beq      lbl_802F0C80
	bl       __ct__Q34Game7Sokkuri5ParmsFv
	mr       r4, r3
...
Sokkuri::Parms::Parms(void)
{
	...
	lis      r4, __vt__Q34Game7Sokkuri5Parms@ha
	addi     r3, r31, 0x7f8
	addi     r0, r4, __vt__Q34Game7Sokkuri5Parms@l
	li       r4, 1
	stw      r0, 0xd8(r31)
	bl       __ct__Q44Game7Sokkuri5Parms11ProperParmsFv
	lwz      r0, 0x14(r1)
	mr       r3, r31
	lwz      r31, 0xc(r1)
	mtlr     r0
...
Sokkuri::Parms::ProperParms::ProperParms(void)
{
	...
	stw      r0, 0x14(r1)
	extsh.   r0, r4
	lis      r4, lbl_8048CE20@ha
	stw      r31, 0xc(r1)
	addi     r31, r4, lbl_8048CE20@l
	stw      r30, 8(r1)
	mr       r30, r3
	beq      lbl_802F0D14
	addi     r0, r30, 0x19c
...
lbl_802F0D14:
	...
	lfs      f0, lbl_8051D0F0@sda21(r2)
	stw      r0, 0xc(r30)
	mr       r4, r30
	lfs      f1, lbl_8051D0F4@sda21(r2)
	addi     r3, r30, 0x34
	stfs     f0, 0x24(r30)
	addi     r5, r5, 0x66703032@l
	lfs      f0, lbl_8051D0F8@sda21(r2)
	addi     r6, r31, 0x44
	stfs     f1, 0x2c(r30)
	stfs     f0, 0x30(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	...
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lfs      f2, lbl_8051D0F0@sda21(r2)
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f1, lbl_8051D0F4@sda21(r2)
	stw      r0, 0x174(r30)
	mr       r3, r30
	lfs      f0, lbl_8051D11C@sda21(r2)
	stfs     f2, 0x18c(r30)
	stfs     f1, 0x194(r30)
	stfs     f0, 0x198(r30)
	lwz      r31, 0xc(r1)
...
void Sokkuri::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game7Sokkuri3ObjFv@ha
	lis      r5, __dt__Q34Game7Sokkuri3ObjFv@ha
	addi     r4, r4, __ct__Q34Game7Sokkuri3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game7Sokkuri3ObjFv@l
	li       r6, 0x2ec
...
Sokkuri::Obj::~Obj(void)
{
	...
	addi     r0, r31, 0x2dc
	addi     r4, r3, __vt__Q34Game7Sokkuri3Obj@l
	stw      r4, 0(r31)
	addi     r3, r4, 0x1b0
	addi     r4, r4, 0x2fc
	stw      r3, 0x178(r31)
...
Sokkuri::Mgr::~Mgr(void)
{
	...
	beq      lbl_802F11BC
	lis      r3, __vt__Q34Game7Sokkuri3Mgr@ha
	addi     r3, r3, __vt__Q34Game7Sokkuri3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_802F11AC
