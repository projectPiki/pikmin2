...
Fuefuki::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game7Fuefuki3Mgr@ha
	lis      r4, lbl_80488C30@ha
	addi     r5, r3, __vt__Q34Game7Fuefuki3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_80488C30@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
void Fuefuki::Mgr::doAlloc()
{
	...
	or.      r4, r3, r3
	beq      lbl_8029BCB4
	bl       __ct__Q34Game7Fuefuki5ParmsFv
	mr       r4, r3
...
Fuefuki::Parms::Parms()
{
	...
	lis      r4, __vt__Q34Game7Fuefuki5Parms@ha
	addi     r3, r31, 0x7f8
	addi     r0, r4, __vt__Q34Game7Fuefuki5Parms@l
	li       r4, 1
	stw      r0, 0xd8(r31)
	bl       __ct__Q44Game7Fuefuki5Parms11ProperParmsFv
	lwz      r0, 0x14(r1)
	mr       r3, r31
	lwz      r31, 0xc(r1)
	mtlr     r0
...
Fuefuki::Parms::ProperParms::ProperParms()
{
	...
	stw      r0, 0x14(r1)
	extsh.   r0, r4
	lis      r4, lbl_80488C20@ha
	stw      r31, 0xc(r1)
	addi     r31, r4, lbl_80488C20@l
	stw      r30, 8(r1)
	mr       r30, r3
	beq      lbl_8029BD48
	addi     r0, r30, 0x174
...
lbl_8029BD48:
	...
	lfs      f0, lbl_8051BC70@sda21(r2)
	stw      r0, 0xc(r30)
	mr       r4, r30
	lfs      f1, lbl_8051BC74@sda21(r2)
	addi     r3, r30, 0x34
	stfs     f0, 0x24(r30)
	addi     r5, r5, 0x66703032@l
	lfs      f0, lbl_8051BC78@sda21(r2)
	addi     r6, r31, 0x48
	stfs     f1, 0x2c(r30)
	stfs     f0, 0x30(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	...
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lfs      f2, lbl_8051BC8C@sda21(r2)
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f1, lbl_8051BC74@sda21(r2)
	stw      r0, 0x14c(r30)
	mr       r3, r30
	lfs      f0, lbl_8051BC90@sda21(r2)
	stfs     f2, 0x164(r30)
	stfs     f1, 0x16c(r30)
	stfs     f0, 0x170(r30)
	lwz      r31, 0xc(r1)
...
void Fuefuki::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game7Fuefuki3ObjFv@ha
	lis      r5, __dt__Q34Game7Fuefuki3ObjFv@ha
	addi     r4, r4, __ct__Q34Game7Fuefuki3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game7Fuefuki3ObjFv@l
	li       r6, 0x304
...
Fuefuki::Obj::~Obj()
{
	...
	addi     r0, r31, 0x2f4
	addi     r4, r3, __vt__Q34Game7Fuefuki3Obj@l
	stw      r4, 0(r31)
	addi     r3, r4, 0x1b0
	addi     r4, r4, 0x2fc
	stw      r3, 0x178(r31)
...
Fuefuki::Mgr::~Mgr()
{
	...
	beq      lbl_8029C198
	lis      r3, __vt__Q34Game7Fuefuki3Mgr@ha
	addi     r3, r3, __vt__Q34Game7Fuefuki3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_8029C188
