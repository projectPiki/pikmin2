...
Sarai::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game5Sarai3Mgr@ha
	lis      r4, lbl_804868A0@ha
	addi     r5, r3, __vt__Q34Game5Sarai3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_804868A0@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
Sarai::Parms::Parms()
{
	...
	lis      r4, __vt__Q34Game5Sarai5Parms@ha
	addi     r3, r31, 0x7f8
	addi     r0, r4, __vt__Q34Game5Sarai5Parms@l
	li       r4, 1
	stw      r0, 0xd8(r31)
	bl       __ct__Q44Game5Sarai5Parms11ProperParmsFv
	lwz      r0, 0x14(r1)
	mr       r3, r31
	lwz      r31, 0xc(r1)
	mtlr     r0
...
Sarai::Parms::ProperParms::ProperParms()
{
	...
	stw      r0, 0x14(r1)
	extsh.   r0, r4
	lis      r4, lbl_80486890@ha
	stw      r31, 0xc(r1)
	addi     r31, r4, lbl_80486890@l
	stw      r30, 8(r1)
	mr       r30, r3
	beq      lbl_80272614
	addi     r0, r30, 0x23c
...
lbl_80272614:
	...
	lfs      f0, lbl_8051B1B0@sda21(r2)
	stw      r0, 0xc(r30)
	mr       r4, r30
	lfs      f1, lbl_8051B1B4@sda21(r2)
	addi     r3, r30, 0x34
	stfs     f0, 0x24(r30)
	addi     r5, r5, 0x66703032@l
	lfs      f0, lbl_8051B1B8@sda21(r2)
	addi     r6, r31, 0x48
	stfs     f1, 0x2c(r30)
	stfs     f0, 0x30(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	...
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lis      r5, 0x66703431@ha
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f0, lbl_8051B1E8@sda21(r2)
	stw      r0, 0x1ec(r30)
	mr       r4, r30
	lfs      f1, lbl_8051B1B4@sda21(r2)
	addi     r3, r30, 0x214
	stfs     f0, 0x204(r30)
	addi     r5, r5, 0x66703431@l
	lfs      f0, lbl_8051B1D8@sda21(r2)
	addi     r6, r31, 0xf4
	stfs     f1, 0x20c(r30)
	stfs     f0, 0x210(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lfs      f2, lbl_8051B1EC@sda21(r2)
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f1, lbl_8051B1B4@sda21(r2)
	stw      r0, 0x214(r30)
	mr       r3, r30
	lfs      f0, lbl_8051B1F0@sda21(r2)
	stfs     f2, 0x22c(r30)
	stfs     f1, 0x234(r30)
	stfs     f0, 0x238(r30)
	lwz      r31, 0xc(r1)
...
void Sarai::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game5Sarai3ObjFv@ha
	lis      r5, __dt__Q34Game5Sarai3ObjFv@ha
	addi     r4, r4, __ct__Q34Game5Sarai3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game5Sarai3ObjFv@l
	li       r6, 0x2e8
...
Sarai::Mgr::~Mgr()
{
	...
	beq      lbl_80272B98
	lis      r3, __vt__Q34Game5Sarai3Mgr@ha
	addi     r3, r3, __vt__Q34Game5Sarai3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_80272B88
