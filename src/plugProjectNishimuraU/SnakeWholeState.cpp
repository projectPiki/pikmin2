 ...
 * Size:	000010
 */
void StateWalk::cleanup(EnemyBase* enemy) { enemy->disableEvent(0, EB_IsEnemyNotBitter); }
 ...
 * Size:	000010
 */
void StateHome::cleanup(EnemyBase* enemy) { enemy->disableEvent(0, EB_IsEnemyNotBitter); }
