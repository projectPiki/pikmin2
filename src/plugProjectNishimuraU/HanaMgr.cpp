...
Hana::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game4Hana3Mgr@ha
	lis      r4, lbl_8048D1D8@ha
	addi     r5, r3, __vt__Q34Game4Hana3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_8048D1D8@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
void Hana::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game4Hana3ObjFv@ha
	lis      r5, __dt__Q34Game4Hana3ObjFv@ha
	addi     r4, r4, __ct__Q34Game4Hana3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game4Hana3ObjFv@l
	li       r6, 0x2f8
...
Hana::Obj::~Obj(void)
{
	...
	addi     r0, r30, 0x2e8
	addi     r4, r3, __vt__Q34Game4Hana3Obj@l
	stw      r4, 0(r30)
	addi     r3, r4, 0x1b0
	addi     r4, r4, 0x334
	stw      r3, 0x178(r30)
...
Hana::Mgr::~Mgr(void)
{
	...
	beq      lbl_802F30E0
	lis      r3, __vt__Q34Game4Hana3Mgr@ha
	addi     r3, r3, __vt__Q34Game4Hana3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_802F30D0
