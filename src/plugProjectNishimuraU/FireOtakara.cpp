...
{
	mEfxChargeFire = new efx::TOtaChargefire;
}
...
{
	mEfxChargeFire->startDemoDrawOff();
}
...
{
	getJAIObject()->startSound(PSSE_EN_OTAKARA_ATTACK_FIRE, 0);
}
} // namespace FireOtakara
} // namespace Game
