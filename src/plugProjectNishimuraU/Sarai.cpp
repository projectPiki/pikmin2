...
void Sarai::Obj::setRandTarget()
{
	...
	float rngAngle = HALF_PI + (dirToSarai + randWeightFloat(PI));
 ...
 * TODO
 */
int Sarai::Obj::getNextStateOnHeight()
{
	if (m_health <= 0.0f) {
		return 1;
	}
 ...
 * Size:	000080
 */
int Sarai::Obj::getStickPikminNum() { return m_stuckPikminCount - getCatchTargetNum(); }
