...
Baby::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game4Baby3Mgr@ha
	lis      r4, lbl_80488034@ha
	addi     r5, r3, __vt__Q34Game4Baby3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_80488034@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
Baby::Parms::Parms()
{
	...
	stwu     r1, -0x10(r1)
	mflr     r0
	lis      r4, lbl_80488028@ha
	stw      r0, 0x14(r1)
	stw      r31, 0xc(r1)
	addi     r31, r4, lbl_80488028@l
	stw      r30, 8(r1)
	mr       r30, r3
	bl       __ct__Q24Game14EnemyParmsBaseFv
	lis      r3, __vt__Q34Game4Baby5Parms@ha
	lis      r5, 0x66703031@ha
	addi     r0, r3, __vt__Q34Game4Baby5Parms@l
	addi     r4, r30, 0x854
	stw      r0, 0xd8(r30)
	li       r7, 0
	addi     r0, r31, 0x28
	...
	lfs      f0, lbl_8051B8C8@sda21(r2)
	stw      r0, 0x804(r30)
	addi     r3, r30, 0x82c
	lfs      f1, lbl_8051B8CC@sda21(r2)
	addi     r4, r30, 0x7f8
	stfs     f0, 0x81c(r30)
	addi     r5, r5, 0x66703131@l
	lfs      f0, lbl_8051B8D0@sda21(r2)
	addi     r6, r31, 0x44
	stfs     f1, 0x824(r30)
	stfs     f0, 0x828(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lfs      f2, lbl_8051B8D4@sda21(r2)
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f1, lbl_8051B8CC@sda21(r2)
	stw      r0, 0x82c(r30)
	mr       r3, r30
	lfs      f0, lbl_8051B8D8@sda21(r2)
	stfs     f2, 0x844(r30)
	stfs     f1, 0x84c(r30)
	stfs     f0, 0x850(r30)
	lwz      r31, 0xc(r1)
...
void Baby::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game4Baby3ObjFv@ha
	lis      r5, __dt__Q34Game4Baby3ObjFv@ha
	addi     r4, r4, __ct__Q34Game4Baby3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game4Baby3ObjFv@l
	li       r6, 0x2e8
...
Baby::Obj::~Obj()
{
	...
	addi     r0, r31, 0x2d8
	addi     r4, r3, __vt__Q34Game4Baby3Obj@l
	stw      r4, 0(r31)
	addi     r3, r4, 0x1b0
	addi     r4, r4, 0x2fc
	stw      r3, 0x178(r31)
...
Baby::Mgr::~Mgr()
{
	...
	beq      lbl_8028D444
	lis      r3, __vt__Q34Game4Baby3Mgr@ha
	addi     r3, r3, __vt__Q34Game4Baby3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_8028D434
