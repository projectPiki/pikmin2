...
Armor::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game5Armor3Mgr@ha
	lis      r4, lbl_80487108@ha
	addi     r5, r3, __vt__Q34Game5Armor3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_80487108@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
void Armor::Mgr::doAlloc()
{
	...
	or.      r4, r3, r3
	beq      lbl_8027D334
	bl       __ct__Q34Game5Armor5ParmsFv
	mr       r4, r3
...
Armor::Parms::Parms()
{
	...
	stwu     r1, -0x10(r1)
	mflr     r0
	lis      r4, lbl_804870F8@ha
	stw      r0, 0x14(r1)
	stw      r31, 0xc(r1)
	addi     r31, r4, lbl_804870F8@l
	stw      r30, 8(r1)
	mr       r30, r3
	bl       __ct__Q24Game14EnemyParmsBaseFv
	lis      r3, __vt__Q34Game5Armor5Parms@ha
	lis      r5, 0x66703031@ha
	addi     r0, r3, __vt__Q34Game5Armor5Parms@l
	addi     r4, r30, 0x87c
	stw      r0, 0xd8(r30)
	li       r7, 0
	addi     r0, r31, 0x28
	...
	lfs      f0, lbl_8051B528@sda21(r2)
	stw      r0, 0x804(r30)
	addi     r3, r30, 0x82c
	lfs      f1, lbl_8051B52C@sda21(r2)
	addi     r4, r30, 0x7f8
	stfs     f0, 0x81c(r30)
	addi     r5, r5, 0x66703131@l
	lfs      f0, lbl_8051B530@sda21(r2)
	addi     r6, r31, 0x44
	stfs     f1, 0x824(r30)
	stfs     f0, 0x828(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	...
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lfs      f1, lbl_8051B538@sda21(r2)
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f0, lbl_8051B52C@sda21(r2)
	stw      r0, 0x854(r30)
	mr       r3, r30
	stfs     f1, 0x86c(r30)
	stfs     f0, 0x874(r30)
...
void Armor::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game5Armor3ObjFv@ha
	lis      r5, __dt__Q34Game5Armor3ObjFv@ha
	addi     r4, r4, __ct__Q34Game5Armor3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game5Armor3ObjFv@l
	li       r6, 0x2f4
...
Armor::Obj::~Obj()
{
	...
	addi     r0, r31, 0x2e4
	addi     r4, r3, __vt__Q34Game5Armor3Obj@l
	stw      r4, 0(r31)
	addi     r3, r4, 0x1b0
	addi     r4, r4, 0x2fc
	stw      r3, 0x178(r31)
...
Armor::Mgr::~Mgr()
{
	...
	beq      lbl_8027D670
	lis      r3, __vt__Q34Game5Armor3Mgr@ha
	addi     r3, r3, __vt__Q34Game5Armor3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_8027D660
