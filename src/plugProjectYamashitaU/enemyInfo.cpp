...
//  name                   ID                                   pID                                members flags      model           anim            animgr          texture     param       collision       stone           childID                           chNum                    droptype
	...
	#if BUGFIX                   
	{"Damagumo",           EnemyTypeID::EnemyID_Damagumo,       -1,                                1,      0x0007,    "",             "",             "",             "",         "",         "",             "",             EnemyTypeID::EnemyID_ShijimiChou, SHIJIMICHOU_GROUP_COUNT, BDT_Boss},
	#else                   
	{"Damagumo",           EnemyTypeID::EnemyID_Damagumo,       -1,                                1,      0x0007,    "",             "",             "",             "",         "",         "",             "",             -1,                               0,                       BDT_Boss},
	#endif                   
	{"BigFoot",            EnemyTypeID::EnemyID_BigFoot,        -1,                                1,      0x0007,    "",             "",             "",             "",         "",         "",             "",             EnemyTypeID::EnemyID_TamagoMushi, TAMAGOMUSHI_GROUP_COUNT, BDT_Boss},
