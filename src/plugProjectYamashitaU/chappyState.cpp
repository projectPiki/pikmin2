 ...
 * Size:	00003C
 */
ChappyBase::StateSleep::StateSleep(int id)
    : State(id)
{
	m_name = "sleep";
}
 ...
 * Size:	0000BC
 */
void ChappyBase::StateSleep::init(Game::EnemyBase* eb, Game::StateArg* s)
{
	SleepArg* arg = (SleepArg*)s;
	if (arg && arg->_00) {
		eb->startMotion(4, nullptr);
		eb->setMotionFrame(70.0f);
	} else {
		eb->startMotion(6, nullptr);
	}

	eb->m_targetCreature = nullptr;

	// Creeping Chrysanthemum
	if (eb->getEnemyTypeID() == EnemyTypeID::EnemyID_Hana) {
		eb->hardConstraintOn();
	} else {
		eb->enableEvent(0, EB_Constraint);
	}

	((Obj*)eb)->setUnderGround();
}
 ...
 * 70%
 */
void ChappyBase::StateSleep::exec(Game::EnemyBase* eb)
{
	Obj* obj = (Obj*)eb;

	if (obj->getCurrAnimIndex() == 6) {
		EnemyAnimKeyEvent* event = obj->m_curAnim;
		if (!event->m_isPlaying) {
			return;
		}

		if (event->m_type == KEYEVENT_END) {
			if (obj->isEvent(0, EB_IsTakingDamage)) {
				transit(obj, CHAPPY_Turn, nullptr);
			} else {
				obj->startMotion(4, nullptr);
			}
		}
	...
	if (!obj->isFinishMotion() && obj->isWakeup()) {
		setNextState(obj, CHAPPY_Turn);
	}
	...
	if (!event->m_isPlaying) {
		// WTF?
		if (event->m_type) {
			obj->startSleepEffect();

			if (event->m_type == 3) {
				obj->finishSleepEffect();
			} else if (event->m_type == 4) {
				obj->createSmokeEffect();
			} else if (event->m_type == KEYEVENT_END) {
				transit(eb, m_nextState, nullptr);
			}
		}
	}

	if (obj->m_health <= 0.0f) {
		transit(eb, CHAPPY_Dead, nullptr);
	}
}
...
// 	lis      r8, __vt__Q34Game10ChappyBase5State@ha
// 	addi     r0, r5, __vt__Q24Game13EnemyFSMState@l
// 	lis      r7, __vt__Q34Game10ChappyBase16StateCautionBase@ha
// 	stw      r0, 0(r3)
// 	lis      r6, lbl_8047AEA8@ha
// 	lis      r5, __vt__Q34Game10ChappyBase9StateDead@ha
// 	li       r0, 0
// 	stw      r4, 4(r3)
// 	addi     r8, r8, __vt__Q34Game10ChappyBase5State@l
// 	addi     r7, r7, __vt__Q34Game10ChappyBase16StateCautionBase@l
// 	addi     r6, r6, lbl_8047AEA8@l
// 	stw      r0, 8(r3)
// 	addi     r4, r5, __vt__Q34Game10ChappyBase9StateDead@l
// 	addi     r0, r2, lbl_80517ABC@sda21
// 	stw      r8, 0(r3)
// 	stw      r7, 0(r3)
// 	stw      r6, 0xc(r3)
// 	stw      r4, 0(r3)
...
// 	/*
// 	lis      r5, __vt__Q24Game13EnemyFSMState@ha
// 	lis      r9, __vt__Q34Game10ChappyBase5State@ha
// 	addi     r0, r5, __vt__Q24Game13EnemyFSMState@l
// 	lis      r8, __vt__Q34Game10ChappyBase16StateCautionBase@ha
// 	stw      r0, 0(r3)
// 	lis      r7, lbl_8047AEA8@ha
// 	lis      r6, __vt__Q34Game10ChappyBase13StateTurnBase@ha
// 	lis      r5, __vt__Q34Game10ChappyBase9StateTurn@ha
// 	stw      r4, 4(r3)
// 	li       r4, 0
// 	addi     r0, r9, __vt__Q34Game10ChappyBase5State@l
// 	addi     r8, r8, __vt__Q34Game10ChappyBase16StateCautionBase@l
// 	stw      r4, 8(r3)
// 	addi     r7, r7, lbl_8047AEA8@l
// 	addi     r6, r6, __vt__Q34Game10ChappyBase13StateTurnBase@l
// 	addi     r4, r5, __vt__Q34Game10ChappyBase9StateTurn@l
// 	stw      r0, 0(r3)
// 	addi     r0, r2, lbl_80517AE0@sda21
// 	stw      r8, 0(r3)
// 	stw      r7, 0xc(r3)
// 	stw      r6, 0(r3)
// 	stw      r4, 0(r3)
...
// 	stw      r0, 0(r3)
// 	lis      r6, lbl_8047AEA8@ha
// 	lis      r5, __vt__Q34Game10ChappyBase9StateWalk@ha
// 	li       r0, 0
// 	stw      r4, 4(r3)
// 	addi     r8, r8, __vt__Q34Game10ChappyBase5State@l
// 	addi     r7, r7, __vt__Q34Game10ChappyBase16StateCautionBase@l
// 	addi     r6, r6, lbl_8047AEA8@l
// 	stw      r0, 8(r3)
// 	addi     r4, r5, __vt__Q34Game10ChappyBase9StateWalk@l
// 	addi     r0, r2, lbl_80517AEC@sda21
// 	stw      r8, 0(r3)
// 	stw      r7, 0(r3)
// 	stw      r6, 0xc(r3)
// 	stw      r4, 0(r3)
...
// 	stw      r0, 0(r3)
// 	lis      r6, lbl_8047AEA8@ha
// 	lis      r5, __vt__Q34Game10ChappyBase11StateAttack@ha
// 	li       r0, 0
// 	stw      r4, 4(r3)
// 	addi     r8, r8, __vt__Q34Game10ChappyBase5State@l
// 	addi     r7, r7, __vt__Q34Game10ChappyBase16StateCautionBase@l
// 	addi     r6, r6, lbl_8047AEA8@l
// 	stw      r0, 8(r3)
// 	addi     r4, r5, __vt__Q34Game10ChappyBase11StateAttack@l
// 	addi     r0, r2, lbl_80517AF4@sda21
// 	stw      r8, 0(r3)
// 	stw      r7, 0(r3)
// 	stw      r6, 0xc(r3)
// 	stw      r4, 0(r3)
...
// 	stw      r0, 0(r3)
// 	lis      r6, lbl_8047AEA8@ha
// 	lis      r5, __vt__Q34Game10ChappyBase10StateFlick@ha
// 	li       r0, 0
// 	stw      r4, 4(r3)
// 	addi     r8, r8, __vt__Q34Game10ChappyBase5State@l
// 	addi     r7, r7, __vt__Q34Game10ChappyBase16StateCautionBase@l
// 	addi     r6, r6, lbl_8047AEA8@l
// 	stw      r0, 8(r3)
// 	addi     r4, r5, __vt__Q34Game10ChappyBase10StateFlick@l
// 	addi     r0, r2, lbl_80517AFC@sda21
// 	stw      r8, 0(r3)
// 	stw      r7, 0(r3)
// 	stw      r6, 0xc(r3)
// 	stw      r4, 0(r3)
...
// 	lis      r7, lbl_8047AEA8@ha
// 	lis      r6, __vt__Q34Game10ChappyBase13StateTurnBase@ha
// 	lis      r5, __vt__Q34Game10ChappyBase15StateTurnToHome@ha
// 	stw      r4, 4(r3)
// 	li       r10, 0
// 	lis      r4, lbl_8047AEBC@ha
// 	addi     r0, r9, __vt__Q34Game10ChappyBase5State@l
// 	stw      r10, 8(r3)
// 	addi     r8, r8, __vt__Q34Game10ChappyBase16StateCautionBase@l
// 	addi     r7, r7, lbl_8047AEA8@l
// 	addi     r6, r6, __vt__Q34Game10ChappyBase13StateTurnBase@l
// 	stw      r0, 0(r3)
// 	addi     r5, r5, __vt__Q34Game10ChappyBase15StateTurnToHome@l
// 	addi     r0, r4, lbl_8047AEBC@l
// 	stw      r8, 0(r3)
// 	stw      r7, 0xc(r3)
// 	stw      r6, 0(r3)
// 	stw      r5, 0(r3)
...
// 	stw      r0, 0(r3)
// 	lis      r6, lbl_8047AEA8@ha
// 	lis      r5, __vt__Q34Game10ChappyBase11StateGoHome@ha
// 	li       r0, 0
// 	stw      r4, 4(r3)
// 	addi     r8, r8, __vt__Q34Game10ChappyBase5State@l
// 	addi     r7, r7, __vt__Q34Game10ChappyBase16StateCautionBase@l
// 	addi     r6, r6, lbl_8047AEA8@l
// 	stw      r0, 8(r3)
// 	addi     r4, r5, __vt__Q34Game10ChappyBase11StateGoHome@l
// 	addi     r0, r2, lbl_80517B04@sda21
// 	stw      r8, 0(r3)
// 	stw      r7, 0(r3)
// 	stw      r6, 0xc(r3)
// 	stw      r4, 0(r3)
