...
{
	enemy->doUpdate();
	enemy->_1E8[0].typeView = enemy->_1E0[0].typeView;
	enemy->_1E8[1].typeView = enemy->_1E0[1].typeView;
	enemy->_1E0[1].typeView |= 0x2;
	enemy->stopMotion();
	enemy->_1E0[0].typeView |= 0x400;
	enemy->m_velocity2.x = 0.0f;
	enemy->m_velocity2.y = 0.0f;
	enemy->m_velocity2.z = 0.0f;
	enemy->m_velocity.x  = 0.0f;
	enemy->m_velocity.y  = 0.0f;
...
{
	create(10);
	registerState(new BirthTypeDropState());
 ...
 * Size:	000034
 */
float EnemyBase::getMotionFrame()
{
	/*
	.loc_0x0:
	  stwu      r1, -0x10(r1)
 ...
 * Size:	000058
 */
float EnemyBase::getMotionFrameMax()
{
	/*
	.loc_0x0:
	  stwu      r1, -0x10(r1)
 ...
 * Size:	000008
 */
float EnemyBase::getDownSmokeScale()
{
	/*
	.loc_0x0:
	  lfs       f1, -0x6BB0(r2)
