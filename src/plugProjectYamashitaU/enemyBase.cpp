...
namespace EnemyBaseFSM {
	 ...
	 * Size:	0001E0
	 */
	bool BirthTypeDropState::isFinishableWaitingBirthTypeDrop(EnemyBase*)
	{
		/*
		.loc_0x0:
		  stwu      r1, -0xF0(r1)
 ...
 * Size:	0001A8
 */
void EnemyBaseFSM::BirthTypeDropState::init(Game::EnemyBase*, Game::StateArg*)
{
	/*
	.loc_0x0:
	  stwu      r1, -0x30(r1)
