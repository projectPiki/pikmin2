...
lbl_8010F35C:
	...
	lis      r3, __vt__Q34Game8Kochappy3Obj@ha
	addi     r0, r31, 0x2d8
	addi     r5, r3, __vt__Q34Game8Kochappy3Obj@l
	li       r3, 0x2c
	stw      r5, 0(r31)
	addi     r4, r5, 0x1b0
	addi     r5, r5, 0x308
...
EnemyAnimatorBase::~EnemyAnimatorBase()
{
	...
	or.      r31, r3, r3
	beq      lbl_8010F4C8
	lis      r5, __vt__Q24Game17EnemyAnimatorBase@ha
	extsh.   r0, r4
	addi     r0, r5, __vt__Q24Game17EnemyAnimatorBase@l
	stw      r0, 0(r31)
	ble      lbl_8010F4C8
	bl       __dl__FPv
...
Kochappy::Obj::~Obj()
{
	...
	lis      r3, __vt__Q34Game8Kochappy3Obj@ha
	addi     r5, r30, 0x2d8
	addi     r4, r3, __vt__Q34Game8Kochappy3Obj@l
	stw      r4, 0(r30)
	addi     r3, r4, 0x1b0
	addi     r0, r4, 0x308
	stw      r3, 0x178(r30)
