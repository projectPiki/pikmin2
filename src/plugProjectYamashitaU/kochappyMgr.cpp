...
Kochappy::Mgr::Mgr(int, unsigned char)
{
	...
	lis      r3, __vt__Q34Game8Kochappy3Mgr@ha
	lis      r4, lbl_8047AB74@ha
	addi     r5, r3, __vt__Q34Game8Kochappy3Mgr@l
	mr       r3, r31
	stw      r5, 0(r31)
	addi     r5, r5, 0x38
	addi     r0, r4, lbl_8047AB74@l
	stw      r5, 4(r31)
	stw      r0, 0x18(r31)
	lwz      r31, 0xc(r1)
	lwz      r0, 0x14(r1)
...
KochappyBase::Parms::Parms()
{
	...
	stwu     r1, -0x10(r1)
	mflr     r0
	lis      r4, lbl_8047AB38@ha
	stw      r0, 0x14(r1)
	stw      r31, 0xc(r1)
	addi     r31, r4, lbl_8047AB38@l
	stw      r30, 8(r1)
	mr       r30, r3
	bl       __ct__Q24Game14EnemyParmsBaseFv
	lis      r3, __vt__Q34Game12KochappyBase5Parms@ha
	lis      r5, 0x66703031@ha
	addi     r0, r3, __vt__Q34Game12KochappyBase5Parms@l
	addi     r4, r30, 0x87c
	stw      r0, 0xd8(r30)
	li       r7, 0
	addi     r0, r31, 0x58
	...
	lfs      f0, lbl_80517A58@sda21(r2)
	stw      r0, 0x804(r30)
	addi     r3, r30, 0x82c
	lfs      f1, lbl_80517A5C@sda21(r2)
	addi     r4, r30, 0x7f8
	stfs     f0, 0x81c(r30)
	addi     r5, r5, 0x66703032@l
	lfs      f0, lbl_80517A60@sda21(r2)
	addi     r6, r31, 0x78
	stfs     f1, 0x824(r30)
	stfs     f0, 0x828(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	...
	lfs      f0, lbl_80517A68@sda21(r2)
	addi     r6, r31, 0x88
	stfs     f1, 0x84c(r30)
	stfs     f0, 0x850(r30)
	bl       __ct__8BaseParmFP10ParametersUlPc
	lis      r3, "__vt__7Parm<f>"@ha
	lfs      f2, lbl_80517A6C@sda21(r2)
	addi     r0, r3, "__vt__7Parm<f>"@l
	lfs      f1, lbl_80517A5C@sda21(r2)
	stw      r0, 0x854(r30)
	mr       r3, r30
	lfs      f0, lbl_80517A70@sda21(r2)
	stfs     f2, 0x86c(r30)
	stfs     f1, 0x874(r30)
	stfs     f0, 0x878(r30)
	lwz      r31, 0xc(r1)
...
void Kochappy::Mgr::loadTexData()
{
	...
	addi     r3, r1, 8
	lwz      r4,
	"cKochappyChangeTexName__Q34Game8Kochappy25@unnamed@kochappyMgr_cpp@"@sda21(r13)
...
Kochappy::Mgr::~Mgr()
{
	...
	beq      lbl_80112608
	lis      r3, __vt__Q34Game8Kochappy3Mgr@ha
	addi     r3, r3, __vt__Q34Game8Kochappy3Mgr@l
	stw      r3, 0(r30)
	addi     r0, r3, 0x38
	stw      r0, 4(r30)
	beq      lbl_801125F8
...
void Kochappy::Mgr::createObj(int)
{
	...
	addi     r3, r3, 0x10
	bl       __nwa__FUl
	lis      r4, __ct__Q34Game8Kochappy3ObjFv@ha
	lis      r5, __dt__Q34Game8Kochappy3ObjFv@ha
	addi     r4, r4, __ct__Q34Game8Kochappy3ObjFv@l
	mr       r7, r31
	addi     r5, r5, __dt__Q34Game8Kochappy3ObjFv@l
	li       r6, 0x2e8
...
Kochappy::Mgr::@4 @~Mgr()
{
	/*
	addi     r3, r3, -4
	b        __dt__Q34Game8Kochappy3MgrFv
	*/
}
} // namespace Game
