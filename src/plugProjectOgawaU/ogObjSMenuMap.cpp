...
r18, 0x38(r1) lwz      r0, 0x74(r1) mtlr     r0 addi     r1, r1, 0x70 blr
	*/
}
...
lbl_80312338:
	...
	stb      r8, 0xe(r1)
	stb      r0, 0xf(r1)
	bl "drawRectZ__Q32og9newScreen11ObjSMenuMapFR8GraphicsR7Rect<f>R6Color4f"
	lwz      r4, 0xb4(r29)
	addi     r3, r1, 0x34
	li       r5, 0
