...
0 bne      lbl_80318D28 lis      r3, lbl_8048EA64@ha lis      r5,
...
void newScreen::ObjKantei::commonUpdate(void)
{
	...
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_80318ED8 lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_80318EEC:
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_80318F14 lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_8031924C:
	...
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_803192E0 lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_803192F4:
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_8031931C lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_8031984C:
	...
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_803198F0 lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_80319904:
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_8031992C lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_803199F0:
	...
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_80319A9C lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
...
lbl_80319AB0:
	lwz      r0,
"sInstance__Q28PSSystem30SingletonBase<Q26PSGame5SeMgr>"@sda21(r13) cmplwi   r0,
0 bne      lbl_80319AD8 lis      r3, lbl_8048EA64@ha lis      r5,
lbl_8048EA70@ha addi     r3, r3, lbl_8048EA64@l li       r4, 0x237 addi     r5,
r5, lbl_8048EA70@l crclr    6 bl       panic_f__12JUTExceptionFPCciPCce
