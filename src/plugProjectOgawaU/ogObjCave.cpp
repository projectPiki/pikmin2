 ...
 * Size:	00009C
 */
ObjCave::ObjCave(char const* name)
{
	m_fadeLevel       = 0.0f;
	m_scale           = 0.0f;
	m_name            = name;
...
void ObjCave::doCreate(JKRArchive* arc)
{
	...
	f32 y                             = msVal._30;
	og::Screen::OtakaraSensor* sensor = m_otakara;
	sensor->_4C                       = msVal._2C;
	sensor->_50                       = y;
...
r3, 0x40(r29) mr       r7, r30 lwz      r5, 0x48(r29) addi     r4, r31, 0x48
	lis      r6, 0x104
	bl
addBlo__Q32og6Screen8BloGroupFPcPQ29P2DScreen10Mgr_tuningUlP10JKRArchive lwz
r3, 0x40(r29) mr       r7, r30 lwz      r5, 0x4c(r29) addi     r4, r31, 0x48
	lis      r6, 0x104
	bl
addBlo__Q32og6Screen8BloGroupFPcPQ29P2DScreen10Mgr_tuningUlP10JKRArchive lwz
r3, 0x40(r29) mr       r7, r30 lwz      r5, 0x50(r29) addi     r4, r31, 0x54
	lis      r6, 0x104
	bl
addBlo__Q32og6Screen8BloGroupFPcPQ29P2DScreen10Mgr_tuningUlP10JKRArchive lwz
r3, 0x40(r29) mr       r7, r30 lwz      r5, 0x54(r29) addi     r4, r31, 0x64
	...
	bl
addBlo__Q32og6Screen8BloGroupFPcPQ29P2DScreen10Mgr_tuningUlP10JKRArchive lwz
r3, 0x40(r29) mr       r7, r30 lwz      r5, 0x58(r29) addi     r4, r31, 0x78
	lis      r6, 0x104
	bl
addBlo__Q32og6Screen8BloGroupFPcPQ29P2DScreen10Mgr_tuningUlP10JKRArchive lwz
r3, 0x44(r29) mr       r4, r30 bl
 ...
 * Size:	0003A4
 */
void ObjCave::commonUpdate(void)
{
	if (m_disp) {
		if (m_disp->m_isFinalFloor) {
			m_paneChika->m_isVisible  = false;
	...
	og::Screen::DispMemberCave* disp = m_disp;
	m_otakara->setParam(disp->m_treasureDist, disp->m_radarState, disp->m_radarEnabled, disp->m_allTreasureGotten);
	...
	if (m_disp->m_drawSensor) {
		...
		f32 y                             = msVal._38;
		og::Screen::OtakaraSensor* sensor = m_otakara;
		sensor->_5C                       = msVal._34;
		sensor->_60                       = y;

		y           = msVal._40;
		sensor      = m_otakara;
		sensor->_64 = msVal._3C;
		sensor->_68 = y;
	}
	m_doping->setDopingEnable(m_disp->m_isBitterUnlocked, m_disp->m_isSpicyUnlocked);
 ...
 * Size:	000074
 */
bool ObjCave::doUpdateFadein(void)
{
	bool check = false;
 ...
 * Size:	000004
 */
void ObjCave::doUpdateFadeinFinish(void) { }
 ...
 * Size:	00000C
 */
void ObjCave::doUpdateFinish(void)
{
	m_fadeLevel = 0.0f;
	/*
	lfs      f0, lbl_8051DBC0@sda21(r2)
 ...
 * Size:	00007C
 */
bool ObjCave::doUpdateFadeout(void)
{
	bool check = false;
	m_fadeLevel += sys->m_deltaTime;
