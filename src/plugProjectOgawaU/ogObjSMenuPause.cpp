...
lbl_803146F0:
	...
	bl       setMenuScreen__Q22og6ScreenFP10JKRArchivePQ29P2DScreen3MgrUx
	stw      r3, 0xec(r29)
	lis      r6, 0x685F3036@ha
	mr       r3, r30
	li       r5, 0
	lwz      r4, 0xc0(r29)
	addi     r6, r6, 0x685F3036@l
	bl       setMenuTitleScreen__Q22og6ScreenFP10JKRArchivePQ29P2DScreen3MgrUx
	stw      r3, 0xf0(r29)
	lis      r6, 0x685F3037@ha
	mr       r3, r30
	li       r5, 0
	lwz      r4, 0xc0(r29)
	addi     r6, r6, 0x685F3037@l
	bl       setMenuScreen__Q22og6ScreenFP10JKRArchivePQ29P2DScreen3MgrUx
	stw      r3, 0xf4(r29)
	lis      r6, 0x685F3038@ha
	mr       r3, r30
	li       r5, 0
	lwz      r4, 0xc0(r29)
	addi     r6, r6, 0x685F3038@l
	bl       setMenuScreen__Q22og6ScreenFP10JKRArchivePQ29P2DScreen3MgrUx
	stw      r3, 0xf8(r29)
	lis      r3, msVal__Q32og9newScreen13ObjSMenuPause@ha
	lfs      f31, msVal__Q32og9newScreen13ObjSMenuPause@l(r3)
	lwz      r3, 0xd8(r29)
	fmr      f1, f31
	bl       open__Q32og6Screen15AnimText_ScreenFf
	lfs      f0, lbl_8051D85C@sda21(r2)
	lwz      r3, 0xdc(r29)
	fadds    f1, f0, f31
	bl       open__Q32og6Screen15AnimText_ScreenFf
	lfs      f0, lbl_8051D860@sda21(r2)
	lwz      r3, 0xe0(r29)
	fadds    f1, f0, f31
	bl       open__Q32og6Screen15AnimText_ScreenFf
	lwz      r4, 0xac(r29)
...
r30, 8(r1) lis      r3, 0x6D703031@ha lis      r5, 0x0050636F@ha li       r8,
0xa lwz      r4, 0xa8(r29) addi     r6, r3, 0x6D703031@l lwz      r3, 0xc0(r29)
	addi     r5, r5, 0x0050636F@l
	addi     r7, r4, 0xc
	li       r9, 0
	li       r10, 1
	bl
setCallBack_CounterRV__Q22og6ScreenFPQ29P2DScreen3MgrUxPUlUsbbP10JKRArchive lwz
r3, 0xa8(r29) lwz      r0, 0xc(r3) cmplwi   r0, 0x2710 bge      lbl_80314A9C lis
r4, 0x4E66696E@ha lwz      r3, 0xc0(r29) addi     r6, r4, 0x4E66696E@l li r5, 0
