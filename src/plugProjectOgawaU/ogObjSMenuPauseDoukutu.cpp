...
lbl_803223F8:
	...
	stw      r3, 0xd4(r29)
	lis      r6, 0x685F3034@ha
	mr       r3, r30
	li       r5, 0
	lwz      r4, 0xbc(r29)
	addi     r6, r6, 0x685F3034@l
	bl       setMenuScreen__Q22og6ScreenFP10JKRArchivePQ29P2DScreen3MgrUx
	stw      r3, 0xd8(r29)
	lis      r6, 0x685F3035@ha
	mr       r3, r30
	li       r5, 0
	lwz      r4, 0xbc(r29)
	addi     r6, r6, 0x685F3035@l
	bl       setMenuScreen__Q22og6ScreenFP10JKRArchivePQ29P2DScreen3MgrUx
	stw      r3, 0xdc(r29)
	mr       r3, r29
	...
	bl       open__Q32og6Screen15AnimText_ScreenFf
	stw      r30, 8(r1)
	lis      r3, 0x6E613031@ha
	addi     r6, r3, 0x6E613031@l
	li       r5, 0x5061
	lwz      r4, 0xa8(r29)
	li       r8, 0xa
	lwz      r3, 0xbc(r29)
	...
	li       r10, 1
	bl
setCallBack_CounterRV__Q22og6ScreenFPQ29P2DScreen3MgrUxPUlUsbbP10JKRArchive lwz
r4, 0xa8(r29) lis      r3, 0x696E3031@ha addi     r6, r3, 0x696E3031@l addi r7,
r29, 0xe4 lwz      r3, 0xc(r4) li       r5, 0x5066 lwz      r0, 8(r4) li r8, 0xa
	li       r9, 0
	li       r10, 1
	add      r0, r3, r0
	stw      r0, 0xe4(r29)
...
r30, 8(r1) lis      r5, 0x6D703031@ha lis      r4, 0x0050636F@ha addi     r7,
r29, 0xe4 lwz      r3, 0xbc(r29) addi     r6, r5, 0x6D703031@l addi     r5, r4,
0x0050636F@l li       r8, 0xa li       r9, 0 li       r10, 1 bl
setCallBack_CounterRV__Q22og6ScreenFPQ29P2DScreen3MgrUxPUlUsbbP10JKRArchive lwz
r3, 0xa8(r29) lbz      r0, 0x10(r3) cmplwi   r0, 0 beq      lbl_80322678 lis r4,
0x4E66696E@ha lwz      r3, 0xbc(r29) addi     r6, r4, 0x4E66696E@l li       r5,
0 bl       TagSearch__Q22og6ScreenFP9J2DScreenUx li       r0, 1 lis      r4,
0x636F6D70@ha stb      r0, 0xb0(r3) addi     r6, r4, 0x636F6D70@l li       r5,
0x4e lwz      r3, 0xbc(r29) bl       TagSearch__Q22og6ScreenFP9J2DScreenUx li
r0, 0 stb      r0, 0xb0(r3) b        lbl_803226B0
...
r0, 0x34(r1) lwz      r31, 0x2c(r1) lwz      r30, 0x28(r1) lwz      r29,
