...
r31, 8(r1) lis      r3, 0x30315F31@ha lis      r5, 0x00507069@ha li       r8,
0xa lwz      r4, 0x38(r30) addi     r6, r3, 0x30315F31@l lwz      r3, 0x3c(r30)
	addi     r5, r5, 0x00507069@l
	addi     r7, r4, 0x5c
	li       r9, 0
	li       r10, 1
...
r3, 0x3c(r30) bl       setCallBackMessage__Q22og6ScreenFPQ29P2DScreen3Mgr li r0,
0 mr       r3, r30 stw      r0, 0x48(r30) lwz      r4, 0x48(r30) bl
setSelectPikmin__Q32og9newScreen10ObjUfoMenuFi li       r3, 0x78 bl __nw__FUl
	or.      r0, r3, r3
	beq      lbl_80323C2C
