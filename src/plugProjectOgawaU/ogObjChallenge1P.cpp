...
setCallBack__Q32og6Screen13NaviLifeGaugeFPQ32og6Screen8DataNaviQ42og6Screen18CallBack_LifeGauge13LifeGaugeType
	...
	li       r10, 1
	bl
setCallBack_CounterRV__Q22og6ScreenFPQ29P2DScreen3MgrUxPUlUsbbP10JKRArchive li
r0, 0x1814 lis      r4, 0x61645031@ha stw      r0, 0x94(r3) lis      r3,
0x00506465@ha addi     r6, r4, 0x61645031@l li       r8, 6 stw      r30, 8(r1)
	addi     r5, r3, 0x00506465@l
	li       r9, 1
	li       r10, 1
	lwz      r4, 0x60(r29)
	lwz      r3, 0x78(r29)
	addi     r7, r4, 0x64
	bl
setCallBack_CounterRV__Q22og6ScreenFPQ29P2DScreen3MgrUxPUlUsbbP10JKRArchive lfs
f1, 0x44(r29) bl       __cvt_fp2unsigned stw      r3, 0x40(r29) lis      r3,
0x696D6531@ha addi     r6, r3, 0x696D6531@l addi     r7, r29, 0x40 stw      r30,
8(r1) li       r5, 0x5074 li       r8, 6 li       r9, 1 lwz      r3, 0x78(r29)
	li       r10, 1
	bl
setCallBack_CounterRV__Q22og6ScreenFPQ29P2DScreen3MgrUxPUlUsbbP10JKRArchive li
r4, 1 mr       r31, r3 bl
