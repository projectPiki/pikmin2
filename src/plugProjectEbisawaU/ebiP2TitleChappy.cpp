...
Chappy::TParam::TParam()
    ...
    , m_cullRadius(this, 'b001', "ÉJÉäÉìÉOîºåa", 2.0f, 0.0f, 10.0f)
    , m_collRadius(this, 'b002', "ÉRÉäÉWÉáÉìîºåa", 2.0f, 0.0f, 10.0f)
    , m_pikiReactRadius(this, 'b003', "ÉsÉNÉ~ÉìîΩâûîºåa", 2.0f, 0.0f, 10.0f)
    , m_hitOffset(this, 'ch20', "ìñÇΩÇËOffset", 2.0f, 0.0f, 10.0f)
    , m_hitRadius(this, 'ch21', "ìñÇΩÇËîºåa", 2.0f, 0.0f, 10.0f)
    , m_walkAngleRand(this, 'ch00', "ï‡çsÉâÉìÉ_ÉÄäpìx", 2.0f, 0.0f, 10.0f)
    , m_walkSpeed(this, 'ch01', "ï‡çsë¨ìx", 2.0f, 0.0f, 10.0f)
    , m_turnSpeed(this, 'ch23', "" /*"ê˘âÒê´î\"*/, 2.0f, 0.0f, 10.0f)
    , // problem with this string
    m_minWaitTime(this, 'ch10', "ë“Çøéûä‘ç≈è¨(ïb)", 2.0f, 0.0f, 10.0f)
    , m_maxWaitTime(this, 'ch11', "ë“Çøéûä‘ç≈ëÂ(ïb)", 2.0f, 0.0f, 10.0f)
    , m_minWalkTime(this, 'ch12', "à⁄ìÆéûä‘ç≈è¨(ïb)", 2.0f, 0.0f, 10.0f)
    , m_maxWalkTime(this, 'ch13', "à⁄ìÆéûä‘ç≈ëÂ(ïb)", 2.0f, 0.0f, 10.0f)
    , m_controlledTime(this, 'ch22', "ÉRÉìÉgÉçÅ[ÉâèÛë‘éûä‘(ïb)", 2.0f, 0.0f, 10.0f)
{
	/*
stwu     r1, -0x10(r1)
mflr     r0
