 ...
 * Size:	0000A0
 */
void JKRAramStream::write_StreamToAram_Async(JSUFileInputStream *, JKRAramBlock *, unsigned long, unsigned long, unsigned long *)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	000024
 */
void JKRAramStream::write_StreamToAram(JSUFileInputStream *, JKRAramBlock *, unsigned long, unsigned long, unsigned long *)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	0000EC
 */
void JKRAramStream::write_StreamToAram(JSUFileInputStream *, unsigned long, unsigned long, unsigned long, unsigned long *)
{
	// UNUSED FUNCTION
}
