...
void J3DTexGenBlockPatched::calc(const Mtx modelMtx)
{
	...
	//     for (s32 i = 0; i < (s32)ARRAY_SIZE(mTexMatrices); i++) {
	//         if (mTexMatrices[i] == nullptr)
	//             continue;

	//         u32 mode = mTexMatrices[i]->getTexMtxInfo().mInfo & 0x7F;
	...
	//             viewMtx[1][3] = 0.0f;
	//             viewMtx[2][3] = 0.0f;
	//             mTexMatrices[i]->setViewMtx(viewMtx);
	//         } else if (mode == J3DTexMtxMode_Projmap || mode == J3DTexMtxMode_ProjmapBasic) {
	//             mTexMatrices[i]->setViewMtx(modelMtx);
	//         } else if (mode == J3DTexMtxMode_ViewProjmap || mode == J3DTexMtxMode_ViewProjmapBasic) {
	//             Mtx viewMtx;
	//             MTXConcat(j3dSys.getViewMtx(), modelMtx, viewMtx);
	//             mTexMatrices[i]->setViewMtx(viewMtx);
	//         } else if (mode == J3DTexMtxMode_EnvmapOldEffectMtx || mode == J3DTexMtxMode_EnvmapEffectMtx || mode ==
	//         J3DTexMtxMode_Unknown5) {
	//             mTexMatrices[i]->setViewMtx(modelMtx);
	//             mTexMatrices[i]->getViewMtx()[0][3] = 0.0f;
	//             mTexMatrices[i]->getViewMtx()[1][3] = 0.0f;
	//             mTexMatrices[i]->getViewMtx()[2][3] = 0.0f;
	//         }
	...
	//             mTexMatrices[i]->setViewMtx(viewMtx);
	//         } else if (mode == J3DTexMtxMode_Projmap || mode == J3DTexMtxMode_ProjmapBasic) {
	//             mTexMatrices[i]->setViewMtx(j3dDefaultMtx);
	//         } else if (mode == J3DTexMtxMode_ViewProjmap || mode == J3DTexMtxMode_ViewProjmapBasic) {
	//             mTexMatrices[i]->setViewMtx(j3dSys.getViewMtx());
	//         } else if (mode == J3DTexMtxMode_EnvmapOldEffectMtx || mode == J3DTexMtxMode_EnvmapEffectMtx || mode ==
	//         J3DTexMtxMode_Unknown5) {
	//             mTexMatrices[i]->setViewMtx(j3dDefaultMtx);
	//         }
 ...
 * @note Size: 0x8
 */
void J3DPEBlockFogOff::setZCompLoc(u8 compLoc) { mZCompLoc = compLoc; }

/**
 * @note Address: 0x80081A88
 * @note Size: 0xC
 */
void J3DPEBlockFogOff::setZCompLoc(const u8* zCompLoc) { mZCompLoc = *zCompLoc; }

/**
 * @note Address: 0x80081A94
 * @note Size: 0x8
 */
u8 J3DPEBlockFogOff::getZCompLoc() const { return mZCompLoc; }
 ...
 * @note Size: 0x8
 */
u32 J3DTexGenBlockPatched::getTexMtxOffset() const { return mTexMtxOffset; }

/**
 * @note Address: 0x80082F88
 * @note Size: 0x8
 */
void J3DTexGenBlockPatched::setTexMtxOffset(u32 offset) { mTexMtxOffset = offset; }
