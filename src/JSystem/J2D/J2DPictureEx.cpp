...
J2DPictureEx::J2DPictureEx()
{
	...
	lis      r4, __vt__12J2DPictureEx@ha
	mr       r3, r31
	addi     r0, r4, __vt__12J2DPictureEx@l
	lis      r4, 0x110
	stw      r0, 0(r31)
	bl       initialize__12J2DPictureExFUl
	lwz      r0, 0x14(r1)
	mr       r3, r31
	lwz      r31, 0xc(r1)
	mtlr     r0
...
void J2DPictureEx::initialize(unsigned long)
{
	...
	stwu     r1, -0x10(r1)
	mflr     r0
	lis      r5, 0x50494332@ha
	stw      r0, 0x14(r1)
	addi     r0, r5, 0x50494332@l
	stw      r31, 0xc(r1)
	mr       r31, r4
	stw      r30, 8(r1)
	mr       r30, r3
 ...
 * Size:	000110
 */
J2DPictureEx::J2DPictureEx(u64, const JGeometry::TBox2f&, const ResTIMG*, u32)
{
	/*
	.loc_0x0:
	  stwu      r1, -0x20(r1)
 ...
 * Size:	000110
 */
J2DPictureEx::J2DPictureEx(u64, const JGeometry::TBox2f&, const char*, u32)
{
	/*
	.loc_0x0:
	  stwu      r1, -0x20(r1)
...
J2DPictureEx::~J2DPictureEx()
{
	...
	or.      r30, r3, r3
	beq      lbl_800552C0
	lis      r3, __vt__12J2DPictureEx@ha
	addi     r0, r3, __vt__12J2DPictureEx@l
	stw      r0, 0(r30)
	lbz      r0, 0x198(r30)
	cmplwi   r0, 0
	beq      lbl_800552A4
...
lbl_800558C8:
	mr       r4, r31
	bl       isInsert__12J2DPictureExCFUc
	clrlwi.  r0, r3, 0x18
	bne      lbl_800558E0
	li       r3, 0
	b        lbl_80055918
...
lbl_800558E0:
	...
	mr       r3, r28
	mr       r4, r31
	bl       insertCommon__12J2DPictureExFUcf
	lwz      r3, 0x168(r28)
	mr       r5, r29
	mr       r6, r30
	clrlwi   r4, r31, 0x18
...
lbl_80056E8C:
	rlwinm   r9, r7, 8, 0x10, 0x17
	rlwinm   r10, r7, 1, 0x17, 0x1e
	addi     r3, r1, 0x10
	addi     r8, r7, 1
	ori      r11, r9, 0xff
	addi     r9, r7, 2
	add      r3, r3, r10
	rlwinm   r8, r8, 8, 0x10, 0x17
	ori      r10, r8, 0xff
	sth      r11, 0(r3)
...
lbl_80056F70:
	lis      r6, 0x0000FFFF@ha
	rlwinm   r4, r4, 1, 0x17, 0x1e
	addi     r0, r6, 0x0000FFFF@l
	addi     r3, r1, 0x10
	sthx     r0, r3, r4
	addi     r0, r6, -252
	addi     r3, r1, 0x12
