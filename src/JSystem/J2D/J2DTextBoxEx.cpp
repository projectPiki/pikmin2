 ...
 * Size:	000074
 */
void J2DTextBoxEx::J2DTextBoxEx(const ResFONT*, const char*, short,
                                unsigned long)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	000074
 */
void J2DTextBoxEx::J2DTextBoxEx(unsigned long long,
                                const JGeometry::TBox2<float>&, const ResFONT*,
                                const char*, short, unsigned long)
{
	// UNUSED FUNCTION
}
...
void J2DTextBoxEx::J2DTextBoxEx(unsigned long long,
                                const JGeometry::TBox2<float>&, const ResFONT*,
                                const char*, short, J2DTextBoxHBinding,
                                J2DTextBoxVBinding, unsigned long)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	00018C
 */
void J2DTextBoxEx::initialize(unsigned long, const ResFONT*, const char*, short,
