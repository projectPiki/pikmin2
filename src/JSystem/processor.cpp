 ...
 * Size:	0000BC
 */
void JMessage::TProcessor::setBegin_messageCode((unsigned short,
                                                 unsigned short))
{
    /*
    .loc_0x0:
 ...
 * Size:	000150
 */
void JMessage::TProcessor::toMessageCode_messageID(const(unsigned long,
                                                         unsigned long, bool*))
{
    /*
    .loc_0x0:
 ...
 * Size:	0000B4
 */
void JMessage::TProcessor::on_select_begin(
    (char const* (*)(JMessage::TProcessor*), void const*, char const*,
     unsigned long))
{
    // UNUSED FUNCTION
}
 ...
 * Size:	000008
 */
void JMessage::TProcessor::do_systemTagCode((unsigned short, void const*,
                                             unsigned long))
{
    /*
    .loc_0x0:
