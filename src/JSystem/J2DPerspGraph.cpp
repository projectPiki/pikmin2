 ...
 * Size:	000074
 */
void J2DPerspGraph::J2DPerspGraph(const JGeometry::TBox2<float> &, float, float, float)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	000074
 */
void J2DPerspGraph::J2DPerspGraph(float, float, float, float, float, float, float)
{
	// UNUSED FUNCTION
}
