 ...
 * Size:	00028C
 */
void JKRAram::mainRamToAram(unsigned char *, unsigned long, unsigned long, JKRExpandSwitch, unsigned long, JKRHeap *, int, unsigned long *)
{
/*
.loc_0x0:
  stwu      r1, -0x30(r1)
 ...
 * Size:	0000F4
 */
void JKRAram::mainRamToAram(unsigned char *, JKRAramBlock *, unsigned long, JKRExpandSwitch, unsigned long, JKRHeap *, int, unsigned long *)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	0002E8
 */
void JKRAram::mainRamToAram_Async(unsigned char *, unsigned long, unsigned long, JKRExpandSwitch, unsigned long, JKRHeap *, void (*) (unsigned long), int, unsigned long *)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	000100
 */
void JKRAram::mainRamToAram_Async(unsigned char *, JKRAramBlock *, unsigned long, JKRExpandSwitch, unsigned long, JKRHeap *, void (*) (unsigned long), int, unsigned long *)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	0002E4
 */
void JKRAram::aramToMainRam_Async(unsigned long, unsigned char *, unsigned long, JKRExpandSwitch, unsigned long, JKRHeap *, void (*) (unsigned long), int, unsigned long *)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	000100
 */
void JKRAram::aramToMainRam_Async(JKRAramBlock *, unsigned char *, unsigned long, unsigned long, JKRExpandSwitch, unsigned long, JKRHeap *, void (*) (unsigned long), int, unsigned long *)
{
	// UNUSED FUNCTION
}
