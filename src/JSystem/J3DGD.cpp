 ...
 * Size:	000128
 */
void J3DGDSetTevIndirect(_GXTevStageID, _GXIndTexStageID, _GXIndTexFormat, _GXIndTexBiasSel, _GXIndTexMtxID, _GXIndTexWrap, _GXIndTexWrap, unsigned char, unsigned char, _GXIndTexAlphaSel)
{
	// UNUSED FUNCTION
}
