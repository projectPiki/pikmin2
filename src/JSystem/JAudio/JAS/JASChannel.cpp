 ...
 * @note Size: 0x8
 */
void JASChannel::directReleaseOsc(u16 a1) { _30[0].mRelease = a1; }
 ...
 * @note Size: 0x8
 */
void JASChannel::setPauseFlag(bool a1) { _1C = a1; }
...
void JASChannel::sweepProc()
{
	...
	mModifiedPitch += (_C0 - mModifiedPitch) / _C4;
	_C4--;
	/*
	stwu     r1, -0x10(r1)
	lwz      r4, 0xc4(r3)
