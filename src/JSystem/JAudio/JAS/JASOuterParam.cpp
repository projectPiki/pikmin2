 ...
 * @note Size: 0x1C
 */
bool JASOuterParam::checkOuterSwitch(u16 p1)
{
	return mOuterSwitch & p1;
}
 ...
 * @note Size: 0x8
 */
u16 JASOuterParam::getOuterUpdate()
{
	return mOuterUpdate;
}
 ...
 * @note Size: 0x10
 */
s16 JASOuterParam::getIntFirFilter(u8 index)
{
	return mFirFilter[index];
}
