 ...
 * @note Size: 0x8
 */
int TSystem::JSGFindObject(TObject**, char const*, TEObject) const
{
	return 1;
}
 ...
 * @note Size: 0x8
 */
int TSystem::JSGCreateObject(char const*, TEObject, u32)
{
	return 0;
}
 ...
 * @note Size: 0x8
 */
int TSystem::JSGGetSystemData(u32)
{
	return 0;
}
