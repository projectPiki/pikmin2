 ...
 * @note Size: 0x8
 */
int TActor::JSGGetAnimation() const
{
	return -1;
}
 ...
 * @note Size: 0x8
 */
f32 TActor::JSGGetAnimationFrame() const
{
	return 0.0f;
}
 ...
 * @note Size: 0x8
 */
f32 TActor::JSGGetAnimationFrameMax() const
{
	return 0.0f;
}
 ...
 * @note Size: 0x8
 */
f32 TActor::JSGGetAnimationTransition() const
{
	return 0.0f;
}
 ...
 * @note Size: 0x8
 */
int TActor::JSGGetTextureAnimation() const
{
	return -1;
}
 ...
 * @note Size: 0x8
 */
f32 TActor::JSGGetTextureAnimationFrame() const
{
	return 0.0f;
}
 ...
 * @note Size: 0x8
 */
f32 TActor::JSGGetTextureAnimationFrameMax() const
{
	return 0.0f;
}
} // namespace JStage
