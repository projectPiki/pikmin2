...
/*
   ...
   getUsableTlut__12J2DPictureExFUc .global __vt__Q28Morimura13TPikminDown2D
...
Morimura::TGameOverBase::TGameOverBase(char*)
{
	...
	lis      r3, __vt__Q28Morimura13TGameOverBase@ha
	li       r5, 0
	addi     r3, r3, __vt__Q28Morimura13TGameOverBase@l
	li       r4, 1
	stw      r3, 0(r31)
	addi     r6, r3, 0x10
	li       r0, 0x96
 ...
 * Size:	0000F0
 */
void Morimura::TGameOverBase::doUpdate()
{
	/*
	stwu     r1, -0x30(r1)
	mflr     r0
	...
	cmplwi   r3, 0
	beq      lbl_8034808C
	bl       update__Q28Morimura15TGameOverScreenFv
	lha      r4, 0x86(r31)
	lha      r0, 0x8e(r31)
	lfs      f2, lbl_8051E2D0@sda21(r2)
	cmpw     r4, r0
	bge      lbl_80348020
	lis      r3, 0x4330
	xoris    r4, r4, 0x8000
...
lbl_80348020:
	...
	beq      lbl_80348054
	lbz      r4, 0x84(r31)
	bl       setFadeAlpha__Q28Morimura15TGameOverScreenFUc
 ...
 * Size:	000010
 */
void Morimura::TGameOverBase::init()
{
	// UNUSED FUNCTION
}
...
void Morimura::TGameOver2D::doCreate(JKRArchive*)
{
	...
	stw      r30, 0x18(r1)
	mr       r30, r4
	lis      r4, lbl_804902F8@ha
	stw      r29, 0x14(r1)
	mr       r29, r3
	addi     r31, r4, lbl_804902F8@l
	stw      r30, 0x78(r3)
	li       r3, 0x20
	sth      r0, 0x86(r29)
	stb      r0, 0x84(r29)
	...
	mr       r4, r30
	li       r5, 3
	bl       __ct__Q28Morimura15TGameOverScreenFP10JKRArchivei
	mr       r0, r3
...
lbl_8034833C:
	...
	lis      r5, 0x104
	lwz      r3, 0x7c(r29)
	bl       init__Q28Morimura15TGameOverScreenFPCcUl
	lwz      r3, 0x7c(r29)
	addi     r4, r31, 0x24
	bl       addAnim__Q28Morimura15TGameOverScreenFPc
	lwz      r3, 0x7c(r29)
	addi     r4, r31, 0x3c
	bl       addAnim__Q28Morimura15TGameOverScreenFPc
	lwz      r3, 0x7c(r29)
 ...
 * Size:	00008C
 */
void Morimura::TGameOverScreen::update()
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
...
void Morimura::TGameOverScreen::setFadeAlpha(unsigned char)
{
	...
	stwu     r1, -0x10(r1)
	mflr     r0
	lis      r6, 0x745F3030@ha
	lis      r5, 0x65666563@ha
	stw      r0, 0x14(r1)
	addi     r6, r6, 0x745F3030@l
	addi     r5, r5, 0x65666563@l
	stw      r31, 0xc(r1)
	mr       r31, r4
	stw      r30, 8(r1)
	mr       r30, r3
	...
	bctrl
	lwz      r3, 4(r30)
	lis      r5, 0x7573656C@ha
	lis      r4, 0x00636170@ha
	lwz      r12, 0(r3)
	addi     r6, r5, 0x7573656C@l
	addi     r5, r4, 0x00636170@l
	lwz      r12, 0x3c(r12)
	mtctr    r12
	bctrl
	lwz      r12, 0(r3)
 ...
 * Size:	000060
 */
Morimura::TGXSetPane::~TGXSetPane()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	or.      r30, r3, r3
	beq      lbl_80348C04
	lis      r5, __vt__Q28Morimura10TGXSetPane@ha
	li       r4, 0
	addi     r0, r5, __vt__Q28Morimura10TGXSetPane@l
	stw      r0, 0(r30)
 ...
 * Size:	0000DC
 */
Morimura::TPikminDown2D::~TPikminDown2D()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	or.      r30, r3, r3
	beq      lbl_80348D0C
	lis      r4, __vt__Q28Morimura13TPikminDown2D@ha
	addi     r4, r4, __vt__Q28Morimura13TPikminDown2D@l
	stw      r4, 0(r30)
	addi     r0, r4, 0x10
	stw      r0, 0x18(r30)
	beq      lbl_80348CFC
	lis      r4, __vt__Q28Morimura13TGameOverBase@ha
	addi     r4, r4, __vt__Q28Morimura13TGameOverBase@l
	stw      r4, 0(r30)
	addi     r0, r4, 0x10
	stw      r0, 0x18(r30)
	beq      lbl_80348CFC
 ...
 * Size:	000008
 */
void Morimura::TGameOverBase::getDispMemberBase()
{
	/*
	lwz      r3, 0x80(r3)
	blr
 ...
 * Size:	000034
 */
void Morimura::TGameOverBase::doUpdateFadeout()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	0000DC
 */
Morimura::TPresidentDown2D::~TPresidentDown2D()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	or.      r30, r3, r3
	beq      lbl_80348E24
	lis      r4, __vt__Q28Morimura16TPresidentDown2D@ha
	addi     r4, r4, __vt__Q28Morimura16TPresidentDown2D@l
	stw      r4, 0(r30)
	addi     r0, r4, 0x10
	stw      r0, 0x18(r30)
	beq      lbl_80348E14
 ...
 * Size:	0000DC
 */
Morimura::TLujiDown2D::~TLujiDown2D()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	or.      r30, r3, r3
	beq      lbl_80348F00
	lis      r4, __vt__Q28Morimura11TLujiDown2D@ha
	addi     r4, r4, __vt__Q28Morimura11TLujiDown2D@l
	stw      r4, 0(r30)
	addi     r0, r4, 0x10
	stw      r0, 0x18(r30)
	beq      lbl_80348EF0
 ...
 * Size:	0000DC
 */
Morimura::TOrimaDown2D::~TOrimaDown2D()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	or.      r30, r3, r3
	beq      lbl_80348FDC
	lis      r4, __vt__Q28Morimura12TOrimaDown2D@ha
	addi     r4, r4, __vt__Q28Morimura12TOrimaDown2D@l
	stw      r4, 0(r30)
	addi     r0, r4, 0x10
	stw      r0, 0x18(r30)
	beq      lbl_80348FCC
 ...
 * Size:	0000DC
 */
Morimura::TGameOver2D::~TGameOver2D()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	or.      r30, r3, r3
	beq      lbl_803490B8
	lis      r4, __vt__Q28Morimura11TGameOver2D@ha
	addi     r4, r4, __vt__Q28Morimura11TGameOver2D@l
	stw      r4, 0(r30)
	addi     r0, r4, 0x10
	stw      r0, 0x18(r30)
	beq      lbl_803490A8
 ...
 * Size:	0000C4
 */
Morimura::TGameOverBase::~TGameOverBase()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000008
 */
@24 @Morimura::TGameOverBase::~TGameOverBase()
{
	/*
	addi     r3, r3, -24
	b        __dt__Q28Morimura13TGameOverBaseFv
	*/
}
 ...
 * Size:	000008
 */
@24 @Morimura::TGameOver2D::~TGameOver2D()
{
	/*
	addi     r3, r3, -24
	b        __dt__Q28Morimura11TGameOver2DFv
	*/
}
 ...
 * Size:	000008
 */
@24 @Morimura::TOrimaDown2D::~TOrimaDown2D()
{
	/*
	addi     r3, r3, -24
	b        __dt__Q28Morimura12TOrimaDown2DFv
	*/
}
 ...
 * Size:	000008
 */
@24 @Morimura::TLujiDown2D::~TLujiDown2D()
{
	/*
	addi     r3, r3, -24
	b        __dt__Q28Morimura11TLujiDown2DFv
	*/
}
 ...
 * Size:	000008
 */
@24 @Morimura::TPresidentDown2D::~TPresidentDown2D()
{
	/*
	addi     r3, r3, -24
	b        __dt__Q28Morimura16TPresidentDown2DFv
	*/
}
 ...
 * Size:	000008
 */
@24 @Morimura::TPikminDown2D::~TPikminDown2D()
{
	/*
	addi     r3, r3, -24
	b        __dt__Q28Morimura13TPikminDown2DFv
	*/
}
