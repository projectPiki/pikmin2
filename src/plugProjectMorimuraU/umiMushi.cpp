 ...
 * Size:	000038
 */
void UmiMushi::eyeScaleCallBack(J3DJoint*, int)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	stw      r0, 0x14(r1)
	bne      lbl_80383124
	lwz      r3, curU__Q24Game8UmiMushi@sda21(r13)
	cmplwi   r3, 0
	beq      lbl_80383124
	bl       eyeScaleMtxCalc__Q34Game8UmiMushi3ObjFv
 ...
 * Size:	000038
 */
void UmiMushi::weakScaleCallBack(J3DJoint*, int)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	cmplwi   r3, 0
	beq      lbl_8038315C
	bl       weakScaleMtxCalc__Q34Game8UmiMushi3ObjFv
 ...
 * Size:	0000B4
 */
void UmiMushi::Obj::setParameters()
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	000030
 */
void UmiMushi::Obj::getBodyRadius()
{
	/*
	lwz      r0, 0x1e0(r3)
	...
	cmpwi    r0, 0x65
	bne      lbl_80383244
	lfs      f1, lbl_8051ED98@sda21(r2)
	blr

lbl_80383244:
	lfs      f1, lbl_8051ED9C@sda21(r2)
	blr
 ...
 * Size:	000020
 */
void birth__Q34Game8UmiMushi3ObjFR10Vector3f f()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	0005A8
 */
void UmiMushi::Obj::onInit(Game::CreatureInitArg*)
{
	/*
	stwu     r1, -0x30(r1)
	mflr     r0
 ...
 * Size:	00004C
 */
void UmiMushi::Obj::setFSM(Game::UmiMushi::FSM*)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	0004B0
 */
void UmiMushi::Obj::doAnimationCullingOff()
{
	/*
	stwu     r1, -0x50(r1)
	mflr     r0
	...
	cmpwi    r0, 0x65
	bne      lbl_80383D58
	stw      r31, curU__Q24Game8UmiMushi@sda21(r13)

lbl_80383D58:
	mr       r3, r31
	bl       doAnimationCullingOff__Q24Game9EnemyBaseFv
	lwz      r3, 0x358(r31)
	bl       update__Q34Game8UmiMushi17UmimushiShadowMgrFv
	lwz      r3, 0x2d8(r31)
	cmplwi   r3, 0
	beq      lbl_80383DF4
	lbz      r0, 0x2dc(r31)
...
lbl_80383E60:
	clrlwi.  r0, r30, 0x18
	bne      lbl_80383E84
	lis      r3, lbl_80493B28@ha
	lis      r5, lbl_80493B10@ha
	addi     r3, r3, lbl_80493B28@l
	li       r4, 0x454
...
lbl_803841A0:
	li       r0, 0
	stw      r0, curU__Q24Game8UmiMushi@sda21(r13)
 ...
 * Size:	000034
 */
void UmiMushi::Obj::doAnimationCullingOn()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000004
 */
void UmiMushi::Obj::doDirectDraw(Graphics&) { }
 ...
 * Size:	000020
 */
void UmiMushi::Obj::doDebugDraw(Graphics&)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000098
 */
void UmiMushi::Obj::changeMaterial()
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	0000DC
 */
void UmiMushi::Obj::doStartMovie()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000090
 */
void UmiMushi::Obj::getShadowParam(Game::ShadowParam&)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000040
 */
void UmiMushi::Obj::doSimulation(float)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000164
 */
void UmiMushi::Obj::damageCallBack(Game::Creature*, float, CollPart*)
{
	/*
	stwu     r1, -0x40(r1)
	mflr     r0
 ...
 * Size:	0000BC
 */
void UmiMushi::Obj::pressCallBack(Game::Creature*, float, CollPart*)
{
	/*
	stwu     r1, -0x30(r1)
	mflr     r0
...
lbl_80384730:
	...
	mr       r4, r30
	mr       r5, r31
	bl       pressCallBack__Q24Game9EnemyBaseFPQ24Game8CreaturefP8CollPart
 ...
 * Size:	0000BC
 */
void UmiMushi::Obj::hipdropCallBack(Game::Creature*, float, CollPart*)
{
	/*
	stwu     r1, -0x30(r1)
	mflr     r0
 ...
 * Size:	0000AC
 */
void UmiMushi::Obj::earthquakeCallBack(Game::Creature*, float)
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	000020
 */
void UmiMushi::Obj::collisionCallback(Game::CollEvent&)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000130
 */
void UmiMushi::Obj::initMouthSlots()
{
	/*
	stwu     r1, -0x50(r1)
	mflr     r0
	...
	lis      r4, lbl_80493BD0@ha
	li       r3, 0xe
	addi     r10, r4, lbl_80493BD0@l
	lwz      r9, 0(r10)
	lwz      r8, 4(r10)
	lwz      r7, 8(r10)
	lwz      r6, 0xc(r10)
 ...
 * Size:	000094
 */
void UmiMushi::Obj::doStartStoneState()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
	...
	bl       __as__4ID32FUl
	lis      r4, 0x6B757469@ha
	lwz      r3, 0x114(r31)
	addi     r4, r4, 0x6B757469@l
	bl       getCollPart__8CollTreeFUl
	lis      r4, 0x73745F5F@ha
	addi     r3, r3, 0x3c
	addi     r4, r4, 0x73745F5F@l
 ...
 * Size:	0000BC
 */
void UmiMushi::Obj::doFinishStoneState()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000028
 */
void UmiMushi::Obj::startCarcassMotion()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	00004C
 */
void UmiMushi::Obj::doGetLifeGaugeParam(Game::LifeGaugeParam&)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	00005C
 */
void UmiMushi::Obj::isReachToGoal(float)
{
	/*
	lwz      r4, 0x2f4(r3)
	addi     r0, r4, 1
 ...
 * Size:	000014
 */
void UmiMushi::Obj::resetWalkParm()
{
	/*
	lfs      f1, 0x1fc(r3)
	lfs      f0, lbl_8051EDA0@sda21(r2)
 ...
 * Size:	000248
 */
void UmiMushi::Obj::isChangeNavi()
{
	/*
	stwu     r1, -0x70(r1)
	mflr     r0
 ...
 * Size:	0001D8
 */
void UmiMushi::Obj::isFindTarget()
{
	/*
	stwu     r1, -0x90(r1)
	mflr     r0
 ...
 * Size:	000240
 */
void UmiMushi::Obj::isAttackStart()
{
	/*
	stwu     r1, -0xb0(r1)
	mflr     r0
 ...
 * Size:	00005C
 */
void UmiMushi::Obj::isOutOfTerritory(float)
{
	/*
	lwz      r4, gameSystem__4Game@sda21(r13)
	lwz      r5, 0xc0(r3)
 ...
 * Size:	000044
 */
void UmiMushi::Obj::fadeAllEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	0000A8
 */
void UmiMushi::Obj::fadeColorEffect()
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	00010C
 */
void UmiMushi::Obj::createColorEffect()
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	0000C0
 */
void UmiMushi::Obj::attackEffect()
{
	/*
	stwu     r1, -0x40(r1)
	mflr     r0
 ...
 * Size:	000070
 */
void UmiMushi::Obj::bubbleEffect()
{
	/*
	stwu     r1, -0x20(r1)
	mflr     r0
 ...
 * Size:	0002C8
 */
void UmiMushi::Obj::eyeScaleMtxCalc()
{
	/*
	stwu     r1, -0x40(r1)
	mflr     r0
 ...
 * Size:	000184
 */
void UmiMushi::Obj::weakScaleMtxCalc()
{
	/*
	lwz      r4, 0x174(r3)
	lhz      r0, 0x362(r3)
...
or.      r30, r3, r3
beq      lbl_8038758C
lis      r3, __vt__Q23efx11TUmiDeadawa@ha
addi     r3, r3, __vt__Q23efx11TUmiDeadawa@l
stw      r3, 0(r30)
addi     r0, r3, 0x14
stw      r0, 4(r30)
beq      lbl_8038757C
...
or.      r30, r3, r3
beq      lbl_80387628
lis      r3, __vt__Q23efx7TUmiEat@ha
addi     r3, r3, __vt__Q23efx7TUmiEat@l
stw      r3, 0(r30)
addi     r0, r3, 0x14
stw      r0, 4(r30)
beq      lbl_80387618
 ...
 * Size:	000004
 */
void UmiMushi::Obj::setInitialSetting(Game::EnemyInitialParamBase*) { }
 ...
 * Size:	000004
 */
void applyImpulse__Q34Game8UmiMushi3ObjFR10Vector3f R10Vector3f() { }
 ...
 * Size:	00000C
 */
void UmiMushi::Obj::getDamageCoeStoneState()
{
	/*
	lwz      r3, 0xc0(r3)
	lfs      f1, 0x81c(r3)
 ...
 * Size:	000028
 */
void UmiMushi::Obj::eatWhitePikminCallBack(Game::Creature*, float)
{
	/*
	stwu     r1, -0x10(r1)
	mflr     r0
 ...
 * Size:	000008
 */
void UmiMushi::Obj::getEnemyTypeID()
{
	/*
	lwz      r3, 0x39c(r3)
	blr
 ...
 * Size:	000008
 */
void UmiMushi::Obj::getMouthSlots()
{
	/*
	addi     r3, r3, 0x2cc
	blr
 ...
 * Size:	000014
 */
void @932 @12 @Game::EnemyBase::viewOnPelletKilled()
{
	/*
	li       r11, 0xc
	lwzx     r11, r3, r11
 ...
 * Size:	000014
 */
void @932 @12 @Game::EnemyBase::viewStartCarryMotion()
{
	/*
	li       r11, 0xc
	lwzx     r11, r3, r11
 ...
 * Size:	000014
 */
void @932 @12 @Game::EnemyBase::viewStartPreCarryMotion()
{
	/*
	li       r11, 0xc
	lwzx     r11, r3, r11
 ...
 * Size:	000014
 */
void @932 @12 @Game::EnemyBase::view_finish_carrymotion()
{
	/*
	li       r11, 0xc
	lwzx     r11, r3, r11
 ...
 * Size:	000014
 */
void @932 @12 @Game::EnemyBase::view_start_carrymotion()
{
	/*
	li       r11, 0xc
	lwzx     r11, r3, r11
 ...
 * Size:	000014
 */
void @932 @12 @Game::EnemyBase::viewGetShape()
{
	/*
	li       r11, 0xc
	lwzx     r11, r3, r11
 ...
 * Size:	000008
 */
@4 @efx::TUmiEat::~TUmiEat()
{
	/*
	addi     r3, r3, -4
	b        __dt__Q23efx7TUmiEatFv
	*/
}
 ...
 * Size:	000008
 */
@4 @efx::TUmiDeadawa::~TUmiDeadawa()
{
	/*
	addi     r3, r3, -4
	b        __dt__Q23efx11TUmiDeadawaFv
	*/
}
