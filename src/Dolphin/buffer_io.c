...
s32 __flush_buffer(bufferStruct* param_1, u32* param_2)
{
	...
	if (uVar1 != 0) {
		...
		iVar2 = param_1->beans(param_1->field0_0x0, param_1->field22_0x1c,
		                       &param_1->field25_0x28, param_1->field45_0x48);
		if (param_2 != nullptr) {
	...
	param_1->field25_0x28 = param_1->field25_0x28
	                        - (param_1->field21_0x18 & param_1->field26_0x2c);
