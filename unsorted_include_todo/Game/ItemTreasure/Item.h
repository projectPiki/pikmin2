#ifndef _GAME_ITEMTREASURE_ITEM_H
#define _GAME_ITEMTREASURE_ITEM_H
...
namespace Game {
struct FSMItem<Game::ItemTreasure::Item, Game::ItemTreasure::FSM, Game::ItemTreasure::State> {
	virtual void _08() = 0;                                                                                                  // _08
	virtual void _0C() = 0;                                                                                                  // _0C
	virtual void _10() = 0;                                                                                                  // _10
	virtual void _14() = 0;                                                                                                  // _14
	...
	virtual void _E0() = 0;                                                                                                  // _E0
	virtual void _E4() = 0;                                                                                                  // _E4
	virtual void FSMItem<ItemTreasure::Item, ItemTreasure::FSM, ItemTreasure::State>::bounceCallback(Sys::Triangle*);        // _E8 (weak)
	virtual void FSMItem<ItemTreasure::Item, ItemTreasure::FSM, ItemTreasure::State>::collisionCallback(CollEvent&);         // _EC (weak)
	virtual void FSMItem<ItemTreasure::Item, ItemTreasure::FSM, ItemTreasure::State>::platCallback(PlatEvent&);              // _F0 (weak)
	virtual void _F4()  = 0;                                                                                                 // _F4
	virtual void _F8()  = 0;                                                                                                 // _F8
	virtual void _FC()  = 0;                                                                                                 // _FC
	virtual void _100() = 0;                                                                                                 // _100
	...
	virtual void FSMItem<ItemTreasure::Item, ItemTreasure::FSM, ItemTreasure::State>::onKeyEvent(const SysShape::KeyEvent&); // _220 (weak)
};
} // namespace Game
...
struct Item : public BaseItem,
              public Creature,
              public CellObject,
              public FSMItem<Game::ItemTreasure::Item, Game::ItemTreasure::FSM, Game::ItemTreasure::State> {
	virtual void constructor();                                 // _2C
	virtual void onInit(CreatureInitArg*);                      // _30
	virtual void doDirectDraw(Graphics&);                       // _50
	virtual void ignoreAtari(Creature*);                        // _190
