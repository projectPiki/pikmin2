#ifndef _GAME_ENEMYBASEFSM_BIRTHTYPEDROPPIKMINSTATE_H
#define _GAME_ENEMYBASEFSM_BIRTHTYPEDROPPIKMINSTATE_H
...
namespace Game {
namespace EnemyBaseFSM {
struct BirthTypeDropPikminState : public BirthTypeDropState, public EnemyFSMState, public State {
