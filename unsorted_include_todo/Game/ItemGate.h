...
namespace Game {
struct FSMItem<Game::ItemGate, Game::GateFSM, Game::GateState> {
	virtual void _08() = 0;                                                             // _08
	virtual void _0C() = 0;                                                             // _0C
	virtual void _10() = 0;                                                             // _10
	virtual void _14() = 0;                                                             // _14
	...
	virtual void doSave(Stream&);                                                       // _E0
	virtual void doLoad(Stream&);                                                       // _E4
	virtual void FSMItem<ItemGate, GateFSM, GateState>::bounceCallback(Sys::Triangle*); // _E8 (weak)
	virtual void FSMItem<ItemGate, GateFSM, GateState>::collisionCallback(CollEvent&);  // _EC (weak)
	virtual void FSMItem<ItemGate, GateFSM, GateState>::platCallback(PlatEvent&);       // _F0 (weak)
};
} // namespace Game

namespace Game {
struct ItemGate : public BaseItem, public Creature, public CellObject, public FSMItem<Game::ItemGate, Game::GateFSM, Game::GateState> {
	virtual void constructor();                                 // _2C
	virtual void onInit(CreatureInitArg*);                      // _30
	virtual void getFaceDir();                                  // _64 (weak)
	virtual void doSave(Stream&);                               // _E0
