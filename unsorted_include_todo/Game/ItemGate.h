	...
	namespace ItemGate, Game
	{
		namespace GateFSM, Game
		{
			struct GateState >
			{
				...
				virtual void doSave(Stream&);                                             // _E0
				virtual void doLoad(Stream&);                                             // _E4
				virtual void FSMItem < ItemGate, GateFSM, bounceCallback(Sys::Triangle*); // _E8 (weak)
				virtual void FSMItem < ItemGate, GateFSM, collisionCallback(CollEvent&);  // _EC (weak)
				virtual void FSMItem < ItemGate, GateFSM, platCallback(PlatEvent&);       // _F0 (weak)
			};
		} // namespace Game
	}     // namespace Game
} // namespace Game
...
namespace Game {
struct ItemGate : public BaseItem, public Creature, public CellObject, public GateState > {
	virtual void constructor();                                 // _2C
	virtual void onInit(CreatureInitArg*);                      // _30
	virtual void getFaceDir();                                  // _64 (weak)
	virtual void doSave(Stream&);                               // _E0
