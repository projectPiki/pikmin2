#ifndef _GAME_ITEMDOWNFLOOR_MGR_H
#define _GAME_ITEMDOWNFLOOR_MGR_H
...
struct Mgr : public TNodeItemMgr, public GenericObjectMgr, public BaseItemMgr, public CNode, public BaseItem > {
	virtual void onLoadResources();                                              // _48
	virtual void generatorGetID();                                               // _58 (weak)
	virtual void generatorBirth(Vector3<float>&, Vector3<float>&, GenItemParm*); // _5C
	virtual void generatorWrite(Stream&, GenItemParm*);                          // _60
	...
	virtual void getCaveName(int);                                               // _BC
	virtual void getCaveID(char*);                                               // _C0

	Mgr();
	void setupDownFloor(Game::ItemDownFloor::Item*);
	void setupPlatform(Game::ItemDownFloor::Item*);
	void birth();
};
} // namespace ItemDownFloor
} // namespace Game
