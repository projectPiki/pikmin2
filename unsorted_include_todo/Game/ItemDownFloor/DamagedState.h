#ifndef _GAME_ITEMDOWNFLOOR_DAMAGEDSTATE_H
#define _GAME_ITEMDOWNFLOOR_DAMAGEDSTATE_H
...
struct DamagedState : public FSMState<Game::ItemDownFloor::Item>, public ItemState<Game::ItemDownFloor::Item> {
	virtual void init(Item*, StateArg*);                       // _08
	virtual void exec(Item*);                                  // _0C
	virtual void cleanup(Item*);                               // _10
	virtual void onKeyEvent(Item*, const SysShape::KeyEvent&); // _24
