...
struct BaseItem {
    ...
    virtual void makeTrMatrix();                                // _1C4 (inline)
...
namespace ItemDownFloor {
    struct Item : public BaseItem,
        ...
        virtual void @480 @getCarryInfoParam(CarryInfoParam&); // _22C (inline)
        virtual void getCarryInfoParam(CarryInfoParam&);       // _230 (inline)
