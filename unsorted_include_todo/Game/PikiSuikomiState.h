#ifndef _GAME_PIKISUIKOMISTATE_H
#define _GAME_PIKISUIKOMISTATE_H
...
namespace Game {
struct PikiSuikomiState : public FSMState<Game::Piki>, public PikiState {
	virtual void init(Piki*, StateArg*);                       // _08
	virtual void exec(Piki*);                                  // _0C
	virtual void cleanup(Piki*);                               // _10
	virtual void ignoreAtari(Piki*, Creature*);                // _20
	...
	void execMouth(Game::Piki*);
	void execString(Game::Piki*);
	void execStomach(Game::Piki*);
};
} // namespace Game
