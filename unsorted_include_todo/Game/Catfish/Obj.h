...
struct PelletView {
	...
	virtual void setAnimationSpeed(float);                     // _2FC (inline)
	virtual void resetEnemyNonStone();                         // _300
	virtual void setEnemyNonStone();                           // _304 (inline)
	virtual void _308() = 0;                                   // _308
	virtual void _30C() = 0;                                   // _30C
	virtual void viewGetBaseScale();                           // _310 (inline)
	virtual void _314() = 0;                                   // _314
	virtual void viewGetCollTreeJointIndex();                  // _318 (inline)
	virtual void viewGetCollTreeOffset();                      // _31C (inline)
	virtual void _320() = 0;                                   // _320
	virtual void _324() = 0;                                   // _324
	virtual void _328() = 0;                                   // _328
	virtual void _32C() = 0;                                   // _32C
	virtual void _330() = 0;                                   // _330
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);    // _334 (inline)
};
} // namespace Game
