#ifndef _GAME_CATFISH_OBJ_H
#define _GAME_CATFISH_OBJ_H
...
/*
    ...
    .4byte hipdropCallBack__Q34Game7Catfish3ObjFPQ24Game8CreaturefP8CollPart
...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _310
	virtual void _314() = 0;                                // _314
	virtual void viewGetCollTreeJointIndex();               // _318
	virtual void viewGetCollTreeOffset();                   // _31C
	virtual void _320() = 0;                                // _320
	virtual void _324() = 0;                                // _324
	virtual void _328() = 0;                                // _328
	virtual void _32C() = 0;                                // _32C
	virtual void _330() = 0;                                // _330
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _334
