...
struct Obj {
	...
	virtual void setAnimationSpeed(float);                     // _2FC (weak)
};
} // namespace KochappyBase
} // namespace Game
...
struct PelletView {
	...
	virtual void viewGetBaseScale();                           // _310 (weak)
	virtual void _314() = 0;                                   // _314
	virtual void viewGetCollTreeJointIndex();                  // _318 (weak)
	virtual void viewGetCollTreeOffset();                      // _31C (weak)
	virtual void _320() = 0;                                   // _320
	virtual void _324() = 0;                                   // _324
	virtual void _328() = 0;                                   // _328
	virtual void _32C() = 0;                                   // _32C
	virtual void _330() = 0;                                   // _330
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);    // _334 (weak)
};
} // namespace Game
