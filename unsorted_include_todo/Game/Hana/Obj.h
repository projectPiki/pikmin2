...
struct EnemyBase {
	...
	virtual void changeMaterial();                                  // _200 (inline)
...
struct PelletView {
	...
	virtual void flickAttackFail();                           // _304 (inline)
	...
	virtual void createEffect();                              // _31C (inline)
	virtual void setupEffect();                               // _320 (inline)
	virtual void startSleepEffect();                          // _324 (inline)
	virtual void finishSleepEffect();                         // _328 (inline)
	virtual void createFlickEffect();                         // _32C (inline)
