...
struct Container<GenericObjectMgr> {
	virtual ~Container<GenericObjectMgr>(); // _08 (weak)
...
struct NodeObjectMgr<GenericObjectMgr> {
	virtual ~NodeObjectMgr<GenericObjectMgr>(); // _08 (weak)
	virtual void _0C() = 0;                     // _0C
...
namespace Game {
struct PelletMgr : public CNode, public Container<GenericObjectMgr>, public NodeObjectMgr<GenericObjectMgr>, public GenericObjectMgr {
