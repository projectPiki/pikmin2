#ifndef _GAME_ITEMPLANT_GROWUPSTATE_H
#define _GAME_ITEMPLANT_GROWUPSTATE_H
...
namespace Game {
namespace ItemPlant {
struct GrowUpState : public FSMState<Game::ItemPlant::Item>, public ItemState<Game::ItemPlant::Item>, public State {
	virtual void init(Item*, StateArg*);                       // _08
	virtual void exec(Item*);                                  // _0C
	virtual void cleanup(Item*);                               // _10
	virtual void onDamage(Item*, float);                       // _20
