#ifndef _GAME_ITEMPLANT_ITEM_H
#define _GAME_ITEMPLANT_ITEM_H
...
struct Item : public BaseItem,
	...
	virtual void interactFarmHaero(InteractFarmHaero&);   // _1FC
	virtual void onSetPosition();                         // _21C
	virtual void hasFruits();                             // _224 (weak)
	virtual void getFruitsNum();                          // _228 (weak)
	virtual void getNearestFruit(Vector3<float>&);        // _22C (weak)
	virtual void bearFruits();                            // _230 (weak)
	virtual void killFruits();                            // _234 (weak)
	virtual void dropFruit(int);                          // _238 (weak)
	virtual void setColor(float);                         // _23C (weak)
