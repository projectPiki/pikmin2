	...
	namespace Item, Game
	{
		...
		namespace FSM, Game
		{
			...
			struct State >
			{
				...
				virtual void _E0() = 0;                                                  // _E0
				virtual void _E4() = 0;                                                  // _E4
				virtual void FSMItem < Item, FSM, bounceCallback(Sys::Triangle*);        // _E8 (inline)
				virtual void FSMItem < Item, FSM, collisionCallback(CollEvent&);         // _EC (inline)
				virtual void FSMItem < Item, FSM, platCallback(PlatEvent&);              // _F0 (inline)
				virtual void _F4()  = 0;                                                 // _F4
				virtual void _F8()  = 0;                                                 // _F8
				virtual void _FC()  = 0;                                                 // _FC
				virtual void _100() = 0;                                                 // _100
				...
				virtual void FSMItem < Item, FSM, onKeyEvent(const SysShape::KeyEvent&); // _220 (inline)
			};
			} // namespace ItemPlant
		}     // namespace Game
		}     // namespace ItemPlant
...
struct Item : public BaseItem, public Creature, public CellObject, public State > {
	...
	virtual void interactFarmHaero(InteractFarmHaero&);   // _1FC
	virtual void onSetPosition();                         // _21C
	virtual void hasFruits();                             // _224 (inline)
	virtual void getFruitsNum();                          // _228 (inline)
	virtual void getNearestFruit(Vector3<float>&);        // _22C (inline)
	virtual void bearFruits();                            // _230 (inline)
	virtual void killFruits();                            // _234 (inline)
	virtual void dropFruit(int);                          // _238 (inline)
	virtual void setColor(float);                         // _23C (inline)
	virtual void startColorMotion(int);                   // _240
	virtual void updateColorMotion(float);                // _244
	virtual void startMotion(int);                        // _248 (inline)
