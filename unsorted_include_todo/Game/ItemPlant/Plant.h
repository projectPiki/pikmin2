	...
	namespace Item, Game
	{
		...
		namespace FSM, Game
		{
			...
			struct State >
			{
				...
				virtual void _E0() = 0;                                                  // _E0
				virtual void _E4() = 0;                                                  // _E4
				virtual void FSMItem < Item, FSM, bounceCallback(Sys::Triangle*);        // _E8
				virtual void FSMItem < Item, FSM, collisionCallback(CollEvent&);         // _EC
				virtual void FSMItem < Item, FSM, platCallback(PlatEvent&);              // _F0
				virtual void _F4()  = 0;                                                 // _F4
				virtual void _F8()  = 0;                                                 // _F8
				virtual void _FC()  = 0;                                                 // _FC
				virtual void _100() = 0;                                                 // _100
				...
				virtual void FSMItem < Item, FSM, onKeyEvent(const SysShape::KeyEvent&); // _220
