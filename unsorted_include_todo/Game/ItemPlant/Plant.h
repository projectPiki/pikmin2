...
namespace ItemPlant {
	struct Item {
		...
		virtual void startColorMotion(int);                   // _238
		virtual void updateColorMotion(float);                // _23C
				...
				namespace FSM, Game
				{
					namespace ItemPlant {
						struct State >
						{
							...
							virtual void FSMItem < Item, FSM,
							    onKeyEvent(const SysShape::KeyEvent&); // _218
...
namespace ItemPlant {
	struct Plant : public BaseItem,
		...
		virtual void FSMItem < Item, FSM,
		    onKeyEvent(const SysShape::KeyEvent&);     // _218
		virtual void hasFruits();                      // _21C
		virtual void getFruitsNum();                   // _220
		virtual void getNearestFruit(Vector3<float>&); // _224
		virtual void bearFruits();                     // _228
		virtual void killFruits();                     // _22C
		virtual void dropFruit(int);                   // _230
		virtual void setColor(float);                  // _234
		virtual void startColorMotion(int);            // _238
		virtual void updateColorMotion(float);         // _23C
		virtual void startMotion(int);                 // _240
