#ifndef _GAME_ITEMPLANT_PLANT_H
#define _GAME_ITEMPLANT_PLANT_H
...
struct Item {
	...
	virtual void hasFruits();                             // _224
	virtual void getFruitsNum();                          // _228
	virtual void getNearestFruit(Vector3<float>&);        // _22C
	virtual void bearFruits();                            // _230
	virtual void killFruits();                            // _234
	virtual void dropFruit(int);                          // _238
	virtual void setColor(float);                         // _23C
	virtual void startColorMotion(int);                   // _240
	virtual void updateColorMotion(float);                // _244
};
} // namespace ItemPlant
} // namespace Game

namespace Game {
struct FSMItem<Game::ItemPlant::Item, Game::ItemPlant::FSM, Game::ItemPlant::State> {
	virtual void _08() = 0;                                                                                         // _08
	virtual void _0C() = 0;                                                                                         // _0C
	virtual void _10() = 0;                                                                                         // _10
	virtual void _14() = 0;                                                                                         // _14
	...
	virtual void _E0() = 0;                                                                                         // _E0
	virtual void _E4() = 0;                                                                                         // _E4
	virtual void FSMItem<ItemPlant::Item, ItemPlant::FSM, ItemPlant::State>::bounceCallback(Sys::Triangle*);        // _E8 (weak)
	virtual void FSMItem<ItemPlant::Item, ItemPlant::FSM, ItemPlant::State>::collisionCallback(CollEvent&);         // _EC (weak)
	virtual void FSMItem<ItemPlant::Item, ItemPlant::FSM, ItemPlant::State>::platCallback(PlatEvent&);              // _F0 (weak)
	virtual void _F4()  = 0;                                                                                        // _F4
	virtual void _F8()  = 0;                                                                                        // _F8
	virtual void _FC()  = 0;                                                                                        // _FC
	virtual void _100() = 0;                                                                                        // _100
	...
	virtual void FSMItem<ItemPlant::Item, ItemPlant::FSM, ItemPlant::State>::onKeyEvent(const SysShape::KeyEvent&); // _220 (weak)
};
} // namespace Game

namespace Game {
namespace ItemPlant {
struct Plant : public BaseItem,
               public Creature,
               public CellObject,
               public Item,
               public FSMItem<Game::ItemPlant::Item, Game::ItemPlant::FSM, Game::ItemPlant::State> {
	virtual void onInit(CreatureInitArg*);         // _30
	virtual void onKill(CreatureKillArg*);         // _34
	virtual void doAnimation();                    // _3C
	virtual void doDirectDraw(Graphics&);          // _50
