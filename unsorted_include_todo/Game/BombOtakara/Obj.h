...
namespace BombOtakara {
	struct Obj : public EnemyBase,
		...
		virtual void interactCreature(Creature*);                        // _2F4
		virtual void createEffect();                                     // _2F8
		virtual void setupEffect();                                      // _2FC
		virtual void startChargeEffect();                                // _300
		virtual void finishChargeEffect();                               // _304
		virtual void createDisChargeEffect();                            // _308
		virtual void effectDrawOn();                                     // _30C
		virtual void effectDrawOff();                                    // _310
		virtual void startEscapeSE();                                    // _314
		virtual void startDisChargeSE();                                 // _318
		virtual void _31C() = 0;                                         // _31C
		virtual void _320() = 0;                                         // _320
		virtual void viewGetBaseScale();                                 // _324
		virtual void _328() = 0;                                         // _328
