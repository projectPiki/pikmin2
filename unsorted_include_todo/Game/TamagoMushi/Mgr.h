#ifndef _GAME_TAMAGOMUSHI_MGR_H
#define _GAME_TAMAGOMUSHI_MGR_H
...
struct Mgr : public EnemyMgrBase, public GenericObjectMgr, public CNode {
	...
	void createGroupByBigFoot(Game::EnemyBirthArg&, int, Vector3<float>&, float);
	void createGroup(Game::TamagoMushi::Obj*, int, bool);
	void createGroupByBigFoot(Game::TamagoMushi::Obj*, int, bool, float);
};
} // namespace TamagoMushi
} // namespace Game
