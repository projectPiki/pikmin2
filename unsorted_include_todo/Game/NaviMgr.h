...
struct Container<Game::Navi> {
	virtual ~Container<Navi>();    // _08 (weak)
	virtual void _0C() = 0;        // _0C
	virtual void getObject(void*); // _10 (weak)
};

struct MonoObjectMgr<Game::Navi> {
	virtual ~MonoObjectMgr<Navi>();       // _08 (weak)
	virtual void _0C() = 0;               // _0C
...
namespace Game {
struct NaviMgr : public CNode, public Container<Game::Navi>, public MonoObjectMgr<Game::Navi>, public GenericObjectMgr {
