#ifndef _GAME_FIREOTAKARA_OBJ_H
#define _GAME_FIREOTAKARA_OBJ_H
...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _32C
	virtual void _330() = 0;                                // _330
	virtual void viewGetCollTreeJointIndex();               // _334
	virtual void viewGetCollTreeOffset();                   // _338
	virtual void _33C() = 0;                                // _33C
	virtual void _340() = 0;                                // _340
	virtual void _344() = 0;                                // _344
	virtual void _348() = 0;                                // _348
	virtual void _34C() = 0;                                // _34C
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _350
