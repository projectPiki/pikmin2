#ifndef _GAME_NAVIDEMO_HOLEINSTATE_H
#define _GAME_NAVIDEMO_HOLEINSTATE_H
...
namespace Game {
struct NaviDemo_HoleInState : public FSMState<Game::Navi>, public NaviState {
	virtual void init(Navi*, StateArg*);                       // _08
	virtual void exec(Navi*);                                  // _0C
	virtual void cleanup(Navi*);                               // _10
	virtual void onKeyEvent(Navi*, const SysShape::KeyEvent&); // _24

	void execGoto(Game::Navi*);
	void initHesitate(Game::Navi*);
	void execHesitate(Game::Navi*);
	void initFall(Game::Navi*);
	void execFall(Game::Navi*);
};
} // namespace Game
