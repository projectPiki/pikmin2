...
struct FakePiki : public Creature, public CellObject {
    ...
    virtual void getMapCollisionRadius();                     // _200 (inline)
    virtual void wallCallback(Vector3<float>&);               // _204 (inline)
    ...
    virtual void isWalking();                            // _21C (inline)
    ...
    void startLookCreature(Game::Creature*);
    void finishLook();
    void updateLook();
    void turnTo(Vector3<float>&);
    void moveVelocity();
    void moveRotation();
