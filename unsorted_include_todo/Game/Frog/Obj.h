...
struct PelletView {
    ...
    virtual void viewGetCollTreeOffset();                   // _2FC (inline)
    virtual void attackNaviPosition();                      // _300 (inline)
    virtual void _304() = 0;                                // _304
    virtual void _308() = 0;                                // _308
    virtual void viewGetBaseScale();                        // _30C (inline)
    virtual void _310() = 0;                                // _310
    virtual void viewGetCollTreeJointIndex();               // _314 (inline)
    virtual void @736 @12 @viewGetCollTreeOffset();         // _318 (inline)
    virtual void _31C() = 0;                                // _31C
    virtual void _320() = 0;                                // _320
    virtual void _324() = 0;                                // _324
    virtual void _328() = 0;                                // _328
    virtual void _32C() = 0;                                // _32C
    virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _330 (inline)
};
} // namespace Game
