...
namespace FixedSizeItemMgr < Game
{
    namespace ItemHoney {
        struct Item >
        {
            virtual void FixedSizeItemMgr < doAnimation();           // _08
            virtual void FixedSizeItemMgr < doEntry();               // _0C
            virtual void FixedSizeItemMgr < doSetView(int);          // _10
            virtual void FixedSizeItemMgr < doViewCalc();            // _14
            virtual void FixedSizeItemMgr < doSimulation(float);     // _18
            virtual void FixedSizeItemMgr < doDirectDraw(Graphics&); // _1C
            ...
            virtual void FixedSizeItemMgr < initDependency();        // _38
            virtual void FixedSizeItemMgr < killAll();               // _3C
            ...
            virtual void FixedSizeItemMgr < kill(Item*);             // _A8
            virtual void FixedSizeItemMgr < get(void*);              // _AC
            virtual void FixedSizeItemMgr < getNext(void*);          // _B0
            virtual void FixedSizeItemMgr < getStart();              // _B4
            virtual void FixedSizeItemMgr < getEnd();                // _B8
