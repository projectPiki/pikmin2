...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _320
	virtual void _324() = 0;                                // _324
	virtual void viewGetCollTreeJointIndex();               // _328
	virtual void viewGetCollTreeOffset();                   // _32C
	virtual void _330() = 0;                                // _330
	virtual void _334() = 0;                                // _334
	virtual void _338() = 0;                                // _338
	virtual void _33C() = 0;                                // _33C
	virtual void _340() = 0;                                // _340
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _344
...
namespace Koganemushi {
	struct Obj : public EnemyBase,
		...
		virtual void createItem();                                       // _2F4
		virtual void resetFartTimer();                                   // _2F8
		virtual void startBodyEffect();                                  // _2FC
		virtual void finishBodyEffect();                                 // _300
		virtual void createFartEffect();                                 // _304
		virtual void effectDrawOn();                                     // _308
		virtual void effectDrawOff();                                    // _30C
		virtual void createPressSENormal();                              // _310
		virtual void createPressSESpecial();                             // _314
		virtual void _318() = 0;                                         // _318
		virtual void _31C() = 0;                                         // _31C
		virtual void viewGetBaseScale();                                 // _320
		virtual void viewGetCollTreeJointIndex();                        // _328
