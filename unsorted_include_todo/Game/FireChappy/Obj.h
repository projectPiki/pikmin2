...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _33C (weak)
	virtual void _340() = 0;                                // _340
	virtual void viewGetCollTreeJointIndex();               // _344 (weak)
	virtual void viewGetCollTreeOffset();                   // _348 (weak)
	virtual void _34C() = 0;                                // _34C
	virtual void _350() = 0;                                // _350
	virtual void _354() = 0;                                // _354
	virtual void _358() = 0;                                // _358
	virtual void _35C() = 0;                                // _35C
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _360 (weak)
};
} // namespace Game
