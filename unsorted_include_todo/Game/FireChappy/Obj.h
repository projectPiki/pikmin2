...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _334
	virtual void _338() = 0;                                // _338
	virtual void viewGetCollTreeJointIndex();               // _33C
	virtual void viewGetCollTreeOffset();                   // _340
	virtual void _344() = 0;                                // _344
	virtual void _348() = 0;                                // _348
	virtual void _34C() = 0;                                // _34C
	virtual void _350() = 0;                                // _350
	virtual void _354() = 0;                                // _354
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _358
...
namespace FireChappy {
	struct Obj : public EnemyBase,
		...
		virtual void isWakeup();                                         // _2F4
		virtual void setAnimationSpeed(float);                           // _2F8
		virtual void flickAttackFail();                                  // _2FC
		virtual void flickStatePikmin();                                 // _300
		virtual void flickAttackBomb();                                  // _304
		virtual void eatAttackPikmin();                                  // _308
		virtual void resetUnderGround();                                 // _30C
		virtual void setUnderGround();                                   // _310
		virtual void createEffect();                                     // _314
		virtual void setupEffect();                                      // _318
		virtual void startSleepEffect();                                 // _31C
		virtual void finishSleepEffect();                                // _320
		virtual void createFlickEffect();                                // _324
		virtual void createSmokeEffect();                                // _328
		virtual void _32C() = 0;                                         // _32C
		virtual void _330() = 0;                                         // _330
		virtual void viewGetBaseScale();                                 // _334
		virtual void viewGetCollTreeJointIndex();                        // _33C
