...
struct PelletView {
	...
	virtual void setAnimationSpeed(float);                    // _300 (inline)
	...
	virtual void resetUnderGround();                          // _314 (inline)
	virtual void setUnderGround();                            // _318 (inline)
	...
	virtual void createSmokeEffect();                         // _330 (inline)
	virtual void _334() = 0;                                  // _334
	virtual void _338() = 0;                                  // _338
	virtual void viewGetBaseScale();                          // _33C (inline)
	virtual void _340() = 0;                                  // _340
	virtual void viewGetCollTreeJointIndex();                 // _344 (inline)
	virtual void viewGetCollTreeOffset();                     // _348 (inline)
	virtual void _34C() = 0;                                  // _34C
	virtual void _350() = 0;                                  // _350
	virtual void _354() = 0;                                  // _354
	virtual void _358() = 0;                                  // _358
	virtual void _35C() = 0;                                  // _35C
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);   // _360 (inline)
};
} // namespace Game
