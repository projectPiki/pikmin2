...
namespace FixedSizePelletMgr < Game
{
    namespace PelletFruit {
        struct Object >
        {
            virtual void FixedSizePelletMgr < doAnimation();           // _08
            virtual void FixedSizePelletMgr < doEntry();               // _0C
            virtual void FixedSizePelletMgr < doSetView(int);          // _10
            virtual void FixedSizePelletMgr < doViewCalc();            // _14
            virtual void FixedSizePelletMgr < doSimulation(float);     // _18
            virtual void FixedSizePelletMgr < doDirectDraw(Graphics&); // _1C
            virtual void _20() = 0;                                    // _20
            virtual void _24() = 0;                                    // _24
            virtual void FixedSizePelletMgr < resetMgr();              // _28
            virtual void _2C() = 0;                                    // _2C
            virtual void _30() = 0;                                    // _30
            virtual void _34() = 0;                                    // _34
            virtual void FixedSizePelletMgr < resetMgrAndResources();  // _38
            virtual void FixedSizePelletMgr < birth();                 // _3C
            virtual void FixedSizePelletMgr < kill(Pellet*);           // _40
            virtual void _44() = 0;                                    // _44
            virtual void FixedSizePelletMgr
                < birthFromTeki(PelletConfig*);                      // _48
            virtual void FixedSizePelletMgr < setComeAlive(int);     // _4C
            virtual void FixedSizePelletMgr < setComeAlive(Pellet*); // _50
            virtual void _54() = 0;                                  // _54
            virtual void _58() = 0;                                  // _58
            virtual void _5C() = 0;                                  // _5C
            virtual void FixedSizePelletMgr < setRevival(Pellet*);   // _60
            virtual void FixedSizePelletMgr < setFromTeki(Pellet*);  // _64
            virtual void FixedSizePelletMgr < getFlag(Pellet*);      // _68
            ...
            virtual void FixedSizePelletMgr < getObjectPtr(void*);   // _88
            virtual void FixedSizePelletMgr < getNext(void*);        // _8C
            virtual void FixedSizePelletMgr < getStart();            // _90
            virtual void FixedSizePelletMgr < getEnd();              // _94
            virtual void _98() = 0;                                  // _98
            virtual void _9C() = 0;                                  // _9C
            virtual void _A0() = 0;                                  // _A0
            virtual void _A4() = 0;                                  // _A4
            virtual void getObject(void*);                           // _A8
            virtual void _AC() = 0;                                  // _AC
            virtual void _B0() = 0;                                  // _B0
            virtual void _B4() = 0;                                  // _B4
            virtual void _B8() = 0;                                  // _B8
            virtual void getAt(int);                                 // _BC
            virtual void getTo();                                    // _C0
            virtual void FixedSizePelletMgr < get(void*);            // _C4
...
namespace PelletFruit {
    struct Mgr : public Object >, public GenericObjectMgr, public BasePelletMgr,
        ...
        virtual void getMgrName();                    // _58
        virtual void getMgrID();                      // _5C
        virtual void _98() = 0;                       // _98
        virtual void _9C() = 0;                       // _9C
        virtual void @84 @__dt();                     // _A0
        virtual ~Mgr();                               // _C8
