...
namespace Game {
struct FSMItem<Game::ItemRock::Item, Game::ItemRock::FSM, Game::ItemRock::State> {
	virtual void _08() = 0;                                                                               // _08
	virtual void _0C() = 0;                                                                               // _0C
	virtual void _10() = 0;                                                                               // _10
	virtual void _14() = 0;                                                                               // _14
	...
	virtual void doSave(Stream&);                                                                         // _E0
	virtual void doLoad(Stream&);                                                                         // _E4
	virtual void FSMItem<ItemRock::Item, ItemRock::FSM, ItemRock::State>::bounceCallback(Sys::Triangle*); // _E8 (weak)
	virtual void FSMItem<ItemRock::Item, ItemRock::FSM, ItemRock::State>::collisionCallback(CollEvent&);  // _EC (weak)
	virtual void FSMItem<ItemRock::Item, ItemRock::FSM, ItemRock::State>::platCallback(PlatEvent&);       // _F0 (weak)
};
} // namespace Game
...
struct Item : public BaseItem,
              public Creature,
              public CellObject,
              public FSMItem<Game::ItemRock::Item, Game::ItemRock::FSM, Game::ItemRock::State> {
	virtual void constructor();                                 // _2C
	virtual void onInit(CreatureInitArg*);                      // _30
	virtual void onKill(CreatureKillArg*);                      // _34
	virtual void doSave(Stream&);                               // _E0
