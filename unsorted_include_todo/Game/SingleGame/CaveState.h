#ifndef _GAME_SINGLEGAME_CAVESTATE_H
#define _GAME_SINGLEGAME_CAVESTATE_H
...
namespace Game {
namespace SingleGame {
struct CaveState : public FSMState<Game::SingleGameSection>, public State {
	virtual void Singleinit(SingleGameSection*, StateArg*);                                          // _08
	virtual void Singleexec(SingleGameSection*);                                                     // _0C
	virtual void Singlecleanup(SingleGameSection*);                                                  // _10
	virtual void Singledraw(SingleGameSection*, Graphics&);                                          // _20
	...
	void check_SMenu(Game::SingleGameSection*);
};
} // namespace SingleGame
} // namespace Game
