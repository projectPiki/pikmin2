...
namespace FSMState < Game
{
	...
	{
		virtual void FSMState < init(SingleGameSection*, StateArg*);         // _08
		virtual void FSMState < exec(SingleGameSection*);                    // _0C
		virtual void FSMState < cleanup(SingleGameSection*);                 // _10
