...
struct PelletView {
	...
	virtual void viewGetBaseScale();                           // _328 (weak)
	virtual void _32C() = 0;                                   // _32C
	virtual void viewGetCollTreeJointIndex();                  // _330 (weak)
	virtual void viewGetCollTreeOffset();                      // _334 (weak)
	virtual void _338() = 0;                                   // _338
	virtual void _33C() = 0;                                   // _33C
	virtual void _340() = 0;                                   // _340
	virtual void _344() = 0;                                   // _344
	virtual void _348() = 0;                                   // _348
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);    // _34C (weak)
};
} // namespace Game
