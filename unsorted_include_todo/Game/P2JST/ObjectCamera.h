...
namespace P2JST {
    struct ObjectBase {
        ...
        virtual void parseUserData_(unsigned long, const void*); // _AC
...
namespace P2JST {
    struct ObjectCamera : public TCamera, public TObject, public ObjectBase {
        ...
        virtual void _94() = 0;                            // _94
        virtual void _98() = 0;                            // _98
        virtual void @4 @reset();                          // _9C
        virtual void @4 @update();                         // _A0
        virtual void @4 @start();                          // _A4
        virtual void @4 @stop();                           // _A8
        virtual void updateCamera();                       // _B0
        virtual void setProjection();                      // _B4
        virtual void setView();                            // _B8
        virtual void isRunning();                          // _BC
        virtual void reset();                              // _C0
        virtual void update();                             // _C4
        virtual void start();                              // _C8
        virtual void stop();                               // _CC
