...
struct JPAEmitterCallBack {
    ...
    virtual void _9C() = 0;                                      // _9C
    virtual void @4 @stop();                                     // _A0 (inline)
    virtual void @4 @parseUserData_(unsigned long, const void*); // _A4 (inline)
    virtual void reset();                                        // _A8 (inline)
    virtual void update();                                       // _AC (inline)
    ...
    virtual void @112 @__dt();                                   // _D4 (inline)
    virtual void execute(JPABaseEmitter*);                       // _D8 (inline)
    virtual void @112 @executeAfter(JPABaseEmitter*);            // _DC (inline)
    virtual void draw(JPABaseEmitter*);                          // _E0 (inline)
    virtual void drawAfter(JPABaseEmitter*);                     // _E4 (inline)
};

namespace Game {
namespace P2JST {
    struct ObjectParticleActor : public TActor,
                                 public ObjectActor,
                                 public TObject,
                                 public JPAEmitterCallBack {
        virtual ~ObjectParticleActor();             // _08 (inline)
        virtual void JSGGetTranslation(Vec*) const; // _3C
        virtual void JSGSetTranslation(const Vec&); // _40
        virtual void JSGSetShape(unsigned long);    // _58
        virtual void _8C() = 0;                     // _8C
