...
struct JPAEmitterCallBack {
    ...
    virtual void execute(JPABaseEmitter*);   // _D8
    virtual void _DC() = 0;                  // _DC
    virtual void draw(JPABaseEmitter*);      // _E0
    virtual void drawAfter(JPABaseEmitter*); // _E4
...
namespace P2JST {
    struct ObjectParticleActor : public TActor,
        ...
        virtual ~ObjectParticleActor();                              // _08
        ...
        virtual void _CC() = 0;                                      // _CC
        virtual void _D0() = 0;                                      // _D0
        virtual void @112 @__dt();                                   // _D4
        virtual void @112 @executeAfter(JPABaseEmitter*);            // _DC
        virtual void executeAfter(JPABaseEmitter*);                  // _E8
