...
struct JPAEmitterCallBack {
    ...
    virtual void execute(JPABaseEmitter*);   // _D0
    virtual void _D4() = 0;                  // _D4
    virtual void draw(JPABaseEmitter*);      // _D8
    virtual void drawAfter(JPABaseEmitter*); // _DC
...
namespace P2JST {
    struct ObjectParticleActor : public TActor,
        ...
        virtual ~ObjectParticleActor();         // _00
        virtual void JSGFGetType() const;       // _04
        virtual void JSGGetName() const;        // _08
        virtual void JSGUpdate();               // _0C
        virtual void JSGGetFlag() const;        // _10
        ...
        virtual void _C4() = 0;                                      // _C4
        virtual void _C8() = 0;                                      // _C8
        virtual void @112 @__dt();                                   // _CC
        virtual void execute(JPABaseEmitter*);                       // _D0
        virtual void @112 @executeAfter(JPABaseEmitter*);            // _D4
        virtual void draw(JPABaseEmitter*);                          // _D8
        virtual void drawAfter(JPABaseEmitter*);                     // _DC
        virtual void executeAfter(JPABaseEmitter*);                  // _E0
