...
struct PelletView {
	...
	virtual void stopEffectRadius(float);                   // _31C (weak)
	...
	virtual void viewGetBaseScale();                        // _330 (weak)
	virtual void _334() = 0;                                // _334
	virtual void viewGetCollTreeJointIndex();               // _338 (weak)
	virtual void viewGetCollTreeOffset();                   // _33C (weak)
	virtual void _340() = 0;                                // _340
	virtual void _344() = 0;                                // _344
	virtual void _348() = 0;                                // _348
	virtual void _34C() = 0;                                // _34C
	virtual void _350() = 0;                                // _350
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _354 (weak)
};
} // namespace Game
