#ifndef _GAME_TANK_OBJ_H
#define _GAME_TANK_OBJ_H
...
struct PelletView {
	...
	virtual void createEffect();                            // _2FC (inline)
	virtual void setupEffect();                             // _300 (inline)
	virtual void startEffect();                             // _304 (inline)
	virtual void startYodare();                             // _308 (inline)
	virtual void finishEffect();                            // _30C (inline)
	virtual void effectDrawOn();                            // _310 (inline)
	virtual void effectDrawOff();                           // _314 (inline)
	virtual void interactCreature(Creature*);               // _318 (inline)
	virtual void stopEffectRadius(float);                   // _31C (inline)
	virtual void createChargeSE();                          // _320 (inline)
	virtual void createDisChargeSE();                       // _324 (inline)
	virtual void _328() = 0;                                // _328
	virtual void _32C() = 0;                                // _32C
	virtual void viewGetBaseScale();                        // _330 (inline)
	virtual void _334() = 0;                                // _334
	virtual void viewGetCollTreeJointIndex();               // _338 (inline)
	virtual void viewGetCollTreeOffset();                   // _33C (inline)
	virtual void _340() = 0;                                // _340
	virtual void _344() = 0;                                // _344
	virtual void _348() = 0;                                // _348
	virtual void _34C() = 0;                                // _34C
	virtual void _350() = 0;                                // _350
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _354 (inline)
};
} // namespace Game
...
struct Obj : public EnemyBase, public Creature, public CellObject, public PelletView {
	...
	void emitCollideRatio(Vector3<float>&, Vector3<float>&, float);
	void updateEmit();
	void updateCaution();
	void getViewAngle();
};
