...
struct PelletView {
	...
	virtual void viewGetCollTreeOffset();                   // _318
...
namespace LeafChappy {
	struct Obj : public EnemyBase,
		...
		virtual void createChappyRelation();                             // _2F4
		virtual void getChappyRelation();                                // _2F8
		virtual void startEnemyRumble();                                 // _2FC
		virtual void resetChappyRelation();                              // _300
		virtual void _304() = 0;                                         // _304
		virtual void _308() = 0;                                         // _308
		virtual void viewGetBaseScale();                                 // _30C
		virtual void viewGetCollTreeJointIndex();                        // _314
