...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _314 (weak)
	virtual void _318() = 0;                                // _318
	virtual void viewGetCollTreeJointIndex();               // _31C (weak)
	virtual void viewGetCollTreeOffset();                   // _320 (weak)
	virtual void _324() = 0;                                // _324
	virtual void _328() = 0;                                // _328
	virtual void _32C() = 0;                                // _32C
	virtual void _330() = 0;                                // _330
	virtual void _334() = 0;                                // _334
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _338 (weak)
};
} // namespace Game
