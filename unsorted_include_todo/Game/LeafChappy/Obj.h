...
struct PelletView {
	...
	virtual void createChappyRelation();                      // _2FC (inline)
	virtual void getChappyRelation();                         // _300 (inline)
	virtual void startEnemyRumble();                          // _304
	virtual void resetChappyRelation();                       // _308 (inline)
	virtual void _30C() = 0;                                  // _30C
	virtual void _310() = 0;                                  // _310
	virtual void viewGetBaseScale();                          // _314 (inline)
	virtual void _318() = 0;                                  // _318
	virtual void viewGetCollTreeJointIndex();                 // _31C (inline)
	virtual void viewGetCollTreeOffset();                     // _320 (inline)
	virtual void _324() = 0;                                  // _324
	virtual void _328() = 0;                                  // _328
	virtual void _32C() = 0;                                  // _32C
	virtual void _330() = 0;                                  // _330
	virtual void _334() = 0;                                  // _334
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);   // _338 (inline)
};
} // namespace Game
...
struct Obj : public EnemyBase, public Creature, public CellObject, public PelletView {
	...
	Obj();
	void birthChildren(Game::EnemyBirthArg&);
