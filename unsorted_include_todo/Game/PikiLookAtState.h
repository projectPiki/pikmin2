#ifndef _GAME_PIKILOOKATSTATE_H
#define _GAME_PIKILOOKATSTATE_H
...
namespace Game {
struct PikiLookAtState : public Piki >, public PikiState {
    virtual void init(Piki*, StateArg*);                        // _08
    virtual void exec(Piki*);                                   // _0C
    virtual void cleanup(Piki*);                                // _10
    virtual void callable();                                    // _44 (inline)
    ...
    virtual void @28 @4 @onKeyEvent(const SysShape::KeyEvent&); // _80 (inline)
};
} // namespace Game
