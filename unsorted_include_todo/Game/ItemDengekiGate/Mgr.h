...
namespace Game {
struct NodeItemMgr<Game::ItemGate> {
	virtual void NodeItemMgr<ItemGate>::doAnimation();                           // _08 (weak)
	virtual void NodeItemMgr<ItemGate>::doEntry();                               // _0C (weak)
	virtual void NodeItemMgr<ItemGate>::doSetView(int);                          // _10 (weak)
	virtual void NodeItemMgr<ItemGate>::doViewCalc();                            // _14 (weak)
	virtual void NodeItemMgr<ItemGate>::doSimulation(float);                     // _18 (weak)
	virtual void NodeItemMgr<ItemGate>::doDirectDraw(Graphics&);                 // _1C (weak)
	...
	virtual void NodeItemMgr<ItemGate>::initDependency();                        // _38 (weak)
	virtual void NodeItemMgr<ItemGate>::killAll();                               // _3C (weak)
	...
	virtual void NodeItemMgr<ItemGate>::kill(ItemGate*);                         // _A0 (weak)
	virtual void NodeItemMgr<ItemGate>::get(void*);                              // _A4 (weak)
	virtual void NodeItemMgr<ItemGate>::getNext(void*);                          // _A8 (weak)
	virtual void NodeItemMgr<ItemGate>::getStart();                              // _AC (weak)
	virtual void NodeItemMgr<ItemGate>::getEnd();                                // _B0 (weak)
};
} // namespace Game
...
struct Container<Game::ItemGate> {
	virtual void _08() = 0;                                                      // _08
	virtual void _0C() = 0;                                                      // _0C
	virtual void _10() = 0;                                                      // _10
	virtual void _14() = 0;                                                      // _14
...
struct Mgr : public NodeItemMgr<Game::ItemGate>,
             public GenericObjectMgr,
             public BaseItemMgr,
             public CNode,
             public Container<Game::ItemGate> {
	virtual void generatorGetID();                                               // _58 (weak)
	virtual void generatorBirth(Vector3<float>&, Vector3<float>&, GenItemParm*); // _5C
	virtual void generatorWrite(Stream&, GenItemParm*);                          // _60
	virtual void generatorRead(Stream&, GenItemParm*, unsigned long);            // _64
