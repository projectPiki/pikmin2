...
namespace NodeItemMgr < Game
{
    struct ItemGate >
    {
        virtual void NodeItemMgr < doAnimation();           // _08
        virtual void NodeItemMgr < doEntry();               // _0C
        virtual void NodeItemMgr < doSetView(int);          // _10
        virtual void NodeItemMgr < doViewCalc();            // _14
        virtual void NodeItemMgr < doSimulation(float);     // _18
        virtual void NodeItemMgr < doDirectDraw(Graphics&); // _1C
        ...
        virtual void NodeItemMgr < initDependency();        // _38
        virtual void NodeItemMgr < killAll();               // _3C
        ...
        virtual void NodeItemMgr < kill(ItemGate*);         // _A0
        virtual void NodeItemMgr < get(void*);              // _A4
        virtual void NodeItemMgr < getNext(void*);          // _A8
        virtual void NodeItemMgr < getStart();              // _AC
        virtual void NodeItemMgr < getEnd();                // _B0
