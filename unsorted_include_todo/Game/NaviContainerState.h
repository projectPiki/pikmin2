#ifndef _GAME_NAVICONTAINERSTATE_H
#define _GAME_NAVICONTAINERSTATE_H
...
namespace Game {
struct NaviContainerState : public FSMState<Game::Navi>, public NaviState {
	virtual void init(Navi*, StateArg*); // _08
	virtual void exec(Navi*);            // _0C
	virtual void cleanup(Navi*);         // _10
	virtual void invincible();           // _20 (weak)

	void enterPikis(Game::Navi*, int);
};
} // namespace Game
