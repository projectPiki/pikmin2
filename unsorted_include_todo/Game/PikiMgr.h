...
struct Container<Game::Piki> {
	virtual ~Container<Piki>();    // _08 (weak)
	virtual void _0C() = 0;        // _0C
	virtual void getObject(void*); // _10 (weak)
};

struct MonoObjectMgr<Game::Piki> {
	virtual ~MonoObjectMgr<Piki>();       // _08 (weak)
	virtual void _0C() = 0;               // _0C
...
namespace Game {
struct PikiMgr : public CNode, public Container<Game::Piki>, public MonoObjectMgr<Game::Piki>, public GenericObjectMgr {
