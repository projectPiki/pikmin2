...
namespace OoPanModoki {
	struct Obj : public EnemyBase,
		...
		virtual void appearRumble();                                     // _2F0
		virtual void hideRumble();                                       // _2F4
		virtual void damageRumble();                                     // _2F8
		virtual void walkFunc();                                         // _2FC
		virtual void canTarget(int, int);                                // _300
		virtual void setFSM(FSM*);                                       // _304
		virtual void _308() = 0;                                         // _308
		virtual void _30C() = 0;                                         // _30C
		virtual void viewGetBaseScale();                                 // _310
		virtual void _314() = 0;                                         // _314
