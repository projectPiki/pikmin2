#ifndef _GAME_OOPANMODOKI_OBJ_H
#define _GAME_OOPANMODOKI_OBJ_H
...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _318
	virtual void _31C() = 0;                                // _31C
	virtual void viewGetCollTreeJointIndex();               // _320
	virtual void viewGetCollTreeOffset();                   // _324
	virtual void _328() = 0;                                // _328
	virtual void _32C() = 0;                                // _32C
	virtual void _330() = 0;                                // _330
	virtual void _334() = 0;                                // _334
	virtual void _338() = 0;                                // _338
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _33C
...
struct Obj : public EnemyBase, public Creature, public CellObject, public PelletView {
	...
	virtual void canTarget(int, int);                            // _308
	virtual void setFSM(FSM*);                                   // _30C
	virtual void _310() = 0;                                     // _310
	virtual void _314() = 0;                                     // _314
