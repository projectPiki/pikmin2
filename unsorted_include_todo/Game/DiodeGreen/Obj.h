#ifndef _GAME_DIODEGREEN_OBJ_H
#define _GAME_DIODEGREEN_OBJ_H

/*
    __vt__Q34Game10DiodeGreen3Obj:
    .4byte 0
    .4byte 0
    ...
    .4byte doEntry__Q34Game10DiodeGreen3ObjFv
    ...
    .4byte getLODCylinder__Q34Game10DiodeGreen3ObjFRQ23Sys8Cylinder
    ...
    .4byte __dt__Q34Game10DiodeGreen3ObjFv
    ...
    .4byte setParameters__Q34Game10DiodeGreen3ObjFv
    ...
    .4byte getEnemyTypeID__Q34Game10DiodeGreen3ObjFv
    ...
    .4byte touchedSE__Q34Game10DiodeGreen3ObjFPQ24Game4Navi
    .4byte 0
    .4byte 0
...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _308
	virtual void _30C() = 0;                                // _30C
	virtual void viewGetCollTreeJointIndex();               // _310
	virtual void viewGetCollTreeOffset();                   // _314
	virtual void _318() = 0;                                // _318
	virtual void _31C() = 0;                                // _31C
	virtual void _320() = 0;                                // _320
	virtual void _324() = 0;                                // _324
	virtual void _328() = 0;                                // _328
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _32C
