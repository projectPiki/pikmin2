#ifndef _GAME_SHIJIMICHOU_MGR_H
#define _GAME_SHIJIMICHOU_MGR_H
...
struct EnemyMgrBase {
	...
	virtual void getEnemy(int);                 // _A4 (weak)
...
struct Mgr : public EnemyMgrBase, public GenericObjectMgr, public CNode {
	...
	void createGroupByPlants(Game::EnemyBirthArg&, int);
	void createGroupByEnemy(Game::EnemyBirthArg&, Game::EnemyBase*, int, bool);
};
} // namespace ShijimiChou
} // namespace Game
