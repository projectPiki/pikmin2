#ifndef _GAME_NAVITHROWSTATE_H
#define _GAME_NAVITHROWSTATE_H
...
namespace Game {
struct NaviThrowState : public Navi >, public NaviState {
    virtual void init(Navi*, StateArg*);                        // _08
    virtual void exec(Navi*);                                   // _0C
    virtual void cleanup(Navi*);                                // _10
    ...
    virtual void @32 @4 @onKeyEvent(const SysShape::KeyEvent&); // _58 (inline)
};
} // namespace Game
