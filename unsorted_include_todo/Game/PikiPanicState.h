#ifndef _GAME_PIKIPANICSTATE_H
#define _GAME_PIKIPANICSTATE_H
...
namespace Game {
struct PikiPanicState : public FSMState<Game::Piki>, public PikiState {
	virtual void init(Piki*, StateArg*);                       // _08
	virtual void exec(Piki*);                                  // _0C
	virtual void cleanup(Piki*);                               // _10
	virtual void bounceCallback(Piki*, Sys::Triangle*);        // _24
	...
	void panicRun(Game::Piki*);
	void panicLobster(Game::Piki*);
};
} // namespace Game
