...
namespace Game {
struct TFlockMgr<Game::ItemUjamushi::Uja> {
	virtual void TFlockMgr<ItemUjamushi::Uja>::getMaxObjects();    // _08 (weak)
	virtual void TFlockMgr<ItemUjamushi::Uja>::getNumObjects();    // _0C (weak)
	virtual void TFlockMgr<ItemUjamushi::Uja>::isFlagAlive(int);   // _10 (weak)
	virtual void TFlockMgr<ItemUjamushi::Uja>::getFlock(int);      // _14 (weak)
	virtual void TFlockMgr<ItemUjamushi::Uja>::killFlock(TFlock*); // _18 (weak)
	...
	virtual void TFlockMgr<ItemUjamushi::Uja>::get(void*);         // _5C (weak)
	virtual void TFlockMgr<ItemUjamushi::Uja>::getNext(void*);     // _60 (weak)
	virtual void TFlockMgr<ItemUjamushi::Uja>::getStart();         // _64 (weak)
	virtual void TFlockMgr<ItemUjamushi::Uja>::getEnd();           // _68 (weak)
};
} // namespace Game
...
struct Container<Game::ItemUjamushi::Uja> {
	virtual void _08() = 0;               // _08
	virtual void _0C() = 0;               // _0C
	virtual void _10() = 0;               // _10
	virtual void _14() = 0;               // _14
...
struct UjaMgr : public TFlockMgr<Game::ItemUjamushi::Uja>, public BaseFlockMgr, public CNode, public Container<Game::ItemUjamushi::Uja> {
	virtual void do_update();             // _1C
	virtual void do_update_boundSphere(); // _20
	virtual void _30() = 0;               // _30
	virtual void _34() = 0;               // _34
