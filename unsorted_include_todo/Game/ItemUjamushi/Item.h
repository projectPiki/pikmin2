#ifndef _GAME_ITEMUJAMUSHI_ITEM_H
#define _GAME_ITEMUJAMUSHI_ITEM_H
...
namespace Game {
struct FSMItem<Game::ItemUjamushi::Item, Game::ItemUjamushi::FSM, Game::ItemUjamushi::State> {
	virtual void _08() = 0;                                                                                                  // _08
	virtual void _0C() = 0;                                                                                                  // _0C
	virtual void _10() = 0;                                                                                                  // _10
	virtual void _14() = 0;                                                                                                  // _14
	...
	virtual void _E0() = 0;                                                                                                  // _E0
	virtual void _E4() = 0;                                                                                                  // _E4
	virtual void FSMItem<ItemUjamushi::Item, ItemUjamushi::FSM, ItemUjamushi::State>::bounceCallback(Sys::Triangle*);        // _E8 (weak)
	virtual void FSMItem<ItemUjamushi::Item, ItemUjamushi::FSM, ItemUjamushi::State>::collisionCallback(CollEvent&);         // _EC (weak)
	virtual void FSMItem<ItemUjamushi::Item, ItemUjamushi::FSM, ItemUjamushi::State>::platCallback(PlatEvent&);              // _F0 (weak)
	virtual void _F4()  = 0;                                                                                                 // _F4
	virtual void _F8()  = 0;                                                                                                 // _F8
	virtual void _FC()  = 0;                                                                                                 // _FC
	virtual void _100() = 0;                                                                                                 // _100
	...
	virtual void FSMItem<ItemUjamushi::Item, ItemUjamushi::FSM, ItemUjamushi::State>::onKeyEvent(const SysShape::KeyEvent&); // _220 (weak)
};
} // namespace Game
...
struct Item : public BaseItem,
              public Creature,
              public CellObject,
              public FSMItem<Game::ItemUjamushi::Item, Game::ItemUjamushi::FSM, Game::ItemUjamushi::State> {
	virtual void onInit(CreatureInitArg*);                  // _30
	virtual void getFlockMgr();                             // _90 (weak)
	virtual void isCollisionFlick();                        // _B0 (weak)
	virtual void ignoreAtari(Creature*);                    // _190
