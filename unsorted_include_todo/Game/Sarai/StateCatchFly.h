#ifndef _GAME_SARAI_STATECATCHFLY_H
#define _GAME_SARAI_STATECATCHFLY_H
...
/*
    ...
    .4byte 0
    .4byte
   init__Q34Game5Sarai13StateCatchFlyFPQ24Game9EnemyBasePQ24Game8StateArg .4byte
   exec__Q34Game5Sarai13StateCatchFlyFPQ24Game9EnemyBase .4byte
   cleanup__Q34Game5Sarai13StateCatchFlyFPQ24Game9EnemyBase .4byte
...
namespace Game {
namespace Sarai {
	struct StateCatchFly : public EnemyFSMState {
		virtual void init(EnemyBase*, StateArg*);         // _00
		virtual void exec(EnemyBase*);                    // _04
		virtual void cleanup(EnemyBase*);                 // _08
		virtual void resume(EnemyBase*);                  // _0C
