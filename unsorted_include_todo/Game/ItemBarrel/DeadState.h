#ifndef _GAME_ITEMBARREL_DEADSTATE_H
#define _GAME_ITEMBARREL_DEADSTATE_H
...
struct DeadState : public FSMState<Game::ItemBarrel::Item>, public ItemState<Game::ItemBarrel::Item> {
	virtual void init(Item*, StateArg*);                       // _08
	virtual void exec(Item*);                                  // _0C
	virtual void cleanup(Item*);                               // _10
	virtual void onDamage(Item*, float);                       // _20
