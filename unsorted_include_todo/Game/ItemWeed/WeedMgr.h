...
namespace TFlockMgr < Game
{
    namespace ItemWeed {
        struct Weed >
        {
            virtual void TFlockMgr < getMaxObjects();    // _08
            virtual void TFlockMgr < getNumObjects();    // _0C
            virtual void TFlockMgr < isFlagAlive(int);   // _10
            virtual void TFlockMgr < getFlock(int);      // _14
            virtual void TFlockMgr < killFlock(TFlock*); // _18
            ...
            virtual void getObject(void*);               // _40
            virtual void _44() = 0;                      // _44
            virtual void _48() = 0;                      // _48
            virtual void _4C() = 0;                      // _4C
            virtual void _50() = 0;                      // _50
            virtual void getAt(int);                     // _54
            virtual void getTo();                        // _58
            virtual void TFlockMgr < get(void*);         // _5C
            virtual void TFlockMgr < getNext(void*);     // _60
            virtual void TFlockMgr < getStart();         // _64
            virtual void TFlockMgr < getEnd();           // _68
