...
namespace Game {
struct TFlockMgr<Game::ItemWeed::Weed> {
	virtual void TFlockMgr<ItemWeed::Weed>::getMaxObjects();    // _08 (weak)
	virtual void TFlockMgr<ItemWeed::Weed>::getNumObjects();    // _0C (weak)
	virtual void TFlockMgr<ItemWeed::Weed>::isFlagAlive(int);   // _10 (weak)
	virtual void TFlockMgr<ItemWeed::Weed>::getFlock(int);      // _14 (weak)
	virtual void TFlockMgr<ItemWeed::Weed>::killFlock(TFlock*); // _18 (weak)
	...
	virtual void TFlockMgr<ItemWeed::Weed>::get(void*);         // _5C (weak)
	virtual void TFlockMgr<ItemWeed::Weed>::getNext(void*);     // _60 (weak)
	virtual void TFlockMgr<ItemWeed::Weed>::getStart();         // _64 (weak)
	virtual void TFlockMgr<ItemWeed::Weed>::getEnd();           // _68 (weak)
};
} // namespace Game
...
struct Container<Game::ItemWeed::Weed> {
	virtual void _08() = 0;               // _08
	virtual void _0C() = 0;               // _0C
	virtual void _10() = 0;               // _10
	virtual void _14() = 0;               // _14
...
namespace Game {
namespace ItemWeed {
struct WeedMgr : public TFlockMgr<Game::ItemWeed::Weed>, public BaseFlockMgr, public CNode, public Container<Game::ItemWeed::Weed> {
	virtual void do_update();             // _1C
	virtual void do_update_boundSphere(); // _20
	virtual void _30() = 0;               // _30
	virtual void _34() = 0;               // _34
