#ifndef _GAME_ITEMWEED_STATE_H
#define _GAME_ITEMWEED_STATE_H
...
struct FSMState<Game::ItemWeed::Item> {
	virtual void FSMState<ItemWeed::Item>::init(ItemWeed::Item*, StateArg*);         // _08 (weak)
	virtual void FSMState<ItemWeed::Item>::exec(ItemWeed::Item*);                    // _0C (weak)
	virtual void FSMState<ItemWeed::Item>::cleanup(ItemWeed::Item*);                 // _10 (weak)
...
namespace Game {
namespace ItemWeed {
struct State : public FSMState<Game::ItemWeed::Item>, public ItemState<Game::ItemWeed::Item> {
};
} // namespace ItemWeed
} // namespace Game
