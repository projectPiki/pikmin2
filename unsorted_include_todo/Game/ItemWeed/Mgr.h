#ifndef _GAME_ITEMWEED_MGR_H
#define _GAME_ITEMWEED_MGR_H
...
namespace Game {
namespace ItemWeed {
struct Mgr : public TNodeItemMgr, public BaseItemMgr, public GenericObjectMgr, public CNode, public Container<Game::BaseItem> {
	virtual void doSimpleDraw(Viewport*);                                        // _20
	virtual void onLoadResources();                                              // _48
	virtual void generatorGetID();                                               // _58 (weak)
	virtual void generatorBirth(Vector3<float>&, Vector3<float>&, GenItemParm*); // _5C
