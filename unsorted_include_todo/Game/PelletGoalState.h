#ifndef _GAME_PELLETGOALSTATE_H
#define _GAME_PELLETGOALSTATE_H
...
namespace Game {
struct PelletGoalState : public FSMState<Game::Pellet>, public PelletState {
	virtual void init(Pellet*, StateArg*); // _08
	virtual void exec(Pellet*);            // _0C
	virtual void cleanup(Pellet*);         // _10

	void checkMovie(Game::Pellet*);
};
} // namespace Game
