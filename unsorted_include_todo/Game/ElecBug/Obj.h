...
struct Obj : public EnemyBase, public Creature, public CellObject, public PelletView {
	...
	void startChargeState(Game::ElecBug::Obj*);
	void startChildChargeState(Game::ElecBug::Obj*);
	void createEffect();
	void setupEffect();
	void startChargeEffect();
	void startDischargeEffect(Game::ElecBug::Obj*);
	void finishPartnerAndEffect();
	void effectDrawOn();
	void effectDrawOff();
	void checkInteract(Game::ElecBug::Obj*);
};
} // namespace ElecBug
} // namespace Game
