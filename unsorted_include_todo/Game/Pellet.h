...
struct Pellet : public Creature, public DynCreature {
    ...
    virtual void onSetPosition();                                    // _1A8
    virtual void _1AC() = 0;                                         // _1AC
    virtual void _1B0() = 0;                                         // _1B0
    virtual void @788 @onKeyEvent(const SysShape::KeyEvent&);        // _1B4
    virtual void _1B8() = 0;                                         // _1B8
    virtual void _1BC() = 0;                                         // _1BC
    virtual void @792 @getCarryInfoParam(CarryInfoParam&);           // _1C0
    virtual void do_onInit(CreatureInitArg*);                        // _1C4
    virtual void onCreateShape();                                    // _1C8
    virtual void theEntry();                                         // _1CC
    virtual void onBounce();                                         // _1D0
    virtual void shadowOn();                                         // _1D4
    virtual void shadowOff();                                        // _1D8
    virtual void isPickable();                                       // _1DC
    virtual void getBedamaColor();                                   // _1E0
    virtual void do_update();                                        // _1E4
    virtual void onKeyEvent(const SysShape::KeyEvent&);              // _1E8
    virtual void _1EC() = 0;                                         // _1EC
    virtual void changeMaterial();                                   // _1F0
    virtual void createKiraEffect(Vector3<float>&);                  // _1F4
    virtual void getCarryInfoParam(CarryInfoParam&);                 // _1F8
    virtual void isCarried();                                        // _1FC
    virtual void isPicked();                                         // _200
    virtual void sound_otakaraEventStart();                          // _204
    virtual void sound_otakaraEventRestart();                        // _208
    virtual void sound_otakaraEventStop();                           // _20C
    virtual void sound_otakaraEventFinish();                         // _210
