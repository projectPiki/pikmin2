...
struct Container<Game::MapUnit> {
	virtual ~Container<MapUnit>(); // _08 (weak)
...
struct NodeObjectMgr<Game::MapUnit> {
	virtual ~NodeObjectMgr<MapUnit>(); // _08 (weak)
	virtual void _0C() = 0;            // _0C
...
struct ObjectMgr<Game::MapUnit> {
	virtual ~ObjectMgr<MapUnit>();        // _08 (weak)
	virtual void _0C() = 0;               // _0C
	virtual void _10() = 0;               // _10
	virtual void _14() = 0;               // _14
	virtual void _18() = 0;               // _18
...
namespace Game {
struct MapUnitMgr : public CNode,
                    public Container<Game::MapUnit>,
                    public NodeObjectMgr<Game::MapUnit>,
                    public GenericObjectMgr,
                    public ObjectMgr<Game::MapUnit> {
