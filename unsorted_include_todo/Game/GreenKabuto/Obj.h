...
struct PelletView {
	...
	virtual void startRotateEffect();                       // _304 (inline)
	virtual void finishRotateEffect();                      // _308 (inline)
	virtual void startWaitEffect();                         // _30C (inline)
	virtual void finishWaitEffect();                        // _310 (inline)
	virtual void effectDrawOn();                            // _314 (inline)
	virtual void effectDrawOff();                           // _318 (inline)
	virtual void _31C() = 0;                                // _31C
	virtual void _320() = 0;                                // _320
	virtual void viewGetBaseScale();                        // _324 (inline)
	virtual void _328() = 0;                                // _328
	virtual void viewGetCollTreeJointIndex();               // _32C (inline)
	virtual void viewGetCollTreeOffset();                   // _330 (inline)
	virtual void _334() = 0;                                // _334
	virtual void _338() = 0;                                // _338
	virtual void _33C() = 0;                                // _33C
	virtual void _340() = 0;                                // _340
	virtual void _344() = 0;                                // _344
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _348 (inline)
};
} // namespace Game
