#ifndef _GAME_GREENKABUTO_OBJ_H
#define _GAME_GREENKABUTO_OBJ_H
...
struct PelletView {
	...
	virtual void viewGetBaseScale();                        // _324
	virtual void _328() = 0;                                // _328
	virtual void viewGetCollTreeJointIndex();               // _32C
	virtual void viewGetCollTreeOffset();                   // _330
	virtual void _334() = 0;                                // _334
	virtual void _338() = 0;                                // _338
	virtual void _33C() = 0;                                // _33C
	virtual void _340() = 0;                                // _340
	virtual void _344() = 0;                                // _344
	virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _348
