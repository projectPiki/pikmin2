#ifndef _GAME_NAVIDEMO_UFOSTATE_H
#define _GAME_NAVIDEMO_UFOSTATE_H
...
namespace Game {
struct NaviDemo_UfoState : public FSMState<Game::Navi>, public NaviState {
	virtual void init(Navi*, StateArg*); // _08
	virtual void exec(Navi*);            // _0C
	virtual void cleanup(Navi*);         // _10

	void execGoto(Game::Navi*);
	void initSuck(Game::Navi*);
	void execSuck(Game::Navi*);
};
} // namespace Game
