...
struct PelletView {
	...
	virtual void appearRumble();                                 // _2F8 (inline)
	virtual void hideRumble();                                   // _2FC (inline)
	virtual void damageRumble();                                 // _300
	virtual void walkFunc();                                     // _304
	virtual void _308() = 0;                                     // _308
	virtual void setFSM(FSM*);                                   // _30C (inline)
	virtual void _310() = 0;                                     // _310
	virtual void _314() = 0;                                     // _314
	virtual void viewGetBaseScale();                             // _318 (inline)
	virtual void _31C() = 0;                                     // _31C
	virtual void viewGetCollTreeJointIndex();                    // _320 (inline)
	virtual void viewGetCollTreeOffset();                        // _324 (inline)
	virtual void _328() = 0;                                     // _328
	virtual void _32C() = 0;                                     // _32C
	virtual void _330() = 0;                                     // _330
	virtual void _334() = 0;                                     // _334
	virtual void _338() = 0;                                     // _338
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);      // _33C (inline)
};
} // namespace Game
...
struct Obj : public EnemyBase, public Creature, public CellObject, public PelletView {
	...
	void killNest();
	void isTargetable(Game::Pellet*);
	void calcSlotGlobalPos(Vector3<float>&);
	void boundEffect();
