...
struct EnemyBase {
	...
	virtual void applyImpulse(Vector3<float>&, Vector3<float>&);    // _18C (weak)
...
struct PelletView {
	...
	virtual void viewGetBaseScale();                             // _318 (weak)
	virtual void _31C() = 0;                                     // _31C
	virtual void viewGetCollTreeJointIndex();                    // _320 (weak)
	virtual void viewGetCollTreeOffset();                        // _324 (weak)
	virtual void _328() = 0;                                     // _328
	virtual void _32C() = 0;                                     // _32C
	virtual void _330() = 0;                                     // _330
	virtual void _334() = 0;                                     // _334
	virtual void _338() = 0;                                     // _338
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);      // _33C (weak)
};
} // namespace Game
