...
struct EnemyBase {
	...
	virtual void doEntry();                                         // _40 (inline)
	virtual void doSetView(int);                                    // _44
	virtual void doViewCalc();                                      // _48 (inline)
	...
	virtual void needShadow();                                      // _138 (inline)
	...
	virtual void update();                                          // _1C8 (inline)
	...
	virtual void doAnimationCullingOff();                           // _1DC (inline)
	virtual void doAnimationCullingOn();                            // _1E0 (inline)
