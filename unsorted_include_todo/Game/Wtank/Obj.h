...
namespace Wtank {
	struct Obj : public EnemyBase,
		...
		virtual void startEffect();                                      // _2FC
		virtual void startYodare();                                      // _300
		virtual void finishEffect();                                     // _304
		virtual void effectDrawOn();                                     // _308
		virtual void effectDrawOff();                                    // _30C
		virtual void interactCreature(Creature*);                        // _310
		virtual void stopEffectRadius(float);                            // _314
		virtual void createChargeSE();                                   // _318
		virtual void createDisChargeSE();                                // _31C
		virtual void _320() = 0;                                         // _320
		virtual void _324() = 0;                                         // _324
		virtual void viewGetBaseScale();                                 // _328
		virtual void viewGetCollTreeJointIndex();                        // _330
