#ifndef _GAME_ELECHIBA_MGR_H
#define _GAME_ELECHIBA_MGR_H
...
namespace Game {
namespace ElecHiba {
struct Mgr : public EnemyMgrBaseAlwaysMovieActor, public EnemyMgrBase, public GenericObjectMgr, public CNode {
	virtual void _38() = 0;             // _38
	virtual void _3C() = 0;             // _3C
