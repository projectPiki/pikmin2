...
struct PelletView {
	...
	virtual void viewGetBaseScale();                              // _32C (weak)
	virtual void _330() = 0;                                      // _330
	virtual void viewGetCollTreeJointIndex();                     // _334 (weak)
	virtual void viewGetCollTreeOffset();                         // _338 (weak)
	virtual void _33C() = 0;                                      // _33C
	virtual void _340() = 0;                                      // _340
	virtual void _344() = 0;                                      // _344
	virtual void _348() = 0;                                      // _348
	virtual void _34C() = 0;                                      // _34C
	virtual void viewEntryShape(Matrixf&, Vector3<float>&);       // _350 (weak)
};
} // namespace Game
