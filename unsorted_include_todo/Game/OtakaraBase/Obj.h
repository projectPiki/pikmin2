...
struct PelletView {
	...
	virtual void interactCreature(Creature*);                     // _2FC (inline)
	virtual void createEffect();                                  // _300 (inline)
	virtual void setupEffect();                                   // _304 (inline)
	virtual void startChargeEffect();                             // _308 (inline)
	virtual void finishChargeEffect();                            // _30C (inline)
	virtual void createDisChargeEffect();                         // _310 (inline)
	virtual void effectDrawOn();                                  // _314 (inline)
	virtual void effectDrawOff();                                 // _318 (inline)
	virtual void startEscapeSE();                                 // _31C
	virtual void startDisChargeSE();                              // _320 (inline)
...
struct Obj : public EnemyBase, public Creature, public CellObject, public PelletView {
	...
	void getTargetPosition(Game::Creature*);
	void resetTreasure();
	void isTakeTreasure();
	void takeTreasure();
	void fallTreasure(bool);
	void isDropTreasure();
	void damageTreasure(float);
	void attackTarget();
