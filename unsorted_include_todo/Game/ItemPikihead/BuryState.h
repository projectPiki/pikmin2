#ifndef _GAME_ITEMPIKIHEAD_BURYSTATE_H
#define _GAME_ITEMPIKIHEAD_BURYSTATE_H
...
struct BuryState : public FSMState<Game::ItemPikihead::Item>, public ItemState<Game::ItemPikihead::Item> {
	virtual void init(Item*, StateArg*);                       // _08
	virtual void exec(Item*);                                  // _0C
	virtual void cleanup(Item*);                               // _10
	virtual void onKeyEvent(Item*, const SysShape::KeyEvent&); // _24
