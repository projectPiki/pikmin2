#ifndef _GAME_ITEMPIKIHEAD_ITEM_H
#define _GAME_ITEMPIKIHEAD_ITEM_H
...
namespace Game {
struct FSMItem<Game::ItemPikihead::Item, Game::ItemPikihead::FSM, Game::ItemPikihead::State> {
	virtual void _08() = 0;                                                                                           // _08
	virtual void _0C() = 0;                                                                                           // _0C
	virtual void _10() = 0;                                                                                           // _10
	virtual void _14() = 0;                                                                                           // _14
	...
	virtual void _E0() = 0;                                                                                           // _E0
	virtual void _E4() = 0;                                                                                           // _E4
	virtual void FSMItem<ItemPikihead::Item, ItemPikihead::FSM, ItemPikihead::State>::bounceCallback(Sys::Triangle*); // _E8 (weak)
	virtual void FSMItem<ItemPikihead::Item, ItemPikihead::FSM, ItemPikihead::State>::collisionCallback(CollEvent&);  // _EC (weak)
	virtual void FSMItem<ItemPikihead::Item, ItemPikihead::FSM, ItemPikihead::State>::platCallback(PlatEvent&);       // _F0 (weak)
};
} // namespace Game
...
struct Item : public BaseItem,
              public Creature,
              public CellObject,
              public FSMItem<Game::ItemPikihead::Item, Game::ItemPikihead::FSM, Game::ItemPikihead::State> {
	virtual void onInit(CreatureInitArg*);              // _30
	virtual void onKill(CreatureKillArg*);              // _34
	virtual void doSimulation(float);                   // _4C
	virtual void getLODSphere(Sys::Sphere&);            // _140
