...
namespace Game {
struct FixedSizePelletMgr<Game::PelletItem::Object> {
	virtual void FixedSizePelletMgr<PelletItem::Object>::doAnimation();                   // _08 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::doEntry();                       // _0C (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::doSetView(int);                  // _10 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::doViewCalc();                    // _14 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::doSimulation(float);             // _18 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::doDirectDraw(Graphics&);         // _1C (weak)
	virtual void _20() = 0;                                                               // _20
	virtual void _24() = 0;                                                               // _24
	virtual void FixedSizePelletMgr<PelletItem::Object>::resetMgr();                      // _28 (weak)
	virtual void _2C() = 0;                                                               // _2C
	virtual void _30() = 0;                                                               // _30
	virtual void _34() = 0;                                                               // _34
	virtual void FixedSizePelletMgr<PelletItem::Object>::resetMgrAndResources();          // _38 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::birth();                         // _3C (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::kill(Pellet*);                   // _40 (weak)
	virtual void setupResources();                                                        // _44
	virtual void FixedSizePelletMgr<PelletItem::Object>::birthFromTeki(PelletConfig*);    // _48 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::setComeAlive(int);               // _4C (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::setComeAlive(Pellet*);           // _50 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::onCreateModel(SysShape::Model*); // _54 (weak)
	virtual void getMgrName();                                                            // _58 (weak)
	virtual void getMgrID();                                                              // _5C (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::setRevival(Pellet*);             // _60 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::setFromTeki(Pellet*);            // _64 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::getFlag(Pellet*);                // _68 (weak)
	...
	virtual void FixedSizePelletMgr<PelletItem::Object>::getObjectPtr(void*);             // _88 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::getNext(void*);                  // _8C (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::getStart();                      // _90 (weak)
	virtual void FixedSizePelletMgr<PelletItem::Object>::getEnd();                        // _94 (weak)
	...
	virtual void FixedSizePelletMgr<PelletItem::Object>::get(void*);                      // _C4 (weak)
};
} // namespace Game
...
struct Container<Game::PelletItem::Object> {
	virtual void _08() = 0;                                                        // _08
	virtual void _0C() = 0;                                                        // _0C
	virtual void _10() = 0;                                                        // _10
	virtual void _14() = 0;                                                        // _14
...
struct Mgr : public FixedSizePelletMgr<Game::PelletItem::Object>,
             public GenericObjectMgr,
             public BasePelletMgr,
             public CNode,
             public Container<Game::PelletItem::Object> {
	virtual void setupResources();                                                 // _44
	virtual void getMgrName();                                                     // _58 (weak)
	virtual void getMgrID();                                                       // _5C (weak)
	virtual void generatorBirth(Vector3<float>&, Vector3<float>&, GenPelletParm*); // _70
