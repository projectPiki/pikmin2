...
struct PelletView {
    ...
    virtual void viewGetBaseScale();                        // _300
    virtual void _304() = 0;                                // _304
    virtual void viewGetCollTreeJointIndex();               // _308
    virtual void viewGetCollTreeOffset();                   // _30C
    virtual void _310() = 0;                                // _310
    virtual void _314() = 0;                                // _314
    virtual void _318() = 0;                                // _318
    virtual void _31C() = 0;                                // _31C
    virtual void _320() = 0;                                // _320
    virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _324
...
struct EnemyBase : public Creature, public CellObject, public PelletView {
    ...
    virtual void _2F8() = 0;                                        // _2F8
    virtual void _2FC() = 0;                                        // _2FC
    virtual void @700 @12 @viewGetShape();                          // _304
    virtual void @700 @12 @view_start_carrymotion();                // _310
    virtual void @700 @12 @view_finish_carrymotion();               // _314
    virtual void @700 @12 @viewStartPreCarryMotion();               // _318
    virtual void @700 @12 @viewStartCarryMotion();                  // _31C
    virtual void @700 @12 @viewOnPelletKilled();                    // _320
