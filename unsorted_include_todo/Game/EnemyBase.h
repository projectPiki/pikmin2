...
struct PelletView {
    ...
    virtual void viewGetBaseScale();                        // _300 (inline)
    virtual void @700 @12 @viewGetShape();                  // _304 (inline)
    virtual void viewGetCollTreeJointIndex();               // _308 (inline)
    virtual void viewGetCollTreeOffset();                   // _30C (inline)
    virtual void @700 @12 @view_start_carrymotion();        // _310 (inline)
    virtual void @700 @12 @view_finish_carrymotion();       // _314 (inline)
    virtual void @700 @12 @viewStartPreCarryMotion();       // _318 (inline)
    virtual void @700 @12 @viewStartCarryMotion();          // _31C (inline)
    virtual void @700 @12 @viewOnPelletKilled();            // _320 (inline)
    virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _324 (inline)
};
} // namespace Game
