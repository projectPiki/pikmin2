#ifndef _GAME_MAROFROG_OBJ_H
#define _GAME_MAROFROG_OBJ_H
...
struct PelletView {
    ...
    virtual void viewGetBaseScale();                        // _30C
    virtual void _310() = 0;                                // _310
    virtual void viewGetCollTreeJointIndex();               // _314
    ...
    virtual void viewEntryShape(Matrixf&, Vector3<float>&); // _330
...
namespace MaroFrog {
    struct Obj : public EnemyBase,
        ...
        virtual void viewGetCollTreeOffset();                   // _2FC
        virtual void attackNaviPosition();                      // _300
        virtual void _304() = 0;                                // _304
        virtual void _308() = 0;                                // _308
        virtual void @736 @12 @viewGetCollTreeOffset();         // _318
