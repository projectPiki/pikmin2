...
struct Container<Sys::Triangle> {
	virtual ~Container<Triangle>(); // _08 (weak)
	virtual void _0C() = 0;         // _0C
	virtual void getObject(void*);  // _10 (weak)
};

struct ArrayContainer<Sys::Triangle> {
	virtual ~ArrayContainer<Triangle>();          // _08 (weak)
	virtual void _0C() = 0;                       // _0C
...
namespace Sys {
struct TriangleTable : public CNode, public Container<Sys::Triangle>, public ArrayContainer<Sys::Triangle> {
