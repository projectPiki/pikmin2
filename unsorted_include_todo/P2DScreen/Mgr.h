#ifndef _P2DSCREEN_MGR_H
#define _P2DSCREEN_MGR_H
...
namespace P2DScreen {
struct Mgr : public J2DScreen, public J2DPane {
	virtual ~Mgr();                                // _08 (inline)
	virtual void update();                         // _30
	virtual void draw(Graphics&, J2DGrafContext&); // _9C

	Mgr();
	void addCallBack(unsigned long long, P2DScreen::Node*);
	void addCallBackPane(J2DPane*, P2DScreen::Node*);
};
} // namespace P2DScreen
