#ifndef _MORIMURA_TPRESIDENTDOWN2D_H
#define _MORIMURA_TPRESIDENTDOWN2D_H
...
namespace Morimura {
struct TPresidentDown2D : public CNode, public ObjBase, public TTestBase, public TGameOverBase {
