#ifndef _MORIMURA_TCHALLENGEENDCOUNT1P_H
#define _MORIMURA_TCHALLENGEENDCOUNT1P_H
...
namespace Morimura {
struct TChallengeEndCount1p : public CNode, public ObjBase, public TDayEndCount, public TTestBase, public TChallengeEndCount {
