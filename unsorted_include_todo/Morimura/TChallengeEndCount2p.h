#ifndef _MORIMURA_TCHALLENGEENDCOUNT2P_H
#define _MORIMURA_TCHALLENGEENDCOUNT2P_H
...
namespace Morimura {
struct TChallengeEndCount2p : public CNode, public ObjBase, public TDayEndCount, public TTestBase, public TChallengeEndCount {
