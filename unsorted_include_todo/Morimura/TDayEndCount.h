#ifndef _MORIMURA_TDAYENDCOUNT_H
#define _MORIMURA_TDAYENDCOUNT_H
...
namespace Morimura {
struct TDayEndCount : public CNode, public ObjBase, public TTestBase {
    virtual ~TDayEndCount();                            // _08
    virtual void _10() = 0;                             // _10
    virtual void _14() = 0;                             // _14
