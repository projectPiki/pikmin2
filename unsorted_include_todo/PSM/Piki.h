...
struct CreatureObj {
	...
	virtual void startSound(unsigned long, unsigned long);                // _7C (weak)
	virtual void startSound(unsigned char, unsigned long, unsigned long); // _80 (weak)
	virtual void startSound(JAISound**, unsigned long, unsigned long);    // _84 (weak)
};
} // namespace PSM
...
namespace PSM {
struct Piki : public CreatureObj, public Creature, public ObjectBase, public Object {
	virtual void _08() = 0;     // _08
	virtual void _0C() = 0;     // _0C
	...
	void startPikiSound(JAInter::Object*, unsigned long, unsigned long);
	void startPikiSetSound(JAInter::Object*, unsigned long, PSGame::SeMgr::SetSeId, unsigned long);
	void startFreePikiSetSound(unsigned long, PSGame::SeMgr::SetSeId, unsigned long, unsigned long);
	void checkHappaChappySE(unsigned long);
};
} // namespace PSM
