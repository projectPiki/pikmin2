#ifndef _PSM_TRACKONDIRECTOR_VOTING_H
#define _PSM_TRACKONDIRECTOR_VOTING_H
...
namespace PSM {
struct TrackOnDirector_Voting : public DirectorBase, public TrackOnDirectorBase, public SwitcherDirector {
	virtual ~TrackOnDirector_Voting(); // _08 (inline)
	virtual void execInner();          // _1C
};
} // namespace PSM
