#ifndef _PSM_ENEMY_SPECIALCHAPPY_H
#define _PSM_ENEMY_SPECIALCHAPPY_H
...
namespace PSM {
struct Enemy_SpecialChappy : public CreatureAnime,
                             public EnemyBig,
                             public EnemyBase,
                             public Creature,
                             public ObjectBase,
    ...
    virtual void _0C() = 0;                             // _0C
    virtual void @16 @__dt();                           // _10 (inline)
    virtual ~Enemy_SpecialChappy();                     // _14 (inline)
    virtual void onPlayingSe(unsigned long, JAISound*); // _38
    virtual void _40() = 0;                             // _40
    virtual void _44() = 0;                             // _44
    virtual void @48 @__dt();                           // _48 (inline)
