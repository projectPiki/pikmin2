...
struct CreatureAnime : public Creature,
    ...
    virtual void @48
        @startSound(unsigned char, unsigned long, unsigned long); // _50
    virtual void @48
        @startSound(JAISound**, unsigned long, unsigned long); // _54
    virtual void @48
        @playActorAnimSound(JAInter::Actor*, float, unsigned char); // _7C
