...
namespace PSM {
struct WorkItem : public CreatureObj,
                  public Creature,
                  public ObjectBase,
                  public Object {
    virtual void _00() = 0;                       // _00
    ...
    virtual void startSound(unsigned char, unsigned long, unsigned long); // _78
    virtual void startSound(JAISound**, unsigned long, unsigned long);    // _7C
    virtual void eventStart();                                            // _80
    virtual void eventRestart();                                          // _84
    virtual void eventStop();                                             // _88
    virtual void eventFinish();                                           // _8C
