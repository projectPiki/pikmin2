...
namespace PSM {
struct WorkItem : public CreatureObj, public Creature, public ObjectBase, public Object {
	virtual void _08() = 0;      // _08
	virtual void _0C() = 0;      // _0C
	virtual ~WorkItem();         // _14 (weak)
	virtual void getCastType();  // _1C (weak)
	virtual void _40() = 0;      // _40
	virtual void _44() = 0;      // _44
	virtual void eventStart();   // _88
	virtual void eventRestart(); // _8C
