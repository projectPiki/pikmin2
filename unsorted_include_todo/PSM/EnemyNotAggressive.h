#ifndef _PSM_ENEMYNOTAGGRESSIVE_H
#define _PSM_ENEMYNOTAGGRESSIVE_H
...
namespace PSM {
struct EnemyNotAggressive : public CreatureAnime,
                            public EnemyBase,
                            public Creature,
                            public ObjectBase,
                            public Object,
    ...
    virtual ~EnemyNotAggressive();                // _0C
    virtual void frameEnd_onPlaySe();             // _10
    ...
    virtual void _9C() = 0;                         // _9C
    virtual void _A0() = 0;                         // _A0
    virtual void @184 @battleOn();                  // _A4
    virtual void @184 @battleOff();                 // _A8
    virtual void _AC() = 0;                         // _AC
    virtual void _B0() = 0;                         // _B0
    virtual void @204 @kehaiOn();                   // _B4
    virtual void @204 @kehaiOff();                  // _B8
    virtual void battleOff();                       // _BC
    virtual void setKilled();                       // _C0
    virtual void updateKehai();                     // _C4
    virtual void updateBattle();                    // _C8
    virtual void kehaiOn();                         // _CC
    virtual void kehaiOff();                        // _D0
    virtual void battleOn();                        // _D4
