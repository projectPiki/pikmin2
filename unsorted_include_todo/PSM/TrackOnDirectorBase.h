#ifndef _PSM_TRACKONDIRECTORBASE_H
#define _PSM_TRACKONDIRECTORBASE_H
...
namespace PSM {
struct TrackOnDirectorBase : public DirectorBase, public SwitcherDirector {
	virtual ~TrackOnDirectorBase();                       // _08
