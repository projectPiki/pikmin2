#ifndef _PSM_PELLETITEM_H
#define _PSM_PELLETITEM_H
...
namespace PSM {
struct PelletItem : public CreatureObj, public Creature, public ObjectBase, public Object, public Otakara {
	virtual void _08() = 0;     // _08
	virtual void _0C() = 0;     // _0C
	virtual ~PelletItem();      // _14 (weak)
	virtual void getCastType(); // _1C (weak)
	virtual void _40() = 0;     // _40
	virtual void _44() = 0;     // _44
