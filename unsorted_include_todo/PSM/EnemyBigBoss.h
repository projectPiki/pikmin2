#ifndef _PSM_ENEMYBIGBOSS_H
#define _PSM_ENEMYBIGBOSS_H
...
struct EnemyMidBoss {
    ...
    virtual void _C8() = 0;            // _C8
    virtual void _CC() = 0;            // _CC
    virtual void postPikiAttack(bool); // _D0
...
namespace PSM {
struct EnemyBigBoss : public CreatureAnime,
                      public EnemyBoss,
                      public EnemyMidBoss,
                      public Creature,
                      public EnemyBase,
    ...
    virtual void updateKehai();                     // _C4
    virtual void updateBattle();                    // _C8
    virtual void jumpRequest(unsigned short);       // _CC
    virtual void postPikiAttack(bool);              // _D0
    virtual void updateDisappearing();              // _D4
