...
struct Container<MapCode::Code> {
	virtual ~Container<Code>();    // _08 (weak)
	virtual void _0C() = 0;        // _0C
	virtual void getObject(void*); // _10 (weak)
};

struct ArrayContainer<MapCode::Code> {
	virtual ~ArrayContainer<Code>();            // _08 (weak)
	virtual void _0C() = 0;                     // _0C
...
namespace MapCode {
namespace Mgr {
struct CodeArray : public CNode, public Container<MapCode::Code>, public ArrayContainer<MapCode::Code> {
