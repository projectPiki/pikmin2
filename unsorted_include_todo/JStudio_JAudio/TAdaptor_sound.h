...
struct TAdaptor_sound : public TAdaptor {
	...
	virtual void adaptor_do_end(const JStudio::TObject*);                                              // _14
	virtual void adaptor_do_update(const JStudio::TObject*, unsigned long);                            // _18
	virtual void adaptor_do_SOUND(JStudio::data::TEOperationData, const void*, unsigned long);         // _20
	...
	virtual void adaptor_do_LOCATED(JStudio::data::TEOperationData, const void*, unsigned long);       // _40
