...
namespace og {
namespace Screen {
struct DopingScreen : public J2DScreen, public J2DPane, public Mgr_tuning {
	virtual Doping ~DopingScreen(); // _08 (inline)
	virtual void Dopingupdate();    // _30

	DopingScreen();
	void setCallBack(JKRArchive*);
	void setParam(og::Screen::DataNavi&);
	void adjPos(float, float);
