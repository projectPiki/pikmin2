...
struct J2DScreen {
	...
	virtual void TotalPokoupdate();                                                                                  // _30
...
namespace og {
namespace Screen {
struct TotalPokoScreen : public J2DScreen, public J2DPane, public Mgr_tuning {
	virtual TotalPoko ~TotalPokoScreen();                                       // _08 (inline)
	virtual void TotalPokoupdate();                                             // _30
	virtual void TotalPokosetCallBack(JKRArchive*, float, float, float, float); // _A0
