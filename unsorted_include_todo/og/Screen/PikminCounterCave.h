#ifndef _OG_SCREEN_PIKMINCOUNTERCAVE_H
#define _OG_SCREEN_PIKMINCOUNTERCAVE_H
...
namespace og {
namespace Screen {
struct PikminCounterCave : public J2DScreen, public J2DPane, public PikminCounter, public Mgr_tuning {
	virtual ~PikminCounterCave();          // _08 (inline)
