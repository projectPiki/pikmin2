...
namespace og {
namespace Screen {
struct NaviLifeGauge : public J2DScreen, public J2DPane, public Mgr_tuning {
	virtual ~NaviLifeGauge(); // _08 (inline)
	virtual void update();    // _30

	void setCallBack(og::Screen::DataNavi*, og::Screen::CallBack_LifeGauge::LifeGaugeType);
