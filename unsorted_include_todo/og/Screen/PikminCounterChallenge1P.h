#ifndef _OG_SCREEN_PIKMINCOUNTERCHALLENGE1P_H
#define _OG_SCREEN_PIKMINCOUNTERCHALLENGE1P_H
...
namespace og {
namespace Screen {
struct PikminCounterChallenge1P : public J2DScreen, public J2DPane, public PikminCounter, public Mgr_tuning {
	virtual ~PikminCounterChallenge1P();   // _08 (inline)
