#ifndef _OG_NEWSCREEN_OBJSMENUCONT_H
#define _OG_NEWSCREEN_OBJSMENUCONT_H
...
namespace og {
namespace newScreen {
    struct ObjSMenuCont : public CNode, public ObjBase, public ObjSMenuBase {
        virtual ~ObjSMenuCont();                            // _08 (inline)
        virtual void _10() = 0;                             // _10
        virtual void _14() = 0;                             // _14
        virtual void @24 @__dt();                           // _18 (inline)
        virtual void doStart(const Screen::StartSceneArg*); // _44
