#ifndef _OG_NEWSCREEN_OBJCHALLENGE1P_H
#define _OG_NEWSCREEN_OBJCHALLENGE1P_H
...
struct ObjChallengeBase {
	...
	virtual void doCreateAfter(JKRArchive*, Screen::CallBack_CounterRV*); // _78
};
} // namespace newScreen
} // namespace og
...
namespace og {
namespace newScreen {
struct ObjChallenge1P : public CNode, public ObjBase, public ObjChallengeBase {
