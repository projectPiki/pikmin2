#ifndef _KH_SCREEN_OBJWINLOSEREASON_H
#define _KH_SCREEN_OBJWINLOSEREASON_H
...
namespace kh {
namespace Screen {
    struct ObjWinLoseReason : public CNode, public ObjBase {
        virtual ~ObjWinLoseReason();        // _08 (inline)
        virtual void _10() = 0;             // _10
        virtual void _14() = 0;             // _14
        virtual void @24 @__dt();           // _18 (inline)
        virtual void doCreate(JKRArchive*); // _4C
