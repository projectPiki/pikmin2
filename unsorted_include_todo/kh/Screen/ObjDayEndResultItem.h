#ifndef _KH_SCREEN_OBJDAYENDRESULTITEM_H
#define _KH_SCREEN_OBJDAYENDRESULTITEM_H
...
namespace kh {
namespace Screen {
struct ObjDayEndResultItem : public CNode, public ObjBase, public ObjDayEndResultBase {
