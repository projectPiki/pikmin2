...
struct J2DTextBox : public J2DPane {
	...
	virtual void getFont() const;                                   // _A0 (inline)
	virtual void setBlack(JUtility::TColor);                        // _A4 (inline)
	virtual void setWhite(JUtility::TColor);                        // _A8 (inline)
	virtual void setBlackWhite(JUtility::TColor, JUtility::TColor); // _AC (inline)
	virtual void getBlack() const;                                  // _B0 (inline)
	virtual void getWhite() const;                                  // _B4 (inline)
