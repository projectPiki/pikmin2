#ifndef _P2JME_ILLUSTRATEDBOOK_TRENDERINGPROCESSOR_H
#define _P2JME_ILLUSTRATEDBOOK_TRENDERINGPROCESSOR_H
...
namespace IllustratedBook {
	struct TRenderingProcessor : public TProcessor {
		...
		virtual void makeMatrix(Matrixf*, Window::DrawInfo*, float,
		                        Vector3<float>); // _80
