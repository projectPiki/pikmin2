#ifndef _P2JME_MOVIE_PODICONSCREEN_H
#define _P2JME_MOVIE_PODICONSCREEN_H
...
namespace P2JME {
namespace Movie {
struct PodIconScreen : public J2DScreen, public J2DPane, public Mgr_tuning {
	virtual ~PodIconScreen(); // _08 (inline)
	virtual void update();    // _30
};
} // namespace Movie
} // namespace P2JME
