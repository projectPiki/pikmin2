#ifndef _P2JME_MOVIE_MESSAGEWINDOWSCREEN_H
#define _P2JME_MOVIE_MESSAGEWINDOWSCREEN_H
...
namespace P2JME {
namespace Movie {
struct MessageWindowScreen : public J2DScreen, public J2DPane, public Mgr, public Mgr_tuning {
	virtual ~MessageWindowScreen(); // _08 (inline)
