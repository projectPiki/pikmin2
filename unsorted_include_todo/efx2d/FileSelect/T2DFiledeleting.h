#ifndef _EFX2D_FILESELECT_T2DFILEDELETING_H
#define _EFX2D_FILESELECT_T2DFILEDELETING_H
...
struct T2DFiledeleting : public TForever, public TBase, public JPAEmitterCallBack {
	virtual void _18() = 0;     // _18
	virtual void _1C() = 0;     // _1C
