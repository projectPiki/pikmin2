#ifndef _EFX2D_WORLDMAP_T2DSHSTAR1_H
#define _EFX2D_WORLDMAP_T2DSHSTAR1_H
...
namespace efx2d {
namespace WorldMap {
struct T2DShstar1 : public TChasePos, public TForever, public TBase, public JPAEmitterCallBack {
	virtual void _18() = 0; // _18
	virtual void _1C() = 0; // _1C
