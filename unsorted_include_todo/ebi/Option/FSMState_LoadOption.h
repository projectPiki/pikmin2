#ifndef _EBI_OPTION_FSMSTATE_LOADOPTION_H
#define _EBI_OPTION_FSMSTATE_LOADOPTION_H
...
namespace ebi {
namespace Option {
struct FSMState_LoadOption : public FSMState, public FSMState<ebi::Option::TMgr> {
	virtual void FSMState_Loaddo_init(TMgr*, Game::StateArg*); // _20
	virtual void FSMState_Loaddo_exec(TMgr*);                  // _24
};
} // namespace Option
} // namespace ebi
