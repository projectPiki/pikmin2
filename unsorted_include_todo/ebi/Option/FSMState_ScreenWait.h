#ifndef _EBI_OPTION_FSMSTATE_SCREENWAIT_H
#define _EBI_OPTION_FSMSTATE_SCREENWAIT_H
...
namespace ebi {
namespace Option {
struct FSMState_ScreenWait : public FSMState, public FSMState<ebi::Option::TMgr> {
