#ifndef _EBI_OPTION_FSMSTATE_WAITCLOSEFORNOCARD_H
#define _EBI_OPTION_FSMSTATE_WAITCLOSEFORNOCARD_H
...
namespace ebi {
namespace Option {
struct FSMState_WaitCloseForNoCard : public FSMState, public FSMState<ebi::Option::TMgr> {
