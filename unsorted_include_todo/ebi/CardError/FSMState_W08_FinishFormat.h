#ifndef _EBI_CARDERROR_FSMSTATE_W08_FINISHFORMAT_H
#define _EBI_CARDERROR_FSMSTATE_W08_FINISHFORMAT_H
...
namespace ebi {
namespace CardError {
struct FSMState_W08_FinishFormat : public FSMState, public FSMState<ebi::CardError::TMgr>, public FSMState_Warning {
