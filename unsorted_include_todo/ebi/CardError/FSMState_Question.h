#ifndef _EBI_CARDERROR_FSMSTATE_QUESTION_H
#define _EBI_CARDERROR_FSMSTATE_QUESTION_H
...
namespace ebi {
namespace CardError {
struct FSMState_Question : public FSMState, public FSMState<ebi::CardError::TMgr> {
