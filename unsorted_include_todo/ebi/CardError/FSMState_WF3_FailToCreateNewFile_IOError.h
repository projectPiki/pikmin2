#ifndef _EBI_CARDERROR_FSMSTATE_WF3_FAILTOCREATENEWFILE_IOERROR_H
#define _EBI_CARDERROR_FSMSTATE_WF3_FAILTOCREATENEWFILE_IOERROR_H
...
namespace ebi {
namespace CardError {
	struct FSMState_WF3_FailToCreateNewFile_IOError : public FSMState,
	                                                  public TMgr >,
