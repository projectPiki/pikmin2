#ifndef _EBI_CARDERROR_FSMSTATE_Q04_DOYOUSTARTGAMEWITHOUTSAVE_H
...
namespace ebi {
namespace CardError {
struct FSMState_Q04_DoYouStartGameWithoutSave : public FSMState, public FSMState<ebi::CardError::TMgr>, public FSMState_Question {
