#ifndef _EBI_CARDERROR_FSMSTATE_Q01_DOYOUOPENIPL_H
#define _EBI_CARDERROR_FSMSTATE_Q01_DOYOUOPENIPL_H
...
namespace ebi {
namespace CardError {
struct FSMState_Q01_DoYouOpenIPL : public FSMState, public FSMState<ebi::CardError::TMgr>, public FSMState_Question {
