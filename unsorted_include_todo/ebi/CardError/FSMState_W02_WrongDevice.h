#ifndef _EBI_CARDERROR_FSMSTATE_W02_WRONGDEVICE_H
#define _EBI_CARDERROR_FSMSTATE_W02_WRONGDEVICE_H
...
namespace ebi {
namespace CardError {
struct FSMState_W02_WrongDevice : public FSMState, public FSMState<ebi::CardError::TMgr>, public FSMState_Warning {
