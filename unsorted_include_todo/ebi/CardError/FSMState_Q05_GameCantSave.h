#ifndef _EBI_CARDERROR_FSMSTATE_Q05_GAMECANTSAVE_H
#define _EBI_CARDERROR_FSMSTATE_Q05_GAMECANTSAVE_H
...
namespace ebi {
namespace CardError {
struct FSMState_Q05_GameCantSave : public FSMState, public FSMState<ebi::CardError::TMgr>, public FSMState_Question {
