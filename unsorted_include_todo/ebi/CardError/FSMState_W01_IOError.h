#ifndef _EBI_CARDERROR_FSMSTATE_W01_IOERROR_H
#define _EBI_CARDERROR_FSMSTATE_W01_IOERROR_H
...
namespace ebi {
namespace CardError {
struct FSMState_W01_IOError : public FSMState, public FSMState<ebi::CardError::TMgr>, public FSMState_Warning {
