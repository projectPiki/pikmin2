#ifndef _EBI_CARDERROR_FSMSTATE_WF4_FAILTOSAVE_NOCARD_H
#define _EBI_CARDERROR_FSMSTATE_WF4_FAILTOSAVE_NOCARD_H
...
namespace ebi {
namespace CardError {
struct FSMState_WF4_FailToSave_NoCard : public FSMState, public FSMState<ebi::CardError::TMgr>, public FSMState_Warning {
