#ifndef _EBI_FS_FSMSTATE03_DOYOUDELETE_H
#define _EBI_FS_FSMSTATE03_DOYOUDELETE_H
...
namespace ebi {
namespace FS {
struct FSMState03_DoYouDelete : public FSMState, public FSMState<ebi::FS::TMgr>, public FSMState_SelectYesNo {
