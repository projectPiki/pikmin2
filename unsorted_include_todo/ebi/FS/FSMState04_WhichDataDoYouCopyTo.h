#ifndef _EBI_FS_FSMSTATE04_WHICHDATADOYOUCOPYTO_H
#define _EBI_FS_FSMSTATE04_WHICHDATADOYOUCOPYTO_H
...
namespace ebi {
namespace FS {
struct FSMState04_WhichDataDoYouCopyTo : public FSMState, public FSMState<ebi::FS::TMgr> {
