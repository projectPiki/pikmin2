...
namespace ebi {
namespace Save {
struct FSMState_NowSave : public FSMState, public FSMState<ebi::Save::TMgr> {
	virtual void FSMState_Nowdo_init(TMgr*, Game::StateArg*); // _20
	virtual void FSMState_Nowdo_exec(TMgr*);                  // _24
};
} // namespace Save
} // namespace ebi
