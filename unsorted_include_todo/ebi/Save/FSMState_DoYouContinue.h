#ifndef _EBI_SAVE_FSMSTATE_DOYOUCONTINUE_H
#define _EBI_SAVE_FSMSTATE_DOYOUCONTINUE_H
...
namespace ebi {
namespace Save {
struct FSMState_DoYouContinue : public FSMState, public FSMState<ebi::Save::TMgr> {
