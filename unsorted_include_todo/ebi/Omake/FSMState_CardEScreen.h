#ifndef _EBI_OMAKE_FSMSTATE_CARDESCREEN_H
#define _EBI_OMAKE_FSMSTATE_CARDESCREEN_H
...
namespace ebi {
namespace Omake {
struct FSMState_CardEScreen : public FSMState, public FSMState<ebi::Omake::TMgr> {
