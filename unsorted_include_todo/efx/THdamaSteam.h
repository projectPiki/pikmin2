#ifndef _EFX_THDAMASTEAM_H
#define _EFX_THDAMASTEAM_H
...
namespace efx {
struct THdamaSteam : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~THdamaSteam();  // _48 (inline)
};
} // namespace efx
