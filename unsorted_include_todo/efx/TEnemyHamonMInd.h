#ifndef _EFX_TENEMYHAMONMIND_H
#define _EFX_TENEMYHAMONMIND_H
...
namespace efx {
struct TEnemyHamonMInd : public TSync, public JPAEmitterCallBack, public TChasePos {
	virtual void create(Arg*);  // _08
	virtual void _14() = 0;     // _14
	virtual void _18() = 0;     // _18
	virtual ~TEnemyHamonMInd(); // _48 (weak)
};
} // namespace efx
