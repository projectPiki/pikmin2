...
struct JPAParticleCallBack {
    ...
    virtual void draw(JPABaseEmitter*, JPABaseParticle*); // _40
...
struct TFueactCircle : public JPAEmitterCallBack, public JPAParticleCallBack {
    ...
    virtual void _30() = 0;                                      // _30
    virtual void _34() = 0;                                      // _34
    virtual void @8 @__dt();                                     // _38
    virtual void @8 @execute(JPABaseEmitter*, JPABaseParticle*); // _3C
    virtual void execute(JPABaseEmitter*);                       // _44
    virtual void execute(JPABaseEmitter*, JPABaseParticle*);     // _48
    virtual void executeAfter(JPABaseEmitter*);                  // _4C
    virtual ~TFueactCircle();                                    // _50
