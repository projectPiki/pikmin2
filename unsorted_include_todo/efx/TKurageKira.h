#ifndef _EFX_TKURAGEKIRA_H
#define _EFX_TKURAGEKIRA_H
...
namespace efx {
struct TKurageKira : public TSync, public JPAEmitterCallBack, public TChasePos {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TKurageKira();  // _48 (inline)
};
} // namespace efx
