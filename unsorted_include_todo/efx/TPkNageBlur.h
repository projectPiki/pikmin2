#ifndef _EFX_TPKNAGEBLUR_H
#define _EFX_TPKNAGEBLUR_H
...
namespace efx {
struct TPkNageBlur : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void create(Arg*); // _08
    virtual void _14() = 0;    // _14
    virtual void _18() = 0;    // _18
    virtual void @4 @__dt();   // _1C (inline)
    virtual ~TPkNageBlur();    // _48 (inline)
