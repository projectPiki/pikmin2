#ifndef _EFX_TKURAGEEYE_H
#define _EFX_TKURAGEEYE_H
...
namespace efx {
struct TKurageEye : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TKurageEye();   // _48 (inline)
};
} // namespace efx
