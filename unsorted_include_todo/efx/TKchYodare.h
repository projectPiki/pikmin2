#ifndef _EFX_TKCHYODARE_H
#define _EFX_TKCHYODARE_H
...
namespace efx {
struct TKchYodare : public TKchYodareBaseChaseMtx, public JPAEmitterCallBack, public TSync, public TChaseMtx {
	virtual void _14() = 0; // _14
	virtual void _18() = 0; // _18
