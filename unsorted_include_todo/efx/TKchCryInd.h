#ifndef _EFX_TKCHCRYIND_H
#define _EFX_TKCHCRYIND_H
...
namespace efx {
struct TKchCryInd : public TSync, public JPAEmitterCallBack, public TChaseMtxT {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TKchCryInd();   // _48 (inline)
