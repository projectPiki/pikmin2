#ifndef _EFX_TTANKFIREHIT_H
#define _EFX_TTANKFIREHIT_H
...
namespace efx {
struct TTankFireHit : public TOneEmitterSimple, public JPAEmitterCallBack {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TTankFireHit(); // _3C (inline)
};
} // namespace efx
