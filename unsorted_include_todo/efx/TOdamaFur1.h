#ifndef _EFX_TODAMAFUR1_H
#define _EFX_TODAMAFUR1_H
...
namespace efx {
struct TOdamaFur1 : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TOdamaFur1();   // _48 (inline)
