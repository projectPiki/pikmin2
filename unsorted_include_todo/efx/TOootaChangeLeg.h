#ifndef _EFX_TOOOTACHANGELEG_H
#define _EFX_TOOOTACHANGELEG_H
...
namespace efx {
struct TOootaChangeLeg : public TSync, public JPAEmitterCallBack, public TChasePosPosLocalYScale {
	virtual void _14() = 0;     // _14
	virtual void _18() = 0;     // _18
