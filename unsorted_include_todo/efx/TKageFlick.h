#ifndef _EFX_TKAGEFLICK_H
#define _EFX_TKAGEFLICK_H
...
namespace efx {
struct TKageFlick : public TSync, public JPAEmitterCallBack, public TChasePos {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TKageFlick();   // _48 (inline)
};
} // namespace efx
