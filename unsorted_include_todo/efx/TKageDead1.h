#ifndef _EFX_TKAGEDEAD1_H
#define _EFX_TKAGEDEAD1_H
...
namespace efx {
struct TKageDead1 : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TKageDead1();   // _48 (inline)
