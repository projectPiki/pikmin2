#ifndef _EFX_TDAMASMOKE_H
#define _EFX_TDAMASMOKE_H
...
namespace efx {
struct TDamaSmoke : public TSync, public JPAEmitterCallBack, public TChasePos {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TDamaSmoke();   // _48 (inline)
};
} // namespace efx
