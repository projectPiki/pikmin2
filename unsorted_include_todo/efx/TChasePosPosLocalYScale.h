#ifndef _EFX_TCHASEPOSPOSLOCALYSCALE_H
#define _EFX_TCHASEPOSPOSLOCALYSCALE_H
...
namespace efx {
struct TChasePosPosLocalYScale : public TSync, public JPAEmitterCallBack {
    virtual void _14() = 0;                                  // _14
    virtual void _18() = 0;                                  // _18
    virtual void @4 @__dt();                                 // _1C (inline)
    virtual void doExecuteEmitterOperation(JPABaseEmitter*); // _38
    virtual ~TChasePosPosLocalYScale();                      // _48 (inline)
