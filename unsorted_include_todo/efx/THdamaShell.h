#ifndef _EFX_THDAMASHELL_H
#define _EFX_THDAMASHELL_H
...
namespace efx {
struct THdamaShell : public TSync, public JPAEmitterCallBack, public TChasePos {
    virtual void create(Arg*); // _08
    virtual void _14() = 0;    // _14
    virtual void _18() = 0;    // _18
    virtual void @4 @__dt();   // _1C (inline)
    virtual ~THdamaShell();    // _48 (inline)
};
} // namespace efx
