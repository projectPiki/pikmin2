#ifndef _EFX_TFUEACTBIRIBASE_H
#define _EFX_TFUEACTBIRIBASE_H
...
namespace efx {
struct TFueactBiriBase : public TSync, public JPAEmitterCallBack {
    virtual void _14() = 0;                                  // _14
    virtual void _18() = 0;                                  // _18
    virtual void @4 @__dt();                                 // _1C (inline)
    virtual void doExecuteEmitterOperation(JPABaseEmitter*); // _38
    virtual ~TFueactBiriBase();                              // _48 (inline)
};
} // namespace efx
