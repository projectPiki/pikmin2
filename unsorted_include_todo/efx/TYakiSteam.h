#ifndef _EFX_TYAKISTEAM_H
#define _EFX_TYAKISTEAM_H
...
namespace efx {
struct TYakiSteam : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TYakiSteam();   // _48 (inline)
};
} // namespace efx
