#ifndef _EFX_TODAMAFUR2_H
#define _EFX_TODAMAFUR2_H
...
namespace efx {
struct TOdamaFur2 : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TOdamaFur2();   // _48 (inline)
