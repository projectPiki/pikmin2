#ifndef _EFX_TKCHDEADYODARE_H
#define _EFX_TKCHDEADYODARE_H
...
namespace efx {
struct TKchDeadYodare : public TKchYodareBaseChaseMtx, public JPAEmitterCallBack, public TSync, public TChaseMtx {
	virtual void _14() = 0;    // _14
	virtual void _18() = 0;    // _18
	virtual ~TKchDeadYodare(); // _48 (weak)

	TKchDeadYodare(float (*)[4]);
};
} // namespace efx
