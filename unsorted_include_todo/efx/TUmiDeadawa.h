#ifndef _EFX_TUMIDEADAWA_H
#define _EFX_TUMIDEADAWA_H
...
namespace efx {
struct TUmiDeadawa : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TUmiDeadawa();  // _48 (inline)
