#ifndef _EFX_TKURAGEGEPU_H
#define _EFX_TKURAGEGEPU_H
...
namespace efx {
struct TKurageGepu : public TSync, public JPAEmitterCallBack, public TChasePos {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TKurageGepu();  // _48 (inline)
};
} // namespace efx
