#ifndef _EFX_THDAMASIGHT_H
#define _EFX_THDAMASIGHT_H
...
struct TForever {
    ...
    virtual void doExecuteEmitterOperation(JPABaseEmitter*); // _38 (inline)
};
} // namespace efx

namespace efx {
struct THdamaSight : public TSync, public JPAEmitterCallBack, public TForever {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~THdamaSight();  // _48 (inline)

    void setPosNrm(Vector3<float>&, Vector3<float>&);
};
} // namespace efx
