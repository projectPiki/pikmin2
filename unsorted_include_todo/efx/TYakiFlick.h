#ifndef _EFX_TYAKIFLICK_H
#define _EFX_TYAKIFLICK_H
...
namespace efx {
struct TYakiFlick : public TSync, public JPAEmitterCallBack, public TChaseMtx {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TYakiFlick();   // _48 (inline)
};
} // namespace efx
