#ifndef _EFX_TQURIDISAP_H
#define _EFX_TQURIDISAP_H
...
namespace efx {
struct TQuriDisap : public TSync, public JPAEmitterCallBack, public TChaseMtxT {
    virtual void _14() = 0;  // _14
    virtual void _18() = 0;  // _18
    virtual void @4 @__dt(); // _1C (inline)
    virtual ~TQuriDisap();   // _48 (inline)
};
} // namespace efx
